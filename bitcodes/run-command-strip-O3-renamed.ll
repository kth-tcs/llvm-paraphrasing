; ModuleID = 'run-command-strip-O3-renamed.bc'
...
define internal void @93(i32 %0) #0 {
  %2 = load %5*, %5** @55, align 8
  %3 = icmp eq %5* %2, null
  br i1 %3, label %43, label %4

4:                                                ; preds = %1, %22
  %5 = phi %5* [ %24, %22 ], [ %2, %1 ]
  %6 = phi %5* [ %23, %22 ], [ null, %1 ]
  %7 = getelementptr inbounds %5, %5* %5, i64 0, i32 2
  %8 = bitcast %5** %7 to i64*
  %9 = load i64, i64* %8, align 8
  store i64 %9, i64* bitcast (%5** @55 to i64*), align 8
  %10 = getelementptr inbounds %5, %5* %5, i64 0, i32 1
  %11 = getelementptr inbounds %5, %5* %5, i64 0, i32 0
  %12 = load i32, i32* %11, align 8
  %13 = tail call i32 @kill(i32 %12, i32 %0) #13
  %14 = load %6*, %6** %10, align 8
  %15 = icmp eq %6* %14, null
  br i1 %15, label %22, label %16

16:                                               ; preds = %4
  %17 = getelementptr inbounds %6, %6* %14, i64 0, i32 13
...
21:                                               ; preds = %16
  store %5* %6, %5** %7, align 8
  br label %22

22:                                               ; preds = %21, %16, %4
  %23 = phi %5* [ %5, %21 ], [ %6, %16 ], [ %6, %4 ]
  %24 = load %5*, %5** @55, align 8
  %25 = icmp eq %5* %24, null
  br i1 %25, label %26, label %4

26:                                               ; preds = %22
  %27 = icmp eq %5* %23, null
  br i1 %27, label %43, label %28

28:                                               ; preds = %26, %41
  %29 = phi %5* [ %31, %41 ], [ %23, %26 ]
...
33:                                               ; preds = %37, %28
  ...
  %35 = tail call i32 @waitpid(i32 %34, i32* null, i32 0) #13
...
41:                                               ; preds = %37, %33
  %42 = icmp eq %5* %31, null
  br i1 %42, label %43, label %28

43:                                               ; preds = %41, %1, %26
  %44 = tail call i32 @sigchain_pop(i32 %0) #13
  %45 = tail call i32 @raise(i32 %0) #13
  ret void
}
...
7:                                                ; preds = %5, %25
  %8 = phi %5* [ %27, %25 ], [ %3, %5 ]
  %9 = phi %5* [ %26, %25 ], [ null, %5 ]
  %10 = getelementptr inbounds %5, %5* %8, i64 0, i32 2
  %11 = bitcast %5** %10 to i64*
  %12 = load i64, i64* %11, align 8
  store i64 %12, i64* bitcast (%5** @55 to i64*), align 8
  %13 = getelementptr inbounds %5, %5* %8, i64 0, i32 1
  %14 = getelementptr inbounds %5, %5* %8, i64 0, i32 0
  %15 = load i32, i32* %14, align 8
  %16 = tail call i32 @kill(i32 %15, i32 %0) #13
  %17 = load %6*, %6** %13, align 8
  %18 = icmp eq %6* %17, null
  br i1 %18, label %25, label %19

19:                                               ; preds = %7
  %20 = getelementptr inbounds %6, %6* %17, i64 0, i32 13
...
24:                                               ; preds = %19
  store %5* %9, %5** %10, align 8
  br label %25

25:                                               ; preds = %7, %19, %24
  %26 = phi %5* [ %8, %24 ], [ %9, %19 ], [ %9, %7 ]
  %27 = load %5*, %5** @55, align 8
  %28 = icmp eq %5* %27, null
  br i1 %28, label %29, label %7

29:                                               ; preds = %25, %92
  %30 = phi %5* [ %93, %92 ], [ %26, %25 ]
...
34:                                               ; preds = %32, %47
  %35 = phi %5* [ %37, %47 ], [ %30, %32 ]
  %36 = getelementptr inbounds %5, %5* %35, i64 0, i32 2
  %37 = load %5*, %5** %36, align 8
  %38 = getelementptr inbounds %5, %5* %35, i64 0, i32 0
  br label %39

39:                                               ; preds = %43, %34
  %40 = load i32, i32* %38, align 8
  %41 = tail call i32 @waitpid(i32 %40, i32* null, i32 0) #13
...
47:                                               ; preds = %39, %43
  %48 = bitcast %5* %35 to i8*
  tail call void @free(i8* %48) #13
  %49 = icmp eq %5* %37, null
  br i1 %49, label %111, label %34

50:                                               ; preds = %5, %92
  %51 = phi %5* [ %94, %92 ], [ %3, %5 ]
  %52 = phi %5* [ %93, %92 ], [ null, %5 ]
  %53 = getelementptr inbounds %5, %5* %51, i64 0, i32 2
  %54 = bitcast %5** %53 to i64*
  %55 = load i64, i64* %54, align 8
  store i64 %55, i64* bitcast (%5** @55 to i64*), align 8
  %56 = getelementptr inbounds %5, %5* %51, i64 0, i32 1
  %57 = load %6*, %6** %56, align 8
  %58 = icmp eq %6* %57, null
  br i1 %58, label %78, label %59

59:                                               ; preds = %50
  %60 = getelementptr inbounds %6, %6* %57, i64 0, i32 14
  %61 = bitcast {}** %60 to void (%6*)**
  %62 = load void (%6*)*, void (%6*)** %61, align 8
  %63 = icmp eq void (%6*)* %62, null
  br i1 %63, label %78, label %64

64:                                               ; preds = %59
  %65 = load i32, i32* getelementptr inbounds (%4, %4* @trace_default_key, i64 0, i32 1), align 8
  %66 = icmp eq i32 %65, 0
  br i1 %66, label %67, label %71

67:                                               ; preds = %64
  %68 = load i8, i8* getelementptr inbounds (%4, %4* @trace_default_key, i64 0, i32 2), align 4
  %69 = and i8 %68, 1
  %70 = icmp eq i8 %69, 0
  br i1 %70, label %71, label %76

71:                                               ; preds = %67, %64
  %72 = getelementptr inbounds %5, %5* %51, i64 0, i32 0
  %73 = load i32, i32* %72, align 8
  %74 = sext i32 %73 to i64
  tail call void (i8*, i32, %4*, i8*, ...) @trace_printf_key_fl(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @0, i64 0, i64 0), i32 46, %4* nonnull @trace_default_key, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @57, i64 0, i64 0), i64 %74) #13
  %75 = load void (%6*)*, void (%6*)** %61, align 8
  br label %76

76:                                               ; preds = %67, %71
  %77 = phi void (%6*)* [ %62, %67 ], [ %75, %71 ]
  tail call void %77(%6* nonnull %57) #13
  br label %78

78:                                               ; preds = %76, %59, %50
  %79 = getelementptr inbounds %5, %5* %51, i64 0, i32 0
  %80 = load i32, i32* %79, align 8
  %81 = tail call i32 @kill(i32 %80, i32 %0) #13
  %82 = load %6*, %6** %56, align 8
  %83 = icmp eq %6* %82, null
  br i1 %83, label %90, label %84

84:                                               ; preds = %78
  %85 = getelementptr inbounds %6, %6* %82, i64 0, i32 13
...
89:                                               ; preds = %84
  store %5* %52, %5** %53, align 8
  br label %92

90:                                               ; preds = %78, %84
  %91 = bitcast %5* %51 to i8*
  tail call void @free(i8* %91) #13
  br label %92

92:                                               ; preds = %90, %89
  %93 = phi %5* [ %51, %89 ], [ %52, %90 ]
  %94 = load %5*, %5** @55, align 8
  %95 = icmp eq %5* %94, null
  br i1 %95, label %29, label %50

96:                                               ; preds = %32, %109
  %97 = phi %5* [ %99, %109 ], [ %30, %32 ]
  %98 = getelementptr inbounds %5, %5* %97, i64 0, i32 2
  %99 = load %5*, %5** %98, align 8
  %100 = getelementptr inbounds %5, %5* %97, i64 0, i32 0
  br label %101

101:                                              ; preds = %105, %96
  %102 = load i32, i32* %100, align 8
  %103 = tail call i32 @waitpid(i32 %102, i32* null, i32 0) #13
  %104 = icmp slt i32 %103, 0
...
109:                                              ; preds = %105, %101
  %110 = icmp eq %5* %99, null
  br i1 %110, label %111, label %96

111:                                              ; preds = %109, %47, %2, %29
  ret void
}
