; ModuleID = 'hash-object-strip-O2-renamed.bc'
...
156:                                              ; preds = %154, %179
  ...
  br i1 %118, label %160, label %162

160:                                              ; preds = %156
  %161 = call i8* @prefix_filename(i8* nonnull %115, i8* %159) #7
  br label %162

162:                                              ; preds = %160, %156
  %163 = phi i8* [ %161, %160 ], [ %159, %156 ]
  %164 = phi i8* [ %161, %160 ], [ null, %156 ]
...
168:                                              ; preds = %162
  ...
  %171 = select i1 %170, i8* %163, i8* %169
  br label %172

172:                                              ; preds = %162, %168
  %173 = phi i8* [ null, %162 ], [ %171, %168 ]
  %174 = load i32, i32* %13, align 4
  %175 = load i32, i32* %11, align 4
  %176 = call i32 (i8*, i32, ...) @open64(i8* %163, i32 0) #7
  %177 = icmp slt i32 %176, 0
  br i1 %177, label %178, label %179

178:                                              ; preds = %172
  call void (i8*, ...) @die_errno(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @26, i64 0, i64 0), i8* %163) #8
  unreachable

179:                                              ; preds = %172
  call fastcc void @32(i32 %176, i8* %165, i8* %173, i32 %174, i32 %175) #7
  call void @free(i8* %164) #7
  %180 = add nuw nsw i64 %157, 1
  %181 = icmp slt i64 %180, %155
  br i1 %181, label %156, label %182

182:                                              ; preds = %179, %131, %152
...
185:                                              ; preds = %182
  ...
  %190 = bitcast %49* %5 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %190) #7
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %190, i8* align 8 bitcast (%49* @27 to i8*), i64 24, i1 false) #7
  %191 = bitcast %49* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %191) #7
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %191, i8* align 8 bitcast (%49* @27 to i8*), i64 24, i1 false) #7
  %192 = load %47*, %47** @stdin, align 8
  %193 = call i32 @strbuf_getline(%49* nonnull %5, %47* %192) #7
  %194 = icmp eq i32 %193, -1
  br i1 %194, label %231, label %195

195:                                              ; preds = %185
  %196 = getelementptr inbounds %49, %49* %5, i64 0, i32 2
  %197 = getelementptr inbounds %49, %49* %6, i64 0, i32 1
  %198 = getelementptr inbounds %49, %49* %6, i64 0, i32 2
  %199 = icmp eq i32 %187, 0
  %200 = getelementptr inbounds [24 x i8], [24 x i8]* %4, i64 0, i64 0
  br label %201
...
205:                                              ; preds = %201
  ...
  %206 = load i8*, i8** %198, align 8
  %207 = icmp eq i8* %206, getelementptr inbounds ([0 x i8], [0 x i8]* @strbuf_slopbuf, i64 0, i64 0)
...
210:                                              ; preds = %205
  %211 = load i8, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @strbuf_slopbuf, i64 0, i64 0), align 1
...
214:                                              ; preds = %210, %208
  %215 = phi i8* [ %209, %208 ], [ %202, %210 ]
  %216 = call i32 @unquote_c_style(%49* nonnull %6, i8* %215, i8** null) #7
...
219:                                              ; preds = %214
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %200, i8* nonnull align 8 %190, i64 24, i1 false) #7
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %190, i8* nonnull align 8 %191, i64 24, i1 false) #7
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %191, i8* nonnull align 16 %200, i64 24, i1 false) #7
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %200)
  %220 = load i8*, i8** %196, align 8
  br label %221

221:                                              ; preds = %219, %201
  %222 = phi i8* [ %220, %219 ], [ %202, %201 ]
  %223 = call i32 (i8*, i32, ...) @open64(i8* %222, i32 0) #7
  %224 = icmp slt i32 %223, 0
  br i1 %224, label %225, label %226

225:                                              ; preds = %221
  call void (i8*, ...) @die_errno(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @26, i64 0, i64 0), i8* %222) #8
  unreachable

226:                                              ; preds = %221
  %227 = select i1 %199, i8* %222, i8* null
  call fastcc void @32(i32 %223, i8* %186, i8* %227, i32 %188, i32 %189) #7
  %228 = load %47*, %47** @stdin, align 8
  %229 = call i32 @strbuf_getline(%49* nonnull %5, %47* %228) #7
...
231:                                              ; preds = %226, %185
  ...
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %190) #7
  br label %232
