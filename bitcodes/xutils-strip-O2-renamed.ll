; ModuleID = 'xutils-strip-O2-renamed.bc'
...
19:                                               ; preds = %82, %12
  %20 = phi i64 [ 5381, %12 ], [ %84, %82 ]
  %21 = phi i8* [ %4, %12 ], [ %83, %82 ]
  %22 = load i8, i8* %21, align 1
  %23 = icmp eq i8 %22, 10
  br i1 %23, label %86, label %24

24:                                               ; preds = %19
  br i1 %10, label %25, label %33
...
52:                                               ; preds = %43, %39
  %53 = phi i1 [ %50, %43 ], [ true, %39 ]
  br i1 %14, label %54, label %82
...
63:                                               ; preds = %59
  %64 = mul i64 %20, 33
  %65 = sext i8 %22 to i64
  %66 = xor i64 %64, %65
  %67 = icmp eq i8* %21, %40
  br i1 %67, label %82, label %68

68:                                               ; preds = %63, %68
  %69 = phi i8* [ %71, %68 ], [ %21, %63 ]
...
77:                                               ; preds = %33, %30, %27, %25
  %78 = mul i64 %20, 33
  %79 = sext i8 %22 to i64
  %80 = xor i64 %78, %79
  %81 = getelementptr inbounds i8, i8* %21, i64 1
  br label %82

82:                                               ; preds = %68, %63, %77, %59, %56, %52, %30
  %83 = phi i8* [ %41, %59 ], [ %41, %56 ], [ %41, %52 ], [ %28, %30 ], [ %81, %77 ], [ %41, %63 ], [ %41, %68 ]
  %84 = phi i64 [ %20, %59 ], [ %58, %56 ], [ %20, %52 ], [ %20, %30 ], [ %80, %77 ], [ %66, %63 ], [ %75, %68 ]
  %85 = icmp ult i8* %83, %1
  br i1 %85, label %19, label %101

86:                                               ; preds = %19
  %87 = getelementptr inbounds i8, i8* %21, i64 1
  br label %101

88:                                               ; preds = %7, %93
  %89 = phi i8* [ %97, %93 ], [ %4, %7 ]
  %90 = phi i64 [ %96, %93 ], [ 5381, %7 ]
...
93:                                               ; preds = %88
  ...
  %98 = icmp ult i8* %97, %1
  br i1 %98, label %88, label %101

99:                                               ; preds = %88
  %100 = getelementptr inbounds i8, i8* %89, i64 1
  br label %101

101:                                              ; preds = %82, %93, %7, %99, %86, %9
  %102 = phi i8* [ %87, %86 ], [ %4, %9 ], [ %100, %99 ], [ %4, %7 ], [ %97, %93 ], [ %83, %82 ]
  %103 = phi i64 [ %20, %86 ], [ 5381, %9 ], [ %90, %99 ], [ 5381, %7 ], [ %96, %93 ], [ %84, %82 ]
  store i8* %102, i8** %0, align 8
  ret i64 %103
}
