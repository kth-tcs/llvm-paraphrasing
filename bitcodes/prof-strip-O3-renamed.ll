; ModuleID = 'prof-strip-O3-renamed.bc'
...
600:                                              ; preds = %597
  %601 = getelementptr %63, %63* %48, i64 0, i32 2, i32 0
...
720:                                              ; preds = %718, %677, %663, %649
  ...
  %728 = getelementptr %35, %35* %727, i64 0, i32 0
...
135:                                              ; preds = %133, %92, %78, %64
  ...
  %143 = getelementptr %35, %35* %142, i64 0, i32 0
...
598:                                              ; preds = %596, %555, %541, %527
  ...
  %606 = getelementptr %35, %35* %605, i64 0, i32 0
...
967:                                              ; preds = %965, %924, %910, %896
  ...
  %975 = getelementptr %35, %35* %974, i64 0, i32 0
  %976 = load i64, i64* %975, align 8
