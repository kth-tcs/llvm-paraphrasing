; ModuleID = 'pdo_dbh-strip-O2-renamed.bc'
...
183:                                              ; preds = %167
  ...
  %189 = getelementptr inbounds %16*, %16** %186, i64 11
  %190 = bitcast %16** %189 to i8**
  store i8* %188, i8** %190, align 8
  %191 = getelementptr inbounds %16*, %16** %186, i64 12
...
215:                                              ; preds = %183
  call fastcc void @189(%47* nonnull %187, %11* nonnull %1, %16* %168, %11* nonnull %4)
  br label %238

216:                                              ; preds = %183
  %217 = call i32 @strcmp(i8* nonnull %56, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @99, i64 0, i64 0)) #11
...
220:                                              ; preds = %216, %219
  %221 = getelementptr inbounds %11, %11* %1, i64 0, i32 1
  %222 = bitcast %13* %221 to %75*
  %223 = getelementptr inbounds %75, %75* %222, i64 0, i32 1
...
227:                                              ; preds = %220
  %228 = bitcast %11* %1 to %76**
  %229 = load %76*, %76** %228, align 8
  %230 = getelementptr inbounds %76, %76* %229, i64 0, i32 0, i32 0
...
234:                                              ; preds = %227
  %235 = load %76*, %76** %228, align 8
  call void @_zval_dtor_func(%76* %235) #10
  br label %236

236:                                              ; preds = %220, %227, %234
  %237 = getelementptr inbounds %11, %11* %1, i64 0, i32 1, i32 0
  store i32 2, i32* %237, align 8
  br label %238

238:                                              ; preds = %52, %236, %215, %181, %140, %125, %110, %100, %67
...
59:                                               ; preds = %50
  ...
  %67 = getelementptr inbounds %16*, %16** %62, i64 11
  %68 = bitcast %16** %67 to i8**
  store i8* %66, i8** %68, align 8
  %69 = load i64, i64* %4, align 8
  %70 = getelementptr inbounds %16*, %16** %62, i64 12
...
137:                                              ; preds = %118, %130, %132
  ...
  call fastcc void @189(%47* nonnull %63, %11* nonnull %1, %16* %138, %11* nonnull %40)
  br label %163

139:                                              ; preds = %132, %111, %108
  %140 = bitcast %47** %27 to %16***
  store %16** %62, %16*** %140, align 8
  %141 = getelementptr inbounds %11, %11* %1, i64 0, i32 0, i32 0
  %142 = load i64, i64* %141, align 8
  %143 = getelementptr inbounds %11, %11* %1, i64 0, i32 1, i32 0
  %144 = load i32, i32* %143, align 8
  %145 = getelementptr inbounds %44, %44* %12, i64 0, i32 19, i32 0, i32 0
  store i64 %142, i64* %145, align 8
  %146 = getelementptr inbounds %44, %44* %12, i64 0, i32 19, i32 1, i32 0
  store i32 %144, i32* %146, align 8
  %147 = load %76*, %76** %89, align 8
  %148 = getelementptr inbounds %76, %76* %147, i64 0, i32 0, i32 0
  %149 = load i32, i32* %148, align 4
  %150 = add i32 %149, -1
  store i32 %150, i32* %148, align 4
  store i32 0, i32* %88, align 8
  %151 = call i32 @strcmp(i8* nonnull %105, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @99, i64 0, i64 0)) #11
  %152 = icmp eq i32 %151, 0
  br i1 %152, label %161, label %153

153:                                              ; preds = %139
  %154 = load %44*, %44** %83, align 8
  call void @pdo_handle_error(%44* %154, %47* nonnull %63)
  br label %161

155:                                              ; preds = %59
  %156 = call i32 @strcmp(i8* nonnull %25, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @99, i64 0, i64 0)) #11
...
159:                                              ; preds = %155, %158
  ...
  %160 = getelementptr inbounds %11, %11* %1, i64 0, i32 1, i32 0
  br label %161

161:                                              ; preds = %139, %159, %153
  %162 = phi i32* [ %143, %139 ], [ %160, %159 ], [ %143, %153 ]
  store i32 2, i32* %162, align 8
  br label %163

163:                                              ; preds = %137, %55, %58, %161, %36, %22, %16
...
; Function Attrs: nounwind uwtable
define internal fastcc void @189(%47* nocapture readonly %0, %11* %1, %16* nocapture readonly %2, %11* %3) unnamed_addr #0 {
  %5 = alloca %11, align 8
  %6 = alloca %11, align 8
  %7 = alloca %53, align 8
  %8 = alloca %54, align 8
  ...
  %14 = getelementptr inbounds %47, %47* %0, i64 0, i32 12
  %15 = load i64, i64* %14, align 8
  %16 = add i64 %15, 32
  %17 = and i64 %16, -8
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %27, i8* align 1 %13, i64 %15, i1 false) #10
  %28 = getelementptr inbounds %10, %10* %19, i64 0, i32 3, i64 %15
  store i8 0, i8* %28, align 1
  %29 = bitcast %11* %5 to i8**
  store i8* %18, i8** %29, align 8
  %30 = getelementptr inbounds %11, %11* %5, i64 0, i32 1, i32 0
  store i32 5126, i32* %30, align 8
  %31 = tail call noalias i8* @_emalloc(i64 40) #13
  ...
  store <2 x i64> <i64 0, i64 11>, <2 x i64>* %36, align 8
  %37 = getelementptr inbounds i8, i8* %31, i64 24
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %37, i8* align 1 getelementptr inbounds ([12 x i8], [12 x i8]* @145, i64 0, i64 0), i64 11, i1 false) #10
  %38 = getelementptr inbounds i8, i8* %31, i64 35
  store i8 0, i8* %38, align 1
  %39 = bitcast %11* %6 to i8**
  store i8* %31, i8** %39, align 8
  %40 = getelementptr inbounds %11, %11* %6, i64 0, i32 1, i32 0
  store i32 5126, i32* %40, align 8
  %41 = load void (%11*, %11*, %11*, i8**)*, void (%11*, %11*, %11*, i8**)** getelementptr inbounds (%21, %21* @std_object_handlers, i64 0, i32 5), align 8
  call void %41(%11* %1, %11* nonnull %6, %11* nonnull %5, i8** null) #10
  call void @_zval_ptr_dtor(%11* nonnull %5) #10
  call void @_zval_ptr_dtor(%11* nonnull %6) #10
  %42 = getelementptr inbounds %16, %16* %2, i64 0, i32 13
  %43 = load %37*, %37** %42, align 8
  %44 = icmp eq %37* %43, null
  br i1 %44, label %80, label %45

45:                                               ; preds = %4
  %46 = bitcast %53* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %46) #10
  %47 = getelementptr inbounds %54, %54* %8, i64 0, i32 0
  call void @llvm.lifetime.start.p0i8(i64 40, i8* nonnull %47) #10
  %48 = bitcast %11* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %48) #10
  %49 = getelementptr inbounds %53, %53* %7, i64 0, i32 0
  store i64 56, i64* %49, align 8
  %50 = getelementptr inbounds %53, %53* %7, i64 0, i32 1, i32 1, i32 0
  store i32 0, i32* %50, align 8
  %51 = bitcast %11* %1 to %20**
  %52 = getelementptr inbounds %11, %11* %1, i64 0, i32 0, i32 0
  %53 = load i64, i64* %52, align 8
  %54 = getelementptr inbounds %53, %53* %7, i64 0, i32 4
  %55 = bitcast %20** %54 to i64*
  store i64 %53, i64* %55, align 8
  %56 = getelementptr inbounds %53, %53* %7, i64 0, i32 2
  store %11* %9, %11** %56, align 8
  %57 = getelementptr inbounds %53, %53* %7, i64 0, i32 6
  store i32 0, i32* %57, align 4
  %58 = getelementptr inbounds %53, %53* %7, i64 0, i32 3
  store %11* null, %11** %58, align 8
  %59 = getelementptr inbounds %53, %53* %7, i64 0, i32 5
  store i8 1, i8* %59, align 8
  %60 = call i32 @zend_fcall_info_args(%53* nonnull %7, %11* %3) #10
  store i8 1, i8* %47, align 8
  %61 = bitcast %37** %42 to i64*
  %62 = load i64, i64* %61, align 8
  %63 = getelementptr inbounds %54, %54* %8, i64 0, i32 1
  %64 = bitcast %37** %63 to i64*
  store i64 %62, i64* %64, align 8
  %65 = call %16* @zend_get_executed_scope() #10
  %66 = getelementptr inbounds %54, %54* %8, i64 0, i32 2
  store %16* %65, %16** %66, align 8
  %67 = load %20*, %20** %51, align 8
  %68 = getelementptr inbounds %20, %20* %67, i64 0, i32 2
  %69 = bitcast %16** %68 to i64*
  %70 = load i64, i64* %69, align 8
  %71 = getelementptr inbounds %54, %54* %8, i64 0, i32 3
  %72 = bitcast %16** %71 to i64*
  store i64 %70, i64* %72, align 8
  %73 = ptrtoint %20* %67 to i64
  %74 = getelementptr inbounds %54, %54* %8, i64 0, i32 4
  %75 = bitcast %20** %74 to i64*
  store i64 %73, i64* %75, align 8
  %76 = call i32 @zend_call_function(%53* nonnull %7, %54* nonnull %8) #10
  %77 = icmp eq i32 %76, -1
  br i1 %77, label %79, label %78

78:                                               ; preds = %45
  call void @_zval_ptr_dtor(%11* nonnull %9) #10
  br label %79

79:                                               ; preds = %45, %78
  call void @zend_fcall_info_args_clear(%53* nonnull %7, i32 1) #10
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %48) #10
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %47) #10
