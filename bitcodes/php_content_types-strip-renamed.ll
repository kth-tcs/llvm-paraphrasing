; ModuleID = 'php_content_types-strip-renamed.bc'
...
define dso_local void @php_default_post_reader() #0 {
  %1 = load i8*, i8** getelementptr inbounds (%0, %0* @sapi_globals, i32 0, i32 1, i32 0), align 8
  %2 = call i32 @strcmp(i8* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0)) #3
  %3 = icmp ne i32 %2, 0
  br i1 %3, label %9, label %4

4:                                                ; preds = %0
  %5 = load %20*, %20** getelementptr inbounds (%0, %0* @sapi_globals, i32 0, i32 1, i32 11), align 8
  %6 = icmp eq %20* null, %5
...
define hidden i32 @php_startup_sapi_content_types() #0 {
  %1 = call i32 @sapi_register_default_post_reader(void ()* @php_default_post_reader)
  %2 = call i32 @sapi_register_treat_data(void (i32, i8*, %29*)* @php_default_treat_data)
  %3 = call i32 @sapi_register_input_filter(i32 (i32, i8*, i8**, i64, i64*)* @php_default_input_filter, i32 ()* null)
  ret i32 0
}

declare dso_local i32 @sapi_register_default_post_reader(void ()*) #2

declare dso_local i32 @sapi_register_treat_data(void (i32, i8*, %29*)*) #2

declare dso_local void @php_default_treat_data(i32, i8*, %29*) #2

declare dso_local i32 @sapi_register_input_filter(i32 (i32, i8*, i8**, i64, i64*)*, i32 ()*) #2

declare dso_local i32 @php_default_input_filter(i32, i8*, i8**, i64, i64*) #2

; Function Attrs: nounwind uwtable
define hidden i32 @php_setup_sapi_content_types() #0 {
  %1 = call i32 @sapi_register_post_entries(%20* getelementptr inbounds ([3 x %20], [3 x %20]* @1, i32 0, i32 0))
  ret i32 0
}

declare dso_local i32 @sapi_register_post_entries(%20*) #2
