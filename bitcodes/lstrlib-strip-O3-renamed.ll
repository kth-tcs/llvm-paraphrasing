; ModuleID = 'lstrlib-strip-O3-renamed.bc'
...
86:                                               ; preds = %73
  %87 = call fastcc i8* @57(%3* nonnull %5, i8* %80, i8* %79)
  %88 = icmp eq i8* %87, null
  br i1 %88, label %123, label %92

89:                                               ; preds = %73
  %90 = call fastcc i8* @57(%3* nonnull %5, i8* %80, i8* nonnull %79)
  %91 = icmp eq i8* %90, null
  br i1 %91, label %131, label %92

92:                                               ; preds = %127, %86, %89
  %93 = phi i8* [ %80, %89 ], [ %80, %86 ], [ %128, %127 ]
  %94 = phi i8* [ %90, %89 ], [ %87, %86 ], [ %129, %127 ]
  br i1 %23, label %95, label %111
...
95:                                               ; preds = %92
  ...
  %98 = sub i64 1, %97
  %99 = add i64 %98, %96
  call void @lua_pushinteger(%1* %0, i64 %99) #8
  %100 = ptrtoint i8* %94 to i64
  %101 = sub i64 %100, %97
  call void @lua_pushinteger(%1* %0, i64 %101) #8
  %102 = load i32, i32* %85, align 8
  %103 = load %1*, %1** %81, align 8
  call void @luaL_checkstack(%1* %103, i32 %102, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @22, i64 0, i64 0)) #8
  %104 = icmp sgt i32 %102, 0
  br i1 %104, label %105, label %109

105:                                              ; preds = %95, %105
  %106 = phi i32 [ %107, %105 ], [ 0, %95 ]
  call fastcc void @60(%3* nonnull %5, i32 %106, i8* null, i8* null) #8
...
111:                                              ; preds = %92
  ...
  %114 = icmp ne i8* %93, null
  %115 = and i1 %114, %113
  %116 = select i1 %115, i32 1, i32 %112
  %117 = load %1*, %1** %81, align 8
  call void @luaL_checkstack(%1* %117, i32 %116, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @22, i64 0, i64 0)) #8
  %118 = icmp sgt i32 %116, 0
  br i1 %118, label %119, label %132

119:                                              ; preds = %111, %119
  %120 = phi i32 [ %121, %119 ], [ 0, %111 ]
  call fastcc void @60(%3* nonnull %5, i32 %120, i8* %93, i8* nonnull %94) #8
  %121 = add nuw nsw i32 %120, 1
  %122 = icmp eq i32 %121, %116
  br i1 %122, label %132, label %119

123:                                              ; preds = %86, %127
  %124 = phi i8* [ %128, %127 ], [ %80, %86 ]
...
127:                                              ; preds = %123
  ...
  store i32 0, i32* %85, align 8
  %129 = call fastcc i8* @57(%3* nonnull %5, i8* nonnull %128, i8* %79)
  %130 = icmp eq i8* %129, null
  br i1 %130, label %123, label %92

131:                                              ; preds = %123, %89
  call void @llvm.lifetime.end.p0i8(i64 544, i8* nonnull %75) #8
  br label %134

132:                                              ; preds = %119, %109, %111
  %133 = phi i32 [ %116, %111 ], [ %110, %109 ], [ %116, %119 ]
  call void @llvm.lifetime.end.p0i8(i64 544, i8* nonnull %75) #8
  br label %135

134:                                              ; preds = %48, %57, %40, %38, %131, %63
  call void @lua_pushnil(%1* %0) #8
  br label %135

135:                                              ; preds = %132, %65, %134
  %136 = phi i32 [ 1, %134 ], [ %133, %132 ], [ 2, %65 ]
...
16:                                               ; preds = %8, %16
  ...
  %20 = icmp ult i8* %19, %6
  br i1 %20, label %16, label %84

21:                                               ; preds = %13, %28
  %22 = phi i8* [ %30, %28 ], [ %1, %13 ]
  %23 = phi i64 [ %29, %28 ], [ 0, %13 ]
  %24 = load i8, i8* %22, align 1
  %25 = zext i8 %24 to i32
  %26 = tail call fastcc i32 @59(i32 %25, i32 %15) #8
  %27 = icmp eq i32 %26, 0
...
28:                                               ; preds = %21
  ...
  %31 = icmp ult i8* %30, %6
  br i1 %31, label %21, label %84

32:                                               ; preds = %8, %80
  %33 = phi i8* [ %82, %80 ], [ %1, %8 ]
  %34 = phi i64 [ %81, %80 ], [ 0, %8 ]
...
45:                                               ; preds = %37, %68
  %46 = phi i8* [ %70, %68 ], [ %43, %37 ]
  %47 = phi i8* [ %69, %68 ], [ %40, %37 ]
...
52:                                               ; preds = %45
  ...
  %54 = tail call fastcc i32 @59(i32 %36, i32 %53) #8
  %55 = icmp eq i32 %54, 0
...
61:                                               ; preds = %58
  %62 = icmp ugt i8 %48, %35
  br i1 %62, label %68, label %63

63:                                               ; preds = %61
  %64 = load i8, i8* %59, align 1
  %65 = icmp ult i8 %64, %35
...
68:                                               ; preds = %66, %63, %61, %52
  %69 = phi i8* [ %50, %52 ], [ %59, %63 ], [ %59, %61 ], [ %46, %66 ]
...
77:                                               ; preds = %52, %63, %66, %72, %74
  %78 = phi i32 [ %76, %74 ], [ %73, %72 ], [ %42, %66 ], [ %42, %63 ], [ %42, %52 ]
  %79 = icmp eq i32 %78, 0
...
84:                                               ; preds = %28, %21, %16, %80, %77, %4
  %85 = phi i64 [ 0, %4 ], [ %34, %77 ], [ %81, %80 ], [ %18, %16 ], [ %23, %21 ], [ %29, %28 ]
  %86 = getelementptr inbounds i8, i8* %3, i64 1
  br label %87

87:                                               ; preds = %90, %84
  %88 = phi i64 [ %85, %84 ], [ %95, %90 ]
  %89 = icmp sgt i64 %88, -1
  br i1 %89, label %90, label %96

90:                                               ; preds = %87
  %91 = getelementptr inbounds i8, i8* %1, i64 %88
  %92 = tail call fastcc i8* @57(%3* %0, i8* %91, i8* nonnull %86)
  %93 = icmp eq i8* %92, null
  %94 = sext i1 %93 to i64
  %95 = add nsw i64 %88, %94
  br i1 %93, label %87, label %96

96:                                               ; preds = %87, %90
  %97 = phi i8* [ %92, %90 ], [ null, %87 ]
  ret i8* %97
}
