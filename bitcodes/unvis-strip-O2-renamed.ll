; ModuleID = 'unvis-strip-O2-renamed.bc'
...
12:                                               ; preds = %7, %17
  %13 = phi i8* [ %18, %17 ], [ %10, %7 ]
  %14 = call i32 @unvis(i8* %13, i8 signext %8, i32* nonnull %3, i32 0)
