; ModuleID = 'test-path-utils-strip-O2-renamed.bc'
...
576:                                              ; preds = %602, %572
  %577 = phi double [ 0.000000e+00, %572 ], [ %603, %602 ]
  %578 = phi i64 [ 0, %572 ], [ %604, %602 ]
  %579 = phi i64 [ 0, %572 ], [ %605, %602 ]
  %580 = tail call i64 @getnanotime() #10
  br i1 %503, label %588, label %581

581:                                              ; preds = %576, %581
  %582 = phi i64 [ %586, %581 ], [ 0, %576 ]
  %583 = getelementptr inbounds i8*, i8** %506, i64 %582
  %584 = load i8*, i8** %583, align 8
  %585 = tail call i32 @verify_path(i8* %584, i32 %505) #10
  %586 = add nuw i64 %582, 1
  %587 = icmp eq i64 %586, %504
  br i1 %587, label %588, label %581

588:                                              ; preds = %581, %576
  %589 = tail call i64 @getnanotime() #10
  %590 = load i32, i32* @protect_ntfs, align 4
  %591 = load i32, i32* @protect_hfs, align 4
  %592 = sub i64 %589, %580
  %593 = uitofp i64 %592 to double
  %594 = fdiv double %593, 1.000000e+06
  %595 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @65, i64 0, i64 0), i32 %590, i32 %591, double %594) #10
  %596 = add i64 %592, %578
  %597 = mul i64 %592, %592
  %598 = uitofp i64 %597 to double
  %599 = fadd double %577, %598
  %600 = add nuw nsw i64 %579, 1
  %601 = icmp eq i64 %600, 15
  br i1 %601, label %606, label %602

602:                                              ; preds = %588, %630
  %603 = phi double [ %599, %588 ], [ 0.000000e+00, %630 ]
  %604 = phi i64 [ %596, %588 ], [ 0, %630 ]
  %605 = phi i64 [ %600, %588 ], [ 0, %630 ]
  br label %576

606:                                              ; preds = %588
  %607 = uitofp i64 %596 to double
  %608 = load i32, i32* @protect_ntfs, align 4
  %609 = sext i32 %608 to i64
  %610 = load i32, i32* @protect_hfs, align 4
  %611 = sext i32 %610 to i64
  %612 = getelementptr inbounds [3 x [2 x double]], [3 x [2 x double]]* %3, i64 0, i64 %609, i64 %611
  %613 = insertelement <2 x double> undef, double %599, i32 0
  %614 = insertelement <2 x double> %613, double %607, i32 1
  %615 = fdiv <2 x double> %614, <double 1.500000e+01, double 1.500000e+01>
  %616 = extractelement <2 x double> %615, i32 1
  store double %616, double* %612, align 8
  %617 = fmul double %616, %616
  %618 = extractelement <2 x double> %615, i32 0
  %619 = fsub double %618, %617
  %620 = fcmp oeq double %619, 0.000000e+00
  br i1 %620, label %630, label %621

621:                                              ; preds = %606, %621
  %622 = phi double [ %629, %621 ], [ %619, %606 ]
  %623 = fdiv double %619, %622
  %624 = fsub double %623, %622
  %625 = fmul double %624, 5.000000e-01
  %626 = fcmp olt double %625, 0x3EB0C6F7A0B5ED8D
  %627 = fcmp ogt double %625, 0xBEB0C6F7A0B5ED8D
  %628 = and i1 %626, %627
  %629 = fadd double %622, %625
  br i1 %628, label %630, label %621

630:                                              ; preds = %621, %606
  %631 = phi double [ 0.000000e+00, %606 ], [ %629, %621 ]
  %632 = fdiv double %616, 1.000000e+06
  %633 = fdiv double %631, 1.000000e+06
  %634 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @66, i64 0, i64 0), double %632, double %633) #10
  %635 = load i32, i32* @protect_hfs, align 4
  %636 = add nsw i32 %635, 1
  store i32 %636, i32* @protect_hfs, align 4
  %637 = icmp slt i32 %635, 1
  br i1 %637, label %602, label %638

638:                                              ; preds = %630
  %639 = load i32, i32* @protect_ntfs, align 4
  %640 = add nsw i32 %639, 1
  store i32 %640, i32* @protect_ntfs, align 4
  %641 = icmp slt i32 %639, 1
  br i1 %641, label %572, label %573

642:                                              ; preds = %659, %573
  %643 = phi i32 [ 0, %573 ], [ %660, %659 ]
  store i32 0, i32* @protect_hfs, align 4
  br label %644

644:                                              ; preds = %644, %642
  %645 = phi i32 [ %643, %642 ], [ %658, %644 ]
  %646 = phi i32 [ 0, %642 ], [ %656, %644 ]
  %647 = sext i32 %645 to i64
  %648 = sext i32 %646 to i64
  %649 = getelementptr inbounds [3 x [2 x double]], [3 x [2 x double]]* %3, i64 0, i64 %647, i64 %648
  %650 = load double, double* %649, align 8
  %651 = fsub double %650, %575
  %652 = fmul double %651, 1.000000e+02
  %653 = fdiv double %652, %575
  %654 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @67, i64 0, i64 0), i32 %645, i32 %646, double %653) #10
  %655 = load i32, i32* @protect_hfs, align 4
  %656 = add nsw i32 %655, 1
  store i32 %656, i32* @protect_hfs, align 4
  %657 = icmp slt i32 %655, 1
  %658 = load i32, i32* @protect_ntfs, align 4
  br i1 %657, label %644, label %659

659:                                              ; preds = %644
  %660 = add nsw i32 %658, 1
  store i32 %660, i32* @protect_ntfs, align 4
  %661 = icmp slt i32 %658, 1
  br i1 %661, label %642, label %662
...
663:                                              ; preds = %441
  %664 = tail call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @35, i64 0, i64 0)) #9
  %665 = icmp eq i32 %664, 0
  br i1 %665, label %666, label %696

666:                                              ; preds = %663
  %667 = icmp sgt i32 %0, 2
  br i1 %667, label %668, label %692

668:                                              ; preds = %666
  %669 = zext i32 %0 to i64
  br label %670

670:                                              ; preds = %687, %668
  %671 = phi i64 [ 2, %668 ], [ %690, %687 ]
  %672 = phi i32 [ 1, %668 ], [ %689, %687 ]
  %673 = phi i32 [ 0, %668 ], [ %688, %687 ]
  %674 = getelementptr inbounds i8*, i8** %1, i64 %671
  %675 = load i8*, i8** %674, align 8
  %676 = tail call i32 @strcmp(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @20, i64 0, i64 0), i8* %675) #9
  %677 = icmp eq i32 %676, 0
  br i1 %677, label %687, label %678

678:                                              ; preds = %670
  %679 = icmp eq i32 %672, 1
  br i1 %679, label %684, label %680

680:                                              ; preds = %678
  %681 = icmp eq i32 %672, 0
  %682 = select i1 %681, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @23, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @37, i64 0, i64 0)
  %683 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @36, i64 0, i64 0), i8* %675, i8* %682) #10
  br label %687

684:                                              ; preds = %678
  %685 = load %4*, %4** @stderr, align 8
  %686 = tail call i32 (%4*, i8*, ...) @fprintf(%4* %685, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @38, i64 0, i64 0), i8* %675, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @23, i64 0, i64 0)) #12
  br label %687

687:                                              ; preds = %670, %684, %680
  %688 = phi i32 [ -1, %680 ], [ %673, %684 ], [ %673, %670 ]
  %689 = phi i32 [ %672, %680 ], [ 1, %684 ], [ 0, %670 ]
  %690 = add nuw nsw i64 %671, 1
  %691 = icmp eq i64 %690, %669
  br i1 %691, label %692, label %670

692:                                              ; preds = %687, %666
  %693 = phi i32 [ 0, %666 ], [ %688, %687 ]
  %694 = icmp ne i32 %693, 0
  %695 = zext i1 %694 to i32
  br label %703

696:                                              ; preds = %29, %663
  %697 = phi i8* [ %35, %663 ], [ %32, %29 ]
  %698 = load %4*, %4** @stderr, align 8
  %699 = load i8*, i8** %1, align 8
  %700 = icmp eq i8* %697, null
  %701 = select i1 %700, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @40, i64 0, i64 0), i8* %697
  %702 = tail call i32 (%4*, i8*, ...) @fprintf(%4* %698, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @39, i64 0, i64 0), i8* %699, i8* %701) #12
  br label %703

703:                                              ; preds = %60, %58, %696, %692, %662, %438, %374, %338, %310, %266, %225, %181, %132, %118, %113, %84, %54, %19
  %704 = phi i32 [ 1, %696 ], [ %695, %692 ], [ 0, %662 ], [ %440, %438 ], [ 0, %374 ], [ %340, %338 ], [ %312, %310 ], [ %262, %266 ], [ %221, %225 ], [ 0, %181 ], [ 0, %132 ], [ 0, %118 ], [ 0, %113 ], [ 0, %84 ], [ 0, %54 ], [ 0, %19 ], [ 0, %58 ], [ 0, %60 ]
  ret i32 %704
}
