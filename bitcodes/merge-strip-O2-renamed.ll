; ModuleID = 'merge-strip-O2-renamed.bc'
...
5:                                                ; preds = %2
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %6, i8* align 8 bitcast (%35* @225 to i8*), i64 32, i1 false)
  %7 = call i32 @string_list_split(%35* nonnull %3, i8* nonnull %0, i32 32, i32 -1) #12
  %8 = getelementptr inbounds %35, %35* %3, i64 0, i32 0
  %9 = load %36*, %36** %8, align 8
  %10 = icmp eq %36* %9, null
  br i1 %10, label %52, label %11

11:                                               ; preds = %5
  %12 = getelementptr inbounds %35, %35* %3, i64 0, i32 1
  %13 = load i32, i32* %12, align 8
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %52, label %15

15:                                               ; preds = %11, %41
  %16 = phi %36* [ %46, %41 ], [ %9, %11 ]
  %17 = getelementptr inbounds %36, %36* %16, i64 0, i32 0
  %18 = load i8*, i8** %17, align 8
  %19 = call fastcc %54* @285(i8* %18)
  %20 = load i64, i64* @55, align 8
  %21 = add i64 %20, 1
  %22 = load i64, i64* @148, align 8
  %23 = icmp ugt i64 %21, %22
  br i1 %23, label %26, label %24

24:                                               ; preds = %15
  %25 = load %54**, %54*** @52, align 8
  br label %41
...
26:                                               ; preds = %15
  ...
  store i64 %31, i64* @148, align 8
  %32 = icmp ugt i64 %31, 2305843009213693951
  br i1 %32, label %33, label %34

33:                                               ; preds = %26
  call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @149, i64 0, i64 0), i64 8, i64 %31) #14
  unreachable

34:                                               ; preds = %26
  %35 = load i8*, i8** bitcast (%54*** @52 to i8**), align 8
  %36 = shl i64 %31, 3
  %37 = call i8* @xrealloc(i8* %35, i64 %36) #12
  store i8* %37, i8** bitcast (%54*** @52 to i8**), align 8
  %38 = bitcast i8* %37 to %54**
  %39 = load i64, i64* @55, align 8
  %40 = add i64 %39, 1
  br label %41

41:                                               ; preds = %34, %24
  %42 = phi i64 [ %21, %24 ], [ %40, %34 ]
  %43 = phi i64 [ %20, %24 ], [ %39, %34 ]
  %44 = phi %54** [ %25, %24 ], [ %38, %34 ]
  store i64 %42, i64* @55, align 8
  %45 = getelementptr inbounds %54*, %54** %44, i64 %43
  store %54* %19, %54** %45, align 8
  %46 = getelementptr inbounds %36, %36* %16, i64 1
  %47 = load %36*, %36** %8, align 8
  %48 = load i32, i32* %12, align 8
  %49 = zext i32 %48 to i64
  %50 = getelementptr inbounds %36, %36* %47, i64 %49
  %51 = icmp ult %36* %46, %50
...
53:                                               ; preds = %2, %87
  %54 = phi i64 [ %88, %87 ], [ 0, %2 ]
  %55 = getelementptr inbounds [5 x %54], [5 x %54]* @153, i64 0, i64 %54, i32 1
...
59:                                               ; preds = %53
  %60 = getelementptr inbounds [5 x %54], [5 x %54]* @153, i64 0, i64 %54
  %61 = load i64, i64* @55, align 8
  %62 = add i64 %61, 1
  %63 = load i64, i64* @148, align 8
  %64 = icmp ugt i64 %62, %63
  br i1 %64, label %67, label %65

65:                                               ; preds = %59
  %66 = load %54**, %54*** @52, align 8
  br label %82
...
75:                                               ; preds = %67
  %76 = load i8*, i8** bitcast (%54*** @52 to i8**), align 8
  %77 = shl i64 %72, 3
  %78 = tail call i8* @xrealloc(i8* %76, i64 %77) #12
  store i8* %78, i8** bitcast (%54*** @52 to i8**), align 8
  %79 = bitcast i8* %78 to %54**
  %80 = load i64, i64* @55, align 8
  %81 = add i64 %80, 1
  br label %82

82:                                               ; preds = %65, %75
  %83 = phi i64 [ %62, %65 ], [ %81, %75 ]
  %84 = phi i64 [ %61, %65 ], [ %80, %75 ]
  %85 = phi %54** [ %66, %65 ], [ %79, %75 ]
  store i64 %83, i64* @55, align 8
  %86 = getelementptr inbounds %54*, %54** %85, i64 %84
  store %54* %60, %54** %86, align 8
  br label %87
