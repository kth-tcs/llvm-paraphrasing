; ModuleID = 'mem-pool-strip-O2-renamed.bc'
...
13:                                               ; preds = %8
  %14 = getelementptr inbounds %1, %1* %9, i64 0, i32 3, i64 0
  %15 = bitcast i64* %14 to i8*
  %16 = getelementptr inbounds %1, %1* %9, i64 0, i32 2
  %17 = bitcast i8** %16 to i64*
  %18 = load i64, i64* %17, align 8
  %19 = ptrtoint i64* %14 to i64
  %20 = sub i64 %18, %19
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %15, i8 -35, i64 %20, i1 false)
  br label %21

21:                                               ; preds = %8, %13
  tail call void @free(i8* nonnull %10) #7
  %22 = icmp eq %1* %12, null
