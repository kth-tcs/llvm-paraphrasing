; ModuleID = 'latency-strip-O2-renamed.bc'
...
13:                                               ; preds = %8
  %14 = tail call i32 @strcasecmp(i8* %12, i8* nonnull %0) #8
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %20

16:                                               ; preds = %13, %8
  %17 = load %29*, %29** getelementptr inbounds (%1, %1* @server, i64 0, i32 327), align 8
  %18 = tail call i32 @dictDelete(%29* %17, i8* %12) #9
  %19 = add nsw i32 %10, 1
  br label %20

20:                                               ; preds = %16, %13
  %21 = phi i32 [ %19, %16 ], [ %10, %13 ]
  %22 = tail call %31* @dictNext(%38* %3) #9
  %23 = icmp eq %31* %22, null
...
25:                                               ; preds = %16
  ...
  tail call void @latencyCommandReplyWithSamples(%24* nonnull %0, %36* %26)
  br label %187

27:                                               ; preds = %1, %12
  %28 = tail call i32 @strcasecmp(i8* %9, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @61, i64 0, i64 0)) #8
  %29 = icmp eq i32 %28, 0
  br i1 %29, label %30, label %75

30:                                               ; preds = %27
  %31 = getelementptr inbounds %24, %24* %0, i64 0, i32 9
  %32 = load i32, i32* %31, align 8
  %33 = icmp eq i32 %32, 3
  br i1 %33, label %34, label %75

34:                                               ; preds = %30
  %35 = load %29*, %29** getelementptr inbounds (%1, %1* @server, i64 0, i32 327), align 8
  %36 = getelementptr inbounds %10*, %10** %5, i64 2
  %37 = load %10*, %10** %36, align 8
  %38 = getelementptr inbounds %10, %10* %37, i64 0, i32 2
  %39 = load i8*, i8** %38, align 8
  %40 = tail call %31* @dictFind(%29* %35, i8* %39) #9
  %41 = icmp eq %31* %40, null
  br i1 %41, label %181, label %42

42:                                               ; preds = %34
  %43 = getelementptr inbounds %31, %31* %40, i64 0, i32 1, i32 0
  %44 = bitcast i8** %43 to %36**
  %45 = load %36*, %36** %44, align 8
  %46 = getelementptr inbounds %31, %31* %40, i64 0, i32 0
  %47 = load i8*, i8** %46, align 8
  %48 = tail call i8* @latencyCommandGenSparkeline(i8* %47, %36* %45)
...
73:                                               ; preds = %69, %64, %59, %55, %52, %42
  %74 = phi i64 [ %72, %69 ], [ %68, %64 ], [ %63, %59 ], [ %58, %55 ], [ %54, %52 ], [ 0, %42 ]
  tail call void @addReplyVerbatim(%24* nonnull %0, i8* %48, i64 %74, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @62, i64 0, i64 0)) #9
  tail call void @sdsfree(i8* %48) #9
  br label %187

75:                                               ; preds = %27, %30
  %76 = tail call i32 @strcasecmp(i8* %9, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @63, i64 0, i64 0)) #8
  %77 = icmp eq i32 %76, 0
  br i1 %77, label %78, label %83

78:                                               ; preds = %75
  %79 = getelementptr inbounds %24, %24* %0, i64 0, i32 9
...
83:                                               ; preds = %75, %78
  %84 = tail call i32 @strcasecmp(i8* %9, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @64, i64 0, i64 0)) #8
  %85 = icmp eq i32 %84, 0
  br i1 %85, label %86, label %118

86:                                               ; preds = %83
  %87 = getelementptr inbounds %24, %24* %0, i64 0, i32 9
  %88 = load i32, i32* %87, align 8
  %89 = icmp eq i32 %88, 2
  br i1 %89, label %90, label %118

90:                                               ; preds = %86
  %91 = tail call i8* @createLatencyReport()
  %92 = getelementptr inbounds i8, i8* %91, i64 -1
  %93 = load i8, i8* %92, align 1
  %94 = trunc i8 %93 to i3
  switch i3 %94, label %116 [
    i3 0, label %95
    i3 1, label %98
    i3 2, label %102
    i3 3, label %107
...
102:                                              ; preds = %90
  %103 = getelementptr inbounds i8, i8* %91, i64 -5
...
107:                                              ; preds = %90
  %108 = getelementptr inbounds i8, i8* %91, i64 -9
...
112:                                              ; preds = %90
  %113 = getelementptr inbounds i8, i8* %91, i64 -17
  %114 = bitcast i8* %113 to i64*
  %115 = load i64, i64* %114, align 1
  br label %116

116:                                              ; preds = %90, %95, %98, %102, %107, %112
  %117 = phi i64 [ %115, %112 ], [ %111, %107 ], [ %106, %102 ], [ %101, %98 ], [ %97, %95 ], [ 0, %90 ]
  tail call void @addReplyVerbatim(%24* nonnull %0, i8* %91, i64 %117, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @62, i64 0, i64 0)) #9
  tail call void @sdsfree(i8* %91) #9
  br label %187

118:                                              ; preds = %83, %86
  %119 = tail call i32 @strcasecmp(i8* %9, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @65, i64 0, i64 0)) #8
  %120 = icmp eq i32 %119, 0
  br i1 %120, label %121, label %171

121:                                              ; preds = %118
  %122 = getelementptr inbounds %24, %24* %0, i64 0, i32 9
...
127:                                              ; preds = %125
  %128 = getelementptr inbounds %10*, %10** %5, i64 2
  %129 = load %10*, %10** %128, align 8
  %130 = getelementptr inbounds %10, %10* %129, i64 0, i32 2
  %131 = load i8*, i8** %130, align 8
  %132 = tail call i32 @latencyResetEvent(i8* %131)
  %133 = load i32, i32* %122, align 8
  %134 = icmp sgt i32 %133, 3
  br i1 %134, label %154, label %168

135:                                              ; preds = %125
  %136 = load %29*, %29** getelementptr inbounds (%1, %1* @server, i64 0, i32 327), align 8
  %137 = tail call %38* @dictGetSafeIterator(%29* %136) #9
  %138 = tail call %31* @dictNext(%38* %137) #9
  %139 = icmp eq %31* %138, null
  br i1 %139, label %152, label %140

140:                                              ; preds = %135, %140
  %141 = phi %31* [ %148, %140 ], [ %138, %135 ]
  %142 = phi i32 [ %147, %140 ], [ 0, %135 ]
  %143 = getelementptr inbounds %31, %31* %141, i64 0, i32 0
  %144 = load i8*, i8** %143, align 8
  %145 = load %29*, %29** getelementptr inbounds (%1, %1* @server, i64 0, i32 327), align 8
  %146 = tail call i32 @dictDelete(%29* %145, i8* %144) #9
  %147 = add nuw nsw i32 %142, 1
  %148 = tail call %31* @dictNext(%38* %137) #9
  %149 = icmp eq %31* %148, null
...
152:                                              ; preds = %150, %135
  %153 = phi i64 [ 0, %135 ], [ %151, %150 ]
  tail call void @dictReleaseIterator(%38* %137) #9
  tail call void @addReplyLongLong(%24* %0, i64 %153) #9
  br label %187

154:                                              ; preds = %127, %154
  %155 = phi i64 [ %164, %154 ], [ 3, %127 ]
  %156 = phi i32 [ %163, %154 ], [ %132, %127 ]
  %157 = load %10**, %10*** %4, align 8
  %158 = getelementptr inbounds %10*, %10** %157, i64 %155
  %159 = load %10*, %10** %158, align 8
  %160 = getelementptr inbounds %10, %10* %159, i64 0, i32 2
  %161 = load i8*, i8** %160, align 8
  %162 = tail call i32 @latencyResetEvent(i8* %161)
  %163 = add nsw i32 %162, %156
  %164 = add nuw nsw i64 %155, 1
  %165 = load i32, i32* %122, align 8
  %166 = sext i32 %165 to i64
  %167 = icmp slt i64 %164, %166
  br i1 %167, label %154, label %168

168:                                              ; preds = %154, %127
  %169 = phi i32 [ %132, %127 ], [ %163, %154 ]
  %170 = sext i32 %169 to i64
  tail call void @addReplyLongLong(%24* nonnull %0, i64 %170) #9
  br label %187

171:                                              ; preds = %118, %121
  %172 = tail call i32 @strcasecmp(i8* %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @66, i64 0, i64 0)) #8
  %173 = icmp eq i32 %172, 0
  br i1 %173, label %174, label %180

174:                                              ; preds = %171
  %175 = getelementptr inbounds %24, %24* %0, i64 0, i32 9
  %176 = load i32, i32* %175, align 8
  %177 = icmp sgt i32 %176, 1
  br i1 %177, label %178, label %180

178:                                              ; preds = %174
  %179 = getelementptr inbounds [8 x i8*], [8 x i8*]* %2, i64 0, i64 0
  call void @addReplyHelp(%24* nonnull %0, i8** nonnull %179) #9
  br label %187
...
181:                                              ; preds = %34
  ...
  %183 = getelementptr inbounds %10*, %10** %182, i64 2
  %184 = load %10*, %10** %183, align 8
  %185 = getelementptr inbounds %10, %10* %184, i64 0, i32 2
  %186 = load i8*, i8** %185, align 8
  tail call void (%24*, i8*, ...) @addReplyErrorFormat(%24* nonnull %0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @67, i64 0, i64 0), i8* %186) #9
  br label %187

187:                                              ; preds = %73, %25, %24, %82, %168, %152, %180, %178, %116, %181
