; ModuleID = 'cmd-rename-window-strip-O2-renamed.bc'
...
define internal i32 @5(%3* %0, %4* %1) #0 {
  ...
  %7 = getelementptr inbounds %5, %5* %3, i64 0, i32 2
  %8 = load i8**, i8*** %7, align 8
  %9 = load i8*, i8** %8, align 8
  %10 = tail call i8* @format_single_from_target(%4* %1, i8* %9) #3
  %11 = getelementptr inbounds %28, %28* %6, i64 0, i32 2
  %12 = load %32*, %32** %11, align 8
  tail call void @window_set_name(%32* %12, i8* %10) #3
  %13 = load %32*, %32** %11, align 8
  %14 = getelementptr inbounds %32, %32* %13, i64 0, i32 22
  %15 = load %23*, %23** %14, align 8
  %16 = tail call %94* @options_set_number(%23* %15, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @4, i64 0, i64 0), i64 0) #3
  %17 = load %32*, %32** %11, align 8
  tail call void @server_redraw_window_borders(%32* %17) #3
  %18 = load %32*, %32** %11, align 8
  tail call void @server_status_window(%32* %18) #3
...
declare dso_local void @window_set_name(%32*, i8*) local_unnamed_addr #1

declare dso_local %94* @options_set_number(%23*, i8*, i64) local_unnamed_addr #1

declare dso_local void @server_redraw_window_borders(%32*) local_unnamed_addr #1

declare dso_local void @server_status_window(%32*) local_unnamed_addr #1
