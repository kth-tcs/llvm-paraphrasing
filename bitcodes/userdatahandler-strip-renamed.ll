; ModuleID = 'userdatahandler-strip-renamed.bc'
...
@php_dom_userdatahandler_class_functions = hidden constant [2 x { i8*, void (%0*, %28*)*, %32*, i32, i32 }] [{ i8*, void (%0*, %28*)*, %32*, i32, i32 } { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i32 0, i32 0), void (%0*, %28*)* @zif_dom_userdatahandler_handle, %32* null, i32 -1, i32 0 }, { i8*, void (%0*, %28*)*, %32*, i32, i32 } zeroinitializer], align 16
@1 = private unnamed_addr constant [20 x i8] c"Not yet implemented\00", align 1

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_userdatahandler_handle(%0* %0, %28* %1) #0 {
  %3 = alloca %0*, align 8
  %4 = alloca %28*, align 8
  store %0* %0, %0** %3, align 8
  store %28* %1, %28** %4, align 8
  call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @1, i32 0, i32 0))
  ret void
}
