; ModuleID = 'cmd-capture-pane-strip-O2-renamed.bc'
...
21:                                               ; preds = %18
  ...
  call void @llvm.lifetime.start.p0i8(i64 5, i8* nonnull %22) #6
  %23 = getelementptr inbounds %15, %15* %11, i64 0, i32 25
  %24 = load %29*, %29** %23, align 8
  %25 = tail call %33* @input_pending(%29* %24) #6
...
50:                                               ; preds = %39
  ...
  %52 = call i32 (i8*, i64, i8*, ...) @xsnprintf(i8* nonnull %22, i64 5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @12, i64 0, i64 0), i32 %51) #6
  br label %53

53:                                               ; preds = %50, %49
  %54 = call i64 @strlen(i8* nonnull %22) #7
  %55 = add i64 %54, %40
  %56 = add i64 %55, 1
  %57 = call i8* @xrealloc(i8* %43, i64 %56) #6
  %58 = getelementptr inbounds i8, i8* %57, i64 %40
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %58, i8* nonnull align 1 %22, i64 %54, i1 false) #6
  %59 = add i32 %42, 1
...
65:                                               ; preds = %53, %27, %35, %62
  ...
  call void @llvm.lifetime.end.p0i8(i64 5, i8* nonnull %22) #6
  br label %215
...
190:                                              ; preds = %208, %176
  %191 = phi i64 [ 0, %176 ], [ %209, %208 ]
  %192 = phi i32 [ %180, %176 ], [ %210, %208 ]
  %193 = phi i8* [ null, %176 ], [ %198, %208 ]
  ...
  br i1 %185, label %201, label %206

201:                                              ; preds = %190
  %202 = getelementptr inbounds %38, %38* %200, i64 0, i32 5
...
206:                                              ; preds = %201, %190
  %207 = getelementptr inbounds i8, i8* %198, i64 %196
  store i8 10, i8* %207, align 1
  br label %208

208:                                              ; preds = %206, %201
  %209 = phi i64 [ %197, %206 ], [ %196, %201 ]
  call void @free(i8* %194) #6
  %210 = add i32 %192, 1
  %211 = icmp ugt i32 %210, %179
  br i1 %211, label %212, label %190

212:                                              ; preds = %208, %84, %85
  %213 = phi i64 [ 0, %84 ], [ 0, %85 ], [ %209, %208 ]
  %214 = phi i8* [ null, %84 ], [ %86, %85 ], [ %198, %208 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %70) #6
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %69) #6
  br label %215

215:                                              ; preds = %212, %65
  %216 = phi i64 [ %213, %212 ], [ %66, %65 ]
  %217 = phi i8* [ %214, %212 ], [ %67, %65 ]
  %218 = icmp eq i8* %217, null
  br i1 %218, label %245, label %219

219:                                              ; preds = %215
  %220 = call i32 @args_has(%7* %7, i8 zeroext 112) #6
  %221 = icmp eq i32 %220, 0
  br i1 %221, label %233, label %222

222:                                              ; preds = %219
  %223 = call i32 @file_can_print(%10* %8) #6
  %224 = icmp eq i32 %223, 0
  br i1 %224, label %225, label %226

225:                                              ; preds = %222
  call void (%4*, i8*, ...) @cmdq_error(%4* %1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @8, i64 0, i64 0)) #6
  call void @free(i8* nonnull %217) #6
  br label %245

226:                                              ; preds = %222
  call void @file_print_buffer(%10* %8, i8* nonnull %217, i64 %216) #6
  %227 = call i32 @args_has(%7* %7, i8 zeroext 80) #6
  %228 = icmp ne i32 %227, 0
  %229 = icmp ne i64 %216, 0
  %230 = and i1 %229, %228
...
233:                                              ; preds = %219
  %234 = call i32 @args_has(%7* %7, i8 zeroext 98) #6
  %235 = icmp eq i32 %234, 0
  br i1 %235, label %238, label %236

236:                                              ; preds = %233
  %237 = call i8* @args_get(%7* %7, i8 zeroext 98) #6
  br label %238

238:                                              ; preds = %233, %236
  %239 = phi i8* [ %237, %236 ], [ null, %233 ]
  %240 = call i32 @paste_set(i8* nonnull %217, i64 %216, i8* %239, i8** nonnull %6) #6
  %241 = icmp eq i32 %240, 0
  br i1 %241, label %245, label %242

242:                                              ; preds = %238
  %243 = load i8*, i8** %6, align 8
  call void (%4*, i8*, ...) @cmdq_error(%4* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @10, i64 0, i64 0), i8* %243) #6
  %244 = load i8*, i8** %6, align 8
  call void @free(i8* %244) #6
  call void @free(i8* nonnull %217) #6
  br label %245

245:                                              ; preds = %232, %238, %215, %242, %225, %15
  %246 = phi i32 [ 0, %15 ], [ -1, %225 ], [ -1, %242 ], [ -1, %215 ], [ 0, %238 ], [ 0, %232 ]
