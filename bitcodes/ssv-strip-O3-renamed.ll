; ModuleID = 'ssv-strip-O3-renamed.bc'
...
42:                                               ; preds = %41, %40
  ...
  %43 = add nsw i64 %24, %14
  %44 = icmp eq i64 %43, %13
  br i1 %44, label %67, label %23

45:                                               ; preds = %17, %64
  %46 = phi i64 [ %65, %64 ], [ %15, %17 ]
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %18) #3
  store i32 0, i32* %7, align 4
  %47 = call x86_fp80 @rrdr2value(%0* nonnull %0, i64 %46, i32 %2, i32* nonnull %7) #3
  %48 = icmp eq i64 %46, %15
  br i1 %48, label %57, label %49

49:                                               ; preds = %45
  %50 = load x86_fp80, x86_fp80* %19, align 16
  %51 = fcmp ogt x86_fp80 %50, %47
...
53:                                               ; preds = %52, %49
  %54 = load x86_fp80, x86_fp80* %20, align 16
  %55 = fcmp olt x86_fp80 %54, %47
  br i1 %55, label %56, label %58

56:                                               ; preds = %53
  store x86_fp80 %47, x86_fp80* %20, align 16
  br label %58
...
63:                                               ; preds = %59
  call void @buffer_rrd_value(%37* %1, x86_fp80 %47) #3
  br label %64

64:                                               ; preds = %62, %63
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %18) #3
  %65 = add nsw i64 %46, %14
