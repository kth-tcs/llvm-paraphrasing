; ModuleID = 'userdatahandler-strip-O2-renamed.bc'
source_filename = "/home/travis/build/orestisfl/compilation-database/build/php-src/ext/dom/userdatahandler.c"
...
@0 = private unnamed_addr constant [7 x i8] c"handle\00", align 1
@php_dom_userdatahandler_class_functions = hidden local_unnamed_addr constant [2 x { i8*, void (%0*, %28*)*, %32*, i32, i32 }] [{ i8*, void (%0*, %28*)*, %32*, i32, i32 } { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i32 0, i32 0), void (%0*, %28*)* @zif_dom_userdatahandler_handle, %32* null, i32 -1, i32 0 }, { i8*, void (%0*, %28*)*, %32*, i32, i32 } zeroinitializer], align 16
@1 = private unnamed_addr constant [20 x i8] c"Not yet implemented\00", align 1

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_userdatahandler_handle(%0* nocapture readnone %0, %28* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @1, i64 0, i64 0)) #2
  ret void
}
