; ModuleID = 'environment-strip-O3-renamed.bc'
...
101:                                              ; preds = %96
  ...
  %103 = getelementptr inbounds %49, %49* %2, i64 0, i32 1
  %104 = load i64, i64* %103, align 8
  %105 = getelementptr inbounds %49, %49* %2, i64 0, i32 2
  %106 = load i8*, i8** %105, align 8
  %107 = call %49** @strbuf_split_buf(i8* %106, i64 %104, i32 47, i32 0) #12
