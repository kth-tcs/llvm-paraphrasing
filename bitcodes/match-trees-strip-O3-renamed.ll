; ModuleID = 'match-trees-strip-O3-renamed.bc'
...
29:                                               ; preds = %25
  ...
  %31 = call i8* (i8*, ...) @xstrfmt(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @4, i64 0, i64 0), i8* %4, i8* %21) #7
...
40:                                               ; preds = %35
  %41 = call fastcc i32 @9(%4* nonnull %17, %4* %1)
  %42 = load i32, i32* %2, align 4
  %43 = icmp slt i32 %42, %41
  br i1 %43, label %46, label %44

44:                                               ; preds = %40
  %45 = inttoptr i64 %36 to i8*
  br label %50

46:                                               ; preds = %40
  %47 = load i8*, i8** %3, align 8
  call void @free(i8* %47) #7
  %48 = inttoptr i64 %36 to i8*
  %49 = call i8* (i8*, ...) @xstrfmt(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @4, i64 0, i64 0), i8* %4, i8* %48) #7
  store i8* %49, i8** %3, align 8
  store i32 %41, i32* %2, align 4
  br label %50

50:                                               ; preds = %44, %46
  %51 = phi i8* [ %45, %44 ], [ %48, %46 ]
  %52 = call i8* (i8*, ...) @xstrfmt(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @5, i64 0, i64 0), i8* %4, i8* %51) #7
  call fastcc void @10(%4* nonnull %17, %4* %1, i32* nonnull %2, i8** %3, i8* %52, i32 %19)
...
71:                                               ; preds = %62
  ...
  %73 = getelementptr inbounds %0, %0* %72, i64 0, i32 14
  %74 = load %41*, %41** %73, align 8
  %75 = getelementptr inbounds %41, %41* %74, i64 0, i32 2
  %76 = load i64, i64* %75, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %59, i8* nonnull align 1 %12, i64 %76, i1 false) #7
  br label %84

77:                                               ; preds = %56
  %78 = getelementptr inbounds %4, %4* %2, i64 0, i32 0, i64 0
  %79 = load %0*, %0** @the_repository, align 8
  %80 = getelementptr inbounds %0, %0* %79, i64 0, i32 14
  %81 = load %41*, %41** %80, align 8
  %82 = getelementptr inbounds %41, %41* %81, i64 0, i32 2
  %83 = load i64, i64* %82, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %59, i8* align 1 %78, i64 %83, i1 false) #7
  br label %84

84:                                               ; preds = %71, %77
  %85 = load i64, i64* %5, align 8
  %86 = load i8*, i8** @tree_type, align 8
  %87 = call i32 @write_object_file(i8* nonnull %24, i64 %85, i8* %86, %4* %3) #7
  call void @free(i8* %24) #7
  br label %88

88:                                               ; preds = %62, %84
  %89 = phi i32 [ %87, %84 ], [ %69, %62 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %13) #7
