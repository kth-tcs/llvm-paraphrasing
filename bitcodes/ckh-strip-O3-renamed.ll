; ModuleID = 'ckh-strip-O3-renamed.bc'
...
82:                                               ; preds = %55, %52, %78
  ...
  %84 = bitcast %9* %0 to %8*
  %85 = getelementptr %9, %9* %0, i64 0, i32 3
...
94:                                               ; preds = %82
  %95 = getelementptr %9, %9* %0, i64 0, i32 10
...
98:                                               ; preds = %94
  ...
  %100 = getelementptr %9, %9* %0, i64 0, i32 1
...
196:                                              ; preds = %194, %153, %139, %125
  ...
  %204 = getelementptr %33, %33* %203, i64 0, i32 0
...
96:                                               ; preds = %94, %53, %39, %25
  ...
  %104 = getelementptr %33, %33* %103, i64 0, i32 0
...
18:                                               ; preds = %4
  ...
  %20 = bitcast %9* %0 to %8*
  %21 = getelementptr %9, %9* %0, i64 0, i32 3
  %22 = getelementptr %9, %9* %0, i64 0, i32 10
  %23 = icmp eq %9* %0, null
  %24 = getelementptr %9, %9* %0, i64 0, i32 1
...
213:                                              ; preds = %152, %164, %175, %211
  ...
  %221 = getelementptr %33, %33* %220, i64 0, i32 0
...
404:                                              ; preds = %402, %361, %347, %333
  ...
  %412 = getelementptr %33, %33* %411, i64 0, i32 0
...
758:                                              ; preds = %756, %715, %701, %687
  ...
  %766 = getelementptr %33, %33* %765, i64 0, i32 0
...
214:                                              ; preds = %210, %187, %184
  ...
  %217 = getelementptr %9, %9* %0, i64 0, i32 3
...
226:                                              ; preds = %214
  %227 = getelementptr %9, %9* %0, i64 0, i32 10
...
230:                                              ; preds = %226
  ...
  %232 = getelementptr %9, %9* %0, i64 0, i32 1
...
328:                                              ; preds = %326, %285, %271, %257
  ...
  %336 = getelementptr %33, %33* %335, i64 0, i32 0
  %337 = load i64, i64* %336, align 8
...
531:                                              ; preds = %529, %488, %474, %460
  ...
  %539 = getelementptr %33, %33* %538, i64 0, i32 0
...
870:                                              ; preds = %868, %827, %813, %799
  ...
  %878 = getelementptr %33, %33* %877, i64 0, i32 0
