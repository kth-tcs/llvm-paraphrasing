; ModuleID = 'resolve-undo-strip-O3-renamed.bc'
...
64:                                               ; preds = %54
  br i1 %63, label %89, label %79

65:                                               ; preds = %54
  br i1 %63, label %73, label %66

66:                                               ; preds = %65
  %67 = bitcast i8* %59 to %18*
  %68 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %62, %18* nonnull %67, i8* %57, i32 1, i32 0) #6
  %69 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %68, i32 1) #6
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %73, label %71

71:                                               ; preds = %66
  %72 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %73

73:                                               ; preds = %71, %66, %65
  %74 = phi i32 [ 0, %65 ], [ 1, %71 ], [ 0, %66 ]
  %75 = getelementptr inbounds i8, i8* %52, i64 4
  %76 = bitcast i8* %75 to i32*
  %77 = load i32, i32* %76, align 4
  %78 = icmp eq i32 %77, 0
  br i1 %78, label %140, label %132

79:                                               ; preds = %64
  %80 = bitcast i8* %59 to %18*
  %81 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %62, %18* nonnull %80, i8* %57, i32 1, i32 0) #6
  %82 = getelementptr inbounds %9, %9* %81, i64 0, i32 3
  %83 = load i32, i32* %82, align 8
  %84 = or i32 %83, 67108864
  store i32 %84, i32* %82, align 8
  %85 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %81, i32 1) #6
  %86 = icmp eq i32 %85, 0
  br i1 %86, label %89, label %87

87:                                               ; preds = %79
  %88 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %89

89:                                               ; preds = %87, %79, %64
  %90 = phi i32 [ 0, %64 ], [ 1, %87 ], [ 0, %79 ]
  %91 = getelementptr inbounds i8, i8* %52, i64 4
...
96:                                               ; preds = %140, %146, %115, %121
  %97 = phi i32 [ %116, %115 ], [ %116, %121 ], [ %141, %140 ], [ %141, %146 ]
  tail call void @free(i8* %57) #6
  %98 = icmp eq i32 %97, 0
...
99:                                               ; preds = %96
  ...
  %100 = load %12*, %12** %3, align 8
  %101 = icmp eq %12* %100, null
  br i1 %101, label %102, label %9

102:                                              ; preds = %99, %46, %50, %96, %95, %2, %43
  %103 = phi i32 [ %45, %43 ], [ %1, %2 ], [ %1, %95 ], [ %1, %96 ], [ %1, %50 ], [ %1, %46 ], [ %1, %99 ]
  ret i32 %103

104:                                              ; preds = %89
  %105 = getelementptr inbounds i8, i8* %52, i64 44
  %106 = bitcast i8* %105 to %18*
  %107 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %93, %18* nonnull %106, i8* %57, i32 2, i32 0) #6
  %108 = getelementptr inbounds %9, %9* %107, i64 0, i32 3
  %109 = load i32, i32* %108, align 8
  %110 = or i32 %109, 67108864
  store i32 %110, i32* %108, align 8
  %111 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %107, i32 1) #6
  %112 = icmp eq i32 %111, 0
  br i1 %112, label %115, label %113

113:                                              ; preds = %104
  %114 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %115

115:                                              ; preds = %113, %104, %89
  %116 = phi i32 [ %90, %89 ], [ 1, %113 ], [ %90, %104 ]
  %117 = getelementptr inbounds i8, i8* %52, i64 8
...
121:                                              ; preds = %115
  %122 = getelementptr inbounds i8, i8* %52, i64 76
  %123 = bitcast i8* %122 to %18*
  %124 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %119, %18* nonnull %123, i8* %57, i32 3, i32 0) #6
  %125 = getelementptr inbounds %9, %9* %124, i64 0, i32 3
  %126 = load i32, i32* %125, align 8
  %127 = or i32 %126, 67108864
  store i32 %127, i32* %125, align 8
  %128 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %124, i32 1) #6
  %129 = icmp eq i32 %128, 0
  br i1 %129, label %96, label %130

130:                                              ; preds = %121
  %131 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %95

132:                                              ; preds = %73
  %133 = getelementptr inbounds i8, i8* %52, i64 44
  %134 = bitcast i8* %133 to %18*
  %135 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %77, %18* nonnull %134, i8* %57, i32 2, i32 0) #6
  %136 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %135, i32 1) #6
  %137 = icmp eq i32 %136, 0
  br i1 %137, label %140, label %138

138:                                              ; preds = %132
  %139 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %140

140:                                              ; preds = %138, %132, %73
  %141 = phi i32 [ %74, %73 ], [ 1, %138 ], [ %74, %132 ]
  %142 = getelementptr inbounds i8, i8* %52, i64 8
...
146:                                              ; preds = %140
  %147 = getelementptr inbounds i8, i8* %52, i64 76
  %148 = bitcast i8* %147 to %18*
  %149 = tail call %9* @make_cache_entry(%8* nonnull %0, i32 %144, %18* nonnull %148, i8* %57, i32 3, i32 0) #6
  %150 = tail call i32 @add_index_entry(%8* nonnull %0, %9* %149, i32 1) #6
  %151 = icmp eq i32 %150, 0
  br i1 %151, label %96, label %152

152:                                              ; preds = %146
  %153 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0), i8* %57) #6
  br label %95
}
