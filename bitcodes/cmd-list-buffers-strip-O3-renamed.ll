; ModuleID = 'cmd-list-buffers-strip-O3-renamed.bc'
...
12:                                               ; preds = %10, %12
  ...
  %16 = tail call i8* @format_expand(%46* %15, i8* %6) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @5, i64 0, i64 0), i8* %16) #3
  tail call void @free(i8* %16) #3
  tail call void @format_free(%46* %15) #3
  %17 = tail call %8* @paste_walk(%8* nonnull %13) #3
  %18 = icmp eq %8* %17, null
  br i1 %18, label %31, label %12

19:                                               ; preds = %10, %28
  %20 = phi %8* [ %29, %28 ], [ %8, %10 ]
  %21 = tail call %9* @cmdq_get_client(%4* %1) #3
  %22 = tail call %46* @format_create(%9* %21, %4* %1, i32 0, i32 0) #3
  tail call void @format_defaults_paste_buffer(%46* %22, %8* nonnull %20) #3
  %23 = tail call i8* @format_expand(%46* %22, i8* nonnull %7) #3
  %24 = tail call i32 @format_true(i8* %23) #3
  tail call void @free(i8* %23) #3
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %28, label %26

26:                                               ; preds = %19
  %27 = tail call i8* @format_expand(%46* %22, i8* %6) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @5, i64 0, i64 0), i8* %27) #3
  tail call void @free(i8* %27) #3
  br label %28

28:                                               ; preds = %19, %26
  tail call void @format_free(%46* %22) #3
  %29 = tail call %8* @paste_walk(%8* nonnull %20) #3
