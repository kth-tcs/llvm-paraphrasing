; ModuleID = 'pages-strip-O3-renamed.bc'
...
62:                                               ; preds = %59
  %63 = call i32 @munmap(i8* nonnull %55, i64 4096) #7
  %64 = icmp eq i32 %63, -1
...
65:                                               ; preds = %62
  ...
  %67 = tail call i32* @__errno_location() #8
  %68 = load i32, i32* %67, align 4
  %69 = call i32 @je_buferror(i32 %68, i8* nonnull %66, i64 64) #7
  call void (i8*, ...) @je_malloc_printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @9, i64 0, i64 0), i8* nonnull %66) #7
  %70 = load i8, i8* @je_opt_abort, align 1
  %71 = icmp eq i8 %70, 0
...
74:                                               ; preds = %59, %57
  ...
  %75 = call i32 @munmap(i8* nonnull %55, i64 4096) #7
  %76 = icmp eq i32 %75, -1
  br i1 %76, label %77, label %86

77:                                               ; preds = %74
  %78 = getelementptr inbounds [64 x i8], [64 x i8]* %1, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %78) #7
  %79 = tail call i32* @__errno_location() #8
  %80 = load i32, i32* %79, align 4
  %81 = call i32 @je_buferror(i32 %80, i8* nonnull %78, i64 64) #7
  call void (i8*, ...) @je_malloc_printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @9, i64 0, i64 0), i8* nonnull %78) #7
  %82 = load i8, i8* @je_opt_abort, align 1
  %83 = icmp eq i8 %82, 0
...
85:                                               ; preds = %77
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %78) #7
  br label %86

86:                                               ; preds = %8, %50, %50, %85, %74, %73, %62
  %87 = phi i1 [ false, %62 ], [ false, %73 ], [ false, %74 ], [ false, %85 ], [ true, %50 ], [ true, %50 ], [ true, %8 ]
  ret i1 %87
}
