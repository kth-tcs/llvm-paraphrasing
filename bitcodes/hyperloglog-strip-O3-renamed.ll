; ModuleID = 'hyperloglog-strip-O3-renamed.bc'
...
define dso_local i32 @hllPatLen(i8* readonly %0, i64 %1, i64* nocapture %2) local_unnamed_addr #2 {
  %4 = trunc i64 %1 to i32
  %5 = shl i64 %1, 32
  %6 = ashr exact i64 %5, 32
  %7 = mul i64 %6, -4132994306676758123
  %8 = xor i64 %7, 2915580697
  %9 = and i32 %4, -8
...
27:                                               ; preds = %17, %13
  %28 = phi i64 [ undef, %13 ], [ %25, %17 ]
  %29 = phi i64 [ %8, %13 ], [ %25, %17 ]
  %30 = phi i8* [ %0, %13 ], [ %26, %17 ]
  %31 = icmp eq i64 %14, 0
  br i1 %31, label %54, label %32

32:                                               ; preds = %27, %32
  %33 = phi i64 [ %51, %32 ], [ %29, %27 ]
  %34 = phi i8* [ %52, %32 ], [ %30, %27 ]
...
54:                                               ; preds = %27, %32, %3
  %55 = phi i8* [ %0, %3 ], [ %11, %32 ], [ %11, %27 ]
  %56 = phi i64 [ %8, %3 ], [ %28, %27 ], [ %51, %32 ]
  %57 = trunc i64 %1 to i3
  switch i3 %57, label %105 [
    i3 -1, label %58
    i3 -2, label %64
    i3 -3, label %71
    i3 -4, label %78
...
105:                                              ; preds = %54, %99
  ...
  %111 = xor i64 %110, %109
  %112 = lshr i64 %111, 14
  %113 = or i64 %112, 1125899906842624
  %114 = and i64 %111, 16384
  %115 = icmp eq i64 %114, 0
  br i1 %115, label %116, label %123

116:                                              ; preds = %105, %116
  %117 = phi i32 [ %119, %116 ], [ 1, %105 ]
  %118 = phi i64 [ %120, %116 ], [ 1, %105 ]
  %119 = add nuw nsw i32 %117, 1
  %120 = shl i64 %118, 1
  %121 = and i64 %120, %113
  %122 = icmp eq i64 %121, 0
  br i1 %122, label %116, label %123

123:                                              ; preds = %116, %105
  %124 = phi i32 [ 1, %105 ], [ %119, %116 ]
  %125 = and i64 %111, 16383
...
define dso_local i32 @hllDenseAdd(i8* nocapture %0, i8* %1, i64 %2) local_unnamed_addr #3 {
  ...
  %6 = call i32 @hllPatLen(i8* %1, i64 %2, i64* nonnull %4)
...
define dso_local i32 @hllSparseAdd(%9* nocapture %0, i8* %1, i64 %2) local_unnamed_addr #3 {
  ...
  %9 = tail call i32 @hllSparseSet(%9* %0, i64 %8, i8 zeroext %7)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #11
  ret i32 %9
}
...
define dso_local i32 @hllAdd(%9* nocapture %0, i8* %1, i64 %2) local_unnamed_addr #3 {
  ...
  %6 = getelementptr inbounds %9, %9* %0, i64 0, i32 2
  %7 = bitcast i8** %6 to %35**
  %8 = load %35*, %35** %7, align 8
  %9 = getelementptr inbounds %35, %35* %8, i64 0, i32 1
...
11:                                               ; preds = %3
  ...
  %13 = call i32 @hllPatLen(i8* %1, i64 %2, i64* nonnull %5) #11
  %14 = load i64, i64* %5, align 8
  %15 = mul nsw i64 %14, 6
  %16 = sdiv i64 %15, 8
  %17 = and i64 %15, 6
  %18 = sub nsw i64 8, %17
  %19 = getelementptr inbounds %35, %35* %8, i64 0, i32 4, i64 %16
  %20 = load i8, i8* %19, align 1
  %21 = zext i8 %20 to i64
  %22 = add nsw i64 %16, 1
  %23 = getelementptr inbounds %35, %35* %8, i64 0, i32 4, i64 %22
...
52:                                               ; preds = %3
  ...
  %54 = call i32 @hllPatLen(i8* %1, i64 %2, i64* nonnull %4) #11
  %55 = trunc i32 %54 to i8
  %56 = load i64, i64* %4, align 8
  %57 = tail call i32 @hllSparseSet(%9* nonnull %0, i64 %56, i8 zeroext %55) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %53) #11
  br label %58

58:                                               ; preds = %3, %52, %50
  %59 = phi i32 [ %57, %52 ], [ %51, %50 ], [ -1, %3 ]
  ret i32 %59
}
...
23:                                               ; preds = %20
  ...
  %28 = load i8, i8* %27, align 1
  %29 = icmp eq i8 %28, 0
  %30 = call i32 @hllMerge(i8* nonnull %3, %9* nonnull %18)
  %31 = select i1 %29, i32 1, i32 %15
  %32 = icmp eq i32 %30, -1
...
95:                                               ; preds = %78, %194
  %96 = phi i64 [ 1, %78 ], [ %196, %194 ]
  %97 = phi i64 [ 1, %78 ], [ %195, %194 ]
  %98 = xor i64 %93, %96
...
121:                                              ; preds = %114, %95
  %122 = phi i32 [ 1, %95 ], [ %117, %114 ]
  %123 = and i64 %109, 16383
  %124 = mul nuw nsw i64 %123, 6
  %125 = lshr i64 %124, 3
  %126 = and i64 %124, 6
  %127 = sub nsw i64 8, %126
  %128 = getelementptr inbounds i8, i8* %7, i64 %125
...
142:                                              ; preds = %121
  ...
  %151 = or i8 %148, %150
  store i8 %151, i8* %128, align 1
  %152 = trunc i64 %127 to i32
  %153 = ashr i32 -64, %152
  %154 = trunc i32 %153 to i8
  %155 = and i8 %133, %154
  %156 = lshr i64 %143, %127
  %157 = trunc i64 %156 to i8
  %158 = or i8 %155, %157
  store i8 %158, i8* %132, align 1
  br label %159

159:                                              ; preds = %121, %142
  %160 = call i32 @hllAdd(%9* %82, i8* nonnull %94, i64 8)
  %161 = icmp eq i64 %97, %96
  br i1 %161, label %162, label %194

162:                                              ; preds = %159
  %163 = load i64, i64* getelementptr inbounds (%0, %0* @server, i64 0, i32 278), align 8
  %164 = lshr i64 %163, 1
  %165 = icmp ugt i64 %164, %96
  br i1 %165, label %166, label %172

166:                                              ; preds = %162
  %167 = load %35*, %35** %84, align 8
  %168 = getelementptr inbounds %35, %35* %167, i64 0, i32 1
...
172:                                              ; preds = %162, %166
  %173 = call i64 @hllCount(%35* nonnull %5, i32* null)
  %174 = load %35*, %35** %84, align 8
  %175 = call i64 @hllCount(%35* %174, i32* null)
...
178:                                              ; preds = %172
  %179 = call i64 @hllCount(%35* nonnull %5, i32* null)
  %180 = sub nsw i64 %96, %179
  %181 = sitofp i64 %96 to double
  %182 = fmul double %181, 4.875000e-02
  %183 = call double @llvm.ceil.f64(double %182)
  %184 = fptoui double %183 to i64
  %185 = icmp eq i64 %96, 10
  %186 = select i1 %185, i64 1, i64 %184
  %187 = icmp slt i64 %180, 0
  %188 = sub nsw i64 0, %180
  %189 = select i1 %187, i64 %188, i64 %180
  %190 = icmp sgt i64 %189, %186
  br i1 %190, label %193, label %191

191:                                              ; preds = %178
  %192 = mul nsw i64 %96, 10
  br label %194

193:                                              ; preds = %178
  call void (%23*, i8*, ...) @addReplyErrorFormat(%23* %0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @8, i64 0, i64 0), i64 %96, i64 %189) #11
  br label %198

194:                                              ; preds = %191, %159
  %195 = phi i64 [ %97, %159 ], [ %192, %191 ]
  %196 = add nuw nsw i64 %96, 1
  %197 = icmp ult i64 %196, 10000001
  br i1 %197, label %95, label %199

198:                                              ; preds = %171, %177, %193
  call void @sdsfree(i8* nonnull %4) #11
  br label %202

199:                                              ; preds = %194
  %200 = load %9*, %9** getelementptr inbounds (%34, %34* @shared, i64 0, i32 1), align 8
  call void @addReply(%23* %0, %9* %200) #11
  call void @sdsfree(i8* nonnull %4) #11
  %201 = icmp eq %9* %82, null
