; ModuleID = 'background_thread-strip-O2-renamed.bc'
...
define dso_local zeroext i1 @je_background_thread_create(%8* %0, i32 %1) local_unnamed_addr #0 {
  ...
  %5 = urem i64 %3, %4
  %6 = load %59*, %59** @je_background_thread_info, align 8
  %7 = bitcast %8* %0 to %7*
  %8 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2
  %9 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2, i32 0, i32 0, i32 1
  %10 = tail call i32 @pthread_mutex_trylock(%56* nonnull %9) #8
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %13, label %12

12:                                               ; preds = %2
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %8) #8
  br label %13

13:                                               ; preds = %12, %2
  %14 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2, i32 0, i32 0, i32 0, i32 8
  %15 = load i64, i64* %14, align 8
  %16 = add i64 %15, 1
  store i64 %16, i64* %14, align 8
  %17 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2, i32 0, i32 0, i32 0, i32 7
  %18 = load %7*, %7** %17, align 8
  %19 = icmp eq %7* %18, %7
  br i1 %19, label %25, label %20

20:                                               ; preds = %13
  %21 = bitcast %7** %17 to %8**
  store %8* %0, %8** %21, align 8
  %22 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2, i32 0, i32 0, i32 0, i32 6
...
25:                                               ; preds = %13, %20
  %26 = load atomic i8, i8* getelementptr inbounds (%64, %64* @je_background_thread_enabled_state, i64 0, i32 0) monotonic, align 1
  %27 = and i8 %26, 1
  %28 = icmp eq i8 %27, 0
  br i1 %28, label %43, label %29

29:                                               ; preds = %25
  %30 = getelementptr inbounds %59, %59* %6, i64 %5, i32 3
...
33:                                               ; preds = %29
  ...
  %34 = getelementptr inbounds %59, %59* %6, i64 %5, i32 4, i32 0
  store atomic i8 0, i8* %34 release, align 1
  %35 = getelementptr inbounds %59, %59* %6, i64 %5, i32 5
  tail call void @je_nstime_init(%5* nonnull %35, i64 0) #8
  %36 = getelementptr inbounds %59, %59* %6, i64 %5, i32 6
  %37 = getelementptr inbounds %59, %59* %6, i64 %5, i32 8
  %38 = bitcast i64* %36 to i8*
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %38, i8 0, i64 16, i1 false) #8
  tail call void @je_nstime_init(%5* nonnull %37, i64 0) #8
  %39 = load i64, i64* @je_n_background_threads, align 8
  %40 = add i64 %39, 1
  store i64 %40, i64* @je_n_background_threads, align 8
  %41 = tail call i32 @pthread_mutex_unlock(%56* nonnull %9) #8
  %42 = icmp eq i32 %1, 0
  br i1 %42, label %68, label %45

43:                                               ; preds = %25, %29
  %44 = tail call i32 @pthread_mutex_unlock(%56* nonnull %9) #8
  br label %104

45:                                               ; preds = %33
  %46 = load %59*, %59** @je_background_thread_info, align 8
  %47 = getelementptr inbounds %59, %59* %46, i64 0, i32 2, i32 0, i32 0, i32 1
  %48 = tail call i32 @pthread_mutex_trylock(%56* nonnull %47) #8
  %49 = icmp eq i32 %48, 0
  br i1 %49, label %52, label %50

50:                                               ; preds = %45
  %51 = getelementptr inbounds %59, %59* %46, i64 0, i32 2
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %51) #8
  br label %52

52:                                               ; preds = %50, %45
  %53 = getelementptr inbounds %59, %59* %46, i64 0, i32 2, i32 0, i32 0, i32 0, i32 8
  %54 = load i64, i64* %53, align 8
  %55 = add i64 %54, 1
  store i64 %55, i64* %53, align 8
  %56 = getelementptr inbounds %59, %59* %46, i64 0, i32 2, i32 0, i32 0, i32 0, i32 7
  %57 = load %7*, %7** %56, align 8
  %58 = icmp eq %7* %57, %7
  br i1 %58, label %64, label %59

59:                                               ; preds = %52
  %60 = bitcast %7** %56 to %8**
  store %8* %0, %8** %60, align 8
  %61 = getelementptr inbounds %59, %59* %46, i64 0, i32 2, i32 0, i32 0, i32 0, i32 6
...
64:                                               ; preds = %52, %59
  %65 = getelementptr inbounds %59, %59* %46, i64 0, i32 1
  %66 = tail call i32 @pthread_cond_signal(%60* nonnull %65) #8
  %67 = tail call i32 @pthread_mutex_unlock(%56* nonnull %47) #8
  br label %104

68:                                               ; preds = %33
  %69 = getelementptr inbounds %8, %8* %0, i64 0, i32 0
  %70 = load i8, i8* %69, align 8
  %71 = icmp eq i8 %70, 0
  %72 = getelementptr inbounds %8, %8* %0, i64 0, i32 3
...
76:                                               ; preds = %68, %75
  %77 = getelementptr inbounds %59, %59* %6, i64 %5, i32 0
  %78 = inttoptr i64 %5 to i8*
  %79 = tail call fastcc i32 @10(i64* %77, i8* %78)
...
86:                                               ; preds = %84
  tail call void (i8*, ...) @je_malloc_printf(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @1, i64 0, i64 0), i32 %79) #8
  %87 = tail call i32 @pthread_mutex_trylock(%56* nonnull %9) #8
  %88 = icmp eq i32 %87, 0
...
90:                                               ; preds = %89, %86
  ...
  %93 = load %7*, %7** %17, align 8
  %94 = icmp eq %7* %93, %7
  br i1 %94, label %100, label %95

95:                                               ; preds = %90
  %96 = bitcast %7** %17 to %8**
  store %8* %0, %8** %96, align 8
  %97 = getelementptr inbounds %59, %59* %6, i64 %5, i32 2, i32 0, i32 0, i32 0, i32 6
...
100:                                              ; preds = %90, %95
  ...
  %101 = load i64, i64* @je_n_background_threads, align 8
  %102 = add i64 %101, -1
  store i64 %102, i64* @je_n_background_threads, align 8
  %103 = tail call i32 @pthread_mutex_unlock(%56* nonnull %9) #8
  br label %104

104:                                              ; preds = %100, %84, %43, %64
  %105 = phi i1 [ false, %64 ], [ false, %43 ], [ true, %100 ], [ false, %84 ]
  ret i1 %105
}
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @10(i64* %0, i8* %1) unnamed_addr #0 {
  %3 = alloca %65, align 8
  %4 = alloca %65, align 8
  %5 = bitcast %65* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 128, i8* nonnull %5) #8
  %6 = call i32 @sigfillset(%65* nonnull %3) #8
  %7 = bitcast %65* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 128, i8* nonnull %7) #8
  %8 = call i32 @pthread_sigmask(i32 2, %65* nonnull %3, %65* nonnull %4) #8
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %19

10:                                               ; preds = %2
  %11 = load i32 (i64*, %0*, i8* (i8*)*, i8*)*, i32 (i64*, %0*, i8* (i8*)*, i8*)** @0, align 8
  %12 = call i32 %11(i64* %0, %0* null, i8* (i8*)* nonnull @11, i8* %1) #8
  %13 = call i32 @pthread_sigmask(i32 2, %65* nonnull %4, %65* null) #8
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %19, label %15

15:                                               ; preds = %10
  call void (i8*, ...) @je_malloc_printf(i8* getelementptr inbounds ([93 x i8], [93 x i8]* @5, i64 0, i64 0), i32 %12, i32 %13) #8
  %16 = load i8, i8* @je_opt_abort, align 1
  %17 = icmp eq i8 %16, 0
...
94:                                               ; preds = %65
  call fastcc void @14(%7* %34, %59* nonnull %33, i32 %4) #8
  br label %95
...
define dso_local zeroext i1 @je_background_threads_disable(%8* %0) local_unnamed_addr #0 {
  ...
  %3 = tail call fastcc zeroext i1 @12(%8* %0, %59* %2)
  ret i1 %3
}

; Function Attrs: nounwind uwtable
define internal fastcc zeroext i1 @12(%8* %0, %59* %1) unnamed_addr #0 {
  %3 = alloca i8*, align 8
  %4 = getelementptr inbounds %8, %8* %0, i64 0, i32 0
...
define dso_local void @je_background_thread_interval_check(%7* %0, %18* %1, %41* %2, i64 %3) local_unnamed_addr #0 {
  %5 = alloca %5, align 8
  %6 = getelementptr inbounds %18, %18* %1, i64 0, i32 25
...
; Function Attrs: nounwind uwtable
define internal fastcc void @13(%8* %0) unnamed_addr #0 {
  %2 = load i64, i64* @je_max_background_threads, align 8
  %3 = alloca i8, i64 %2, align 16
  %4 = icmp ugt i64 %2, 1
...
8:                                                ; preds = %74, %11, %5
  %9 = phi i64 [ 1, %11 ], [ 1, %5 ], [ %24, %74 ]
  %10 = phi i32 [ 1, %11 ], [ 1, %5 ], [ %26, %74 ]
  br label %85
...
34:                                               ; preds = %34, %32
  ...
  %39 = bitcast i8* %38 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %39, align 1
  ...
  %44 = bitcast i8* %43 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %44, align 1
  ...
  %49 = bitcast i8* %48 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %49, align 1
  ...
  %54 = bitcast i8* %53 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %54, align 1
...
63:                                               ; preds = %60, %63
  ...
  store <16 x i8> zeroinitializer, <16 x i8>* %68, align 1
...
76:                                               ; preds = %85, %74, %1
  %77 = load %59*, %59** @je_background_thread_info, align 8
  %78 = getelementptr inbounds %59, %59* %77, i64 0, i32 3
...
81:                                               ; preds = %76
  %82 = bitcast %8* %0 to %7*
  %83 = getelementptr inbounds %8, %8* %0, i64 0, i32 0
  %84 = getelementptr inbounds %8, %8* %0, i64 0, i32 3
  br label %240

85:                                               ; preds = %8, %85
  %86 = phi i64 [ %90, %85 ], [ %9, %8 ]
  %87 = phi i32 [ %89, %85 ], [ %10, %8 ]
  %88 = getelementptr inbounds i8, i8* %3, i64 %86
  store i8 0, i8* %88, align 1
  %89 = add i32 %87, 1
  %90 = zext i32 %89 to i64
  %91 = icmp ugt i64 %2, %90
  br i1 %91, label %85, label %76

92:                                               ; preds = %234, %134, %76
  %93 = phi %59* [ %77, %76 ], [ %135, %134 ], [ %236, %234 ]
  %94 = load i64, i64* @je_max_background_threads, align 8
...
98:                                               ; preds = %240, %134
  %99 = phi i32 [ %241, %240 ], [ %137, %134 ]
  %100 = phi %59* [ %242, %240 ], [ %135, %134 ]
  %101 = icmp eq i32 %99, 2
  br i1 %101, label %102, label %139

102:                                              ; preds = %98
  %103 = getelementptr inbounds %59, %59* %100, i64 0, i32 2
  %104 = getelementptr inbounds %59, %59* %100, i64 0, i32 2, i32 0, i32 0, i32 1
  %105 = tail call i32 @pthread_mutex_unlock(%56* nonnull %104) #8
  %106 = tail call i32 @pthread_mutex_trylock(%56* nonnull getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 1)) #8
...
109:                                              ; preds = %108, %102
  %110 = load i64, i64* getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 0, i32 8), align 8
  %111 = add i64 %110, 1
  store i64 %111, i64* getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 0, i32 8), align 8
  %112 = load %7*, %7** getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 0, i32 7), align 8
  %113 = icmp eq %7* %112, %82
...
114:                                              ; preds = %109
  ...
  %115 = load i64, i64* getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 0, i32 6), align 8
  %116 = add i64 %115, 1
  store i64 %116, i64* getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 0, i32 6), align 8
  br label %117

117:                                              ; preds = %114, %109
  %118 = tail call i32 @pthread_mutex_unlock(%56* nonnull getelementptr inbounds (%1, %1* @je_background_thread_lock, i64 0, i32 0, i32 0, i32 1)) #8
  %119 = tail call i32 @pthread_mutex_trylock(%56* nonnull %104) #8
  %120 = icmp eq i32 %119, 0
  br i1 %120, label %122, label %121

121:                                              ; preds = %117
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %103) #8
  br label %122

122:                                              ; preds = %121, %117
  %123 = getelementptr inbounds %59, %59* %100, i64 0, i32 2, i32 0, i32 0, i32 0, i32 8
  %124 = load i64, i64* %123, align 8
  %125 = add i64 %124, 1
  store i64 %125, i64* %123, align 8
  %126 = getelementptr inbounds %59, %59* %100, i64 0, i32 2, i32 0, i32 0, i32 0, i32 7
  %127 = load %7*, %7** %126, align 8
  %128 = icmp eq %7* %127, %82
  br i1 %128, label %134, label %129

129:                                              ; preds = %122
  %130 = bitcast %7** %126 to %8**
  store %8* %0, %8** %130, align 8
  %131 = getelementptr inbounds %59, %59* %100, i64 0, i32 2, i32 0, i32 0, i32 0, i32 6
...
134:                                              ; preds = %129, %122
  %135 = load %59*, %59** @je_background_thread_info, align 8
  %136 = getelementptr inbounds %59, %59* %135, i64 0, i32 3
  %137 = load i32, i32* %136, align 8
  %138 = icmp eq i32 %137, 0
  br i1 %138, label %92, label %98

139:                                              ; preds = %98
  %140 = zext i32 %243 to i64
  %141 = load i64, i64* @je_n_background_threads, align 8
  %142 = icmp eq i64 %141, %140
  br i1 %142, label %244, label %143

143:                                              ; preds = %139
  %144 = getelementptr inbounds %59, %59* %100, i64 0, i32 2, i32 0, i32 0, i32 1
  %145 = tail call i32 @pthread_mutex_unlock(%56* nonnull %144) #8
  %146 = load i64, i64* @je_max_background_threads, align 8
  %147 = icmp ugt i64 %146, 1
  br i1 %147, label %148, label %209

148:                                              ; preds = %143, %204
  %149 = phi i64 [ %205, %204 ], [ %146, %143 ]
  %150 = phi i64 [ %207, %204 ], [ 1, %143 ]
  %151 = phi i32 [ %206, %204 ], [ 1, %143 ]
  %152 = getelementptr inbounds i8, i8* %3, i64 %150
  %153 = load i8, i8* %152, align 1
  %154 = icmp eq i8 %153, 0
  br i1 %154, label %155, label %204

155:                                              ; preds = %148
  %156 = load %59*, %59** @je_background_thread_info, align 8
  %157 = getelementptr inbounds %59, %59* %156, i64 %150, i32 2, i32 0, i32 0, i32 1
  %158 = tail call i32 @pthread_mutex_trylock(%56* nonnull %157) #8
  %159 = icmp eq i32 %158, 0
  br i1 %159, label %162, label %160

160:                                              ; preds = %155
  %161 = getelementptr inbounds %59, %59* %156, i64 %150, i32 2
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %161) #8
  br label %162

162:                                              ; preds = %160, %155
  %163 = getelementptr inbounds %59, %59* %156, i64 %150, i32 2, i32 0, i32 0, i32 0, i32 8
  %164 = load i64, i64* %163, align 8
  %165 = add i64 %164, 1
  store i64 %165, i64* %163, align 8
  %166 = getelementptr inbounds %59, %59* %156, i64 %150, i32 2, i32 0, i32 0, i32 0, i32 7
  %167 = load %7*, %7** %166, align 8
  %168 = icmp eq %7* %167, %82
  br i1 %168, label %174, label %169

169:                                              ; preds = %162
  %170 = bitcast %7** %166 to %8**
  store %8* %0, %8** %170, align 8
  %171 = getelementptr inbounds %59, %59* %156, i64 %150, i32 2, i32 0, i32 0, i32 0, i32 6
...
174:                                              ; preds = %169, %162
  %175 = getelementptr inbounds %59, %59* %156, i64 %150, i32 3
  %176 = load i32, i32* %175, align 8
  %177 = icmp eq i32 %176, 1
  %178 = tail call i32 @pthread_mutex_unlock(%56* nonnull %157) #8
  br i1 %177, label %181, label %179

179:                                              ; preds = %174
  %180 = load i64, i64* @je_max_background_threads, align 8
  br label %204

181:                                              ; preds = %174
  %182 = getelementptr inbounds i8, i8* %3, i64 %150
  %183 = load i8, i8* %83, align 8
  %184 = icmp eq i8 %183, 0
  %185 = load i8, i8* %84, align 1
  %186 = add i8 %185, 1
  store i8 %186, i8* %84, align 1
...
188:                                              ; preds = %187, %181
  %189 = getelementptr inbounds %59, %59* %156, i64 %150, i32 0
  %190 = inttoptr i64 %150 to i8*
  %191 = tail call fastcc i32 @10(i64* %189, i8* %190) #8
  %192 = load i8, i8* %84, align 1
  %193 = add i8 %192, -1
  store i8 %193, i8* %84, align 1
...
200:                                              ; preds = %196
  tail call void (i8*, ...) @je_malloc_printf(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @7, i64 0, i64 0), i32 %191) #8
  %201 = load i8, i8* @je_opt_abort, align 1
...
204:                                              ; preds = %179, %148
  %205 = phi i64 [ %180, %179 ], [ %149, %148 ]
  %206 = add i32 %151, 1
  %207 = zext i32 %206 to i64
  %208 = icmp ugt i64 %205, %207
  br i1 %208, label %148, label %209

209:                                              ; preds = %204, %200, %198, %143
  %210 = phi i32 [ %199, %198 ], [ %243, %200 ], [ %243, %143 ], [ %243, %204 ]
  %211 = phi i8 [ 1, %198 ], [ 1, %200 ], [ 0, %143 ], [ 0, %204 ]
  %212 = load %59*, %59** @je_background_thread_info, align 8
  %213 = getelementptr inbounds %59, %59* %212, i64 0, i32 2, i32 0, i32 0, i32 1
  %214 = tail call i32 @pthread_mutex_trylock(%56* nonnull %213) #8
  %215 = icmp eq i32 %214, 0
  br i1 %215, label %218, label %216

216:                                              ; preds = %209
  %217 = getelementptr inbounds %59, %59* %212, i64 0, i32 2
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %217) #8
  br label %218

218:                                              ; preds = %216, %209
  %219 = getelementptr inbounds %59, %59* %212, i64 0, i32 2, i32 0, i32 0, i32 0, i32 8
  %220 = load i64, i64* %219, align 8
  %221 = add i64 %220, 1
  store i64 %221, i64* %219, align 8
  %222 = getelementptr inbounds %59, %59* %212, i64 0, i32 2, i32 0, i32 0, i32 0, i32 7
  %223 = load %7*, %7** %222, align 8
  %224 = icmp eq %7* %223, %82
  br i1 %224, label %230, label %225

225:                                              ; preds = %218
  %226 = bitcast %7** %222 to %8**
  store %8* %0, %8** %226, align 8
  %227 = getelementptr inbounds %59, %59* %212, i64 0, i32 2, i32 0, i32 0, i32 0, i32 6
...
230:                                              ; preds = %218, %225
  %231 = icmp eq i8 %211, 0
  br i1 %231, label %232, label %234

232:                                              ; preds = %230
  %233 = load %59*, %59** @je_background_thread_info, align 8
  br label %244

234:                                              ; preds = %230, %244
  %235 = phi i32 [ %246, %244 ], [ %210, %230 ]
  %236 = load %59*, %59** @je_background_thread_info, align 8
  %237 = getelementptr inbounds %59, %59* %236, i64 0, i32 3
  %238 = load i32, i32* %237, align 8
  %239 = icmp eq i32 %238, 0
  br i1 %239, label %92, label %240

240:                                              ; preds = %81, %234
  %241 = phi i32 [ %79, %81 ], [ %238, %234 ]
  %242 = phi %59* [ %77, %81 ], [ %236, %234 ]
  %243 = phi i32 [ 1, %81 ], [ %235, %234 ]
  br label %98

244:                                              ; preds = %232, %139
  %245 = phi %59* [ %233, %232 ], [ %100, %139 ]
  %246 = phi i32 [ %210, %232 ], [ %243, %139 ]
  tail call fastcc void @14(%7* %82, %59* %245, i32 0)
  br label %234

247:                                              ; preds = %96, %284
  %248 = phi %59* [ %93, %96 ], [ %289, %284 ]
  %249 = phi i64 [ 1, %96 ], [ %286, %284 ]
  %250 = phi i32 [ 1, %96 ], [ %285, %284 ]
  %251 = getelementptr inbounds i8, i8* %3, i64 %249
  %252 = load i8, i8* %251, align 1
  %253 = icmp eq i8 %252, 0
  br i1 %253, label %257, label %254

254:                                              ; preds = %247
  %255 = getelementptr inbounds %59, %59* %248, i64 %249
  %256 = tail call fastcc zeroext i1 @12(%8* %0, %59* %255)
  br label %284

257:                                              ; preds = %247
  %258 = getelementptr inbounds %59, %59* %248, i64 %249, i32 2, i32 0, i32 0, i32 1
  %259 = tail call i32 @pthread_mutex_trylock(%56* nonnull %258) #8
  %260 = icmp eq i32 %259, 0
  br i1 %260, label %263, label %261

261:                                              ; preds = %257
  %262 = getelementptr inbounds %59, %59* %248, i64 %249, i32 2
  tail call void @je_malloc_mutex_lock_slow(%1* nonnull %262) #8
  br label %263

263:                                              ; preds = %261, %257
  %264 = getelementptr inbounds %59, %59* %248, i64 %249, i32 2, i32 0, i32 0, i32 0, i32 8
  %265 = load i64, i64* %264, align 8
  %266 = add i64 %265, 1
  store i64 %266, i64* %264, align 8
  %267 = getelementptr inbounds %59, %59* %248, i64 %249, i32 2, i32 0, i32 0, i32 0, i32 7
  %268 = load %7*, %7** %267, align 8
  %269 = icmp eq %7* %268, %97
  br i1 %269, label %275, label %270

270:                                              ; preds = %263
  %271 = bitcast %7** %267 to %8**
  store %8* %0, %8** %271, align 8
  %272 = getelementptr inbounds %59, %59* %248, i64 %249, i32 2, i32 0, i32 0, i32 0, i32 6
...
275:                                              ; preds = %263, %270
  %276 = getelementptr inbounds %59, %59* %248, i64 %249, i32 3
  %277 = load i32, i32* %276, align 8
  %278 = icmp eq i32 %277, 0
  br i1 %278, label %282, label %279

279:                                              ; preds = %275
  %280 = load i64, i64* @je_n_background_threads, align 8
  %281 = add i64 %280, -1
  store i64 %281, i64* @je_n_background_threads, align 8
  store i32 0, i32* %276, align 8
  br label %282

282:                                              ; preds = %275, %279
  %283 = tail call i32 @pthread_mutex_unlock(%56* nonnull %258) #8
  br label %284

284:                                              ; preds = %282, %254
  %285 = add i32 %250, 1
  %286 = zext i32 %285 to i64
  %287 = load i64, i64* @je_max_background_threads, align 8
  %288 = icmp ugt i64 %287, %286
  %289 = load %59*, %59** @je_background_thread_info, align 8
  br i1 %288, label %247, label %290

290:                                              ; preds = %284, %92
  %291 = phi %59* [ %93, %92 ], [ %289, %284 ]
  %292 = getelementptr inbounds %59, %59* %291, i64 0, i32 3
  store i32 0, i32* %292, align 8
  ret void
}

; Function Attrs: inlinehint nounwind uwtable
define internal fastcc void @14(%7* %0, %59* %1, i32 %2) unnamed_addr #7 {
  %4 = alloca %69, align 8
  %5 = alloca %5, align 8
  %6 = alloca %5, align 8
  %7 = alloca %5, align 8
...
71:                                               ; preds = %69
  ...
  %74 = tail call fastcc i64 @15(%7* %0, %41* nonnull %72, %39* nonnull %73) #8
...
76:                                               ; preds = %71
  ...
  %79 = tail call fastcc i64 @15(%7* %0, %41* nonnull %77, %39* nonnull %78) #8
...
; Function Attrs: nounwind uwtable
define internal fastcc i64 @15(%7* %0, %41* %1, %39* %2) unnamed_addr #0 {
