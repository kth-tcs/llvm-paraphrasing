; ModuleID = 'phpdbg_frame-strip-O2-renamed.bc'
...
113:                                              ; preds = %108, %175
  %114 = phi %58* [ %102, %108 ], [ %178, %175 ]
  %115 = phi i8 [ 0, %108 ], [ %177, %175 ]
  %116 = phi i32 [ 0, %108 ], [ %176, %175 ]
...
132:                                              ; preds = %127
  br i1 %110, label %133, label %152

133:                                              ; preds = %132
  %134 = load i8, i8* %111, align 8
  %135 = icmp eq i8 %134, 1
  %136 = sext i32 %116 to i64
  %137 = getelementptr inbounds %22, %22* %97, i64 %136
  br i1 %135, label %138, label %141

138:                                              ; preds = %133
  %139 = bitcast %22* %137 to i8**
  %140 = load i8*, i8** %139, align 8
  br label %145

141:                                              ; preds = %133
  %142 = getelementptr inbounds %22, %22* %137, i64 0, i32 0
  %143 = load %25*, %25** %142, align 8
  %144 = getelementptr inbounds %25, %25* %143, i64 0, i32 3, i64 0
  br label %145

145:                                              ; preds = %138, %141
  %146 = phi i8* [ %140, %138 ], [ %144, %141 ]
  %147 = icmp ne i8 %115, 0
  %148 = or i1 %147, %112
  br i1 %148, label %152, label %149

149:                                              ; preds = %145
  %150 = getelementptr inbounds %22, %22* %97, i64 %136, i32 3
  %151 = load i8, i8* %150, align 1
  br label %152

152:                                              ; preds = %132, %145, %149
  %153 = phi i8* [ %146, %145 ], [ %146, %149 ], [ null, %132 ]
  %154 = phi i8 [ %115, %145 ], [ %151, %149 ], [ %115, %132 ]
  %155 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %156 = icmp ne i8 %154, 0
  %157 = select i1 %156, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @43, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @5, i64 0, i64 0)
  %158 = icmp ne i8* %153, null
  %159 = select i1 %158, i8* %153, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @5, i64 0, i64 0)
  %160 = call i32 (i32, i8*, ...) @phpdbg_xml_internal(i32 %155, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @42, i64 0, i64 0), i8* %157, i8* %159) #9
  %161 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %162 = select i1 %158, i8* %153, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @31, i64 0, i64 0)
  %163 = select i1 %156, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @45, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @5, i64 0, i64 0)
  %164 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %161, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @44, i64 0, i64 0), i8* %162, i8* %163) #9
  br label %168

165:                                              ; preds = %127
  %166 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %167 = call i32 (i32, i8*, ...) @phpdbg_xml_internal(i32 %166, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @38, i64 0, i64 0)) #9
  br label %168

168:                                              ; preds = %165, %152
  %169 = phi i8 [ %154, %152 ], [ %115, %165 ]
  %170 = add nsw i32 %116, 1
  %171 = call i8* @phpdbg_short_zval_print(%48* %117, i32 40) #9
  %172 = call i64 (i8*, ...) @php_printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @46, i64 0, i64 0), i8* %171) #9
  call void @_efree(i8* %171) #9
  %173 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %174 = call i32 (i32, i8*, ...) @phpdbg_xml_internal(i32 %173, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @47, i64 0, i64 0)) #9
  br label %175

175:                                              ; preds = %113, %168
  %176 = phi i32 [ %170, %168 ], [ %116, %113 ]
  %177 = phi i8 [ %169, %168 ], [ %115, %113 ]
  %178 = getelementptr inbounds %58, %58* %114, i64 1
  %179 = icmp eq %58* %178, %106
...
182:                                              ; preds = %180
  %183 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %184 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %183, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @48, i64 0, i64 0)) #9
  br label %185

185:                                              ; preds = %95, %180, %182
  %186 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %187 = call i32 (i32, i8*, ...) @phpdbg_xml_internal(i32 %186, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @49, i64 0, i64 0)) #9
  br label %188

188:                                              ; preds = %185, %66
  %189 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %190 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %189, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @50, i64 0, i64 0)) #9
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %4) #9
  ret void
}
