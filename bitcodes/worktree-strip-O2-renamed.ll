; ModuleID = 'worktree-strip-O2-renamed.bc'
...
1240:                                             ; preds = %1233
  ...
  %1241 = getelementptr inbounds %48, %48* %1209, i64 0, i32 0
...
1289:                                             ; preds = %1288, %1245
  %1290 = bitcast %29* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1290) #11
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1290, i8* align 8 bitcast (%29* @150 to i8*), i64 24, i1 false) #11
  %1291 = load i8*, i8** %1241, align 8
  %1292 = call i64 @strlen(i8* %1291) #13
  call void @strbuf_add(%29* nonnull %4, i8* %1291, i64 %1292) #11
...
1305:                                             ; preds = %1300, %1289
  ...
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1290) #11
  br label %1307
