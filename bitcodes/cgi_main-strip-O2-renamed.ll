; ModuleID = 'cgi_main-strip-O2-renamed.bc'
...
99:                                               ; preds = %97, %138
  %100 = phi i8* [ %95, %97 ], [ %140, %138 ]
  %101 = phi i8 [ %92, %97 ], [ %139, %138 ]
  br label %102

102:                                              ; preds = %99, %131
  %103 = phi i8* [ %100, %99 ], [ %132, %131 ]
...
108:                                              ; preds = %102
  %109 = icmp ugt i64 %106, 7
  br i1 %109, label %110, label %123

110:                                              ; preds = %108
  %111 = bitcast i8* %103 to i8**
  %112 = load i8*, i8** %111, align 8
  %113 = call i32 @strncasecmp(i8* %112, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @74, i64 0, i64 0), i64 7) #14
  %114 = icmp eq i32 %113, 0
  br i1 %114, label %115, label %120

115:                                              ; preds = %110
  %116 = icmp eq i8 %101, 0
  br i1 %116, label %117, label %138

117:                                              ; preds = %115
  %118 = call i64 @php_output_write_unbuffered(i8* %112, i64 %106) #12
  %119 = call i64 @php_output_write_unbuffered(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @78, i64 0, i64 0), i64 2) #12
  br label %138

120:                                              ; preds = %110
  %121 = icmp ugt i64 %106, 13
  %122 = and i1 %98, %121
  br i1 %122, label %126, label %123

123:                                              ; preds = %108, %120
  %124 = bitcast i8* %103 to i8**
  %125 = load i8*, i8** %124, align 8
  br label %134

126:                                              ; preds = %120
  %127 = bitcast i8* %103 to i8**
  %128 = load i8*, i8** %127, align 8
  %129 = call i32 @strncasecmp(i8* %128, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @79, i64 0, i64 0), i64 13) #14
  %130 = icmp eq i32 %129, 0
  br i1 %130, label %131, label %134

131:                                              ; preds = %126
  %132 = call i8* @zend_llist_get_next_ex(%25* %94, %26** nonnull %3) #12
  %133 = icmp eq i8* %132, null
  br i1 %133, label %142, label %102

134:                                              ; preds = %126, %123
  %135 = phi i8* [ %125, %123 ], [ %128, %126 ]
  %136 = call i64 @php_output_write_unbuffered(i8* %135, i64 %106) #12
  %137 = call i64 @php_output_write_unbuffered(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @78, i64 0, i64 0), i64 2) #12
  br label %138

138:                                              ; preds = %102, %115, %134, %117
  %139 = phi i8 [ %101, %115 ], [ 1, %117 ], [ %101, %134 ], [ %101, %102 ]
  %140 = call i8* @zend_llist_get_next_ex(%25* %94, %26** nonnull %3) #12
  %141 = icmp eq i8* %140, null
  br i1 %141, label %142, label %99

142:                                              ; preds = %138, %131, %91
  %143 = call i64 @php_output_write_unbuffered(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @78, i64 0, i64 0), i64 2) #12
  br label %144
