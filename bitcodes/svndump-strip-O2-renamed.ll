; ModuleID = 'svndump-strip-O2-renamed.bc'
...
@60 = internal global %4 { i64 0, i64 0, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @strbuf_slopbuf, i32 0, i32 0) }, align 8
...
44:                                               ; preds = %41
  call fastcc void @79(%4* nonnull @61, %4* null, i32* nonnull %2)
  br label %54

45:                                               ; preds = %41
  call fastcc void @79(%4* nonnull @60, %4* nonnull @61, i32* nonnull %2)
  store i64 0, i64* getelementptr inbounds (%4, %4* @60, i64 0, i32 1), align 8
  %46 = load i8*, i8** getelementptr inbounds (%4, %4* @60, i64 0, i32 2), align 8
...
54:                                               ; preds = %49, %48, %44, %43
  %55 = tail call i8* @buffer_read_line(%0* nonnull @0) #9
...
; Function Attrs: nounwind uwtable
define internal fastcc void @79(%4* nocapture readonly %0, %4* %1, i32* nocapture %2) unnamed_addr #0 {
  %4 = alloca [24 x i8], align 16
  %5 = getelementptr inbounds %4, %4* %0, i64 0, i32 2
  %6 = load i8*, i8** %5, align 8
  %7 = getelementptr inbounds %4, %4* %0, i64 0, i32 1
...
9:                                                ; preds = %3
  %10 = tail call i32 @memcmp(i8* %6, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @65, i64 0, i64 0), i64 7) #12
  %11 = icmp eq i32 %10, 0
...
15:                                               ; preds = %12
  %16 = bitcast %4* %1 to i8*
  %17 = getelementptr inbounds [24 x i8], [24 x i8]* %4, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %17)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %17, i8* align 8 bitcast (%4* getelementptr inbounds (%5, %5* @6, i64 0, i32 2) to i8*), i64 24, i1 false) #9
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 bitcast (%4* getelementptr inbounds (%5, %5* @6, i64 0, i32 2) to i8*), i8* align 1 %16, i64 24, i1 false) #9
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %16, i8* nonnull align 16 %17, i64 24, i1 false) #9
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %17)
  br label %67

18:                                               ; preds = %3
  %19 = tail call i32 @memcmp(i8* %6, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @67, i64 0, i64 0), i64 10) #12
  %20 = icmp eq i32 %19, 0
...
23:                                               ; preds = %21
  store i64 0, i64* getelementptr inbounds (%5, %5* @6, i64 0, i32 3, i32 1), align 8
  %24 = load i8*, i8** getelementptr inbounds (%5, %5* @6, i64 0, i32 3, i32 2), align 8
...
31:                                               ; preds = %21
  %32 = bitcast %4* %1 to i8*
  %33 = getelementptr inbounds [24 x i8], [24 x i8]* %4, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %33)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %33, i8* align 8 bitcast (%4* getelementptr inbounds (%5, %5* @6, i64 0, i32 3) to i8*), i64 24, i1 false) #9
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 bitcast (%4* getelementptr inbounds (%5, %5* @6, i64 0, i32 3) to i8*), i8* align 1 %32, i64 24, i1 false) #9
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %32, i8* nonnull align 16 %33, i64 24, i1 false) #9
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %33)
  br label %67

34:                                               ; preds = %3
  %35 = tail call i32 @memcmp(i8* %6, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @68, i64 0, i64 0), i64 8) #12
  %36 = icmp eq i32 %35, 0
...
40:                                               ; preds = %37
  %41 = getelementptr inbounds %4, %4* %1, i64 0, i32 2
  %42 = load i8*, i8** %41, align 8
  %43 = tail call i32 @parse_date_basic(i8* %42, i64* getelementptr inbounds (%5, %5* @6, i64 0, i32 1), i32* null) #9
  %44 = icmp eq i32 %43, 0
  br i1 %44, label %67, label %45

45:                                               ; preds = %40
  %46 = load i8*, i8** %41, align 8
  tail call void (i8*, ...) @warning(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @70, i64 0, i64 0), i8* %46) #9
  br label %67
...
49:                                               ; preds = %47
  %50 = tail call i32 @memcmp(i8* %6, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @71, i64 0, i64 0), i64 14) #12
  %51 = icmp eq i32 %50, 0
...
54:                                               ; preds = %52
  %55 = tail call i32 @memcmp(i8* %6, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @72, i64 0, i64 0), i64 11) #12
  %56 = icmp eq i32 %55, 0
...
65:                                               ; preds = %63
  ...
  %66 = select i1 %48, i32 33261, i32 40960
  store i32 %66, i32* getelementptr inbounds (%6, %6* @12, i64 0, i32 2), align 8
  br label %67

67:                                               ; preds = %27, %26, %15, %3, %65, %31, %45, %54, %49, %34, %40, %18, %9, %61, %64
  ret void
}
