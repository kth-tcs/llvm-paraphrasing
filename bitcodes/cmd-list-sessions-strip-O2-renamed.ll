; ModuleID = 'cmd-list-sessions-strip-O2-renamed.bc'
...
17:                                               ; preds = %12
  %18 = tail call i8* @format_expand(%74* %16, i8* nonnull %7) #3
  %19 = tail call i32 @format_true(i8* %18) #3
  tail call void @free(i8* %18) #3
  %20 = icmp eq i32 %19, 0
  br i1 %20, label %23, label %21

21:                                               ; preds = %12, %17
  %22 = tail call i8* @format_expand(%74* %16, i8* %6) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @7, i64 0, i64 0), i8* %22) #3
...
23:                                               ; preds = %17, %21
  ...
  %24 = add i32 %14, 1
  %25 = tail call %6* @sessions_RB_NEXT(%6* nonnull %13) #3
