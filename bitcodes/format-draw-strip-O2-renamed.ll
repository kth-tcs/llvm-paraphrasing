; ModuleID = 'format-draw-strip-O2-renamed.bc'
...
define dso_local void @format_draw(%2* %0, %0* nocapture readonly %1, i32 %2, i8* %3, %70* %4) local_unnamed_addr #0 {
  ...
  %82 = getelementptr inbounds %92, %92* %15, i64 0, i32 6
...
321:                                              ; preds = %319
  %322 = getelementptr inbounds %94, %94* %307, i64 0, i32 4
  %323 = load i32, i32* %322, align 8
  %324 = load i32, i32* %80, align 4
  %325 = icmp eq i32 %323, %324
  br i1 %325, label %326, label %333

326:                                              ; preds = %321
  %327 = icmp eq i32 %323, 3
  br i1 %327, label %328, label %376

328:                                              ; preds = %326
  %329 = getelementptr inbounds %94, %94* %307, i64 0, i32 5
...
376:                                              ; preds = %326, %328, %349, %317, %358
  %377 = phi i8* [ %359, %358 ], [ %350, %349 ], [ %301, %317 ], [ %301, %326 ], [ %301, %328 ]
  %378 = phi i8* [ %359, %358 ], [ %351, %349 ], [ %302, %317 ], [ %302, %326 ], [ %302, %328 ]
  %379 = phi i8* [ %359, %358 ], [ %352, %349 ], [ %303, %317 ], [ %303, %326 ], [ %303, %328 ]
  %380 = phi i8* [ %359, %358 ], [ %353, %349 ], [ %304, %317 ], [ %304, %326 ], [ %304, %328 ]
  %381 = phi i8* [ %359, %358 ], [ %354, %349 ], [ %305, %317 ], [ %305, %326 ], [ %305, %328 ]
  %382 = phi i8* [ %359, %358 ], [ %355, %349 ], [ %306, %317 ], [ %306, %326 ], [ %306, %328 ]
  %383 = phi %94* [ %360, %358 ], [ null, %349 ], [ %307, %317 ], [ %307, %326 ], [ %307, %328 ]
...
506:                                              ; preds = %498
  ...
  %522 = or i1 %521, %520
  %523 = select i1 %522, i32 0, i32 %386
  %524 = select i1 %522, i32 0, i32 %390
  call fastcc void @22(%2* %0, i32 %24, i32 %26, i32 %499, i32 %502, %40* nonnull %52, %40* nonnull %56, %40* nonnull %60, i32 %524, i32 %523, %93* nonnull %17) #6
  br label %525
...
586:                                              ; preds = %578
  ...
  %599 = or i1 %598, %597
  %600 = load i32, i32* %76, align 8
  %601 = lshr i32 %600, 1
  %602 = select i1 %599, i32 %601, i32 %386
  %603 = select i1 %599, i32 %601, i32 %390
  call fastcc void @22(%2* %0, i32 %24, i32 %26, i32 %594, i32 %582, %40* nonnull %52, %40* nonnull %56, %40* nonnull %60, i32 %603, i32 %602, %93* nonnull %17) #6
  br label %604
...
663:                                              ; preds = %655
  ...
  %680 = or i1 %679, %678
  %681 = select i1 %680, i32 0, i32 %386
  %682 = select i1 %680, i32 0, i32 %390
  %683 = sub i32 %2, %659
  %684 = sub i32 %683, %660
  call fastcc void @22(%2* %0, i32 %24, i32 %26, i32 %684, i32 %659, %40* nonnull %52, %40* nonnull %56, %40* nonnull %60, i32 %682, i32 %681, %93* nonnull %17) #6
  br label %685
...
31:                                               ; preds = %27
  %32 = getelementptr inbounds %94, %94* %21, i64 0, i32 2
  %33 = load i32, i32* %32, align 8
  %34 = icmp ult i32 %33, %16
  br i1 %34, label %51, label %35

35:                                               ; preds = %31, %27
  %36 = icmp eq %94* %23, null
  %37 = getelementptr inbounds %94, %94* %21, i64 0, i32 6, i32 1
  %38 = bitcast %94*** %37 to i64*
  %39 = load i64, i64* %38, align 8
  %40 = ptrtoint %94* %23 to i64
  br i1 %36, label %46, label %41

41:                                               ; preds = %35
  %42 = getelementptr inbounds %94, %94* %23, i64 0, i32 6, i32 1
  %43 = bitcast %94*** %42 to i64*
  store i64 %39, i64* %43, align 8
  %44 = bitcast %94*** %37 to i64**
...
48:                                               ; preds = %46, %41
  %49 = phi i64* [ %47, %46 ], [ %45, %41 ]
  store i64 %40, i64* %49, align 8
  %50 = bitcast %94* %21 to i8*
  tail call void @free(i8* %50) #6
  br label %80

51:                                               ; preds = %31
  %52 = icmp ult i32 %33, %6
...
54:                                               ; preds = %53, %51
  %55 = phi i32 [ %6, %53 ], [ %33, %51 ]
  %56 = icmp ugt i32 %29, %16
...
58:                                               ; preds = %57, %54
  %59 = phi i32 [ %16, %57 ], [ %29, %54 ]
  %60 = icmp eq i32 %55, %59
  br i1 %60, label %61, label %77

61:                                               ; preds = %58
  %62 = icmp eq %94* %23, null
  %63 = getelementptr inbounds %94, %94* %21, i64 0, i32 6, i32 1
  %64 = bitcast %94*** %63 to i64*
  %65 = load i64, i64* %64, align 8
  %66 = ptrtoint %94* %23 to i64
  br i1 %62, label %72, label %67

67:                                               ; preds = %61
  %68 = getelementptr inbounds %94, %94* %23, i64 0, i32 6, i32 1
  %69 = bitcast %94*** %68 to i64*
  store i64 %65, i64* %69, align 8
  %70 = bitcast %94*** %63 to i64**
...
74:                                               ; preds = %72, %67
  %75 = phi i64* [ %73, %72 ], [ %71, %67 ]
  store i64 %66, i64* %75, align 8
  %76 = bitcast %94* %21 to i8*
  tail call void @free(i8* %76) #6
  br label %80
...
80:                                               ; preds = %77, %74, %48, %20
  %81 = icmp eq %94* %23, null
