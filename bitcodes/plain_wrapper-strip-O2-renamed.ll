; ModuleID = 'plain_wrapper-strip-O2-renamed.bc'
...
10:                                               ; preds = %8
  %11 = bitcast %23** %4 to i64*
  %12 = load i64, i64* %11, align 8
  %13 = bitcast %23** %2 to i64*
  store i64 %12, i64* %13, align 8
  br label %14

14:                                               ; preds = %8, %10
  %15 = call noalias i8* @_emalloc_192() #10
  %16 = getelementptr inbounds i8, i8* %15, i64 12
  %17 = bitcast i8* %16 to i32*
  %18 = getelementptr inbounds i8, i8* %15, i64 16
  %19 = bitcast i8* %18 to i32*
  call void @llvm.memset.p0i8.i64(i8* align 8 %15, i8 0, i64 192, i1 false) #10
  store i32 8, i32* %19, align 8
  store i32 0, i32* %17, align 4
  %20 = getelementptr inbounds i8, i8* %15, i64 24
  %21 = bitcast i8* %20 to %23**
  store %23* null, %23** %21, align 8
  %22 = getelementptr inbounds i8, i8* %15, i64 8
  %23 = bitcast i8* %22 to i32*
  store i32 %6, i32* %23, align 8
  %24 = call %2* @_php_stream_alloc(%3* nonnull @php_stream_stdio_ops, i8* %15, i8* null, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @0, i64 0, i64 0)) #10
  %25 = icmp eq %2* %24, null
  br i1 %25, label %42, label %26

26:                                               ; preds = %14
  %27 = getelementptr inbounds %2, %2* %24, i64 0, i32 1
  %28 = bitcast i8** %27 to %24**
  %29 = load %24*, %24** %28, align 8
  %30 = getelementptr inbounds %2, %2* %24, i64 0, i32 4
  store %0* @php_plain_files_wrapper, %0** %30, align 8
  %31 = load %23*, %23** %4, align 8
  %32 = getelementptr inbounds %23, %23* %31, i64 0, i32 3, i64 0
  %33 = getelementptr inbounds %23, %23* %31, i64 0, i32 2
  %34 = load i64, i64* %33, align 8
  %35 = call noalias i8* @_estrndup(i8* nonnull %32, i64 %34) #10
  %36 = getelementptr inbounds %2, %2* %24, i64 0, i32 13
  store i8* %35, i8** %36, align 8
  %37 = bitcast %23** %4 to i64*
  %38 = load i64, i64* %37, align 8
  %39 = getelementptr inbounds %24, %24* %29, i64 0, i32 4
  %40 = bitcast %23** %39 to i64*
  store i64 %38, i64* %40, align 8
  %41 = getelementptr inbounds %24, %24* %29, i64 0, i32 3
  store i32 8, i32* %41, align 8
  br label %44

42:                                               ; preds = %14
  %43 = call i32 @close(i32 %6) #10
  call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @1, i64 0, i64 0)) #10
  br label %44

44:                                               ; preds = %3, %26, %42
  %45 = phi %2* [ %24, %26 ], [ null, %42 ], [ null, %3 ]
...
103:                                              ; preds = %102
  %104 = call i32 @php_check_open_basedir_ex(i8* nonnull %7, i32 0) #10
  %105 = icmp eq i32 %104, 0
  br i1 %105, label %106, label %110

106:                                              ; preds = %103, %102
  %107 = call %2* @_php_stream_fopen(i8* nonnull %7, i8* %1, %23** %3, i32 %4)
...
110:                                              ; preds = %103, %106, %93
  %111 = phi i8* [ %98, %103 ], [ %98, %106 ], [ %94, %93 ]
...
114:                                              ; preds = %36, %28, %10, %113, %109, %46, %39, %31
  %115 = phi %2* [ %32, %31 ], [ %40, %39 ], [ %107, %109 ], [ null, %113 ], [ %47, %46 ], [ null, %10 ], [ null, %28 ], [ null, %36 ]
...
41:                                               ; preds = %38
  br i1 %37, label %71, label %42

42:                                               ; preds = %41
  %43 = call i8* @strrchr(i8* nonnull %20, i32 47) #9
  %44 = icmp eq i8* %43, null
  br i1 %44, label %71, label %45

45:                                               ; preds = %42, %38
  %46 = phi i8* [ %39, %38 ], [ %43, %42 ]
  store i8 0, i8* %46, align 1
  %47 = icmp ugt i8* %46, %20
  br i1 %47, label %48, label %57

48:                                               ; preds = %45, %54
  %49 = phi i32 [ %55, %54 ], [ 0, %45 ]
  %50 = phi i8* [ %51, %54 ], [ %46, %45 ]
...
54:                                               ; preds = %48
  ...
  store i8 0, i8* %51, align 1
  %56 = icmp ugt i8* %51, %20
  br i1 %56, label %48, label %57

57:                                               ; preds = %48, %54, %45
  %58 = phi i8* [ %46, %45 ], [ %51, %54 ], [ %50, %48 ]
  %59 = phi i32 [ 0, %45 ], [ %55, %54 ], [ %49, %48 ]
  %60 = call i32 @__xstat(i32 1, i8* nonnull %20, %5* nonnull %6) #10
  %61 = icmp eq i32 %60, 0
...
64:                                               ; preds = %62
  ...
  %68 = getelementptr i8, i8* %58, i64 1
  %69 = zext i32 %59 to i64
  call void @llvm.memset.p0i8.i64(i8* align 1 %68, i8 47, i64 %69, i1 false)
  %70 = getelementptr i8, i8* %58, i64 %67
  br label %73
...
73:                                               ; preds = %64, %62, %23
  %74 = phi i8* [ %26, %23 ], [ %58, %62 ], [ %70, %64 ]
  %75 = icmp eq i8* %74, %20
  %76 = sext i32 %2 to i64
  br i1 %75, label %77, label %79

77:                                               ; preds = %73
  %78 = call i32 @php_mkdir(i8* %12, i64 %76) #10
  br label %113

79:                                               ; preds = %71, %73
  %80 = phi i64 [ %72, %71 ], [ %76, %73 ]
  %81 = phi i8* [ null, %71 ], [ %74, %73 ]
  %82 = call i32 @php_mkdir(i8* nonnull %20, i64 %80) #10
  %83 = icmp eq i32 %82, 0
  br i1 %83, label %84, label %113

84:                                               ; preds = %79
  %85 = icmp eq i8* %81, null
  %86 = select i1 %85, i8* %20, i8* %81
  %87 = getelementptr inbounds i8, i8* %86, i64 1
  %88 = icmp eq i8* %87, %25
  br i1 %88, label %113, label %89

89:                                               ; preds = %84, %109
  %90 = phi i8* [ %111, %109 ], [ %87, %84 ]
  %91 = phi i8* [ %90, %109 ], [ %86, %84 ]
  %92 = phi i32 [ %110, %109 ], [ 0, %84 ]
...
99:                                               ; preds = %95
  %100 = call i32 @mkdir(i8* nonnull %20, i32 %2) #10
...
105:                                              ; preds = %102
  %106 = tail call i32* @__errno_location() #12
  %107 = load i32, i32* %106, align 4
  %108 = call i8* @strerror(i32 %107) #10
  call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @17, i64 0, i64 0), i8* %108) #10
  br label %113

109:                                              ; preds = %95, %99, %89
  %110 = phi i32 [ %100, %99 ], [ %92, %95 ], [ %92, %89 ]
  %111 = getelementptr inbounds i8, i8* %90, i64 1
  %112 = icmp eq i8* %111, %25
  br i1 %112, label %113, label %89

113:                                              ; preds = %109, %84, %102, %79, %105, %77
  %114 = phi i32 [ %100, %102 ], [ %100, %105 ], [ %82, %79 ], [ %78, %77 ], [ 0, %84 ], [ %110, %109 ]
