; ModuleID = 'pathspec-strip-O2-renamed.bc'
...
90:                                               ; preds = %84, %125
  %91 = phi i64 [ 0, %84 ], [ %129, %125 ]
  %92 = phi i32 [ 0, %84 ], [ %100, %125 ]
...
103:                                              ; preds = %90
  tail call fastcc void @60(i8* %94, i32 %101) #15
  unreachable
...
107:                                              ; preds = %104
  %108 = getelementptr inbounds %8, %8* %95, i64 0, i32 0
  %109 = load i8*, i8** %108, align 8
  %110 = getelementptr inbounds %8, %8* %75, i64 %91, i32 3
  %111 = load i32, i32* %110, align 4
  %112 = tail call i32 @has_symlink_leading_path(i8* %109, i32 %111) #13
  %113 = icmp eq i32 %112, 0
  br i1 %113, label %116, label %114

114:                                              ; preds = %107
  %115 = tail call fastcc i8* @61(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @4, i64 0, i64 0))
  tail call void (i8*, ...) @die(i8* %115, i8* %94) #14
  unreachable

116:                                              ; preds = %105, %107
  %117 = phi i32* [ %106, %105 ], [ %110, %107 ]
  %118 = getelementptr inbounds %8, %8* %75, i64 %91, i32 5
...
122:                                              ; preds = %116
  %123 = load i8, i8* %87, align 4
  %124 = or i8 %123, 1
  store i8 %124, i8* %87, align 4
  br label %125
...
125:                                              ; preds = %122, %116
  ...
  %130 = icmp ult i64 %129, %89
  br i1 %130, label %90, label %131

131:                                              ; preds = %125, %81
  %132 = phi i32 [ 0, %81 ], [ %100, %125 ]
  %133 = icmp eq i32 %132, %68
  br i1 %133, label %134, label %139

134:                                              ; preds = %131
  %135 = select i1 %22, i32 %82, i32 0
  %136 = getelementptr inbounds %8, %8* %75, i64 %69
  tail call fastcc void @59(%8* %136, i32 0, i8* %3, i32 %135, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @5, i64 0, i64 0))
  %137 = load i32, i32* %70, align 8
  %138 = add nsw i32 %137, 1
  store i32 %138, i32* %70, align 8
  br label %139

139:                                              ; preds = %134, %131
  %140 = getelementptr inbounds %7, %7* %0, i64 0, i32 2
...
151:                                              ; preds = %148
  ...
  %153 = load i8*, i8** %77, align 8
  tail call void @qsort(i8* %153, i64 %152, i64 56, i32 (i8*, i8*)* nonnull @62) #13
  br label %154

154:                                              ; preds = %151, %148, %139, %32, %16, %35
  ret void
}
...
433:                                              ; preds = %468, %427
  %434 = phi i64 [ 0, %427 ], [ %469, %468 ]
  %435 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %434, i32 0
...
439:                                              ; preds = %433
  %440 = load i8*, i8** %430, align 8
  %441 = load i64, i64* %431, align 8
  %442 = add i64 %441, -1
  %443 = getelementptr inbounds i8, i8* %440, i64 %442
  %444 = load i8, i8* %443, align 1
  %445 = icmp eq i8 %444, 40
...
452:                                              ; preds = %449, %446
  ...
  %454 = add i64 %453, 1
  %455 = load i8*, i8** %430, align 8
  br label %456

456:                                              ; preds = %452, %449
  %457 = phi i8* [ %440, %449 ], [ %455, %452 ]
  %458 = phi i64 [ %450, %449 ], [ %454, %452 ]
  %459 = phi i64 [ %441, %449 ], [ %453, %452 ]
  store i64 %458, i64* %431, align 8
  %460 = getelementptr inbounds i8, i8* %457, i64 %459
  store i8 44, i8* %460, align 1
  %461 = load i8*, i8** %430, align 8
...
464:                                              ; preds = %456, %439
  %465 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %434, i32 2
  %466 = load i8*, i8** %465, align 8
  %467 = call i64 @strlen(i8* %466) #12
  call void @strbuf_add(%6* nonnull %9, i8* %466, i64 %467) #13
  br label %468

468:                                              ; preds = %464, %433
  %469 = add nuw nsw i64 %434, 1
  %470 = icmp eq i64 %469, 6
  br i1 %470, label %471, label %433

471:                                              ; preds = %468
  call void (%6*, i8*, ...) @strbuf_addf(%6* nonnull %9, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @49, i64 0, i64 0), i32 %429) #13
  %472 = call i64 @strlen(i8* %411) #12
  call void @strbuf_add(%6* nonnull %9, i8* %411, i64 %472) #13
  %473 = call i8* @strbuf_detach(%6* nonnull %9, i64* null) #13
  %474 = getelementptr inbounds %8, %8* %0, i64 0, i32 1
  store i8* %473, i8** %474, align 8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %428) #13
  br label %478

475:                                              ; preds = %424, %406
  %476 = call i8* @xstrdup(i8* %4) #13
  %477 = getelementptr inbounds %8, %8* %0, i64 0, i32 1
  store i8* %476, i8** %477, align 8
  br label %478

478:                                              ; preds = %475, %471
  br i1 %409, label %479, label %482

479:                                              ; preds = %478
  %480 = load i32, i32* %415, align 4
  %481 = getelementptr inbounds %8, %8* %0, i64 0, i32 5
  store i32 %480, i32* %481, align 4
  br label %489

482:                                              ; preds = %478
  %483 = load i8*, i8** %412, align 8
  %484 = call i32 @simple_length(i8* %483) #13
  %485 = getelementptr inbounds %8, %8* %0, i64 0, i32 5
...
489:                                              ; preds = %482, %479
  %490 = phi i32 [ %488, %482 ], [ %480, %479 ]
  %491 = getelementptr inbounds %8, %8* %0, i64 0, i32 6
  store i32 0, i32* %491, align 8
  %492 = getelementptr inbounds %8, %8* %0, i64 0, i32 5
  br i1 %410, label %493, label %509

493:                                              ; preds = %489
  %494 = load i32, i32* %415, align 4
  %495 = icmp slt i32 %490, %494
  br i1 %495, label %496, label %509

496:                                              ; preds = %493
  %497 = load i8*, i8** %412, align 8
...
502:                                              ; preds = %496
  ...
  %504 = call i32 @no_wildcard(i8* nonnull %503) #13
  %505 = icmp eq i32 %504, 0
  br i1 %505, label %509, label %506

506:                                              ; preds = %502
  %507 = load i32, i32* %491, align 8
  %508 = or i32 %507, 1
  store i32 %508, i32* %491, align 8
  br label %509

509:                                              ; preds = %489, %502, %493, %496, %506
  %510 = load i32, i32* %492, align 4
  %511 = load i32, i32* %415, align 4
  %512 = icmp sgt i32 %510, %511
  br i1 %512, label %516, label %513

513:                                              ; preds = %509
  %514 = load i32, i32* %416, align 8
...
6:                                                ; preds = %34, %2
  %7 = phi i64 [ 0, %2 ], [ %35, %34 ]
  %8 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %7, i32 0
...
19:                                               ; preds = %16
  %20 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %7, i32 1
  %21 = call i32 @use_gettext_poison() #13
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %23, label %25

23:                                               ; preds = %19
  %24 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @52, i64 0, i64 0), i32 5) #13
  br label %25

25:                                               ; preds = %19, %23
  %26 = phi i8* [ %24, %23 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @55, i64 0, i64 0), %19 ]
  %27 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %7, i32 2
  %28 = load i8*, i8** %27, align 8
  %29 = load i8, i8* %20, align 4
  %30 = sext i8 %29 to i32
  call void (%6*, i8*, ...) @strbuf_addf(%6* nonnull %3, i8* %26, i8* %28, i32 %30) #13
  br label %34

31:                                               ; preds = %16
  %32 = getelementptr inbounds [6 x %3], [6 x %3]* @19, i64 0, i64 %7, i32 2
  %33 = load i8*, i8** %32, align 8
  call void (%6*, i8*, ...) @strbuf_addf(%6* nonnull %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @53, i64 0, i64 0), i8* %33) #13
  br label %34
...
37:                                               ; preds = %34
  %38 = call fastcc i8* @61(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @54, i64 0, i64 0))
  %39 = getelementptr inbounds %6, %6* %3, i64 0, i32 2
  %40 = load i8*, i8** %39, align 8
  call void (i8*, ...) @die(i8* %38, i8* %0, i8* %40) #14
  unreachable
}
...
46:                                               ; preds = %40, %42
  %47 = phi i8* [ %41, %40 ], [ %34, %42 ]
  %48 = call i32 @unquote_c_style(%6* nonnull %10, i8* %47, i8** null) #13
  %49 = icmp eq i32 %48, 0
  br i1 %49, label %53, label %50

50:                                               ; preds = %46
  %51 = call fastcc i8* @61(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @10, i64 0, i64 0))
  %52 = load i8*, i8** %27, align 8
  call void (i8*, ...) @die(i8* %51, i8* %52) #14
  unreachable
...
54:                                               ; preds = %53, %33, %32
  ...
  %56 = call i8* @argv_array_push(%0* nonnull %8, i8* %55) #13
...
64:                                               ; preds = %59, %60
  %65 = call i32 %13(%6* nonnull %9, %1* %23) #13
  %66 = icmp eq i32 %65, -1
...
67:                                               ; preds = %64, %22
  ...
  %68 = load %1*, %1** @stdin, align 8
  %69 = icmp eq %1* %23, %68
  br i1 %69, label %72, label %70

70:                                               ; preds = %67
  %71 = call i32 @fclose(%1* %23)
  br label %72

72:                                               ; preds = %67, %70
  %73 = getelementptr inbounds %0, %0* %8, i64 0, i32 0
  %74 = load i8**, i8*** %73, align 8
  call void @parse_pathspec(%7* %0, i32 %1, i32 %2, i8* %3, i8** %74)
