; ModuleID = 'blocked-strip-O2-renamed.bc'
...
23:                                               ; preds = %20
  ...
  %25 = getelementptr inbounds %36, %36* %6, i64 %21
  %26 = bitcast %36* %25 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %24, i8* align 8 %26, i64 16, i1 false)
  br label %27

27:                                               ; preds = %23, %20
  %28 = load %28*, %28** %16, align 8
  %29 = getelementptr inbounds %9*, %9** %2, i64 %21
  %30 = bitcast %9** %29 to i8**
  %31 = load i8*, i8** %30, align 8
  %32 = tail call i32 @dictAdd(%28* %28, i8* %31, i8* %22) #6
  %33 = icmp eq i32 %32, 0
...
35:                                               ; preds = %27
  %36 = load %9*, %9** %29, align 8
  tail call void @incrRefCount(%9* %36) #6
  %37 = load %1*, %1** %17, align 8
  %38 = getelementptr inbounds %1, %1* %37, i64 0, i32 2
  %39 = load %28*, %28** %38, align 8
  %40 = load i8*, i8** %30, align 8
  %41 = tail call %31* @dictFind(%28* %39, i8* %40) #6
  %42 = icmp eq %31* %41, null
  br i1 %42, label %43, label %55

43:                                               ; preds = %35
  %44 = tail call %19* @listCreate() #6
  %45 = load %1*, %1** %17, align 8
  %46 = getelementptr inbounds %1, %1* %45, i64 0, i32 2
  %47 = load %28*, %28** %46, align 8
  %48 = load i8*, i8** %30, align 8
  %49 = bitcast %19* %44 to i8*
  %50 = tail call i32 @dictAdd(%28* %47, i8* %48, i8* %49) #6
  %51 = load %9*, %9** %29, align 8
  tail call void @incrRefCount(%9* %51) #6
  %52 = icmp eq i32 %50, 0
  br i1 %52, label %59, label %53

53:                                               ; preds = %43
  %54 = load %9*, %9** %29, align 8
  tail call void @_serverAssertWithInfo(%23* nonnull %0, %9* %54, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @7, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @1, i64 0, i64 0), i32 589) #6
  tail call void @_exit(i32 1) #7
  unreachable

55:                                               ; preds = %35
  %56 = getelementptr inbounds %31, %31* %41, i64 0, i32 1, i32 0
  %57 = bitcast i8** %56 to %19**
  %58 = load %19*, %19** %57, align 8
  br label %59

59:                                               ; preds = %43, %55
  %60 = phi %19* [ %58, %55 ], [ %44, %43 ]
  %61 = tail call %19* @listAddNodeTail(%19* %60, i8* nonnull %18) #6
  %62 = getelementptr inbounds %19, %19* %60, i64 0, i32 1
  %63 = bitcast %20** %62 to i64*
  %64 = load i64, i64* %63, align 8
  %65 = bitcast i8* %22 to i64*
...
69:                                               ; preds = %66, %12
  %70 = getelementptr inbounds %23, %23* %0, i64 0, i32 23
  %71 = load i64, i64* %70, align 8
  %72 = or i64 %71, 16
  store i64 %72, i64* %70, align 8
  %73 = getelementptr inbounds %23, %23* %0, i64 0, i32 41
  store i32 %1, i32* %73, align 8
  %74 = load i32, i32* getelementptr inbounds (%0, %0* @server, i64 0, i32 263), align 8
  %75 = add i32 %74, 1
  store i32 %75, i32* getelementptr inbounds (%0, %0* @server, i64 0, i32 263), align 8
  %76 = sext i32 %1 to i64
  %77 = getelementptr inbounds %0, %0* @server, i64 0, i32 264, i64 %76
