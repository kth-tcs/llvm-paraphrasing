; ModuleID = 'checkout-index-strip-O2-renamed.bc'
...
265:                                              ; preds = %331, %263
  %266 = phi i32 [ %261, %263 ], [ %332, %331 ]
  %267 = phi i64 [ 0, %263 ], [ %335, %331 ]
  %268 = phi %2* [ null, %263 ], [ %334, %331 ]
  %269 = phi i32 [ 0, %263 ], [ %333, %331 ]
...
287:                                              ; preds = %284
  %288 = getelementptr inbounds %2, %2* %272, i64 0, i32 5
  %289 = load i32, i32* %288, align 8
  %290 = icmp ugt i32 %289, %147
  br i1 %290, label %291, label %331

291:                                              ; preds = %287
  %292 = getelementptr inbounds %2, %2* %272, i64 0, i32 8, i64 0
  %293 = call i32 @memcmp(i8* nonnull %2, i8* nonnull %292, i64 %264) #11
  %294 = icmp eq i32 %293, 0
  br i1 %294, label %295, label %331

295:                                              ; preds = %291, %284, %283
  %296 = icmp ne %2* %268, null
...
300:                                              ; preds = %295
  %301 = getelementptr inbounds %2, %2* %268, i64 0, i32 5
  %302 = load i32, i32* %301, align 8
  %303 = getelementptr inbounds %2, %2* %272, i64 0, i32 5
  %304 = load i32, i32* %303, align 8
  %305 = icmp eq i32 %302, %304
  %306 = getelementptr inbounds %2, %2* %268, i64 0, i32 8, i64 0
  br i1 %305, label %307, label %312

307:                                              ; preds = %300
  %308 = getelementptr inbounds %2, %2* %272, i64 0, i32 8, i64 0
  %309 = zext i32 %302 to i64
  %310 = call i32 @memcmp(i8* nonnull %306, i8* nonnull %308, i64 %309) #11
  %311 = icmp eq i32 %310, 0
  br i1 %311, label %321, label %312

312:                                              ; preds = %307, %300
  call fastcc void @51(i8* nonnull %306, i8* %2) #10
  %313 = load i32, i32* @15, align 4
  br label %314

314:                                              ; preds = %312, %295
  %315 = phi i32 [ %297, %295 ], [ %313, %312 ]
  %316 = icmp eq i32 %315, 0
  br i1 %316, label %325, label %317

317:                                              ; preds = %314
  %318 = load i32, i32* %273, align 8
  %319 = lshr i32 %318, 12
  %320 = and i32 %319, 3
  br label %321

321:                                              ; preds = %317, %307
  %322 = phi i32 [ %320, %317 ], [ %276, %307 ]
  %323 = zext i32 %322 to i64
  %324 = getelementptr inbounds [4 x [26 x i8]], [4 x [26 x i8]]* @40, i64 0, i64 %323, i64 0
  br label %325

325:                                              ; preds = %321, %314
  %326 = phi i8* [ %324, %321 ], [ null, %314 ]
  %327 = call i32 @checkout_entry(%2* %272, %0* nonnull @18, i8* %326, i32* null) #10
  %328 = lshr i32 %327, 31
  %329 = add nsw i32 %328, %269
  %330 = load i32, i32* getelementptr inbounds (%1, %1* @the_index, i64 0, i32 2), align 4
  br label %331

331:                                              ; preds = %325, %291, %287, %279
  %332 = phi i32 [ %330, %325 ], [ %266, %279 ], [ %266, %291 ], [ %266, %287 ]
  %333 = phi i32 [ %329, %325 ], [ %269, %279 ], [ %269, %291 ], [ %269, %287 ]
  %334 = phi %2* [ %272, %325 ], [ %268, %279 ], [ %268, %291 ], [ %268, %287 ]
  %335 = add nuw nsw i64 %267, 1
  %336 = zext i32 %332 to i64
  %337 = icmp ult i64 %335, %336
  br i1 %337, label %265, label %338

338:                                              ; preds = %331
  %339 = icmp ne %2* %334, null
...
343:                                              ; preds = %338
  %344 = getelementptr inbounds %2, %2* %334, i64 0, i32 8, i64 0
  call fastcc void @51(i8* nonnull %344, i8* %2) #10
  br label %345
...
347:                                              ; preds = %345
  %348 = call i32 @trace2_cmd_exit_fl(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @34, i64 0, i64 0), i32 127, i32 128) #10
  call void @exit(i32 %348) #12
  unreachable

349:                                              ; preds = %345, %260, %257
  %350 = getelementptr inbounds %42, %42* %5, i64 0, i32 0
  %351 = load %43*, %43** %350, align 8
  %352 = icmp eq %43* %351, null
  br i1 %352, label %361, label %353

353:                                              ; preds = %349
  %354 = getelementptr inbounds %43, %43* %351, i64 0, i32 1
  %355 = load volatile i32, i32* %354, align 8
  %356 = icmp eq i32 %355, 0
  br i1 %356, label %361, label %357

357:                                              ; preds = %353
  %358 = call i32 @write_locked_index(%1* nonnull @the_index, %42* nonnull %5, i32 1) #10
