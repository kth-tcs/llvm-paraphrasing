; ModuleID = 'color-strip-O3-renamed.bc'
...
100:                                              ; preds = %97
  ...
  %103 = getelementptr i8, i8* %38, i64 2
  %104 = load i8, i8* %103, align 1
  %105 = zext i8 %102 to i64
  %106 = getelementptr inbounds [256 x i8], [256 x i8]* @hexval_table, i64 0, i64 %105
...
116:                                              ; preds = %100
  ...
  %120 = getelementptr i8, i8* %38, i64 4
  %121 = load i8, i8* %120, align 1
  %122 = zext i8 %119 to i64
  %123 = getelementptr inbounds [256 x i8], [256 x i8]* @hexval_table, i64 0, i64 %122
...
133:                                              ; preds = %116
  ...
  %137 = getelementptr i8, i8* %38, i64 6
  %138 = load i8, i8* %137, align 1
  %139 = zext i8 %136 to i64
  %140 = getelementptr inbounds [256 x i8], [256 x i8]* @hexval_table, i64 0, i64 %139
  %141 = load i8, i8* %140, align 1
  %142 = sext i8 %141 to i32
  %143 = shl nsw i32 %142, 4
...
23:                                               ; preds = %19, %17, %14, %11, %8
  %24 = phi i32 [ 0, %8 ], [ 1, %11 ], [ 2, %14 ], [ -1, %17 ], [ %22, %19 ]
  store i32 %24, i32* @23, align 4
  br label %25

25:                                               ; preds = %3, %23
  %26 = tail call i32 @git_default_config(i8* %0, i8* %1, i8* %2) #7
  ret i32 %26
}
