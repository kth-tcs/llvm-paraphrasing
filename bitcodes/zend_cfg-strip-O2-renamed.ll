; ModuleID = 'zend_cfg-strip-O2-renamed.bc'
...
29:                                               ; preds = %27, %106
  %30 = phi i64 [ %108, %106 ], [ 1, %27 ]
  %31 = phi i32 [ %107, %106 ], [ 0, %27 ]
...
35:                                               ; preds = %29
  %36 = getelementptr inbounds %45, %45* %5, i64 %30, i32 5
...
39:                                               ; preds = %35
  ...
  %41 = getelementptr inbounds %45, %45* %5, i64 %30, i32 6
...
45:                                               ; preds = %39, %95
  %46 = phi i64 [ 0, %39 ], [ %97, %95 ]
  %47 = phi i32 [ -1, %39 ], [ %96, %95 ]
  %48 = add nsw i64 %46, %43
  %49 = getelementptr inbounds i32, i32* %40, i64 %48
  %50 = load i32, i32* %49, align 4
  %51 = icmp slt i32 %47, 0
  %52 = sext i32 %50 to i64
  %53 = getelementptr inbounds %45, %45* %5, i64 %52, i32 7
  %54 = load i32, i32* %53, align 8
  %55 = icmp sgt i32 %54, -1
  br i1 %51, label %56, label %58

56:                                               ; preds = %45
  %57 = select i1 %55, i32 %50, i32 %47
  br label %95

58:                                               ; preds = %45
  %59 = xor i1 %55, true
  %60 = icmp eq i32 %47, %50
  %61 = or i1 %60, %59
  br i1 %61, label %95, label %65

62:                                               ; preds = %87, %75
  %63 = phi i32 [ %67, %75 ], [ %90, %87 ]
  %64 = icmp eq i32 %63, %76
  br i1 %64, label %95, label %65

65:                                               ; preds = %58, %62
  %66 = phi i32 [ %76, %62 ], [ %50, %58 ]
  %67 = phi i32 [ %63, %62 ], [ %47, %58 ]
...
75:                                               ; preds = %79, %65
  %76 = phi i32 [ %66, %65 ], [ %82, %79 ]
  %77 = phi i32 [ %70, %65 ], [ %85, %79 ]
  %78 = icmp slt i32 %73, %77
  br i1 %78, label %87, label %62

79:                                               ; preds = %65, %79
  %80 = phi i64 [ %83, %79 ], [ %68, %65 ]
  %81 = getelementptr inbounds %45, %45* %5, i64 %80, i32 7
  %82 = load i32, i32* %81, align 8
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds i32, i32* %22, i64 %83
  %85 = load i32, i32* %84, align 4
  %86 = icmp slt i32 %85, %73
  br i1 %86, label %79, label %75

87:                                               ; preds = %75, %87
  %88 = phi i64 [ %91, %87 ], [ %71, %75 ]
  %89 = getelementptr inbounds %45, %45* %5, i64 %88, i32 7
  %90 = load i32, i32* %89, align 8
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds i32, i32* %22, i64 %91
  %93 = load i32, i32* %92, align 4
  %94 = icmp slt i32 %93, %77
  br i1 %94, label %87, label %62

95:                                               ; preds = %62, %58, %56
  %96 = phi i32 [ %57, %56 ], [ %47, %58 ], [ %76, %62 ]
  %97 = add nuw nsw i64 %46, 1
  %98 = icmp slt i64 %97, %44
...
101:                                              ; preds = %99
  %102 = getelementptr inbounds %45, %45* %5, i64 %30, i32 7
  %103 = load i32, i32* %102, align 8
...
106:                                              ; preds = %35, %99, %105, %101, %29
  %107 = phi i32 [ %31, %29 ], [ 1, %105 ], [ %31, %101 ], [ %31, %99 ], [ %31, %35 ]
...
120:                                              ; preds = %148, %113
  %121 = phi i64 [ 1, %113 ], [ %149, %148 ]
  %122 = getelementptr inbounds %45, %45* %5, i64 %121, i32 1
  %123 = load i32, i32* %122, align 8
  %124 = icmp sgt i32 %123, -1
  br i1 %124, label %148, label %125

125:                                              ; preds = %120
  %126 = getelementptr inbounds %45, %45* %5, i64 %121, i32 7
...
129:                                              ; preds = %125
  ...
  %131 = getelementptr inbounds %45, %45* %5, i64 %130, i32 10
  %132 = load i32, i32* %131, align 4
  %133 = zext i32 %132 to i64
  %134 = icmp ult i64 %121, %133
  br i1 %134, label %135, label %138

135:                                              ; preds = %129
  %136 = getelementptr inbounds %45, %45* %5, i64 %121, i32 11
...
138:                                              ; preds = %129, %138
  %139 = phi i32 [ %142, %138 ], [ %132, %129 ]
  %140 = sext i32 %139 to i64
  %141 = getelementptr inbounds %45, %45* %5, i64 %140, i32 11
  %142 = load i32, i32* %141, align 8
  %143 = zext i32 %142 to i64
  %144 = icmp ugt i64 %121, %143
  br i1 %144, label %138, label %145

145:                                              ; preds = %138
  %146 = getelementptr inbounds %45, %45* %5, i64 %121, i32 11
  store i32 %142, i32* %146, align 8
  %147 = trunc i64 %121 to i32
  store i32 %147, i32* %141, align 8
  br label %148

148:                                              ; preds = %125, %145, %135, %120
  %149 = add nuw nsw i64 %121, 1
  %150 = icmp eq i64 %149, %114
  br i1 %150, label %115, label %120

151:                                              ; preds = %173, %118
  %152 = phi i64 [ 0, %118 ], [ %174, %173 ]
  %153 = getelementptr inbounds %45, %45* %5, i64 %152, i32 1
  %154 = load i32, i32* %153, align 8
  %155 = icmp sgt i32 %154, -1
  br i1 %155, label %173, label %156

156:                                              ; preds = %151, %162
  %157 = phi i64 [ %164, %162 ], [ %152, %151 ]
  %158 = phi i32 [ %163, %162 ], [ 0, %151 ]
  %159 = getelementptr inbounds %45, %45* %5, i64 %157, i32 7
...
162:                                              ; preds = %156
  ...
  %165 = getelementptr inbounds %45, %45* %5, i64 %164, i32 9
  %166 = load i32, i32* %165, align 8
  %167 = icmp sgt i32 %166, -1
  br i1 %167, label %168, label %156

168:                                              ; preds = %162
  %169 = add nsw i32 %166, %163
  br label %170

170:                                              ; preds = %156, %168
  %171 = phi i32 [ %169, %168 ], [ %158, %156 ]
  %172 = getelementptr inbounds %45, %45* %5, i64 %152, i32 9
  store i32 %171, i32* %172, align 8
  br label %173

173:                                              ; preds = %151, %170
  %174 = add nuw nsw i64 %152, 1
  %175 = icmp eq i64 %174, %119
