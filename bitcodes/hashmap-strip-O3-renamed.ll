; ModuleID = 'hashmap-strip-O3-renamed.bc'
...
define dso_local %1* @hashmap_get(%0* nocapture readonly %0, %1* %1, i8* %2) local_unnamed_addr #2 {
  ...
  %6 = getelementptr %0, %0* %0, i64 0, i32 4
  %7 = load i32, i32* %6, align 4
  %8 = getelementptr %1, %1* %1, i64 0, i32 1
...
define dso_local void @hashmap_add(%0* nocapture %0, %1* %1) local_unnamed_addr #2 {
  ...
  %4 = load i32, i32* %3, align 4
  %5 = getelementptr %1, %1* %1, i64 0, i32 1
...
51:                                               ; preds = %51, %48
  ...
  %55 = getelementptr %1, %1* %52, i64 0, i32 1
...
88:                                               ; preds = %88, %85
  ...
  %92 = getelementptr %1, %1* %89, i64 0, i32 1
