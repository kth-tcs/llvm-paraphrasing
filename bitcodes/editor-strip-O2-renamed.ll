; ModuleID = 'editor-strip-O2-renamed.bc'
...
9:                                                ; preds = %5
  %10 = call i8* @git_editor()
  store i8* %10, i8** %1, align 8
  br label %11

11:                                               ; preds = %0, %5, %9
  %12 = phi i8* [ %3, %0 ], [ %7, %5 ], [ %10, %9 ]
...
define dso_local i32 @launch_sequence_editor(i8* %0, %0* %1, i8** %2) local_unnamed_addr #3 {
  ...
  %6 = tail call i8* @getenv(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @6, i64 0, i64 0)) #7
  store i8* %6, i8** %4, align 8
  %7 = icmp eq i8* %6, null
  br i1 %7, label %8, label %14

8:                                                ; preds = %3
  %9 = call i32 @git_config_get_string_const(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @7, i64 0, i64 0), i8** nonnull %4) #7
  %10 = load i8*, i8** %4, align 8
  %11 = icmp eq i8* %10, null
  br i1 %11, label %12, label %14

12:                                               ; preds = %8
  %13 = call i8* @git_editor() #7
  store i8* %13, i8** %4, align 8
  br label %14

14:                                               ; preds = %3, %8, %12
  %15 = phi i8* [ %6, %3 ], [ %10, %8 ], [ %13, %12 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #7
  %16 = call fastcc i32 @17(i8* %15, i8* %0, %0* %1, i8** %2)
  ret i32 %16
}
