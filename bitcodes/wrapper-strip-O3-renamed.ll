; ModuleID = 'wrapper-strip-O3-renamed.bc'
...
define dso_local i8* @xmalloc(i64 %0) local_unnamed_addr #0 {
  %2 = load i64, i64* @29, align 8
  %3 = icmp eq i64 %2, 0
  br i1 %3, label %4, label %8

4:                                                ; preds = %1
  %5 = tail call i64 @git_env_ulong(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @30, i64 0, i64 0), i64 0) #5
  %6 = icmp eq i64 %5, 0
...
11:                                               ; preds = %8
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @31, i64 0, i64 0), i64 %0, i64 %9) #11
  unreachable

12:                                               ; preds = %8
  %13 = tail call noalias i8* @malloc(i64 %0) #5
...
17:                                               ; preds = %12
  %18 = tail call noalias i8* @malloc(i64 1) #5
  br label %19

19:                                               ; preds = %17, %12
  %20 = phi i8* [ %13, %12 ], [ %18, %17 ]
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @xmallocz(i64 %0) local_unnamed_addr #0 {
  %2 = icmp eq i64 %0, -1
...
4:                                                ; preds = %1
  %5 = add i64 %0, 1
  %6 = load i64, i64* @29, align 8
  %7 = icmp eq i64 %6, 0
  br i1 %7, label %8, label %12

8:                                                ; preds = %4
  %9 = tail call i64 @git_env_ulong(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @30, i64 0, i64 0), i64 0) #5
  %10 = icmp eq i64 %9, 0
...
15:                                               ; preds = %12
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @31, i64 0, i64 0), i64 %5, i64 %13) #11
  unreachable

16:                                               ; preds = %12
  %17 = tail call noalias i8* @malloc(i64 %5) #5
  %18 = icmp eq i8* %17, null
  br i1 %18, label %19, label %20

19:                                               ; preds = %16
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @27, i64 0, i64 0), i64 %5) #11
  unreachable
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @xmallocz_gently(i64 %0) local_unnamed_addr #0 {
  %2 = icmp eq i64 %0, -1
...
5:                                                ; preds = %1
  %6 = add i64 %0, 1
  %7 = load i64, i64* @29, align 8
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %9, label %13

9:                                                ; preds = %5
  %10 = tail call i64 @git_env_ulong(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @30, i64 0, i64 0), i64 0) #5
  %11 = icmp eq i64 %10, 0
...
16:                                               ; preds = %13
  %17 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @31, i64 0, i64 0), i64 %6, i64 %14) #5
  br label %25

18:                                               ; preds = %13
  %19 = tail call noalias i8* @malloc(i64 %6) #5
  %20 = icmp eq i8* %19, null
  br i1 %20, label %21, label %23

21:                                               ; preds = %18
  %22 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @27, i64 0, i64 0), i64 %6) #5
  br label %25
...
25:                                               ; preds = %16, %3, %21, %23
  %26 = phi i8* [ null, %3 ], [ %19, %23 ], [ null, %21 ], [ null, %16 ]
  ret i8* %26
}

; Function Attrs: nounwind uwtable
define dso_local noalias i8* @xmemdupz(i8* nocapture readonly %0, i64 %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %1, -1
  br i1 %3, label %4, label %5
...
16:                                               ; preds = %13
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @31, i64 0, i64 0), i64 %6, i64 %14) #11
  unreachable

17:                                               ; preds = %13
  %18 = tail call noalias i8* @malloc(i64 %6) #5
  %19 = icmp eq i8* %18, null
  br i1 %19, label %20, label %21

20:                                               ; preds = %17
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @27, i64 0, i64 0), i64 %6) #11
  unreachable

21:                                               ; preds = %17
  %22 = getelementptr inbounds i8, i8* %18, i64 %1
  store i8 0, i8* %22, align 1
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %18, i8* align 1 %0, i64 %1, i1 false)
  ret i8* %18
}
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @xstrndup(i8* %0, i64 %1) local_unnamed_addr #0 {
...
11:                                               ; preds = %2
  %12 = add i64 %8, 1
  %13 = load i64, i64* @29, align 8
  %14 = icmp eq i64 %13, 0
  br i1 %14, label %15, label %19

15:                                               ; preds = %11
  %16 = tail call i64 @git_env_ulong(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @30, i64 0, i64 0), i64 0) #5
  %17 = icmp eq i64 %16, 0
...
22:                                               ; preds = %19
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @31, i64 0, i64 0), i64 %12, i64 %20) #11
  unreachable

23:                                               ; preds = %19
  %24 = tail call noalias i8* @malloc(i64 %12) #5
  %25 = icmp eq i8* %24, null
  br i1 %25, label %26, label %27

26:                                               ; preds = %23
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @27, i64 0, i64 0), i64 %12) #11
  unreachable

27:                                               ; preds = %23
  %28 = getelementptr inbounds i8, i8* %24, i64 %8
  store i8 0, i8* %28, align 1
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %24, i8* align 1 %0, i64 %8, i1 false) #5
  ret i8* %24
}
...
37:                                               ; preds = %34
  %38 = call fastcc i8* @35(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @4, i64 0, i64 0))
...
42:                                               ; preds = %39
  %43 = call fastcc i8* @35(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @5, i64 0, i64 0))
  call void (i8*, ...) @die_errno(i8* %43, i8* %0) #11
  unreachable

44:                                               ; preds = %39
  %45 = call fastcc i8* @35(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @6, i64 0, i64 0))
...
define internal fastcc i8* @35(i8* %0) unnamed_addr #8 {
...
17:                                               ; preds = %13
  %18 = tail call fastcc i8* @35(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @4, i64 0, i64 0))
...
20:                                               ; preds = %19, %19
  %21 = tail call fastcc i8* @35(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @5, i64 0, i64 0))
  tail call void (i8*, ...) @die_errno(i8* %21, i8* %0) #11
  unreachable

22:                                               ; preds = %10, %19
  %23 = tail call fastcc i8* @35(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @6, i64 0, i64 0))
...
14:                                               ; preds = %9
  %15 = tail call fastcc i8* @35(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @19, i64 0, i64 0))
...
5:                                                ; preds = %0
  %6 = call fastcc i8* @35(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @20, i64 0, i64 0))
...
7:                                                ; preds = %3
  %8 = tail call fastcc i8* @35(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @23, i64 0, i64 0))
...
12:                                               ; preds = %9
  %13 = tail call fastcc i8* @35(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @24, i64 0, i64 0))
...
11:                                               ; preds = %7
  %12 = call fastcc i8* @35(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @26, i64 0, i64 0))
