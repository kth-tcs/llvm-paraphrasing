; ModuleID = 'spawn_server-strip-O3-renamed.bc'
...
@11 = private unnamed_addr constant [56 x i8] c"SPAWN: Failed to change signal handler for signal: %d.\0A\00", align 1
@12 = internal unnamed_addr global %15* null, align 8
@13 = private unnamed_addr constant [20 x i8] c"uv_pipe_init(): %s\0A\00", align 1
@14 = private unnamed_addr constant [16 x i8] c"server_pipe.ipc\00", align 1
@15 = private unnamed_addr constant [24 x i8] c"void spawn_server(void)\00", align 1
@16 = private unnamed_addr constant [20 x i8] c"uv_pipe_open(): %s\0A\00", align 1
@17 = private unnamed_addr constant [39 x i8] c"0 == uv_cond_init(&wait_children_cond)\00", align 1
@18 = private unnamed_addr constant [41 x i8] c"0 == uv_mutex_init(&wait_children_mutex)\00", align 1
@19 = internal unnamed_addr global %31* null, align 8
@20 = internal global %16 zeroinitializer, align 8
@21 = private unnamed_addr constant [21 x i8] c"uv_async_init(): %s\0A\00", align 1
@22 = internal global i64 0, align 8
@23 = private unnamed_addr constant [24 x i8] c"uv_thread_create(): %s\0A\00", align 1
@24 = internal unnamed_addr global i32 0, align 4
@25 = private unnamed_addr constant [11 x i8] c"error == 0\00", align 1
@26 = internal unnamed_addr global i1 false, align 4
@27 = private unnamed_addr constant [43 x i8] c"Shutting down spawn server loop complete.\0A\00", align 1
@28 = private unnamed_addr constant [25 x i8] c"0 == uv_loop_close(loop)\00", align 1
@29 = private unnamed_addr constant [41 x i8] c"void child_waited_async_cb(uv_async_t *)\00", align 1
@30 = private unnamed_addr constant [27 x i8] c"SPAWN: Failed to wait: %s\0A\00", align 1
@31 = private unnamed_addr constant [25 x i8] c"SPAWN: No child exited.\0A\00", align 1
@32 = private unnamed_addr constant [24 x i8] c"CLD_EXITED == i.si_code\00", align 1
@33 = private unnamed_addr constant [27 x i8] c"void wait_children(void *)\00", align 1
@34 = private unnamed_addr constant [77 x i8] c"SPAWN: race condition detected, waiting for child process %d to be indexed.\0A\00", align 1
@35 = private unnamed_addr constant [40 x i8] c"0 == uv_async_send(&child_waited_async)\00", align 1
@36 = private unnamed_addr constant [45 x i8] c"SERVER %s: Zero bytes read from spawn pipe.\0A\00", align 1
@37 = private unnamed_addr constant [13 x i8] c"on_pipe_read\00", align 1
@38 = private unnamed_addr constant [26 x i8] c"EOF found in spawn pipe.\0A\00", align 1
@39 = private unnamed_addr constant [8 x i8] c"%s: %s\0A\00", align 1
@40 = private unnamed_addr constant [40 x i8] c"Shutting down spawn server event loop.\0A\00", align 1
@41 = private unnamed_addr constant [23 x i8] c"uv_thread_create(): %s\00", align 1
@42 = internal global [4096 x i8] zeroinitializer, align 16
@43 = private unnamed_addr constant [38 x i8] c"SPAWN_PROT_EXEC_CMD == header->opcode\00", align 1
@44 = private unnamed_addr constant [55 x i8] c"void server_parse_spawn_protocol(unsigned int, char *)\00", align 1
@45 = private unnamed_addr constant [23 x i8] c"NULL != header->handle\00", align 1
@46 = private unnamed_addr constant [42 x i8] c"SPAWN: Ran out of protocol buffer space.\0A\00", align 1
...
33:                                               ; preds = %32, %15
  ...
  %49 = call i32 @uv_write(%32* nonnull %7, %26* bitcast (%14* @8 to %26*), %25* nonnull %48, i32 2, void (%32*, i32)* nonnull @47) #9
  %50 = icmp eq i32 %49, 0
...
; Function Attrs: nounwind uwtable
define internal void @47(%32* nocapture readonly %0, i32 %1) #2 {
...
15:                                               ; preds = %12, %0
  ...
  %23 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %24 = call i32 @sigaction(i32 13, %33* nonnull %1, %33* null) #9
  %25 = icmp eq i32 %24, -1
  br i1 %25, label %26, label %29

26:                                               ; preds = %15
  %27 = load %0*, %0** @stderr, align 8
  %28 = call i32 (%0*, i8*, ...) @fprintf(%0* %27, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 13) #10
  br label %29

29:                                               ; preds = %15, %26
  store i32 0, i32* %20, align 8
  %30 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %31 = call i32 @sigaction(i32 2, %33* nonnull %1, %33* null) #9
  %32 = icmp eq i32 %31, -1
  br i1 %32, label %89, label %92

33:                                               ; preds = %141
  %34 = load %0*, %0** @stderr, align 8
  %35 = call i8* @uv_strerror(i32 %144) #9
  %36 = call i32 (%0*, i8*, ...) @fprintf(%0* %34, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @13, i64 0, i64 0), i8* %35) #10
  call void @exit(i32 %144) #11
  unreachable

37:                                               ; preds = %141
  %38 = load i32, i32* getelementptr inbounds (%14, %14* @8, i64 0, i32 20), align 8
  %39 = icmp eq i32 %38, 0
  br i1 %39, label %40, label %41

40:                                               ; preds = %37
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @14, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 341, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @15, i64 0, i64 0)) #11
  unreachable

41:                                               ; preds = %37
  %42 = call i32 @uv_pipe_open(%14* nonnull @8, i32 0) #9
  %43 = icmp eq i32 %42, 0
  br i1 %43, label %48, label %44

44:                                               ; preds = %41
  %45 = load %0*, %0** @stderr, align 8
  %46 = call i8* @uv_strerror(i32 %42) #9
  %47 = call i32 (%0*, i8*, ...) @fprintf(%0* %45, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @16, i64 0, i64 0), i8* %46) #10
  call void @exit(i32 %42) #11
  unreachable

48:                                               ; preds = %41
  call void @avl_init_lock(%2* nonnull @1, i32 (i8*, i8*)* nonnull @spawn_exec_compare) #9
  store i1 false, i1* @6, align 1
  %49 = call i32 @uv_cond_init(%10* nonnull @7) #9
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %52, label %51

51:                                               ; preds = %48
  call void @__assert_fail(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @17, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 351, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @15, i64 0, i64 0)) #11
  unreachable

52:                                               ; preds = %48
  %53 = call i32 @uv_mutex_init(%7* nonnull @5) #9
  %54 = icmp eq i32 %53, 0
  br i1 %54, label %56, label %55

55:                                               ; preds = %52
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @18, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 352, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @15, i64 0, i64 0)) #11
  unreachable

56:                                               ; preds = %52
  store %31* null, %31** @19, align 8
  %57 = load %15*, %15** @12, align 8
  %58 = call i32 @uv_async_init(%15* %57, %16* nonnull @20, void (%16*)* nonnull @49) #9
  %59 = icmp eq i32 %58, 0
  br i1 %59, label %64, label %60

60:                                               ; preds = %56
  %61 = load %0*, %0** @stderr, align 8
  %62 = call i8* @uv_strerror(i32 %58) #9
  %63 = call i32 (%0*, i8*, ...) @fprintf(%0* %61, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @21, i64 0, i64 0), i8* %62) #10
  call void @exit(i32 %58) #11
  unreachable

64:                                               ; preds = %56
  %65 = call i32 @uv_thread_create(i64* nonnull @22, void (i8*)* nonnull @50, i8* null) #9
  %66 = icmp eq i32 %65, 0
  br i1 %66, label %71, label %67

67:                                               ; preds = %64
  %68 = load %0*, %0** @stderr, align 8
  %69 = call i8* @uv_strerror(i32 %65) #9
  %70 = call i32 (%0*, i8*, ...) @fprintf(%0* %68, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @23, i64 0, i64 0), i8* %69) #10
  call void @exit(i32 %65) #11
  unreachable

71:                                               ; preds = %64
  store i32 0, i32* @24, align 4
  %72 = call i32 @uv_read_start(%26* bitcast (%14* @8 to %26*), void (%23*, i64, %25*)* nonnull @51, void (%26*, i64, %25*)* nonnull @52) #9
  %73 = icmp eq i32 %72, 0
  br i1 %73, label %74, label %76

74:                                               ; preds = %71
  %75 = load i1, i1* @26, align 4
  br i1 %75, label %81, label %77

76:                                               ; preds = %71
  call void @__assert_fail(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @25, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 368, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @15, i64 0, i64 0)) #11
  unreachable

77:                                               ; preds = %74, %77
  %78 = load %15*, %15** @12, align 8
  %79 = call i32 @uv_run(%15* %78, i32 0) #9
  %80 = load i1, i1* @26, align 4
  br i1 %80, label %81, label %77

81:                                               ; preds = %77, %74
  %82 = load %0*, %0** @stderr, align 8
  %83 = call i64 @fwrite(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @27, i64 0, i64 0), i64 42, i64 1, %0* %82) #10
  %84 = load %15*, %15** @12, align 8
  %85 = call i32 @uv_loop_close(%15* %84) #9
  %86 = icmp eq i32 %85, 0
  br i1 %86, label %88, label %87

87:                                               ; preds = %81
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @28, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 374, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @15, i64 0, i64 0)) #11
  unreachable
...
89:                                               ; preds = %29
  ...
  %91 = call i32 (%0*, i8*, ...) @fprintf(%0* %90, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 2) #10
  br label %92

92:                                               ; preds = %89, %29
  store i32 0, i32* %20, align 8
  %93 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %94 = call i32 @sigaction(i32 3, %33* nonnull %1, %33* null) #9
  %95 = icmp eq i32 %94, -1
  br i1 %95, label %96, label %99

96:                                               ; preds = %92
  %97 = load %0*, %0** @stderr, align 8
  %98 = call i32 (%0*, i8*, ...) @fprintf(%0* %97, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 3) #10
  br label %99

99:                                               ; preds = %96, %92
  store i32 0, i32* %20, align 8
  %100 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %101 = call i32 @sigaction(i32 15, %33* nonnull %1, %33* null) #9
  %102 = icmp eq i32 %101, -1
  br i1 %102, label %103, label %106

103:                                              ; preds = %99
  %104 = load %0*, %0** @stderr, align 8
  %105 = call i32 (%0*, i8*, ...) @fprintf(%0* %104, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 15) #10
  br label %106

106:                                              ; preds = %103, %99
  store i32 0, i32* %20, align 8
  %107 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %108 = call i32 @sigaction(i32 1, %33* nonnull %1, %33* null) #9
  %109 = icmp eq i32 %108, -1
  br i1 %109, label %110, label %113

110:                                              ; preds = %106
  %111 = load %0*, %0** @stderr, align 8
  %112 = call i32 (%0*, i8*, ...) @fprintf(%0* %111, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 1) #10
  br label %113

113:                                              ; preds = %110, %106
  store i32 0, i32* %20, align 8
  %114 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %115 = call i32 @sigaction(i32 10, %33* nonnull %1, %33* null) #9
  %116 = icmp eq i32 %115, -1
  br i1 %116, label %117, label %120

117:                                              ; preds = %113
  %118 = load %0*, %0** @stderr, align 8
  %119 = call i32 (%0*, i8*, ...) @fprintf(%0* %118, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 10) #10
  br label %120

120:                                              ; preds = %117, %113
  store i32 0, i32* %20, align 8
  %121 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %122 = call i32 @sigaction(i32 12, %33* nonnull %1, %33* null) #9
  %123 = icmp eq i32 %122, -1
  br i1 %123, label %124, label %127

124:                                              ; preds = %120
  %125 = load %0*, %0** @stderr, align 8
  %126 = call i32 (%0*, i8*, ...) @fprintf(%0* %125, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 12) #10
  br label %127

127:                                              ; preds = %124, %120
  store i32 0, i32* %20, align 8
  %128 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %129 = call i32 @sigaction(i32 7, %33* nonnull %1, %33* null) #9
  %130 = icmp eq i32 %129, -1
  br i1 %130, label %131, label %134

131:                                              ; preds = %127
  %132 = load %0*, %0** @stderr, align 8
  %133 = call i32 (%0*, i8*, ...) @fprintf(%0* %132, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 7) #10
  br label %134

134:                                              ; preds = %131, %127
  store i32 0, i32* %20, align 8
  %135 = call i32 @sigemptyset(%35* nonnull %21) #9
  store void (i32)* @48, void (i32)** %22, align 8
  %136 = call i32 @sigaction(i32 17, %33* nonnull %1, %33* null) #9
  %137 = icmp eq i32 %136, -1
  br i1 %137, label %138, label %141

138:                                              ; preds = %134
  %139 = load %0*, %0** @stderr, align 8
  %140 = call i32 (%0*, i8*, ...) @fprintf(%0* %139, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @11, i64 0, i64 0), i32 17) #10
  br label %141

141:                                              ; preds = %138, %134
  call void @signals_unblock() #9
  %142 = call %15* @uv_default_loop() #9
  store %15* %142, %15** @12, align 8
  %143 = getelementptr inbounds %15, %15* %142, i64 0, i32 0
  store i8* null, i8** %143, align 8
  %144 = call i32 @uv_pipe_init(%15* %142, %14* nonnull @8, i32 1) #9
  %145 = icmp eq i32 %144, 0
  br i1 %145, label %37, label %33
}
...
define internal void @48(i32 %0) #7 {
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @49(%16* nocapture readnone %0) #2 {
...
12:                                               ; preds = %6, %40
  ...
  store i64 %16, i64* bitcast (%31** @19 to i64*), align 8
  ...
  %37 = call i32 @uv_write(%32* nonnull %18, %26* bitcast (%14* @8 to %26*), %25* nonnull %11, i32 2, void (%32*, i32)* nonnull @47) #9
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %40, label %39

39:                                               ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @9, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 99, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @29, i64 0, i64 0)) #11
  unreachable
...
; Function Attrs: nounwind uwtable
define internal void @50(i8* nocapture readnone %0) #2 {
  %2 = alloca %36, align 8
  %3 = alloca %31, align 8
...
27:                                               ; preds = %23
  ...
  %30 = call i32 (%0*, i8*, ...) @fprintf(%0* %28, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @30, i64 0, i64 0), i8* %29) #10
  br label %62
...
34:                                               ; preds = %31
  ...
  %36 = call i64 @fwrite(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @31, i64 0, i64 0), i64 24, i64 1, %0* %35) #10
  br label %62
...
40:                                               ; preds = %37
  call void @__assert_fail(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @32, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 134, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @33, i64 0, i64 0)) #11
  unreachable
...
44:                                               ; preds = %41, %44
  ...
  %47 = call i32 (%0*, i8*, ...) @fprintf(%0* %45, i8* getelementptr inbounds ([77 x i8], [77 x i8]* @34, i64 0, i64 0), i32 %46) #10
...
51:                                               ; preds = %44, %41
  ...
  call void @uv_mutex_lock(%7* nonnull @5) #9
  %56 = load i64, i64* bitcast (%31** @19 to i64*), align 8
  %57 = getelementptr inbounds %4, %4* %52, i64 1, i32 1
  %58 = bitcast i8* %57 to i64*
  store i64 %56, i64* %58, align 8
  store %4* %52, %4** bitcast (%31** @19 to %4**), align 8
  call void @uv_mutex_unlock(%7* nonnull @5) #9
  %59 = call i32 @uv_async_send(%16* nonnull @20) #9
  %60 = icmp eq i32 %59, 0
  br i1 %60, label %18, label %61

61:                                               ; preds = %51
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @35, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 147, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @33, i64 0, i64 0)) #11
  unreachable

62:                                               ; preds = %23, %27, %34
  %63 = load i1, i1* @26, align 4
...
; Function Attrs: nounwind uwtable
define internal void @51(%23* nocapture readnone %0, i64 %1, %25* nocapture %2) #2 {
...
; Function Attrs: nounwind uwtable
define internal void @52(%26* %0, i64 %1, %25* readonly %2) #2 {
...
4:                                                ; preds = %3
  ...
  %6 = tail call i32 (%0*, i8*, ...) @fprintf(%0* %5, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @36, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @37, i64 0, i64 0)) #10
  br label %112

7:                                                ; preds = %3
  %8 = load %0*, %0** @stderr, align 8
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @38, i64 0, i64 0), i64 25, i64 1, %0* %8) #10
  br label %17
...
12:                                               ; preds = %10
  ...
  %16 = tail call i32 (%0*, i8*, ...) @fprintf(%0* %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @39, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @37, i64 0, i64 0), i8* %15) #10
  br label %17
...
17:                                               ; preds = %7, %12
  ...
  %19 = tail call i64 @fwrite(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @40, i64 0, i64 0), i64 39, i64 1, %0* %18) #10
  %20 = tail call i32 @uv_read_stop(%26* %0) #9
  tail call void @uv_close(%23* bitcast (%14* @8 to %23*), void (%23*)* null) #9
  %21 = tail call i32 @uv_thread_join(i64* nonnull @22) #9
  %22 = icmp eq i32 %21, 0
...
23:                                               ; preds = %17
  ...
  %26 = tail call i32 (%0*, i8*, ...) @fprintf(%0* %24, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @41, i64 0, i64 0), i8* %25) #10
  br label %27

27:                                               ; preds = %17, %23
  tail call void @uv_close(%23* bitcast (%16* @20 to %23*), void (%23*)* null) #9
  br label %112
...
42:                                               ; preds = %37
  ...
  %47 = getelementptr inbounds [4096 x i8], [4096 x i8]* @42, i64 0, i64 %46
...
53:                                               ; preds = %42, %37
  ...
  %57 = load i32, i32* bitcast ([4096 x i8]* @42 to i32*), align 16
  %58 = icmp eq i32 %57, 0
  br i1 %58, label %60, label %59

59:                                               ; preds = %53
  tail call void @__assert_fail(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @43, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 213, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @44, i64 0, i64 0)) #11
  unreachable

60:                                               ; preds = %53
  %61 = load i8*, i8** bitcast (i8* getelementptr inbounds ([4096 x i8], [4096 x i8]* @42, i64 0, i64 8) to i8**), align 8
  %62 = icmp eq i8* %61, null
  br i1 %62, label %63, label %64

63:                                               ; preds = %60
  tail call void @__assert_fail(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @45, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @3, i64 0, i64 0), i32 214, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @44, i64 0, i64 0)) #11
  unreachable
...
66:                                               ; preds = %64
  ...
  %71 = getelementptr inbounds [4096 x i8], [4096 x i8]* @42, i64 0, i64 %70
...
77:                                               ; preds = %66, %64
  ...
  %81 = load i16, i16* bitcast (i8* getelementptr inbounds ([4096 x i8], [4096 x i8]* @42, i64 0, i64 16) to i16*), align 16
...
85:                                               ; preds = %77
  ...
  %87 = tail call i64 @fwrite(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @46, i64 0, i64 0), i64 41, i64 1, %0* %86) #13
...
94:                                               ; preds = %89
  ...
  %99 = getelementptr inbounds [4096 x i8], [4096 x i8]* @42, i64 0, i64 %98
...
109:                                              ; preds = %104
  %110 = load i8*, i8** bitcast (i8* getelementptr inbounds ([4096 x i8], [4096 x i8]* @42, i64 0, i64 8) to i8**), align 8
  tail call void @spawn_protocol_execute_command(i8* %110, i8* getelementptr inbounds ([4096 x i8], [4096 x i8]* @42, i64 0, i64 18), i16 zeroext %92) #9
  store i32 0, i32* @24, align 4
