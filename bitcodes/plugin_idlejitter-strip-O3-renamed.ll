; ModuleID = 'plugin_idlejitter-strip-O3-renamed.bc'
...
49:                                               ; preds = %46, %48
  %50 = call i64 @rrddim_set_by_pointer(%22* %25, %26* %28, i64 %74) #5
  %51 = call i64 @rrddim_set_by_pointer(%22* %25, %26* %30, i64 %76) #5
  %52 = zext i32 %77 to i64
  %53 = udiv i64 %70, %52
  %54 = call i64 @rrddim_set_by_pointer(%22* %25, %26* %32, i64 %53) #5
  call void @rrdset_done(%22* %25) #5
  %55 = add i64 %45, 1
  %56 = load volatile i32, i32* @netdata_exit, align 4
  %57 = icmp eq i32 %56, 0
  br i1 %57, label %44, label %88

58:                                               ; preds = %44, %58
  %59 = phi i64 [ 0, %44 ], [ %68, %58 ]
  %60 = phi i64 [ 0, %44 ], [ %76, %58 ]
  %61 = phi i64 [ 0, %44 ], [ %74, %58 ]
  %62 = phi i64 [ 0, %44 ], [ %70, %58 ]
  %63 = phi i32 [ 0, %44 ], [ %77, %58 ]
  %64 = call i32 @now_monotonic_high_precision_timeval(%23* nonnull %3) #5
  %65 = call i32 @sleep_usec(i64 %17) #5
  %66 = call i32 @now_monotonic_high_precision_timeval(%23* nonnull %4) #5
  %67 = call i64 @dt_usec(%23* nonnull %4, %23* nonnull %3) #5
  %68 = add i64 %67, %59
  %69 = sub i64 %67, %17
  %70 = add i64 %69, %62
  %71 = icmp eq i32 %63, 0
  ...
  %73 = or i1 %71, %72
  %74 = select i1 %73, i64 %69, i64 %61
  %75 = icmp ugt i64 %69, %60
  %76 = select i1 %75, i64 %69, i64 %60
  %77 = add nuw nsw i32 %63, 1
  %78 = icmp ult i64 %68, %37
  br i1 %78, label %58, label %79

79:                                               ; preds = %58
  %80 = load volatile i32, i32* @netdata_exit, align 4
  %81 = icmp eq i32 %80, 0
  br i1 %81, label %46, label %88

82:                                               ; preds = %42, %85
  %83 = load volatile i32, i32* @netdata_exit, align 4
  %84 = icmp eq i32 %83, 0
  br i1 %84, label %85, label %88

85:                                               ; preds = %82
  %86 = load volatile i32, i32* @netdata_exit, align 4
  %87 = icmp eq i32 %86, 0
  br i1 %87, label %82, label %88

88:                                               ; preds = %49, %79, %85, %82, %16
  ...
  store volatile i32 2, i32* %90, align 8
  ...
  store volatile i32 0, i32* %90, align 8
