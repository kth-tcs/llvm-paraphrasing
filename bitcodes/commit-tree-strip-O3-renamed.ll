; ModuleID = 'commit-tree-strip-O3-renamed.bc'
...
16:                                               ; preds = %12
  %17 = tail call i64 @strlen(i8* nonnull %1) #10
  tail call void @strbuf_add(%0* nonnull %6, i8* nonnull %1, i64 %17) #9
  br label %38

18:                                               ; preds = %12
  %19 = getelementptr inbounds %0, %0* %6, i64 0, i32 0
...
28:                                               ; preds = %22, %25
  %29 = phi i64 [ %23, %22 ], [ %27, %25 ]
  %30 = phi i64 [ %14, %22 ], [ %26, %25 ]
  ...
  %37 = tail call i64 @strlen(i8* nonnull %1) #10
  tail call void @strbuf_add(%0* nonnull %6, i8* nonnull %1, i64 %37) #9
  br label %38
...
41:                                               ; preds = %38
  %42 = getelementptr inbounds %0, %0* %6, i64 0, i32 2
...
48:                                               ; preds = %41
  %49 = getelementptr inbounds %0, %0* %6, i64 0, i32 0
...
59:                                               ; preds = %55, %52
  %60 = phi i8* [ %43, %52 ], [ %58, %55 ]
  %61 = phi i64 [ %53, %52 ], [ %57, %55 ]
  %62 = phi i64 [ %39, %52 ], [ %56, %55 ]
