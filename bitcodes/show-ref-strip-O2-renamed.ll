; ModuleID = 'show-ref-strip-O2-renamed.bc'
...
73:                                               ; preds = %67
  %74 = call i32 @strncmp(i8* nonnull %56, i8* nonnull %9, i64 %22) #8
  %75 = icmp eq i32 %74, 0
  br i1 %75, label %76, label %85

76:                                               ; preds = %73, %66
  %77 = call i32 @check_refname_format(i8* nonnull %56, i32 0) #7
  %78 = icmp eq i32 %77, 0
...
80:                                               ; preds = %76
  %81 = call i32 @string_list_has_string(%2* nonnull @43, i8* nonnull %56) #7
  %82 = icmp eq i32 %81, 0
  br i1 %82, label %83, label %85

83:                                               ; preds = %80
  %84 = call i32 @puts(i8* nonnull %10) #7
  br label %85

85:                                               ; preds = %83, %80, %79, %73, %67
  %86 = load %4*, %4** @stdin, align 8
  %87 = call i8* @fgets(i8* nonnull %10, i32 1024, %4* %86) #7
...
101:                                              ; preds = %98
  %102 = getelementptr inbounds %10, %10* %5, i64 0, i32 0, i64 0
  br label %104
...
104:                                              ; preds = %101, %116
  %105 = phi i8* [ %99, %101 ], [ %121, %116 ]
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %102) #7
  %106 = call i32 @starts_with(i8* nonnull %105, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @7, i64 0, i64 0)) #7
...
110:                                              ; preds = %104
  %111 = call i32 @strcmp(i8* %109, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @8, i64 0, i64 0)) #8
  %112 = icmp eq i32 %111, 0
  br i1 %112, label %113, label %123

113:                                              ; preds = %104, %110
  %114 = call i32 @read_ref(i8* %109, %10* nonnull %5) #7
...
116:                                              ; preds = %113
  ...
  call fastcc void @51(i8* %118, %10* nonnull %5)
...
126:                                              ; preds = %123
  ...
  call void (i8*, ...) @die(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @10, i64 0, i64 0), i8* %128) #9
  unreachable
...
133:                                              ; preds = %130
  %134 = tail call i32 @head_ref(i32 (i8*, %10*, i32, i8*)* nonnull @52, i8* null) #7
  br label %135

135:                                              ; preds = %130, %133
  %136 = tail call i32 @for_each_ref(i32 (i8*, %10*, i32, i8*)* nonnull @52, i8* null) #7
...
146:                                              ; preds = %116, %98, %135, %139, %129, %89
  %147 = phi i32 [ 0, %89 ], [ 1, %129 ], [ 1, %139 ], [ 0, %135 ], [ 0, %98 ], [ 0, %116 ]
  ret i32 %147
}
