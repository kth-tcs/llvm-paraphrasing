; ModuleID = 'preload-index-strip-O3-renamed.bc'
...
57:                                               ; preds = %53, %73
  %58 = phi i64 [ %75, %73 ], [ 0, %53 ]
  %59 = phi i32 [ %74, %73 ], [ 0, %53 ]
  %60 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %58
  %61 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %58, i32 1
  store %1* %0, %1** %61, align 8
  %62 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %58, i32 4
  store i32 %59, i32* %62, align 8
  %63 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %58, i32 5
  store i32 %32, i32* %63, align 4
  %64 = load %19*, %19** %55, align 8
  %65 = icmp eq %19* %64, null
  br i1 %65, label %68, label %66

66:                                               ; preds = %57
  %67 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %58, i32 3
  store %25* %5, %25** %67, align 8
  br label %68

68:                                               ; preds = %66, %57
  %69 = getelementptr inbounds %24, %24* %60, i64 0, i32 0
  %70 = bitcast %24* %60 to i8*
  %71 = call i32 @pthread_create(i64* nonnull %69, %30* null, i8* (i8*)* nonnull @11, i8* nonnull %70) #7
  %72 = icmp eq i32 %71, 0
  br i1 %72, label %73, label %97

73:                                               ; preds = %68
  %74 = add nsw i32 %59, %32
...
80:                                               ; preds = %53, %101
  %81 = phi i64 [ %103, %101 ], [ 0, %53 ]
  %82 = phi i32 [ %102, %101 ], [ 0, %53 ]
  %83 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81
  %84 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81, i32 1
  store %1* %0, %1** %84, align 8
  %85 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81, i32 2
  call void @copy_pathspec(%20* nonnull %85, %20* nonnull %1) #7
  %86 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81, i32 4
  store i32 %82, i32* %86, align 8
  %87 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81, i32 5
  store i32 %32, i32* %87, align 4
  %88 = load %19*, %19** %55, align 8
  %89 = icmp eq %19* %88, null
  br i1 %89, label %92, label %90

90:                                               ; preds = %80
  %91 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %81, i32 3
  store %25* %5, %25** %91, align 8
  br label %92

92:                                               ; preds = %80, %90
  %93 = getelementptr inbounds %24, %24* %83, i64 0, i32 0
  %94 = bitcast %24* %83 to i8*
  %95 = call i32 @pthread_create(i64* nonnull %93, %30* null, i8* (i8*)* nonnull @11, i8* nonnull %94) #7
  %96 = icmp eq i32 %95, 0
  br i1 %96, label %101, label %97

97:                                               ; preds = %92, %68
  %98 = phi i32 [ %71, %68 ], [ %95, %92 ]
  %99 = call fastcc i8* @10(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @2, i64 0, i64 0))
  %100 = call i8* @strerror(i32 %98) #7
  call void (i8*, ...) @die(i8* %99, i8* %100) #8
  unreachable

101:                                              ; preds = %92
  %102 = add nsw i32 %82, %32
  %103 = add nuw nsw i64 %81, 1
  %104 = icmp ult i64 %103, %56
  br i1 %104, label %80, label %77

105:                                              ; preds = %107
  %106 = icmp ult i64 %113, %79
  br i1 %106, label %107, label %115

107:                                              ; preds = %78, %105
  %108 = phi i64 [ 0, %78 ], [ %113, %105 ]
  %109 = getelementptr inbounds [20 x %24], [20 x %24]* %4, i64 0, i64 %108, i32 0
  %110 = load i64, i64* %109, align 8
  %111 = call i32 @pthread_join(i64 %110, i8** null) #7
  %112 = icmp eq i32 %111, 0
  %113 = add nuw nsw i64 %108, 1
  br i1 %112, label %105, label %114
...
115:                                              ; preds = %105, %51, %77
  %116 = getelementptr inbounds %25, %25* %5, i64 0, i32 1
  call void @stop_progress(%19** nonnull %116) #7
  %117 = load i32, i32* getelementptr inbounds (%0, %0* @trace_perf_key, i64 0, i32 1), align 8
  %118 = icmp eq i32 %117, 0
  br i1 %118, label %119, label %123

119:                                              ; preds = %115
  %120 = load i8, i8* getelementptr inbounds (%0, %0* @trace_perf_key, i64 0, i32 2), align 4
  %121 = and i8 %120, 1
  %122 = icmp eq i8 %121, 0
  br i1 %122, label %123, label %125

123:                                              ; preds = %119, %115
  %124 = call i64 @getnanotime() #7
  call void (i8*, i32, i64, i8*, ...) @trace_performance_leave_fl(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @4, i64 0, i64 0), i32 147, i64 %124, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @5, i64 0, i64 0)) #7
  br label %125

125:                                              ; preds = %16, %119, %123, %21, %3
