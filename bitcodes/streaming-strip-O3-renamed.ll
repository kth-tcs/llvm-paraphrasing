; ModuleID = 'streaming-strip-O3-renamed.bc'
...
32:                                               ; preds = %29, %102
  %33 = phi i64 [ %103, %102 ], [ 0, %29 ]
  %34 = getelementptr inbounds [16384 x i8], [16384 x i8]* %7, i64 0, i64 %33
  %35 = load i8, i8* %34, align 4
  %36 = icmp eq i8 %35, 0
  br i1 %36, label %47, label %37

37:                                               ; preds = %32, %47, %92, %97, %29
  %38 = icmp eq i64 %31, 0
  br i1 %38, label %44, label %39

39:                                               ; preds = %37
  %40 = call i64 @lseek64(i32 %0, i64 %31, i32 1) #6
  %41 = icmp eq i64 %40, -1
  br i1 %41, label %68, label %44

42:                                               ; preds = %102
  %43 = add nsw i64 %31, 16384
  call void @llvm.lifetime.end.p0i8(i64 16384, i8* nonnull %20) #6
  br label %52

44:                                               ; preds = %37, %39
  %45 = call i64 @write_in_full(i32 %0, i8* nonnull %20, i64 %30) #6
  call void @llvm.lifetime.end.p0i8(i64 16384, i8* nonnull %20) #6
  %46 = icmp sgt i64 %45, -1
  br i1 %46, label %52, label %83

47:                                               ; preds = %32
  %48 = or i64 %33, 1
  %49 = getelementptr inbounds [16384 x i8], [16384 x i8]* %7, i64 0, i64 %48
  %50 = load i8, i8* %49, align 1
  %51 = icmp eq i8 %50, 0
  br i1 %51, label %92, label %37

52:                                               ; preds = %44, %42
  %53 = phi i64 [ %43, %42 ], [ 0, %44 ]
  call void @llvm.lifetime.start.p0i8(i64 16384, i8* nonnull %20) #6
  %54 = load %1*, %1** %21, align 8
  %55 = getelementptr inbounds %1, %1* %54, i64 0, i32 1
  %56 = load i64 (%0*, i8*, i64)*, i64 (%0*, i8*, i64)** %55, align 8
  %57 = call i64 %56(%0* nonnull %11, i8* nonnull %20, i64 16384) #6
  %58 = icmp slt i64 %57, 0
  br i1 %58, label %68, label %29

59:                                               ; preds = %27, %69
  %60 = phi i64 [ %73, %69 ], [ %25, %27 ]
  %61 = icmp eq i64 %60, 0
...
65:                                               ; preds = %59
  %66 = call i64 @write_in_full(i32 %0, i8* nonnull %20, i64 %60) #6
  call void @llvm.lifetime.end.p0i8(i64 16384, i8* nonnull %20) #6
  %67 = icmp sgt i64 %66, -1
  br i1 %67, label %69, label %83

68:                                               ; preds = %39, %52, %69, %19
  call void @llvm.lifetime.end.p0i8(i64 16384, i8* nonnull %20) #6
  br label %83

69:                                               ; preds = %65
  call void @llvm.lifetime.start.p0i8(i64 16384, i8* nonnull %20) #6
  %70 = load %1*, %1** %21, align 8
  %71 = getelementptr inbounds %1, %1* %70, i64 0, i32 1
  %72 = load i64 (%0*, i8*, i64)*, i64 (%0*, i8*, i64)** %71, align 8
  %73 = call i64 %72(%0* nonnull %11, i8* nonnull %20, i64 16384) #6
  %74 = icmp slt i64 %73, 0
  br i1 %74, label %68, label %59

75:                                               ; preds = %63
  %76 = add nsw i64 %31, -1
  %77 = call i64 @lseek64(i32 %0, i64 %76, i32 1) #6
  %78 = icmp eq i64 %77, -1
  br i1 %78, label %83, label %79

79:                                               ; preds = %75
  %80 = call i64 @xwrite(i32 %0, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @1, i64 0, i64 0), i64 1) #6
  %81 = icmp eq i64 %80, 1
...
83:                                               ; preds = %44, %65, %68, %79, %16, %75, %82
  %84 = phi i32 [ -1, %16 ], [ -1, %75 ], [ -1, %79 ], [ 0, %82 ], [ -1, %68 ], [ -1, %65 ], [ -1, %44 ]
  %85 = bitcast %0* %11 to i32 (%0*)***
  %86 = load i32 (%0*)**, i32 (%0*)*** %85, align 8
  %87 = load i32 (%0*)*, i32 (%0*)** %86, align 8
  %88 = call i32 %87(%0* nonnull %11) #6
  %89 = bitcast %0* %11 to i8*
  call void @free(i8* %89) #6
  br label %90

90:                                               ; preds = %15, %13, %83
  %91 = phi i32 [ %84, %83 ], [ -1, %13 ], [ -1, %15 ]
...
92:                                               ; preds = %47
  %93 = or i64 %33, 2
  %94 = getelementptr inbounds [16384 x i8], [16384 x i8]* %7, i64 0, i64 %93
...
97:                                               ; preds = %92
  %98 = or i64 %33, 3
  %99 = getelementptr inbounds [16384 x i8], [16384 x i8]* %7, i64 0, i64 %98
  %100 = load i8, i8* %99, align 1
  %101 = icmp eq i8 %100, 0
  br i1 %101, label %102, label %37

102:                                              ; preds = %97
  %103 = add nuw nsw i64 %33, 4
  %104 = icmp ult i64 %103, 16384
  br i1 %104, label %32, label %42
}
