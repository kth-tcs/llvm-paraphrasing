; ModuleID = 'list-objects-filter-options-strip-O3-renamed.bc'
...
10:                                               ; preds = %2
  %11 = getelementptr inbounds %2, %2* %0, i64 0, i32 0
  br label %56

12:                                               ; preds = %2
  %13 = getelementptr inbounds %2, %2* %0, i64 0, i32 0
  %14 = tail call i8* @xstrdup(i8* %1) #13
  %15 = tail call %4* @string_list_append(%3* %13, i8* %14) #13
  %16 = call fastcc i32 @32(%2* nonnull %0, i8* %1, %0* nonnull %6)
  br label %110

17:                                               ; preds = %2
  %18 = tail call i8* @xcalloc(i64 2, i64 88) #13
  %19 = bitcast %2* %0 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %18, i8* align 8 %19, i64 88, i1 false) #13
  tail call void @llvm.memset.p0i8.i64(i8* align 8 %19, i8 0, i64 64, i1 false) #13
  %20 = getelementptr inbounds %2, %2* %0, i64 0, i32 8
  %21 = bitcast %2** %20 to i8**
  store i8* %18, i8** %21, align 8
  %22 = getelementptr inbounds %2, %2* %0, i64 0, i32 6
  %23 = bitcast i64* %22 to <2 x i64>*
  store <2 x i64> <i64 1, i64 2>, <2 x i64>* %23, align 8
  store i32 5, i32* %8, align 8
  %24 = getelementptr inbounds %2, %2* %0, i64 0, i32 0
  %25 = tail call i8* @xstrdup(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @21, i64 0, i64 0)) #13
  %26 = tail call %4* @string_list_append(%3* %24, i8* %25) #13
  %27 = load %2*, %2** %20, align 8
  %28 = getelementptr inbounds %2, %2* %27, i64 0, i32 0
  %29 = getelementptr inbounds %2, %2* %27, i64 0, i32 0, i32 1
...
32:                                               ; preds = %17
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %33, i8* align 8 bitcast (%0* @28 to i8*), i64 24, i1 false) #13
  call void @strbuf_add_separated_string_list(%0* nonnull %5, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @6, i64 0, i64 0), %3* %28) #13
  call void @string_list_clear(%3* %28, i32 0) #13
  %34 = call i8* @strbuf_detach(%0* nonnull %5, i64* null) #13
  %35 = call %4* @string_list_append(%3* %28, i8* %34) #13
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %33) #13
  br label %36

36:                                               ; preds = %32, %17
  %37 = getelementptr inbounds %2, %2* %27, i64 0, i32 0, i32 0
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %41, i8* align 8 bitcast (%0* @28 to i8*), i64 24, i1 false) #13
  call void @strbuf_addstr_urlencode(%0* nonnull %4, i8* %40, i32 (i8)* nonnull @34) #13
  %42 = load i32, i32* getelementptr inbounds (%1, %1* @trace_default_key, i64 0, i32 1), align 8
  %43 = icmp eq i32 %42, 0
  br i1 %43, label %44, label %48

44:                                               ; preds = %36
  %45 = load i8, i8* getelementptr inbounds (%1, %1* @trace_default_key, i64 0, i32 2), align 4
  %46 = and i8 %45, 1
  %47 = icmp eq i8 %46, 0
  br i1 %47, label %48, label %51

48:                                               ; preds = %44, %36
  %49 = getelementptr inbounds %0, %0* %4, i64 0, i32 2
  %50 = load i8*, i8** %49, align 8
  call void (i8*, i32, %1*, i8*, ...) @trace_printf_key_fl(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @2, i64 0, i64 0), i32 186, %1* nonnull @trace_default_key, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @29, i64 0, i64 0), i8* %50) #13
  br label %51

51:                                               ; preds = %48, %44
  %52 = call i8* @strbuf_detach(%0* nonnull %4, i64* null) #13
  %53 = call %4* @string_list_append(%3* %24, i8* %52) #13
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %41) #13
  %54 = load %2*, %2** %20, align 8
  %55 = getelementptr inbounds %2, %2* %54, i64 0, i32 0
  call void @string_list_clear(%3* %55, i32 0) #13
  br label %56

56:                                               ; preds = %10, %51
  %57 = phi %3* [ %11, %10 ], [ %24, %51 ]
  %58 = call i8* @xstrdup(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i64 0, i64 0)) #13
  %59 = call %4* @string_list_append(%3* %57, i8* %58) #13
  %60 = bitcast %0* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %60) #13
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %60, i8* align 8 bitcast (%0* @28 to i8*), i64 24, i1 false) #13
  call void @strbuf_addstr_urlencode(%0* nonnull %3, i8* %1, i32 (i8)* nonnull @34) #13
  %61 = load i32, i32* getelementptr inbounds (%1, %1* @trace_default_key, i64 0, i32 1), align 8
  %62 = icmp eq i32 %61, 0
  br i1 %62, label %63, label %67

63:                                               ; preds = %56
  %64 = load i8, i8* getelementptr inbounds (%1, %1* @trace_default_key, i64 0, i32 2), align 4
  %65 = and i8 %64, 1
  %66 = icmp eq i8 %65, 0
  br i1 %66, label %67, label %70

67:                                               ; preds = %63, %56
  %68 = getelementptr inbounds %0, %0* %3, i64 0, i32 2
  %69 = load i8*, i8** %68, align 8
  call void (i8*, i32, %1*, i8*, ...) @trace_printf_key_fl(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @2, i64 0, i64 0), i32 186, %1* nonnull @trace_default_key, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @29, i64 0, i64 0), i8* %69) #13
  br label %70

70:                                               ; preds = %63, %67
  %71 = call i8* @strbuf_detach(%0* nonnull %3, i64* null) #13
  %72 = call %4* @string_list_append(%3* %57, i8* %71) #13
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %60) #13
  %73 = getelementptr inbounds %2, %2* %0, i64 0, i32 6
...
78:                                               ; preds = %70
  %79 = getelementptr inbounds %2, %2* %0, i64 0, i32 7
  %80 = load i64, i64* %79, align 8
  %81 = icmp ugt i64 %75, %80
  br i1 %81, label %85, label %82

82:                                               ; preds = %78
  %83 = getelementptr inbounds %2, %2* %0, i64 0, i32 8
...
85:                                               ; preds = %78
  ...
  %90 = select i1 %89, i64 %75, i64 %88
  store i64 %90, i64* %79, align 8
  %91 = getelementptr inbounds %2, %2* %0, i64 0, i32 8
  %92 = bitcast %2** %91 to i8**
  %93 = icmp ugt i64 %90, 209622091746699450
  br i1 %93, label %94, label %95

94:                                               ; preds = %85
  call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @30, i64 0, i64 0), i64 88, i64 %90) #12
  unreachable

95:                                               ; preds = %85
  %96 = load i8*, i8** %92, align 8
  %97 = mul i64 %90, 88
  %98 = call i8* @xrealloc(i8* %96, i64 %97) #13
  store i8* %98, i8** %92, align 8
  %99 = bitcast i8* %98 to %2*
  %100 = load i64, i64* %73, align 8
  br label %101

101:                                              ; preds = %82, %95
  %102 = phi %2** [ %83, %82 ], [ %91, %95 ]
  %103 = phi i64 [ %74, %82 ], [ %100, %95 ]
  %104 = phi %2* [ %84, %82 ], [ %99, %95 ]
  %105 = getelementptr inbounds %2, %2* %104, i64 %103
  %106 = bitcast %2* %105 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %106, i8 0, i64 88, i1 false)
  store i64 %75, i64* %73, align 8
  %107 = load %2*, %2** %102, align 8
  %108 = getelementptr inbounds %2, %2* %107, i64 %74
  %109 = call fastcc i32 @32(%2* %108, i8* %1, %0* nonnull %6)
  br label %110

110:                                              ; preds = %101, %12
  %111 = phi i32 [ %109, %101 ], [ %16, %12 ]
  %112 = icmp eq i32 %111, 0
  br i1 %112, label %116, label %113

113:                                              ; preds = %110
  %114 = getelementptr inbounds %0, %0* %6, i64 0, i32 2
  %115 = load i8*, i8** %114, align 8
  call void (i8*, ...) @die(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @4, i64 0, i64 0), i8* %115) #12
  unreachable
...
9:                                                ; preds = %1
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %10, i8* align 8 bitcast (%0* @28 to i8*), i64 24, i1 false)
  %11 = getelementptr inbounds %2, %2* %0, i64 0, i32 4
  %12 = load i64, i64* %11, align 8
  call void (%0*, i8*, ...) @strbuf_addf(%0* nonnull %3, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @7, i64 0, i64 0), i64 %12) #13
  %13 = getelementptr inbounds %2, %2* %0, i64 0, i32 0
  call void @string_list_clear(%3* %13, i32 0) #13
  %14 = call i8* @strbuf_detach(%0* nonnull %3, i64* null) #13
  %15 = call %4* @string_list_append(%3* %13, i8* %14) #13
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %10) #13
  br label %16

16:                                               ; preds = %7, %9
  %17 = phi %3* [ %8, %7 ], [ %13, %9 ]
  %18 = getelementptr inbounds %2, %2* %0, i64 0, i32 0, i32 1
...
20:                                               ; preds = %16
  call void (i8*, i32, i8*, ...) @BUG_fl(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @2, i64 0, i64 0), i32 276, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @5, i64 0, i64 0)) #12
  unreachable

21:                                               ; preds = %16
  %22 = bitcast %0* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %22) #13
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %22, i8* align 8 bitcast (%0* @28 to i8*), i64 24, i1 false) #13
  call void @strbuf_add_separated_string_list(%0* nonnull %2, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @6, i64 0, i64 0), %3* %17) #13
  call void @string_list_clear(%3* %17, i32 0) #13
  %23 = call i8* @strbuf_detach(%0* nonnull %2, i64* null) #13
  %24 = call %4* @string_list_append(%3* %17, i8* %23) #13
...
25:                                               ; preds = %16, %21
  ...
  %28 = getelementptr inbounds %4, %4* %27, i64 0, i32 0
...
define dso_local void @partial_clone_register(i8* %0, %2* %1) local_unnamed_addr #0 {
  %3 = tail call %7* @promisor_remote_find(i8* %0) #13
  %4 = icmp eq %7* %3, null
...
5:                                                ; preds = %2
  ...
  %6 = tail call i8* (i8*, ...) @xstrfmt(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @10, i64 0, i64 0), i8* %0) #13
  tail call void @git_config_set(i8* %6, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @11, i64 0, i64 0)) #13
  tail call void @free(i8* %6) #13
  br label %7

7:                                                ; preds = %2, %5
  %8 = tail call i8* (i8*, ...) @xstrfmt(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @12, i64 0, i64 0), i8* %0) #13
  %9 = tail call i8* @expand_list_objects_filter_spec(%2* %1)
  tail call void @git_config_set(i8* %8, i8* %9) #13
  tail call void @free(i8* %8) #13
  tail call void @promisor_remote_reinit() #13
  ret void
}
...
32:                                               ; preds = %13, %26
  ...
  %38 = getelementptr %0, %0* %1, i64 0, i32 2
