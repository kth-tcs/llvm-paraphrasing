; ModuleID = 'tree-walk-strip-O2-renamed.bc'
...
define dso_local void @strbuf_make_traverse_path(%7* %0, %0* readonly %1, i8* nocapture readonly %2, i64 %3) local_unnamed_addr #0 {
  %5 = getelementptr inbounds %0, %0* %1, i64 0, i32 5
...
10:                                               ; preds = %4
  ...
  %19 = sub i64 %18, %15
  %20 = tail call i8* @make_traverse_path(i8* %16, i64 %19, %0* nonnull %1, i8* %2, i64 %3)
...
29:                                               ; preds = %10
  ...
  %31 = icmp eq i8* %30, getelementptr inbounds ([0 x i8], [0 x i8]* @strbuf_slopbuf, i64 0, i64 0)
  br i1 %31, label %34, label %32

32:                                               ; preds = %29
  %33 = getelementptr inbounds i8, i8* %30, i64 %22
...
63:                                               ; preds = %59, %47
  ...
  %71 = getelementptr inbounds %0, %0* %3, i64 0, i32 6
...
126:                                              ; preds = %119
  %127 = getelementptr inbounds [8 x %5], [8 x %5]* %6, i64 0, i64 %120, i32 2
...
184:                                              ; preds = %180
  %185 = getelementptr inbounds [8 x %5], [8 x %5]* %6, i64 0, i64 %148, i32 2
...
231:                                              ; preds = %228
  %232 = getelementptr inbounds [8 x %5], [8 x %5]* %6, i64 0, i64 %148, i32 2
...
356:                                              ; preds = %367, %354
  ...
  %358 = getelementptr inbounds [8 x %54], [8 x %54]* %7, i64 0, i64 %357, i32 1
...
12:                                               ; preds = %5
  ...
  %17 = getelementptr inbounds %53, %53* %1, i64 0, i32 1, i32 2
  br label %18
...
48:                                               ; preds = %22
  %49 = getelementptr inbounds %5, %5* %1, i64 0, i32 2
...
66:                                               ; preds = %52, %419
  ...
  %78 = getelementptr inbounds %2, %2* %70, i64 %69, i32 2
