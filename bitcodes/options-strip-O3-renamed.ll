; ModuleID = 'options-strip-O3-renamed.bc'
...
6:                                                ; preds = %2, %18
  %7 = phi %3* [ %20, %18 ], [ %4, %2 ]
  %8 = getelementptr %3, %3* %7, i64 0, i32 1
...
31:                                               ; preds = %26, %43
  ...
  %33 = getelementptr %3, %3* %32, i64 0, i32 1
...
23:                                               ; preds = %18, %2, %22
  ...
  %28 = getelementptr i8, i8* %24, i64 8
...
32:                                               ; preds = %23, %44
  ...
  %34 = getelementptr %3, %3* %33, i64 0, i32 1
...
22:                                               ; preds = %17, %98
  %23 = phi i32 [ %99, %98 ], [ 0, %17 ]
  br label %24

24:                                               ; preds = %22, %35
  %25 = phi %99* [ %37, %35 ], [ %20, %22 ]
  %26 = getelementptr %99, %99* %25, i64 0, i32 0
...
42:                                               ; preds = %39, %35, %104, %17
  %43 = phi i32 [ 0, %17 ], [ %23, %35 ], [ %40, %104 ], [ -1, %39 ]
  %44 = tail call i32 @options_array_set(%3* %0, i32 %43, i8* %1, i32 0, i8** %2)
  br label %89

45:                                               ; preds = %3
  br i1 %15, label %89, label %46

46:                                               ; preds = %45
  %47 = tail call i8* @xstrdup(i8* nonnull %1) #12
  store i8* %47, i8** %4, align 8
  %48 = call i8* @strsep(i8** nonnull %4, i8* %11) #12
  %49 = icmp eq i8* %48, null
  br i1 %49, label %88, label %50

50:                                               ; preds = %46
  %51 = getelementptr inbounds %3, %3* %0, i64 0, i32 3
  %52 = bitcast %4* %51 to %99**
  br label %53

53:                                               ; preds = %50, %57
  %54 = phi i8* [ %48, %50 ], [ %58, %57 ]
  %55 = load i8, i8* %54, align 1
  %56 = icmp eq i8 %55, 0
  br i1 %56, label %57, label %60

57:                                               ; preds = %53, %83
  %58 = call i8* @strsep(i8** nonnull %4, i8* %11) #12
  %59 = icmp eq i8* %58, null
  br i1 %59, label %88, label %53

60:                                               ; preds = %53
  %61 = load %99*, %99** %52, align 8
  %62 = icmp eq %99* %61, null
  br i1 %62, label %83, label %63

63:                                               ; preds = %60, %115
  %64 = phi i32 [ %116, %115 ], [ 0, %60 ]
  br label %65

65:                                               ; preds = %63, %76
  %66 = phi %99* [ %78, %76 ], [ %61, %63 ]
  %67 = getelementptr %99, %99* %66, i64 0, i32 0
  %68 = load i32, i32* %67, align 8
...
83:                                               ; preds = %121, %76, %60
  %84 = phi i32 [ 0, %60 ], [ %81, %121 ], [ %64, %76 ]
  %85 = call i32 @options_array_set(%3* %0, i32 %84, i8* nonnull %54, i32 0, i8** %2)
  %86 = icmp eq i32 %85, 0
...
89:                                               ; preds = %45, %16, %88, %87, %42
  %90 = phi i32 [ %44, %42 ], [ 0, %88 ], [ -1, %87 ], [ 0, %16 ], [ 0, %45 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #12
  ret i32 %90

91:                                               ; preds = %39, %104
  %92 = phi %99* [ %106, %104 ], [ %20, %39 ]
  %93 = getelementptr %99, %99* %92, i64 0, i32 0
  %94 = load i32, i32* %93, align 8
  %95 = icmp ugt i32 %94, %40
  br i1 %95, label %102, label %96

96:                                               ; preds = %91
  %97 = icmp ugt i32 %94, %23
...
100:                                              ; preds = %96
  %101 = getelementptr inbounds %99, %99* %92, i64 0, i32 2, i32 1
  br label %104

102:                                              ; preds = %91
  %103 = getelementptr inbounds %99, %99* %92, i64 0, i32 2, i32 0
  br label %104

104:                                              ; preds = %102, %100
  %105 = phi %99** [ %103, %102 ], [ %101, %100 ]
  %106 = load %99*, %99** %105, align 8
  %107 = icmp eq %99* %106, null
  br i1 %107, label %42, label %91

108:                                              ; preds = %80, %121
  %109 = phi %99* [ %123, %121 ], [ %61, %80 ]
  %110 = getelementptr %99, %99* %109, i64 0, i32 0
...
117:                                              ; preds = %113
  %118 = getelementptr inbounds %99, %99* %109, i64 0, i32 2, i32 1
  br label %121

119:                                              ; preds = %108
  %120 = getelementptr inbounds %99, %99* %109, i64 0, i32 2, i32 0
  br label %121

121:                                              ; preds = %119, %117
  %122 = phi %99** [ %120, %119 ], [ %118, %117 ]
  %123 = load %99*, %99** %122, align 8
  %124 = icmp eq %99* %123, null
  br i1 %124, label %83, label %108
}
...
27:                                               ; preds = %22, %38
  ...
  %29 = getelementptr %99, %99* %28, i64 0, i32 0
...
118:                                              ; preds = %113, %129
  ...
  %120 = getelementptr %99, %99* %119, i64 0, i32 0
...
16:                                               ; preds = %11, %27
  ...
  %18 = getelementptr %99, %99* %17, i64 0, i32 0
...
10:                                               ; preds = %2, %24
  %11 = phi %99* [ %26, %24 ], [ %8, %2 ]
  %12 = getelementptr %99, %99* %11, i64 0, i32 0
  %13 = load i32, i32* %12, align 8
...
21:                                               ; preds = %16, %32
  ...
  %23 = getelementptr %99, %99* %22, i64 0, i32 0
...
38:                                               ; preds = %28
  ...
  %40 = tail call fastcc i8* @55(%0* nonnull %5, %4* nonnull %39, i32 %2)
  br label %44

41:                                               ; preds = %7, %3
  %42 = getelementptr inbounds %3, %3* %0, i64 0, i32 3
  %43 = tail call fastcc i8* @55(%0* %5, %4* nonnull %42, i32 %2)
  br label %44
...
; Function Attrs: nounwind uwtable
define internal fastcc i8* @55(%0* %0, %4* nocapture readonly %1, i32 %2) unnamed_addr #0 {
  %4 = alloca i8*, align 8
  %5 = bitcast i8** %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %5) #12
  %6 = icmp eq %0* %0, null
...
11:                                               ; preds = %7
  %12 = bitcast %4* %1 to %75**
  %13 = load %75*, %75** %12, align 8
  %14 = tail call i8* @cmd_list_print(%75* %13, i32 0) #12
  br label %62
...
19:                                               ; preds = %18
  %20 = bitcast %4* %1 to i64*
  %21 = load i64, i64* %20, align 8
  %22 = call i32 (i8**, i8*, ...) @xasprintf(i8** nonnull %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i64 0, i64 0), i64 %21) #12
  br label %52

23:                                               ; preds = %18
  %24 = bitcast %4* %1 to i64*
  %25 = load i64, i64* %24, align 8
  %26 = tail call i8* @key_string_lookup_key(i64 %25) #12
  %27 = tail call i8* @xstrdup(i8* %26) #12
  store i8* %27, i8** %4, align 8
  br label %52

28:                                               ; preds = %18
  %29 = bitcast %4* %1 to i64*
  %30 = load i64, i64* %29, align 8
  %31 = trunc i64 %30 to i32
  %32 = tail call i8* @colour_tostring(i32 %31) #12
  %33 = tail call i8* @xstrdup(i8* %32) #12
  store i8* %33, i8** %4, align 8
  br label %52

34:                                               ; preds = %18
  %35 = icmp eq i32 %2, 0
  %36 = bitcast %4* %1 to i64*
  %37 = load i64, i64* %36, align 8
  br i1 %35, label %40, label %38

38:                                               ; preds = %34
  %39 = call i32 (i8**, i8*, ...) @xasprintf(i8** nonnull %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i64 0, i64 0), i64 %37) #12
  br label %52

40:                                               ; preds = %34
  %41 = icmp eq i64 %37, 0
  %42 = select i1 %41, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @1, i64 0, i64 0)
  %43 = tail call i8* @xstrdup(i8* %42) #12
  store i8* %43, i8** %4, align 8
  br label %52

44:                                               ; preds = %18
  %45 = getelementptr inbounds %0, %0* %0, i64 0, i32 6
  %46 = load i8**, i8*** %45, align 8
  %47 = bitcast %4* %1 to i64*
  %48 = load i64, i64* %47, align 8
  %49 = getelementptr inbounds i8*, i8** %46, i64 %48
  %50 = load i8*, i8** %49, align 8
  %51 = tail call i8* @xstrdup(i8* %50) #12
  store i8* %51, i8** %4, align 8
  br label %52

52:                                               ; preds = %38, %40, %18, %44, %28, %23, %19
...
56:                                               ; preds = %3, %54
  %57 = getelementptr inbounds %4, %4* %1, i64 0, i32 0
  %58 = load i8*, i8** %57, align 8
  %59 = tail call i8* @xstrdup(i8* %58) #12
  br label %62

60:                                               ; preds = %54
  %61 = tail call i8* @xstrdup(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @8, i64 0, i64 0)) #12
  br label %62

62:                                               ; preds = %60, %56, %52, %11
  %63 = phi i8* [ %14, %11 ], [ %53, %52 ], [ %59, %56 ], [ %61, %60 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #12
  ret i8* %63
}
...
13:                                               ; preds = %12, %25
  ...
  %15 = getelementptr %3, %3* %14, i64 0, i32 1
...
30:                                               ; preds = %29, %42
  ...
  %32 = getelementptr %3, %3* %31, i64 0, i32 1
...
55:                                               ; preds = %50, %67
  ...
  %57 = getelementptr %3, %3* %56, i64 0, i32 1
  %58 = load i8*, i8** %57, align 8
...
14:                                               ; preds = %13, %26
  ...
  %16 = getelementptr %3, %3* %15, i64 0, i32 1
...
56:                                               ; preds = %51, %68
  ...
  %58 = getelementptr %3, %3* %57, i64 0, i32 1
...
16:                                               ; preds = %4, %28
  %17 = phi %3* [ %30, %28 ], [ %14, %4 ]
  %18 = getelementptr %3, %3* %17, i64 0, i32 1
...
69:                                               ; preds = %61
  %70 = getelementptr %1, %1* %0, i64 0, i32 1
...
78:                                               ; preds = %74, %90
  ...
  %80 = getelementptr %3, %3* %79, i64 0, i32 1
...
103:                                              ; preds = %98, %115
  ...
  %105 = getelementptr %3, %3* %104, i64 0, i32 1
...
11:                                               ; preds = %7, %23
  %12 = phi %3* [ %25, %23 ], [ %9, %7 ]
  %13 = getelementptr %3, %3* %12, i64 0, i32 1
...
27:                                               ; preds = %23, %7
  %28 = getelementptr %1, %1* %0, i64 0, i32 1
...
36:                                               ; preds = %32, %48
  ...
  %38 = getelementptr %3, %3* %37, i64 0, i32 1
...
61:                                               ; preds = %56, %73
  ...
  %63 = getelementptr %3, %3* %62, i64 0, i32 1
  %64 = load i8*, i8** %63, align 8
...
7:                                                ; preds = %3, %19
  %8 = phi %3* [ %21, %19 ], [ %5, %3 ]
  %9 = getelementptr %3, %3* %8, i64 0, i32 1
