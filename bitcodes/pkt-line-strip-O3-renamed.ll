; ModuleID = 'pkt-line-strip-O3-renamed.bc'
...
12:                                               ; preds = %9
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @41, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @42, i64 0, i64 0), i32 168, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @43, i64 0, i64 0)) #12
  unreachable

13:                                               ; preds = %8, %9
  call fastcc void @47(%0* nonnull @33, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @7, i64 0, i64 0), i8* %1, %2* nonnull %5) #6
  ...
  %16 = call i64 @write_in_full(i32 %0, i8* %14, i64 %15) #6
...
18:                                               ; preds = %13
  ...
  call void @check_pipe(i32 %20) #6
  %21 = call fastcc i8* @45(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @34, i64 0, i64 0)) #6
...
18:                                               ; preds = %13
  %19 = call i32 @use_gettext_poison() #6
  %20 = icmp eq i32 %19, 0
  br i1 %20, label %21, label %23

21:                                               ; preds = %18
  %22 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([32 x i8], [32 x i8]* @34, i64 0, i64 0), i32 5) #6
  br label %23

23:                                               ; preds = %18, %21
  %24 = phi i8* [ %22, %21 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @32, i64 0, i64 0), %18 ]
  %25 = call i32 (i8*, ...) @error(i8* %24) #6
  br label %26

26:                                               ; preds = %13, %23
  %27 = phi i32 [ -1, %23 ], [ 0, %13 ]
  call void @llvm.va_end(i8* nonnull %4)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #6
  ret i32 %27
}
...
define dso_local void @packet_write(i32 %0, i8* %1, i64 %2) local_unnamed_addr #0 {
  %4 = tail call fastcc i32 @46(i32 %0, i8* %1, i64 %2)
  %5 = icmp eq i32 %4, 0
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @46(i32 %0, i8* %1, i64 %2) unnamed_addr #0 {
...
define dso_local void @packet_buf_write(%0* %0, i8* %1, ...) local_unnamed_addr #0 {
  ...
  %5 = getelementptr inbounds [1 x %2], [1 x %2]* %3, i64 0, i64 0
  call void @llvm.va_start(i8* nonnull %4)
  call fastcc void @47(%0* %0, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @7, i64 0, i64 0), i8* %1, %2* nonnull %5)
  call void @llvm.va_end(i8* nonnull %4)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #6
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal fastcc void @47(%0* %0, i8* %1, i8* %2, %2* %3) unnamed_addr #0 {
...
8:                                                ; preds = %6
  %9 = tail call fastcc i32 @46(i32 %1, i8* getelementptr inbounds ([65516 x i8], [65516 x i8]* @10, i64 0, i64 0), i64 %4)
  %10 = icmp eq i32 %9, 0
...
10:                                               ; preds = %4
  ...
  %12 = tail call fastcc i32 @46(i32 %2, i8* %11, i64 %8)
  %13 = add i64 %8, %5
  %14 = icmp eq i32 %12, 0
...
define dso_local i32 @packet_read_with_status(i32 %0, i8** %1, i64* nocapture %2, i8* %3, i32 %4, i32* nocapture %5, i32 %6) local_unnamed_addr #0 {
  ...
  %10 = call fastcc i32 @48(i32 %0, i8** %1, i64* %2, i8* nonnull %9, i32 4, i32 %6)
...
67:                                               ; preds = %62
  %68 = call fastcc i32 @48(i32 %0, i8** %1, i64* %2, i8* %3, i32 %63, i32 %6)
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @48(i32 %0, i8** %1, i64* nocapture %2, i8* %3, i32 %4, i32 %5) unnamed_addr #0 {
  %7 = icmp sgt i32 %0, -1
  %8 = icmp ne i8** %1, null
  %9 = and i1 %7, %8
...
define dso_local void @packet_writer_write(%4* nocapture readonly %0, i8* %1, ...) local_unnamed_addr #0 {
  ...
  store i64 0, i64* getelementptr inbounds (%0, %0* @33, i64 0, i32 1), align 8
  %13 = load i8*, i8** getelementptr inbounds (%0, %0* @33, i64 0, i32 2), align 8
...
20:                                               ; preds = %15, %16
  call fastcc void @47(%0* nonnull @33, i8* %12, i8* %1, %2* nonnull %5) #6
  %21 = load i8*, i8** getelementptr inbounds (%0, %0* @33, i64 0, i32 2), align 8
  %22 = load i64, i64* getelementptr inbounds (%0, %0* @33, i64 0, i32 1), align 8
  %23 = call i64 @write_in_full(i32 %7, i8* %21, i64 %22) #6
...
25:                                               ; preds = %20
  ...
  call void @check_pipe(i32 %27) #6
  %28 = call fastcc i8* @45(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @34, i64 0, i64 0)) #6
  call void (i8*, ...) @die_errno(i8* %28) #12
  unreachable
