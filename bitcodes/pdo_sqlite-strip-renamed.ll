; ModuleID = 'pdo_sqlite-strip-renamed.bc'
...
define hidden i32 @zm_startup_pdo_sqlite(i32 %0, i32 %1) #0 {
  ...
  %5 = call %14* @php_pdo_get_dbh_ce()
  %6 = call i32 @zend_declare_class_constant_long(%14* %5, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @4, i32 0, i32 0), i64 20, i64 2048)
  %7 = call i32 @php_pdo_register_driver(%8* @pdo_sqlite_driver)
  ret i32 %7
}
...
define hidden i32 @zm_shutdown_pdo_sqlite(i32 %0, i32 %1) #0 {
  ...
  store i32 %0, i32* %3, align 4
  store i32 %1, i32* %4, align 4
  call void @php_pdo_unregister_driver(%8* @pdo_sqlite_driver)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define hidden void @zm_info_pdo_sqlite(%3* %0) #0 {
  %2 = alloca %3*, align 8
  store %3* %0, %3** %2, align 8
  call void @php_info_print_table_start()
  call void (i32, ...) @php_info_print_table_header(i32 2, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @5, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @6, i32 0, i32 0))
  %3 = call i8* @sqlite3_libversion()
  call void (i32, ...) @php_info_print_table_row(i32 2, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @7, i32 0, i32 0), i8* %3)
  call void @php_info_print_table_end()
  ret void
}

declare dso_local i32 @zend_declare_class_constant_long(%14*, i8*, i64, i64) #1

declare dso_local %14* @php_pdo_get_dbh_ce() #1

declare dso_local i32 @php_pdo_register_driver(%8*) #1

declare dso_local void @php_pdo_unregister_driver(%8*) #1
