; ModuleID = 'nistp224-strip-O2-renamed.bc'
...
100:                                              ; preds = %46
  %101 = bitcast [4 x i64]* %8 to <2 x i64>*
  ...
  %106 = bitcast [4 x i64]* %9 to <2 x i64>*
  %107 = load <2 x i64>, <2 x i64>* %106, align 16
  %108 = getelementptr inbounds [4 x i64], [4 x i64]* %9, i64 0, i64 2
  %109 = bitcast i64* %108 to <2 x i64>*
  %110 = load <2 x i64>, <2 x i64>* %109, align 16
  %111 = bitcast [4 x i64]* %10 to <2 x i64>*
  %112 = load <2 x i64>, <2 x i64>* %111, align 16
  %113 = getelementptr inbounds [4 x i64], [4 x i64]* %10, i64 0, i64 2
  %114 = bitcast i64* %113 to <2 x i64>*
  %115 = load <2 x i64>, <2 x i64>* %114, align 16
  br label %116

116:                                              ; preds = %7, %100
  %117 = phi <2 x i64> [ %102, %100 ], [ zeroinitializer, %7 ]
  %118 = phi <2 x i64> [ %105, %100 ], [ zeroinitializer, %7 ]
  %119 = phi <2 x i64> [ %107, %100 ], [ zeroinitializer, %7 ]
  %120 = phi <2 x i64> [ %110, %100 ], [ zeroinitializer, %7 ]
  %121 = phi <2 x i64> [ %112, %100 ], [ zeroinitializer, %7 ]
  %122 = phi <2 x i64> [ %115, %100 ], [ zeroinitializer, %7 ]
  %123 = bitcast i64* %0 to <2 x i64>*
  store <2 x i64> %117, <2 x i64>* %123, align 8
  %124 = getelementptr inbounds i64, i64* %0, i64 2
  %125 = bitcast i64* %124 to <2 x i64>*
  store <2 x i64> %118, <2 x i64>* %125, align 8
  %126 = bitcast i64* %1 to <2 x i64>*
  store <2 x i64> %119, <2 x i64>* %126, align 8
  %127 = getelementptr inbounds i64, i64* %1, i64 2
  %128 = bitcast i64* %127 to <2 x i64>*
  store <2 x i64> %120, <2 x i64>* %128, align 8
  %129 = bitcast i64* %2 to <2 x i64>*
  store <2 x i64> %121, <2 x i64>* %129, align 8
  %130 = getelementptr inbounds i64, i64* %2, i64 2
  %131 = bitcast i64* %130 to <2 x i64>*
  store <2 x i64> %122, <2 x i64>* %131, align 8
