; ModuleID = 'paste-strip-O3-renamed.bc'
...
9:                                                ; preds = %6, %21
  %10 = phi %1* [ %23, %21 ], [ %7, %6 ]
  %11 = getelementptr %1, %1* %10, i64 0, i32 2
...
83:                                               ; preds = %80, %95
  ...
  %85 = getelementptr %1, %1* %84, i64 0, i32 2
...
4:                                                ; preds = %1
  %5 = getelementptr %1, %1* %0, i64 0, i32 2
  %6 = load i8*, i8** %5, align 8
  br label %7

7:                                                ; preds = %4, %19
  %8 = phi %1* [ %2, %4 ], [ %21, %19 ]
  %9 = getelementptr %1, %1* %8, i64 0, i32 2
...
4:                                                ; preds = %1
  %5 = getelementptr %1, %1* %0, i64 0, i32 5
  %6 = load i32, i32* %5, align 4
  br label %7

7:                                                ; preds = %4, %21
  %8 = phi %1* [ %2, %4 ], [ %23, %21 ]
  %9 = getelementptr %1, %1* %8, i64 0, i32 5
...
25:                                               ; preds = %22, %37
  ...
  %27 = getelementptr %1, %1* %26, i64 0, i32 2
...
44:                                               ; preds = %33
  %45 = getelementptr %1, %1* %26, i64 0, i32 2
  br label %46

46:                                               ; preds = %44, %58
  %47 = phi %1* [ %60, %58 ], [ %23, %44 ]
  %48 = getelementptr %1, %1* %47, i64 0, i32 2
...
75:                                               ; preds = %72, %71, %62, %63, %41, %42, %19, %20, %11, %12
  %76 = phi i32 [ -1, %12 ], [ -1, %11 ], [ -1, %20 ], [ -1, %19 ], [ -1, %42 ], [ -1, %41 ], [ -1, %63 ], [ -1, %62 ], [ 0, %71 ], [ 0, %72 ]
  ret i32 %76
}
...
42:                                               ; preds = %39, %54
  ...
  %44 = getelementptr %1, %1* %43, i64 0, i32 2
