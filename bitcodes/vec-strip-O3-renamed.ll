; ModuleID = 'vec-strip-O3-renamed.bc'
...
29:                                               ; preds = %3, %29
  ...
  %32 = call i32 @vec_done(i64 %28, i64 %2) #7
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %29, label %39

34:                                               ; preds = %3, %34
  %35 = phi i64 [ %36, %34 ], [ 0, %3 ]
  ...
  %37 = call i32 @vec_done(i64 %28, i64 %2) #7
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %34, label %39

39:                                               ; preds = %34, %29
  %40 = phi i64 [ %31, %29 ], [ %36, %34 ]
  call void @__gmpz_clear(%3* nonnull %21) #7
  call void @__gmpz_clear(%3* nonnull %20) #7
  call void @__gmpz_clear(%3* nonnull %19) #7
  call void @__gmpz_clear(%3* nonnull %18) #7
...
45:                                               ; preds = %42
  %46 = tail call i8* @vec_curve_get_name(i32 0) #7
  %47 = icmp eq i8* %46, null
  br i1 %47, label %75, label %48

48:                                               ; preds = %45
  br i1 %43, label %49, label %69

49:                                               ; preds = %48, %49
  %50 = phi i8* [ %53, %49 ], [ %46, %48 ]
  %51 = phi i32 [ %52, %49 ], [ 0, %48 ]
  tail call void @time_curve(i8* nonnull %50, i64 2000)
  %52 = add nuw nsw i32 %51, 1
  %53 = tail call i8* @vec_curve_get_name(i32 %52) #7
  %54 = icmp eq i8* %53, null
  br i1 %54, label %75, label %49
...
57:                                               ; preds = %55, %57
  %58 = phi i64 [ %61, %57 ], [ 2, %55 ]
  %59 = getelementptr inbounds i8*, i8** %1, i64 %58
  %60 = load i8*, i8** %59, align 8
  tail call void @time_curve(i8* %60, i64 2000)
  %61 = add nuw nsw i64 %58, 1
  %62 = icmp eq i64 %61, %56
  br i1 %62, label %80, label %57

63:                                               ; preds = %55, %63
  %64 = phi i64 [ %67, %63 ], [ 2, %55 ]
  %65 = getelementptr inbounds i8*, i8** %1, i64 %64
  %66 = load i8*, i8** %65, align 8
  tail call void @test_curve(i8* %66)
  %67 = add nuw nsw i64 %64, 1
  %68 = icmp eq i64 %67, %56
  br i1 %68, label %80, label %63

69:                                               ; preds = %48, %69
  %70 = phi i8* [ %73, %69 ], [ %46, %48 ]
  %71 = phi i32 [ %72, %69 ], [ 0, %48 ]
  tail call void @test_curve(i8* nonnull %70)
  %72 = add nuw nsw i32 %71, 1
  %73 = tail call i8* @vec_curve_get_name(i32 %72) #7
  %74 = icmp eq i8* %73, null
  br i1 %74, label %75, label %69

75:                                               ; preds = %69, %49, %45
  %76 = phi i32 [ 0, %45 ], [ %52, %49 ], [ %72, %69 ]
  %77 = tail call i32 (...) @vec_curve_number_of_names() #7
