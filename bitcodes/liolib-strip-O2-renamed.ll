; ModuleID = 'liolib-strip-O2-renamed.bc'
...
6:                                                ; preds = %1
  %7 = tail call i32 (%1*, i8*, ...) @luaL_error(%1* %0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @22, i64 0, i64 0)) #7
  br label %8

8:                                                ; preds = %6, %1
  %9 = tail call fastcc i32 @65(%1* %0, %2* %4)
  %10 = tail call i32 @ferror(%2* %4) #7
  %11 = icmp eq i32 %10, 0
...
12:                                               ; preds = %8
  %13 = tail call i32* @__errno_location() #8
  %14 = load i32, i32* %13, align 4
  %15 = tail call i8* @strerror(i32 %14) #7
  %16 = tail call i32 (%1*, i8*, ...) @luaL_error(%1* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @21, i64 0, i64 0), i8* %15) #7
  br label %25
...
19:                                               ; preds = %17
  %20 = tail call i32 @lua_toboolean(%1* %0, i32 -10004) #7
  %21 = icmp eq i32 %20, 0
...
22:                                               ; preds = %19
  ...
  tail call void @lua_getfenv(%1* %0, i32 1) #7
  tail call void @lua_getfield(%1* %0, i32 -1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @19, i64 0, i64 0)) #7
  %23 = tail call i32 (%1*)* @lua_tocfunction(%1* %0, i32 -1) #7
  %24 = tail call i32 %23(%1* %0) #7
  br label %25

25:                                               ; preds = %22, %19, %17, %12
  %26 = phi i32 [ %16, %12 ], [ 1, %17 ], [ 0, %19 ], [ 0, %22 ]
  ret i32 %26
}
