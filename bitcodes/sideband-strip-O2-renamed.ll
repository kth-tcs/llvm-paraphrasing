; ModuleID = 'sideband-strip-O2-renamed.bc'
...
20:                                               ; preds = %14
  %21 = add i32 %19, 5
  %22 = call i32 (i8*, i64, i8*, ...) @xsnprintf(i8* nonnull %9, i64 5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @13, i64 0, i64 0), i32 %21) #8
...
23:                                               ; preds = %14
  %24 = add i32 %19, 4
  %25 = call i32 (i8*, i64, i8*, ...) @xsnprintf(i8* nonnull %9, i64 5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @13, i64 0, i64 0), i32 %24) #8
  call void @write_or_die(i32 %0, i8* nonnull %9, i64 4) #8
  br label %26

26:                                               ; preds = %23, %20
  %27 = zext i32 %19 to i64
  call void @write_or_die(i32 %0, i8* %15, i64 %27) #8
