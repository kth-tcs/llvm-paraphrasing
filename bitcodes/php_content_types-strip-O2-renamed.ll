; ModuleID = 'php_content_types-strip-O2-renamed.bc'
source_filename = "/home/travis/build/orestisfl/compilation-database/build/php-src/main/php_content_types.c"
...
@0 = private unnamed_addr constant [5 x i8] c"POST\00", align 1
@1 = internal global [3 x %20] [%20 { i8* getelementptr inbounds ([34 x i8], [34 x i8]* @2, i32 0, i32 0), i32 33, void ()* @sapi_read_standard_form_data, void (i8*, i8*)* @php_std_post_handler }, %20 { i8* getelementptr inbounds ([20 x i8], [20 x i8]* @3, i32 0, i32 0), i32 19, void ()* null, void (i8*, i8*)* @rfc1867_post_handler }, %20 zeroinitializer], align 16
@2 = private unnamed_addr constant [34 x i8] c"application/x-www-form-urlencoded\00", align 1
@3 = private unnamed_addr constant [20 x i8] c"multipart/form-data\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @php_default_post_reader() #0 {
  %1 = load i8*, i8** getelementptr inbounds (%0, %0* @sapi_globals, i64 0, i32 1, i32 0), align 8
  %2 = tail call i32 @strcmp(i8* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i64 0, i64 0)) #3
  %3 = icmp eq i32 %2, 0
  %4 = load %20*, %20** getelementptr inbounds (%0, %0* @sapi_globals, i64 0, i32 1, i32 11), align 8
  %5 = icmp eq %20* %4, null
  %6 = and i1 %3, %5
...
declare dso_local void @sapi_read_standard_form_data() #2

; Function Attrs: nounwind uwtable
define hidden i32 @php_startup_sapi_content_types() local_unnamed_addr #0 {
  %1 = tail call i32 @sapi_register_default_post_reader(void ()* nonnull @php_default_post_reader) #4
  %2 = tail call i32 @sapi_register_treat_data(void (i32, i8*, %29*)* nonnull @php_default_treat_data) #4
  %3 = tail call i32 @sapi_register_input_filter(i32 (i32, i8*, i8**, i64, i64*)* nonnull @php_default_input_filter, i32 ()* null) #4
  ret i32 0
}

declare dso_local i32 @sapi_register_default_post_reader(void ()*) local_unnamed_addr #2

declare dso_local i32 @sapi_register_treat_data(void (i32, i8*, %29*)*) local_unnamed_addr #2

declare dso_local void @php_default_treat_data(i32, i8*, %29*) #2

declare dso_local i32 @sapi_register_input_filter(i32 (i32, i8*, i8**, i64, i64*)*, i32 ()*) local_unnamed_addr #2

declare dso_local i32 @php_default_input_filter(i32, i8*, i8**, i64, i64*) #2

; Function Attrs: nounwind uwtable
define hidden i32 @php_setup_sapi_content_types() local_unnamed_addr #0 {
  %1 = tail call i32 @sapi_register_post_entries(%20* getelementptr inbounds ([3 x %20], [3 x %20]* @1, i64 0, i64 0)) #4
  ret i32 0
}

declare dso_local i32 @sapi_register_post_entries(%20*) local_unnamed_addr #2

declare dso_local void @php_std_post_handler(i8*, i8*) #2

declare dso_local void @rfc1867_post_handler(i8*, i8*) #2
