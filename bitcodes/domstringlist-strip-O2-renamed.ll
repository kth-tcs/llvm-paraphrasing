; ModuleID = 'domstringlist-strip-O2-renamed.bc'
...
define hidden void @zif_dom_domstringlist_item(%1* nocapture readnone %0, %29* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0)) #3
  ret void
}

; Function Attrs: nounwind uwtable
define hidden i32 @dom_domstringlist_length_read(%33* nocapture readnone %0, %29* nocapture %1) local_unnamed_addr #0 {
