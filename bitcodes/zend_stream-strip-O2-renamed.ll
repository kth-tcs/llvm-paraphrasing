; ModuleID = 'zend_stream-strip-O2-renamed.bc'
...
154:                                              ; preds = %151
  %155 = getelementptr inbounds %0, %0* %0, i64 0, i32 0, i32 0, i32 3
  %156 = getelementptr inbounds %0, %0* %0, i64 0, i32 0, i32 0, i32 0
  br label %157

157:                                              ; preds = %166, %154
  %158 = phi i64 [ 0, %154 ], [ %169, %166 ]
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %5) #8
  %159 = load i64 (i8*, i8*, i64)*, i64 (i8*, i8*, i64)** %155, align 8
  %160 = load i8*, i8** %156, align 8
  %161 = call i64 %159(i8* %160, i8* nonnull %5, i64 1) #8
...
192:                                              ; preds = %104, %109
  ...
  %194 = getelementptr inbounds %0, %0* %0, i64 0, i32 0, i32 0, i32 3
  %195 = getelementptr inbounds %0, %0* %0, i64 0, i32 0, i32 0, i32 0
  br label %196
...
208:                                              ; preds = %206, %217
  ...
  %210 = load i64 (i8*, i8*, i64)*, i64 (i8*, i8*, i64)** %194, align 8
  %211 = load i8*, i8** %195, align 8
  %212 = call i64 %210(i8* %211, i8* nonnull %4, i64 1) #8
