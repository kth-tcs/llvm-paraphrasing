; ModuleID = 'ignore-strip-O2-renamed.bc'
...
69:                                               ; preds = %66, %107
  %70 = phi %0* [ %64, %66 ], [ %110, %107 ]
  %71 = phi i64 [ %61, %66 ], [ %108, %107 ]
  br i1 %67, label %86, label %72

72:                                               ; preds = %69
  %73 = getelementptr inbounds %0, %0* %70, i64 0, i32 0
  %74 = load i8**, i8*** %73, align 8
  %75 = getelementptr inbounds %0, %0* %70, i64 0, i32 1
  %76 = load i64, i64* %75, align 8
  %77 = trunc i64 %76 to i32
  %78 = call i32 @binary_search(i8* nonnull %53, i8** %74, i32 0, i32 %77) #9
  %79 = icmp sgt i32 %78, -1
  br i1 %79, label %80, label %86

80:                                               ; preds = %72
  %81 = getelementptr inbounds %0, %0* %70, i64 0, i32 0
  %82 = load i8**, i8*** %81, align 8
  %83 = sext i32 %78 to i64
  %84 = getelementptr inbounds i8*, i8** %82, i64 %83
  %85 = load i8*, i8** %84, align 8
  call void (i8*, ...) @log_debug(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @17, i64 0, i64 0), i8* %62, i8* %85) #9
  br label %113

86:                                               ; preds = %72, %69
  %87 = call fastcc i32 @30(%0* nonnull %70, i8* %44, i8* %62)
  %88 = icmp eq i32 %87, 0
  br i1 %88, label %89, label %113

89:                                               ; preds = %86
  %90 = call i32 @is_directory(i8* %0, %11* %1) #9
  %91 = icmp eq i32 %90, 0
...
94:                                               ; preds = %92
  %95 = call i64 @strlen(i8* %62) #10
  br label %96

96:                                               ; preds = %92, %94
  %97 = phi i64 [ %71, %92 ], [ %95, %94 ]
  %98 = add i64 %97, -1
  %99 = getelementptr inbounds i8, i8* %62, i64 %98
...
102:                                              ; preds = %96
  ...
  %104 = call fastcc i32 @30(%0* nonnull %70, i8* %44, i8* %103)
...
107:                                              ; preds = %96, %89, %102
  %108 = phi i64 [ %97, %102 ], [ %97, %96 ], [ %71, %89 ]
  %109 = getelementptr inbounds %0, %0* %70, i64 0, i32 16
...
113:                                              ; preds = %18, %86, %102, %30, %34, %35, %80, %112, %8
  %114 = phi i32 [ 0, %8 ], [ 0, %34 ], [ 0, %30 ], [ 1, %35 ], [ 1, %112 ], [ 0, %80 ], [ 0, %102 ], [ 0, %86 ], [ 0, %18 ]
  ret i32 %114
}
