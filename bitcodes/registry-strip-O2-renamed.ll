; ModuleID = 'registry-strip-O2-renamed.bc'
...
define dso_local i32 @registry_request_hello_json(%19* %0, %42* nocapture readonly %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
11:                                               ; preds = %7
  %12 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
49:                                               ; preds = %45
  %50 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
62:                                               ; preds = %45
  ...
  %64 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
10:                                               ; preds = %7
  %11 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
24:                                               ; preds = %7
  ...
  %28 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
25:                                               ; preds = %7
  ...
  %29 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
29:                                               ; preds = %25
  %30 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
45:                                               ; preds = %42
  %46 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
61:                                               ; preds = %58
  %62 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
82:                                               ; preds = %74
  %83 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
100:                                              ; preds = %95
  %101 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
...
113:                                              ; preds = %95
  ...
  %115 = getelementptr inbounds %42, %42* %1, i64 0, i32 27, i32 2
