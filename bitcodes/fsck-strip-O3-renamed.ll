; ModuleID = 'fsck-strip-O3-renamed.bc'
...
define internal i32 @132(%6* %0, i8* nocapture readnone %1, i8* nocapture readnone %2) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %5, i8* align 8 bitcast ({ i32 (%20*, i32, i8*, %57*)*, i32 (%57*, %6*, i32, i32, i8*)*, i8, i32*, %58, %60* }* @102 to i8*), i64 80, i1 false) #9
  %6 = load %2*, %2** @the_repository, align 8
  %7 = tail call %20* @lookup_object(%2* %6, %6* %0) #9
  %8 = icmp eq %20* %7, null
...
14:                                               ; preds = %9
  %15 = getelementptr inbounds %20, %20* %7, i64 0, i32 0
...
19:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds %20, %20* %7, i64 0, i32 2
  %22 = tail call i32 @oid_object_info(%2* %20, %6* nonnull %21, i64* null) #9
  %23 = icmp sgt i32 %22, 0
  br i1 %23, label %24, label %27

24:                                               ; preds = %19
  %25 = load %2*, %2** @the_repository, align 8
  %26 = tail call i8* @object_as_type(%2* %25, %20* nonnull %7, i32 %22, i32 0) #9
  br label %27

27:                                               ; preds = %24, %19, %14
  %28 = bitcast %57* %4 to i32 (%20*, i32, i8*, %57*)**
  store i32 (%20*, i32, i8*, %57*)* @116, i32 (%20*, i32, i8*, %57*)** %28, align 8
  %29 = call i32 @fsck_walk(%20* nonnull %7, i8* null, %57* nonnull %4) #9
  br label %30
...
define internal i32 @133(%6* %0, %13* nocapture readnone %1, i32 %2, i8* nocapture readnone %3) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %6, i8* align 8 bitcast ({ i32 (%20*, i32, i8*, %57*)*, i32 (%57*, %6*, i32, i32, i8*)*, i8, i32*, %58, %60* }* @102 to i8*), i64 80, i1 false) #9
  %7 = load %2*, %2** @the_repository, align 8
  %8 = tail call %20* @lookup_object(%2* %7, %6* %0) #9
  %9 = icmp eq %20* %8, null
...
15:                                               ; preds = %10
  %16 = getelementptr inbounds %20, %20* %8, i64 0, i32 0
...
20:                                               ; preds = %15
  %21 = load %2*, %2** @the_repository, align 8
  %22 = getelementptr inbounds %20, %20* %8, i64 0, i32 2
  %23 = tail call i32 @oid_object_info(%2* %21, %6* nonnull %22, i64* null) #9
  %24 = icmp sgt i32 %23, 0
  br i1 %24, label %25, label %28

25:                                               ; preds = %20
  %26 = load %2*, %2** @the_repository, align 8
  %27 = tail call i8* @object_as_type(%2* %26, %20* nonnull %8, i32 %23, i32 0) #9
  br label %28

28:                                               ; preds = %25, %20, %15
  %29 = bitcast %57* %5 to i32 (%20*, i32, i8*, %57*)**
  store i32 (%20*, i32, i8*, %57*)* @116, i32 (%20*, i32, i8*, %57*)** %29, align 8
  %30 = call i32 @fsck_walk(%20* nonnull %8, i8* null, %57* nonnull %5) #9
  br label %31
