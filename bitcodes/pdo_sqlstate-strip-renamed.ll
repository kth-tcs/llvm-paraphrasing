; ModuleID = 'pdo_sqlstate-strip-renamed.bc'
...
declare dso_local void @zend_hash_destroy(%0*) #1

; Function Attrs: nounwind uwtable
define hidden i32 @pdo_sqlstate_init_error_table() #0 {
  ...
  call void @_zend_hash_init(%0* @0, i32 266, void (%5*)* null, i8 zeroext 1)
  store i64 0, i64* %1, align 8
  br label %5

5:                                                ; preds = %17, %0
  %6 = load i64, i64* %1, align 8
  %7 = icmp ult i64 %6, 266
  br i1 %7, label %8, label %20

8:                                                ; preds = %5
  %9 = load i64, i64* %1, align 8
  %10 = getelementptr inbounds [266 x %10], [266 x %10]* @1, i64 0, i64 %9
  ...
  %16 = call i8* @263(%0* @0, i8* %13, i64 5, i8* %15)
  br label %17
...
declare dso_local void @_zend_hash_init(%0*, i32, void (%5*)*, i8 zeroext) #1

; Function Attrs: alwaysinline nounwind uwtable
define internal i8* @263(%0* %0, i8* %1, i64 %2, i8* %3) #3 {
  %5 = alloca i8*, align 8
  %6 = alloca %0*, align 8
  %7 = alloca i8*, align 8
...
; Function Attrs: nounwind uwtable
define hidden i8* @pdo_sqlstate_state_to_description(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca %10*, align 8
...
; Function Attrs: alwaysinline nounwind uwtable
define internal i8* @264(%0* %0, i8* %1, i64 %2) #3 {
  %4 = alloca i8*, align 8
  %5 = alloca %0*, align 8
  %6 = alloca i8*, align 8
...
declare dso_local %5* @_zend_hash_str_add(%0*, i8*, i64, %5*) #1

; Function Attrs: nounwind readnone willreturn
declare i64 @llvm.expect.i64(i64, i64) #4

declare dso_local %5* @zend_hash_str_find(%0*, i8*, i64) #1
