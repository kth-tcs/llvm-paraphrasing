; ModuleID = 'cmd-list-clients-strip-O2-renamed.bc'
...
28:                                               ; preds = %19
  %29 = tail call %6* @cmdq_get_client(%4* %1) #3
  %30 = tail call %46* @format_create(%6* %29, %4* %1, i32 0, i32 0) #3
  tail call void (%46*, i8*, i8*, ...) @format_add(%46* %30, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @5, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @6, i64 0, i64 0), i32 %21) #3
  tail call void @format_defaults(%46* %30, %6* nonnull %20, %75* null, %16* null, %11* null) #3
  %31 = tail call i8* @format_expand(%46* %30, i8* %14) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @7, i64 0, i64 0), i8* %31) #3
  tail call void @free(i8* %31) #3
  tail call void @format_free(%46* %30) #3
  %32 = add i32 %21, 1
  br label %33

33:                                               ; preds = %19, %28
  %34 = phi i32 [ %21, %19 ], [ %32, %28 ]
  %35 = getelementptr inbounds %6, %6* %20, i64 0, i32 57, i32 0
