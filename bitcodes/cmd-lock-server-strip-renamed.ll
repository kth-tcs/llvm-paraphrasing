; ModuleID = 'cmd-lock-server-strip-renamed.bc'
...
define internal i32 @10(%3* %0, %4* %1) #0 {
  ...
  %9 = call %5* @cmdq_get_target(%4* %8)
  store %5* %9, %5** %5, align 8
  %10 = bitcast %57** %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %10) #4
  %11 = load %4*, %4** %4, align 8
  %12 = call %57* @cmdq_get_target_client(%4* %11)
  store %57* %12, %57** %6, align 8
  %13 = load %3*, %3** %3, align 8
  %14 = call %0* @cmd_get_entry(%3* %13)
  %15 = icmp eq %0* %14, @cmd_lock_server_entry
  br i1 %15, label %16, label %17

16:                                               ; preds = %2
  call void @server_lock()
  br label %28

17:                                               ; preds = %2
  %18 = load %3*, %3** %3, align 8
  %19 = call %0* @cmd_get_entry(%3* %18)
  %20 = icmp eq %0* %19, @cmd_lock_session_entry
...
21:                                               ; preds = %17
  ...
  call void @server_lock_session(%6* %24)
  br label %27

25:                                               ; preds = %17
  %26 = load %57*, %57** %6, align 8
  call void @server_lock_client(%57* %26)
  br label %27
...
declare dso_local void @server_lock() #3

declare dso_local void @server_lock_session(%6*) #3

declare dso_local void @server_lock_client(%57*) #3
