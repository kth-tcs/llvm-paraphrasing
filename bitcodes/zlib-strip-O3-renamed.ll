; ModuleID = 'zlib-strip-O3-renamed.bc'
...
define dso_local void @git_deflate_init_gzip(%0* %0, i32 %1) local_unnamed_addr #0 {
  tail call fastcc void @22(%0* %0, i32 %1, i32 31)
  ret void
}

; Function Attrs: nounwind uwtable
define internal fastcc void @22(%0* %0, i32 %1, i32 %2) unnamed_addr #0 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 8 %16, i8 0, i64 160, i1 false)
  %17 = tail call i32 @deflateInit2_(%1* %15, i32 %1, i32 8, i32 %2, i32 8, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i64 0, i64 0), i32 112) #5
  %18 = load i64, i64* %6, align 8
  %19 = load i64, i64* %10, align 8
  %20 = bitcast i8** %4 to <2 x i64>*
  %21 = load <2 x i64>, <2 x i64>* %20, align 8
  %22 = insertelement <2 x i64> undef, i64 %18, i32 0
  %23 = insertelement <2 x i64> %22, i64 %19, i32 1
  %24 = sub <2 x i64> %23, %21
...
46:                                               ; preds = %39
  %47 = tail call fastcc i8* @21(i32 %17)
  %48 = getelementptr inbounds %0, %0* %0, i64 0, i32 0, i32 6
  %49 = load i8*, i8** %48, align 8
  %50 = icmp eq i8* %49, null
  %51 = select i1 %50, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @2, i64 0, i64 0), i8* %49
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @20, i64 0, i64 0), i8* %47, i8* %51) #6
  unreachable
}

; Function Attrs: nounwind uwtable
define dso_local void @git_deflate_init_raw(%0* %0, i32 %1) local_unnamed_addr #0 {
  tail call fastcc void @22(%0* %0, i32 %1, i32 -15)
  ret void
}
