; ModuleID = 'list-objects-filter-strip-O2-renamed.bc'
...
21:                                               ; preds = %12, %76
  %22 = phi %55* [ %20, %12 ], [ %86, %76 ]
  %23 = phi i32 [ 7, %12 ], [ %92, %76 ]
  %24 = phi i64 [ 0, %12 ], [ %93, %76 ]
...
30:                                               ; preds = %29
  %31 = getelementptr inbounds %55, %55* %22, i64 %24, i32 3, i32 0, i64 0
  %32 = load %4*, %4** @the_repository, align 8
  %33 = getelementptr inbounds %4, %4* %32, i64 0, i32 14
  %34 = load %45*, %45** %33, align 8
  %35 = getelementptr inbounds %45, %45* %34, i64 0, i32 2
  %36 = load i64, i64* %35, align 8
  %37 = icmp eq i64 %36, 32
  %38 = select i1 %37, i64 32, i64 20
  %39 = tail call i32 @memcmp(i8* nonnull %16, i8* nonnull %31, i64 %38) #12
  %40 = icmp eq i32 %39, 0
...
43:                                               ; preds = %41, %21
  %44 = getelementptr inbounds %55, %55* %22, i64 %24, i32 1
  %45 = tail call i32 @oidset_contains(%49* nonnull %44, %8* nonnull %14) #11
  %46 = icmp eq i32 %45, 0
  br i1 %46, label %47, label %76

47:                                               ; preds = %43
  %48 = getelementptr inbounds %55, %55* %22, i64 %24, i32 0
...
55:                                               ; preds = %51
  %56 = getelementptr inbounds %3, %3* %49, i64 0, i32 0
  %57 = load i32 (%4*, i32, %48*, i8*, i8*, %49*, i8*)*, i32 (%4*, i32, %48*, i8*, i8*, %49*, i8*)** %56, align 8
  %58 = getelementptr inbounds %3, %3* %49, i64 0, i32 4
  %59 = load %49*, %49** %58, align 8
  %60 = getelementptr inbounds %3, %3* %49, i64 0, i32 3
  %61 = load i8*, i8** %60, align 8
  %62 = tail call i32 %57(%4* %0, i32 %1, %48* nonnull %2, i8* %3, i8* %4, %49* %59, i8* %61) #11
  br label %63

63:                                               ; preds = %47, %51, %55
  %64 = phi i32 [ %62, %55 ], [ %17, %51 ], [ %17, %47 ]
  %65 = and i32 %64, 1
  %66 = icmp eq i32 %65, 0
  br i1 %66, label %69, label %67

67:                                               ; preds = %63
  %68 = tail call i32 @oidset_insert(%49* nonnull %44, %8* nonnull %14) #11
  br label %69
...
72:                                               ; preds = %69
  ...
  %75 = getelementptr inbounds %55, %55* %22, i64 %24, i32 3, i32 0, i64 0
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %75, i8* nonnull align 4 %19, i64 32, i1 false) #11
  br label %76

76:                                               ; preds = %29, %30, %43, %69, %72
  %77 = phi i32 [ 0, %30 ], [ 0, %29 ], [ 0, %43 ], [ %64, %69 ], [ %64, %72 ]
  %78 = and i32 %77, 2
  %79 = icmp eq i32 %78, 0
  %80 = and i32 %23, -3
  %81 = select i1 %79, i32 %80, i32 %23
  %82 = and i32 %77, 1
  %83 = icmp eq i32 %82, 0
  %84 = and i32 %81, -2
  %85 = select i1 %83, i32 %84, i32 %81
  %86 = load %55*, %55** %13, align 8
  %87 = getelementptr inbounds %55, %55* %86, i64 %24, i32 4
