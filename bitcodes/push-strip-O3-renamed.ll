; ModuleID = 'push-strip-O3-renamed.bc'
...
616:                                              ; preds = %614
  ...
  br i1 %618, label %620, label %632

620:                                              ; preds = %616, %620
  %621 = phi i64 [ %630, %620 ], [ 0, %616 ]
  %622 = phi i32 [ %629, %620 ], [ 0, %616 ]
  %623 = getelementptr inbounds i8*, i8** %611, i64 %621
  %624 = load i8*, i8** %623, align 8
  %625 = call %47* @transport_get(%45* nonnull %478, i8* %624) #9
  %626 = call fastcc i32 @127(%47* %625, %5* %602, i32 %549) #9
  %627 = icmp ne i32 %626, 0
  %628 = zext i1 %627 to i32
  %629 = add nuw nsw i32 %622, %628
  %630 = add nuw nsw i64 %621, 1
  %631 = icmp eq i64 %630, %619
  br i1 %631, label %655, label %620

632:                                              ; preds = %616, %632
  %633 = phi i64 [ %643, %632 ], [ 0, %616 ]
  %634 = phi i32 [ %642, %632 ], [ 0, %616 ]
  %635 = getelementptr inbounds i8*, i8** %611, i64 %633
  %636 = load i8*, i8** %635, align 8
  %637 = call %47* @transport_get(%45* nonnull %478, i8* %636) #9
  %638 = getelementptr inbounds %47, %47* %637, i64 0, i32 6
  store %0* %306, %0** %638, align 8
  %639 = call fastcc i32 @127(%47* %637, %5* %602, i32 %549) #9
  %640 = icmp ne i32 %639, 0
  %641 = zext i1 %640 to i32
  %642 = add nuw nsw i32 %634, %641
  %643 = add nuw nsw i64 %633, 1
  %644 = icmp eq i64 %643, %619
  br i1 %644, label %655, label %632

645:                                              ; preds = %601
  %646 = call %47* @transport_get(%45* nonnull %478, i8* null) #9
  %647 = and i32 %549, 16384
  %648 = icmp eq i32 %647, 0
  br i1 %648, label %651, label %649

649:                                              ; preds = %645
  %650 = getelementptr inbounds %47, %47* %646, i64 0, i32 6
  store %0* %306, %0** %650, align 8
  br label %651

651:                                              ; preds = %649, %645
  %652 = call fastcc i32 @127(%47* %646, %5* %602, i32 %549) #9
  %653 = icmp ne i32 %652, 0
  %654 = zext i1 %653 to i32
  br label %655

655:                                              ; preds = %632, %620, %651, %614
  %656 = phi i32 [ %654, %651 ], [ 0, %614 ], [ %629, %620 ], [ %642, %632 ]
...
16:                                               ; preds = %12
  %17 = getelementptr %46, %46* %1, i64 0, i32 5
...
44:                                               ; preds = %36
  ...
  %49 = getelementptr %6, %6* %48, i64 0, i32 1
...
54:                                               ; preds = %51
  tail call fastcc void @129(i8* %50, %45* %0) #13
  unreachable
...
define internal fastcc void @129(i8* %0, %45* nocapture readonly %1) unnamed_addr #8 {
  br label %3

3:                                                ; preds = %8, %2
  %4 = phi i8* [ %0, %2 ], [ %9, %8 ]
  %5 = phi i8* [ getelementptr inbounds ([12 x i8], [12 x i8]* @101, i64 0, i64 0), %2 ], [ %11, %8 ]
...
13:                                               ; preds = %3, %8
  %14 = phi i8* [ %0, %8 ], [ %4, %3 ]
  %15 = load i32, i32* @push_default, align 4
  %16 = icmp eq i32 %15, 5
  br i1 %16, label %17, label %22

17:                                               ; preds = %13
  %18 = tail call i32 @use_gettext_poison() #9
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %20, label %22

20:                                               ; preds = %17
  %21 = tail call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([77 x i8], [77 x i8]* @110, i64 0, i64 0), i32 5) #9
  br label %22

22:                                               ; preds = %20, %17, %13
  %23 = phi i8* [ getelementptr inbounds ([1 x i8], [1 x i8]* @91, i64 0, i64 0), %13 ], [ %21, %20 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @92, i64 0, i64 0), %17 ]
  %24 = tail call fastcc i8* @126(i8* getelementptr inbounds ([251 x i8], [251 x i8]* @111, i64 0, i64 0))
  %25 = getelementptr inbounds %45, %45* %1, i64 0, i32 1
  %26 = load i8*, i8** %25, align 8
  tail call void (i8*, ...) @die(i8* %24, i8* %26, i8* %14, i8* %26, i8* %23) #10
  unreachable
}
