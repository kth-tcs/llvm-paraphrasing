; ModuleID = 'reflog-walk-strip-O2-renamed.bc'
...
77:                                               ; preds = %75
  call fastcc void @12(%35* %60)
  call void @free(i8* nonnull %59) #8
  %78 = load i8*, i8** %6, align 8
  %79 = call fastcc %35* @11(i8* %78)
  br label %80

80:                                               ; preds = %73, %77, %75
  %81 = phi %35* [ %60, %73 ], [ %79, %77 ], [ %60, %75 ]
  %82 = phi i8* [ %59, %73 ], [ %78, %77 ], [ %59, %75 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %68) #8
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %67) #8
  %83 = icmp eq %35* %81, null
  br i1 %83, label %88, label %84

84:                                               ; preds = %80
  %85 = getelementptr inbounds %35, %35* %81, i64 0, i32 3
  %86 = load i32, i32* %85, align 8
  %87 = icmp eq i32 %86, 0
  br i1 %87, label %88, label %89

88:                                               ; preds = %80, %84
  call fastcc void @12(%35* %81)
  call void @free(i8* %82) #8
  br label %160

89:                                               ; preds = %62, %84
  %90 = phi %35* [ %81, %84 ], [ %60, %62 ]
  %91 = phi i8* [ %82, %84 ], [ %59, %62 ]
  %92 = phi i32* [ %85, %84 ], [ %63, %62 ]
  %93 = call %21* @string_list_insert(%20* nonnull %43, i8* %91) #8
  %94 = getelementptr inbounds %21, %21* %93, i64 0, i32 1
  %95 = bitcast i8** %94 to %35**
  store %35* %90, %35** %95, align 8
  br label %96

96:                                               ; preds = %89, %46
  %97 = phi i32* [ %92, %89 ], [ %50, %46 ]
  %98 = phi %35* [ %90, %89 ], [ %49, %46 ]
  %99 = phi i8* [ %91, %89 ], [ %14, %46 ]
  call void @free(i8* %99) #8
  %100 = call i8* @xcalloc(i64 1, i64 16) #8
  %101 = icmp slt i32 %40, 0
  %102 = load i32, i32* %97, align 8
  br i1 %101, label %103, label %120

103:                                              ; preds = %96
  %104 = getelementptr inbounds %35, %35* %98, i64 0, i32 2
  %105 = sext i32 %102 to i64
  br label %106

106:                                              ; preds = %110, %103
  %107 = phi i64 [ %108, %110 ], [ %105, %103 ]
  %108 = add nsw i64 %107, -1
  %109 = icmp sgt i64 %107, 0
  br i1 %109, label %110, label %119

110:                                              ; preds = %106
  %111 = load %36*, %36** %104, align 8
  %112 = getelementptr inbounds %36, %36* %111, i64 %108, i32 3
  %113 = load i64, i64* %112, align 8
  %114 = icmp ugt i64 %113, %41
  br i1 %114, label %106, label %115

115:                                              ; preds = %110
  %116 = trunc i64 %108 to i32
  %117 = bitcast i8* %100 to i32*
  store i32 %116, i32* %117, align 8
  %118 = icmp slt i32 %116, 0
  br i1 %118, label %119, label %124

119:                                              ; preds = %106, %115
  call void @free(i8* nonnull %100) #8
  br label %160
...
124:                                              ; preds = %115, %120
  %125 = getelementptr inbounds i8, i8* %100, i64 4
  %126 = bitcast i8* %125 to i32*
  store i32 %42, i32* %126, align 4
  %127 = getelementptr inbounds i8, i8* %100, i64 8
  %128 = bitcast i8* %127 to %35**
  store %35* %98, %35** %128, align 8
  %129 = getelementptr inbounds %33, %33* %0, i64 0, i32 1
  %130 = load i64, i64* %129, align 8
  %131 = add i64 %130, 1
  %132 = getelementptr inbounds %33, %33* %0, i64 0, i32 2
  %133 = load i64, i64* %132, align 8
  %134 = icmp ugt i64 %131, %133
  br i1 %134, label %138, label %135

135:                                              ; preds = %124
  %136 = getelementptr inbounds %33, %33* %0, i64 0, i32 0
...
138:                                              ; preds = %124
  ...
  %144 = bitcast %33* %0 to i8**
  %145 = icmp ugt i64 %143, 2305843009213693951
  br i1 %145, label %146, label %147

146:                                              ; preds = %138
  call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @10, i64 0, i64 0), i64 8, i64 %143) #10
  unreachable

147:                                              ; preds = %138
  %148 = load i8*, i8** %144, align 8
  %149 = shl i64 %143, 3
  %150 = call i8* @xrealloc(i8* %148, i64 %149) #8
  store i8* %150, i8** %144, align 8
  %151 = bitcast i8* %150 to %34**
  %152 = load i64, i64* %129, align 8
  %153 = add i64 %152, 1
  br label %154

154:                                              ; preds = %135, %147
  %155 = phi i64 [ %131, %135 ], [ %153, %147 ]
  %156 = phi i64 [ %130, %135 ], [ %152, %147 ]
  %157 = phi %34** [ %137, %135 ], [ %151, %147 ]
  store i64 %155, i64* %129, align 8
  %158 = getelementptr inbounds %34*, %34** %157, i64 %156
  %159 = bitcast %34** %158 to i8**
  store i8* %100, i8** %159, align 8
  br label %160

160:                                              ; preds = %154, %119, %88
  %161 = phi i32 [ -1, %119 ], [ 0, %154 ], [ -1, %88 ]
  ret i32 %161
}
...
define internal fastcc %35* @11(i8* %0) unnamed_addr #0 {
  ...
  %6 = tail call i32 @for_each_reflog_ent(i8* %0, i32 (%5*, %5*, i8*, i64, i32, i8*, i8*)* nonnull @13, i8* %2) #8
...
14:                                               ; preds = %11
  %15 = tail call i32 @for_each_reflog_ent(i8* nonnull %12, i32 (%5*, %5*, i8*, i64, i32, i8*, i8*)* nonnull @13, i8* %2) #8
...
19:                                               ; preds = %16
  ...
  %21 = tail call i32 @for_each_reflog_ent(i8* %20, i32 (%5*, %5*, i8*, i64, i32, i8*, i8*)* nonnull @13, i8* nonnull %2) #8
...
24:                                               ; preds = %19
  ...
  %26 = tail call i32 @for_each_reflog_ent(i8* %25, i32 (%5*, %5*, i8*, i64, i32, i8*, i8*)* nonnull @13, i8* nonnull %2) #8
  br label %27
...
; Function Attrs: nounwind uwtable
define internal fastcc void @12(%35* %0) unnamed_addr #0 {
  %2 = icmp eq %35* %0, null
...
9:                                                ; preds = %3, %9
  %10 = phi i64 [ %17, %9 ], [ 0, %3 ]
  %11 = phi %36* [ %21, %9 ], [ %8, %3 ]
  %12 = getelementptr inbounds %36, %36* %11, i64 %10, i32 2
  %13 = load i8*, i8** %12, align 8
  tail call void @free(i8* %13) #8
  %14 = load %36*, %36** %7, align 8
  %15 = getelementptr inbounds %36, %36* %14, i64 %10, i32 5
...
22:                                               ; preds = %9, %3
  %23 = phi %36* [ %8, %3 ], [ %21, %9 ]
  %24 = getelementptr inbounds %36, %36* %23, i64 0, i32 0, i32 0, i64 0
  tail call void @free(i8* %24) #8
  %25 = getelementptr inbounds %35, %35* %0, i64 0, i32 0
  %26 = load i8*, i8** %25, align 8
  tail call void @free(i8* %26) #8
  %27 = bitcast %35* %0 to i8*
...
7:                                                ; preds = %5, %60
  ...
  %14 = getelementptr inbounds %34, %34* %13, i64 0, i32 0
  %15 = load i32, i32* %14, align 8
  %16 = icmp sgt i32 %15, -1
  br i1 %16, label %17, label %60

17:                                               ; preds = %7
  %18 = getelementptr inbounds %34, %34* %13, i64 0, i32 2
  br label %19
...
41:                                               ; preds = %38
  %42 = load %35*, %35** %18, align 8
  %43 = getelementptr inbounds %35, %35* %42, i64 0, i32 2
  %44 = load %36*, %36** %43, align 8
  %45 = load i32, i32* %14, align 8
  %46 = sext i32 %45 to i64
  %47 = getelementptr inbounds %36, %36* %44, i64 %46, i32 3
  %48 = load i64, i64* %47, align 8
  %49 = getelementptr inbounds %34, %34* %8, i64 0, i32 2
  %50 = load %35*, %35** %49, align 8
  %51 = getelementptr inbounds %35, %35* %50, i64 0, i32 2
  %52 = load %36*, %36** %51, align 8
  %53 = getelementptr inbounds %34, %34* %8, i64 0, i32 0
  %54 = load i32, i32* %53, align 8
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds %36, %36* %52, i64 %55, i32 3
...
; Function Attrs: nounwind uwtable
define internal i32 @13(%5* nocapture readonly %0, %5* nocapture readonly %1, i8* %2, i64 %3, i32 %4, i8* %5, i8* nocapture %6) #0 {
