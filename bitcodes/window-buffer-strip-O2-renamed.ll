; ModuleID = 'window-buffer-strip-O2-renamed.bc'
...
18:                                               ; preds = %6
  ...
  %22 = load i8*, i8** %21, align 8
  %23 = call %94* @paste_get_name(i8* %22) #7
...
95:                                               ; preds = %86
  ...
  br i1 %81, label %102, label %97

97:                                               ; preds = %95
  %98 = tail call i8* @format_expand(%88* %96, i8* nonnull %3) #7
  %99 = tail call i32 @format_true(i8* %98) #7
...
102:                                              ; preds = %97, %95
  ...
  %104 = tail call i8* @format_expand(%88* %96, i8* %103) #7
  %105 = load %91*, %91** %85, align 8
  %106 = bitcast %92* %90 to i8*
  %107 = getelementptr inbounds %92, %92* %90, i64 0, i32 1
  %108 = load i32, i32* %107, align 8
  %109 = zext i32 %108 to i64
  %110 = load i8*, i8** %91, align 8
  %111 = tail call %99* @mode_tree_add(%91* %105, %99* null, i8* %106, i64 %109, i8* %110, i8* %104, i32 -1) #7
  tail call void @free(i8* %104) #7
  tail call void @format_free(%88* %96) #7
  br label %112

112:                                              ; preds = %86, %102, %101
