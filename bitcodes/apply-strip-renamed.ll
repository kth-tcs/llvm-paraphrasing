; ModuleID = 'apply-strip-renamed.bc'
...
define dso_local i32 @cmd_apply(i32 %0, i8** %1, i8* %2) #0 {
  ...
  %14 = bitcast %32* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 328, i8* %14) #4
  %15 = load %0*, %0** @the_repository, align 8
  %16 = load i8*, i8** %6, align 8
  %17 = call i32 @init_apply_state(%32* %10, %0* %15, i8* %16)
  %18 = icmp ne i32 %17, 0
  br i1 %18, label %19, label %21

19:                                               ; preds = %3
  %20 = call i32 @trace2_cmd_exit_fl(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @0, i32 0, i32 0), i32 20, i32 128)
  call void @exit(i32 %20) #5
  unreachable

21:                                               ; preds = %3
  %22 = load i32, i32* %4, align 4
  %23 = load i8**, i8*** %5, align 8
  %24 = call i32 @apply_parse_options(i32 %22, i8** %23, %32* %10, i32* %7, i32* %8, i8** getelementptr inbounds ([2 x i8*], [2 x i8*]* @1, i32 0, i32 0))
  store i32 %24, i32* %4, align 4
  %25 = load i32, i32* %7, align 4
  %26 = call i32 @check_apply_state(%32* %10, i32 %25)
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %28, label %30

28:                                               ; preds = %21
  %29 = call i32 @trace2_cmd_exit_fl(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @0, i32 0, i32 0), i32 27, i32 128)
  call void @exit(i32 %29) #5
  unreachable
...
30:                                               ; preds = %21
  ...
  %34 = call i32 @apply_all_patches(%32* %10, i32 %31, i8** %32, i32 %33)
  store i32 %34, i32* %9, align 4
  call void @clear_apply_state(%32* %10)
  %35 = load i32, i32* %9, align 4
  %36 = bitcast %32* %10 to i8*
  call void @llvm.lifetime.end.p0i8(i64 328, i8* %36) #4
...
declare dso_local i32 @init_apply_state(%32*, %0*, i8*) #2
...
declare dso_local i32 @apply_parse_options(i32, i8**, %32*, i32*, i32*, i8**) #2

declare dso_local i32 @check_apply_state(%32*, i32) #2

declare dso_local i32 @apply_all_patches(%32*, i32, i8**, i32) #2

declare dso_local void @clear_apply_state(%32*) #2
