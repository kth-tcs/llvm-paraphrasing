; ModuleID = 'ref-cache-strip-O2-renamed.bc'
...
10:                                               ; preds = %6, %109
  %11 = phi %33* [ %0, %6 ], [ %93, %109 ]
  %12 = phi i8* [ %4, %6 ], [ %111, %109 ]
  %13 = ptrtoint i8* %12 to i64
  %14 = sub i64 %13, %7
  %15 = add nsw i64 %14, 1
  br i1 %8, label %62, label %16

16:                                               ; preds = %10
  %17 = getelementptr inbounds %33, %33* %11, i64 0, i32 0
  %18 = load i32, i32* %17, align 8
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %62, label %20

20:                                               ; preds = %16
  tail call fastcc void @11(%33* nonnull %11) #10
  %21 = getelementptr inbounds %33, %33* %11, i64 0, i32 4
  %22 = bitcast %35*** %21 to i8**
  %23 = load i8*, i8** %22, align 8
  %24 = load i32, i32* %17, align 8
  %25 = icmp eq i32 %24, 0
  %26 = bitcast i8* %23 to %35**
...
29:                                               ; preds = %53, %27
  %30 = phi i64 [ %55, %53 ], [ 0, %27 ]
  %31 = phi i64 [ %54, %53 ], [ %28, %27 ]
  %32 = add i64 %31, %30
  %33 = lshr i64 %32, 1
  %34 = shl i64 %33, 3
  ...
  %38 = getelementptr inbounds %35, %35* %37, i64 0, i32 2, i64 0
  %39 = tail call i32 @strncmp(i8* nonnull %1, i8* nonnull %38, i64 %15) #11
  %40 = icmp eq i32 %39, 0
  br i1 %40, label %41, label %46

41:                                               ; preds = %29
  %42 = getelementptr inbounds %35, %35* %37, i64 0, i32 2, i64 %15
...
53:                                               ; preds = %51, %46
  %54 = phi i64 [ %31, %51 ], [ %33, %46 ]
  %55 = phi i64 [ %52, %51 ], [ %30, %46 ]
  %56 = icmp ult i64 %55, %54
  br i1 %56, label %29, label %62

57:                                               ; preds = %49
  %58 = icmp eq i8* %35, null
  %59 = trunc i64 %33 to i32
  %60 = icmp eq i32 %59, -1
  %61 = or i1 %60, %58
  br i1 %61, label %62, label %79

62:                                               ; preds = %53, %57, %20, %16, %10
  br i1 %9, label %113, label %63

63:                                               ; preds = %62
  %64 = getelementptr inbounds %33, %33* %11, i64 0, i32 3
  %65 = bitcast %34** %64 to i64*
  %66 = load i64, i64* %65, align 8
  %67 = icmp ugt i64 %15, -41
  br i1 %67, label %68, label %69

68:                                               ; preds = %63
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @6, i64 0, i64 0), i64 40, i64 %15) #9
  unreachable

69:                                               ; preds = %63
  %70 = icmp eq i64 %15, -41
...
72:                                               ; preds = %69
  %73 = add i64 %14, 42
  %74 = tail call i8* @xcalloc(i64 1, i64 %73) #10
  %75 = bitcast i8* %74 to %35*
  %76 = getelementptr inbounds i8, i8* %74, i64 40
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %76, i8* align 1 %1, i64 %15, i1 false) #10
  %77 = getelementptr inbounds i8, i8* %74, i64 24
  %78 = bitcast i8* %77 to i64*
  store i64 %66, i64* %78, align 8
  store i8 16, i8* %74, align 8
  tail call void @add_entry_to_dir(%33* nonnull %11, %35* %75) #10
  br label %84

79:                                               ; preds = %57
  %80 = shl i64 %33, 32
  %81 = ashr exact i64 %80, 32
  %82 = getelementptr inbounds %35*, %35** %26, i64 %81
  %83 = load %35*, %35** %82, align 8
  br label %84

84:                                               ; preds = %79, %72
  %85 = phi %35* [ %75, %72 ], [ %83, %79 ]
...
92:                                               ; preds = %84
  %93 = getelementptr inbounds %35, %35* %85, i64 0, i32 1, i32 0
  %94 = and i32 %88, 32
  %95 = icmp eq i32 %94, 0
  br i1 %95, label %109, label %96

96:                                               ; preds = %92
  %97 = getelementptr inbounds %35, %35* %85, i64 0, i32 1, i32 0, i32 3
  %98 = load %34*, %34** %97, align 8
  %99 = getelementptr inbounds %34, %34* %98, i64 0, i32 2
  %100 = load void (%6*, %33*, i8*)*, void (%6*, %33*, i8*)** %99, align 8
  %101 = icmp eq void (%6*, %33*, i8*)* %100, null
...
103:                                              ; preds = %96
  %104 = getelementptr inbounds %34, %34* %98, i64 0, i32 1
  %105 = load %6*, %6** %104, align 8
  %106 = getelementptr inbounds %35, %35* %85, i64 0, i32 2, i64 0
  tail call void %100(%6* %105, %33* nonnull %93, i8* nonnull %106) #10
...
109:                                              ; preds = %92, %103
  %110 = getelementptr inbounds i8, i8* %12, i64 1
  %111 = tail call i8* @strchr(i8* nonnull %110, i32 47) #11
  %112 = icmp eq i8* %111, null
  br i1 %112, label %113, label %10

113:                                              ; preds = %109, %62, %3
  %114 = phi %33* [ %0, %3 ], [ null, %62 ], [ %93, %109 ]
  ret %33* %114
}
...
9:                                                ; preds = %6, %103
  %10 = phi i64 [ 0, %6 ], [ %104, %103 ]
  %11 = load %35**, %35*** %7, align 8
  %12 = getelementptr inbounds %35*, %35** %11, i64 %10
  %13 = load %35*, %35** %12, align 8
  %14 = getelementptr inbounds %35, %35* %13, i64 0, i32 0
  %15 = load i8, i8* %14, align 8
  %16 = and i8 %15, 16
  %17 = icmp eq i8 %16, 0
...
24:                                               ; preds = %19
  %25 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0
  %26 = and i32 %20, 32
  %27 = icmp eq i32 %26, 0
  br i1 %27, label %41, label %28

28:                                               ; preds = %24
  %29 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0, i32 3
  %30 = load %34*, %34** %29, align 8
  %31 = getelementptr inbounds %34, %34* %30, i64 0, i32 2
  %32 = load void (%6*, %33*, i8*)*, void (%6*, %33*, i8*)** %31, align 8
  %33 = icmp eq void (%6*, %33*, i8*)* %32, null
...
35:                                               ; preds = %28
  %36 = getelementptr inbounds %34, %34* %30, i64 0, i32 1
  %37 = load %6*, %6** %36, align 8
  %38 = getelementptr inbounds %35, %35* %13, i64 0, i32 2, i64 0
  tail call void %32(%6* %37, %33* nonnull %25, i8* nonnull %38) #10
...
41:                                               ; preds = %24, %35
  tail call fastcc void @13(%33* nonnull %25, i8* null)
  br label %103

42:                                               ; preds = %18
  %43 = getelementptr inbounds %35, %35* %13, i64 0, i32 2, i64 0
  %44 = load i8, i8* %1, align 1
  %45 = icmp eq i8 %44, 0
  br i1 %45, label %59, label %46

46:                                               ; preds = %42, %52
  %47 = phi i8 [ %55, %52 ], [ %44, %42 ]
  %48 = phi i8* [ %54, %52 ], [ %1, %42 ]
...
52:                                               ; preds = %46
  ...
  %56 = icmp eq i8 %55, 0
  br i1 %56, label %59, label %46

57:                                               ; preds = %46
  %58 = icmp eq i8 %50, 0
  br i1 %58, label %81, label %103
...
64:                                               ; preds = %59
  %65 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0
  %66 = and i32 %60, 32
  %67 = icmp eq i32 %66, 0
  br i1 %67, label %80, label %68

68:                                               ; preds = %64
  %69 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0, i32 3
  %70 = load %34*, %34** %69, align 8
  %71 = getelementptr inbounds %34, %34* %70, i64 0, i32 2
  %72 = load void (%6*, %33*, i8*)*, void (%6*, %33*, i8*)** %71, align 8
  %73 = icmp eq void (%6*, %33*, i8*)* %72, null
...
75:                                               ; preds = %68
  %76 = getelementptr inbounds %34, %34* %70, i64 0, i32 1
  %77 = load %6*, %6** %76, align 8
  tail call void %72(%6* %77, %33* nonnull %65, i8* nonnull %43) #10
...
80:                                               ; preds = %64, %75
  tail call fastcc void @13(%33* nonnull %65, i8* null)
  br label %103

81:                                               ; preds = %57
  %82 = zext i8 %15 to i32
  %83 = and i32 %82, 16
  %84 = icmp eq i32 %83, 0
...
86:                                               ; preds = %81
  %87 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0
  %88 = and i32 %82, 32
  %89 = icmp eq i32 %88, 0
  br i1 %89, label %102, label %90

90:                                               ; preds = %86
  %91 = getelementptr inbounds %35, %35* %13, i64 0, i32 1, i32 0, i32 3
  %92 = load %34*, %34** %91, align 8
  %93 = getelementptr inbounds %34, %34* %92, i64 0, i32 2
  %94 = load void (%6*, %33*, i8*)*, void (%6*, %33*, i8*)** %93, align 8
  %95 = icmp eq void (%6*, %33*, i8*)* %94, null
...
97:                                               ; preds = %90
  %98 = getelementptr inbounds %34, %34* %92, i64 0, i32 1
  %99 = load %6*, %6** %98, align 8
  tail call void %94(%6* %99, %33* nonnull %87, i8* nonnull %43) #10
...
102:                                              ; preds = %86, %97
  tail call fastcc void @13(%33* nonnull %87, i8* nonnull %1)
  br label %103

103:                                              ; preds = %57, %9, %41, %102, %80
  %104 = add nuw nsw i64 %10, 1
  %105 = load i32, i32* %3, align 8
  %106 = sext i32 %105 to i64
  %107 = icmp slt i64 %104, %106
  br i1 %107, label %9, label %108
