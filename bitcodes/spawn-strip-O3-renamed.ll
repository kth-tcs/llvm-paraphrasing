; ModuleID = 'spawn-strip-O3-renamed.bc'
...
11:                                               ; preds = %3
  ...
  %13 = bitcast %2* %12 to %3*
  call void @uv_mutex_lock(%3* nonnull %13) #7
  %14 = getelementptr inbounds %2, %2* %8, i64 5, i32 1
...
22:                                               ; preds = %19, %22
  call void @uv_cond_wait(%6* nonnull %21, %3* nonnull %13) #7
...
26:                                               ; preds = %22, %11
  call void @uv_mutex_unlock(%3* nonnull %13) #7
  call void @uv_mutex_lock(%3* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 1)) #7
  %27 = load volatile i32, i32* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 3), align 8
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %30

29:                                               ; preds = %26
  call void @__assert_fail(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @7, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @1, i64 0, i64 0), i32 129, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @8, i64 0, i64 0)) #8
  unreachable

30:                                               ; preds = %26
  %31 = call %2* @avl_remove(%1* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 0), %2* nonnull %8) #7
  %32 = icmp eq %2* %31, null
  br i1 %32, label %33, label %34

33:                                               ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @1, i64 0, i64 0), i32 132, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @8, i64 0, i64 0)) #8
  unreachable

34:                                               ; preds = %30
  %35 = add i32 %27, -1
  store volatile i32 %35, i32* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 3), align 8
  call void @uv_cond_signal(%6* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 2)) #7
  call void @uv_mutex_unlock(%3* getelementptr inbounds (%0, %0* @spawn_cmd_queue, i64 0, i32 1)) #7
  %36 = getelementptr inbounds %2, %2* %8, i64 5, i32 0, i64 1
  %37 = bitcast %2** %36 to i32*
  %38 = load i32, i32* %37, align 8
  store i32 %38, i32* %1, align 4
  %39 = getelementptr inbounds %2, %2* %8, i64 6
  %40 = bitcast %2* %39 to i64*
  %41 = load i64, i64* %40, align 8
  store i64 %41, i64* %2, align 8
  %42 = getelementptr inbounds %2, %2* %8, i64 2, i32 1
  %43 = bitcast i8* %42 to %6*
  call void @uv_cond_destroy(%6* nonnull %43) #7
  call void @uv_mutex_destroy(%3* nonnull %13) #7
  %44 = getelementptr inbounds %2, %2* %8, i64 5
  %45 = bitcast %2* %44 to i8**
  %46 = load i8*, i8** %45, align 8
  call void @freez(i8* %46) #7
  %47 = bitcast %2* %8 to i8*
  call void @freez(i8* %47) #7
