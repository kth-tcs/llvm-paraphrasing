; ModuleID = 'input-keys-strip-O2-renamed.bc'
...
74:                                               ; preds = %68, %97
  %75 = phi i64 [ 0, %68 ], [ %98, %97 ]
  %76 = add nsw i64 %75, -45
...
78:                                               ; preds = %74
  ...
  %80 = and i32 %79, 8
  %81 = icmp eq i32 %80, 0
  br i1 %81, label %97, label %89

82:                                               ; preds = %74
  %83 = add nsw i64 %75, -29
...
89:                                               ; preds = %78, %85, %82
  %90 = getelementptr inbounds [77 x %1], [77 x %1]* @4, i64 0, i64 %75, i32 0
  %91 = load i64, i64* %90, align 8
  %92 = or i64 %91, 17592186044416
  %93 = icmp eq i64 %92, %69
  %94 = and i1 %93, %73
  %95 = icmp eq i64 %91, %69
  %96 = or i1 %94, %95
  br i1 %96, label %104, label %97

97:                                               ; preds = %89, %85, %78
  %98 = add nuw nsw i64 %75, 1
  %99 = icmp ult i64 %98, 77
...
104:                                              ; preds = %89, %100
  %105 = getelementptr inbounds [77 x %1], [77 x %1]* @4, i64 0, i64 %75, i32 1
  %106 = load i8*, i8** %105, align 8
  %107 = tail call i64 @strlen(i8* %106) #6
  tail call void (i8*, ...) @log_debug(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @6, i64 0, i64 0), i64 %69, i8* %106) #5
  br i1 %72, label %110, label %108

108:                                              ; preds = %104
  %109 = tail call i32 @bufferevent_write(%34* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i64 0, i64 0), i64 1) #5
  br label %110

110:                                              ; preds = %104, %108
  %111 = tail call i32 @bufferevent_write(%34* %2, i8* %106, i64 %107) #5
  br label %112

112:                                              ; preds = %39, %4, %110, %103, %65, %48, %34, %13
  %113 = phi i32 [ 0, %13 ], [ 0, %34 ], [ 0, %48 ], [ 0, %65 ], [ -1, %103 ], [ 0, %110 ], [ 0, %4 ], [ -1, %39 ]
