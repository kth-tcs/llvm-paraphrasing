; ModuleID = 'lolwut5-strip-O3-renamed.bc'
...
23:                                               ; preds = %82, %19
  %24 = phi i32 [ 0, %19 ], [ %83, %82 ]
  br i1 %20, label %25, label %82
...
33:                                               ; preds = %25, %33
  %34 = phi i32 [ %79, %33 ], [ 0, %25 ]
  %35 = sitofp i32 %34 to float
  %36 = fmul float %11, %35
  %37 = fadd float %21, %36
  %38 = fadd float %37, %22
  %39 = fptosi float %38 to i32
  %40 = tail call i32 @rand() #5
  ...
  %56 = and i32 %55, 1
  %57 = icmp eq i32 %56, 0
  %58 = fsub float -0.000000e+00, %44
  %59 = select i1 %57, float %44, float %58
  ...
  tail call void @lwDrawSquare(%0* %17, i32 %74, i32 %78, float %11, float %59, i32 1) #5
  %79 = add nuw nsw i32 %34, 1
  %80 = icmp eq i32 %79, %1
  br i1 %80, label %82, label %33
...
82:                                               ; preds = %85, %33, %23
  ...
  %84 = icmp eq i32 %83, %2
  br i1 %84, label %81, label %23

85:                                               ; preds = %25, %85
  %86 = phi i32 [ %92, %85 ], [ 0, %25 ]
  %87 = sitofp i32 %86 to float
  %88 = fmul float %11, %87
  %89 = fadd float %21, %88
  %90 = fadd float %89, %22
  %91 = fptosi float %90 to i32
  tail call void @lwDrawSquare(%0* %17, i32 %91, i32 %30, float %11, float 0.000000e+00, i32 1) #5
  %92 = add nuw nsw i32 %86, 1
  %93 = icmp eq i32 %92, %1
  br i1 %93, label %82, label %85
}
