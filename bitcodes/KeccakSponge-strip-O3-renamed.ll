; ModuleID = 'KeccakSponge-strip-O3-renamed.bc'
...
19:                                               ; preds = %12, %45
  %20 = phi i8* [ %47, %45 ], [ %1, %12 ]
  %21 = phi i64 [ %46, %45 ], [ 0, %12 ]
...
28:                                               ; preds = %19
  %29 = tail call i64 @KeccakF1600_FastLoop_Absorb(i8* nonnull %15, i32 %18, i8* %20, i64 %27) #3
  %30 = add i64 %29, %21
  %31 = getelementptr inbounds i8, i8* %20, i64 %29
  br label %45
...
32:                                               ; preds = %19
  ...
  %39 = add i64 %21, %38
  tail call void @KeccakP1600_AddBytes(i8* nonnull %15, i8* %20, i32 %22, i32 %37) #3
...
45:                                               ; preds = %44, %32, %28
  %46 = phi i64 [ %30, %28 ], [ %39, %44 ], [ %39, %32 ]
  %47 = phi i8* [ %31, %28 ], [ %40, %44 ], [ %40, %32 ]
  %48 = icmp ult i64 %46, %2
  br i1 %48, label %19, label %87

49:                                               ; preds = %12, %83
  %50 = phi i8* [ %85, %83 ], [ %1, %12 ]
  %51 = phi i64 [ %84, %83 ], [ 0, %12 ]
...
58:                                               ; preds = %49
  %59 = icmp ult i64 %57, %14
  br i1 %59, label %66, label %60

60:                                               ; preds = %58, %60
  %61 = phi i8* [ %63, %60 ], [ %50, %58 ]
  %62 = phi i64 [ %64, %60 ], [ %57, %58 ]
  tail call void @KeccakP1600_AddBytes(i8* %15, i8* %61, i32 0, i32 %6) #3
  tail call void @KeccakP1600_Permute_24rounds(i8* %15) #3
  %63 = getelementptr inbounds i8, i8* %61, i64 %14
  %64 = sub i64 %62, %14
  %65 = icmp ult i64 %64, %14
  br i1 %65, label %66, label %60

66:                                               ; preds = %60, %58
  %67 = phi i64 [ %57, %58 ], [ %64, %60 ]
  %68 = phi i8* [ %50, %58 ], [ %63, %60 ]
  %69 = sub i64 %2, %67
  br label %83
...
70:                                               ; preds = %49
  ...
  %77 = add i64 %51, %76
  tail call void @KeccakP1600_AddBytes(i8* nonnull %15, i8* %50, i32 %52, i32 %75) #3
  %78 = getelementptr inbounds i8, i8* %50, i64 %76
...
83:                                               ; preds = %70, %82, %66
  %84 = phi i64 [ %69, %66 ], [ %77, %82 ], [ %77, %70 ]
  %85 = phi i8* [ %68, %66 ], [ %78, %82 ], [ %78, %70 ]
  %86 = icmp ult i64 %84, %2
  br i1 %86, label %49, label %87

87:                                               ; preds = %83, %45, %10, %3
  %88 = phi i32 [ 1, %3 ], [ 0, %10 ], [ 0, %45 ], [ 0, %83 ]
  ret i32 %88
}
