; ModuleID = 'math-strip-O3-renamed.bc'
...
127:                                              ; preds = %123
  %128 = sub i64 0, %5
  br i1 %43, label %129, label %146

129:                                              ; preds = %127, %144
  %130 = phi i32 [ %136, %144 ], [ 0, %127 ]
  %131 = phi i8* [ %145, %144 ], [ %125, %127 ]
  %132 = phi i8* [ %133, %144 ], [ %124, %127 ]
  ...
  %139 = icmp ult i8* %133, %19
  %140 = or i1 %139, %138
  br i1 %140, label %144, label %141

141:                                              ; preds = %129
  %142 = getelementptr inbounds i8, i8* %135, i64 %128
  %143 = getelementptr inbounds i8, i8* %142, i64 1
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %143, i8* nonnull align 1 %4, i64 %5, i1 false)
  br label %144

144:                                              ; preds = %141, %129
  %145 = phi i8* [ %142, %141 ], [ %135, %129 ]
  br i1 %139, label %153, label %129

146:                                              ; preds = %127, %146
  %147 = phi i8* [ %151, %146 ], [ %125, %127 ]
  %148 = phi i8* [ %149, %146 ], [ %124, %127 ]
  %149 = getelementptr inbounds i8, i8* %148, i64 -1
  %150 = load i8, i8* %148, align 1
  %151 = getelementptr inbounds i8, i8* %147, i64 -1
  store i8 %150, i8* %147, align 1
  %152 = icmp ult i8* %149, %19
  br i1 %152, label %153, label %146

153:                                              ; preds = %146, %144, %123
  %154 = phi i8* [ %125, %123 ], [ %145, %144 ], [ %151, %146 ]
...
156:                                              ; preds = %155, %153
  store i64 %69, i64* %80, align 8
  %157 = getelementptr inbounds %0, %0* %13, i64 0, i32 0, i32 1
...
163:                                              ; preds = %156
  %164 = getelementptr inbounds %0, %0* %13, i64 0, i32 0, i32 0
...
168:                                              ; preds = %163
  ...
  %171 = bitcast %0* %13 to i8*
  br i1 %170, label %173, label %172

172:                                              ; preds = %168
  tail call void @free(i8* %171) #12
  br label %174

173:                                              ; preds = %168
  tail call void @_efree(i8* %171) #12
  br label %174

174:                                              ; preds = %173, %172, %163, %156, %15, %6
  %175 = phi %0* [ null, %6 ], [ %13, %15 ], [ %73, %156 ], [ %73, %163 ], [ %73, %172 ], [ %73, %173 ]
  ret %0* %175
}
