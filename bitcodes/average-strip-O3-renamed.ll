; ModuleID = 'average-strip-O3-renamed.bc'
...
define dso_local noalias nonnull i8* @grouping_create_average(%0* nocapture readnone %0) local_unnamed_addr #0 {
...
define dso_local void @grouping_reset_average(%0* nocapture readonly %0) local_unnamed_addr #2 {
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_free_average(%0* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 8
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_add_average(%0* nocapture readonly %0, x86_fp80 %1) local_unnamed_addr #0 {
...
; Function Attrs: norecurse nounwind uwtable
define dso_local x86_fp80 @grouping_flush_average(%0* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #2 {
...
13:                                               ; preds = %2
  %14 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 1
...
17:                                               ; preds = %13
  ...
  %20 = and i32 %19, 4
  %21 = icmp eq i32 %20, 0
  %22 = getelementptr inbounds %38, %38* %5, i64 0, i32 0
  %23 = load x86_fp80, x86_fp80* %22, align 16
  br i1 %21, label %30, label %24

24:                                               ; preds = %17
  %25 = uitofp i64 %7 to x86_fp80
  %26 = fdiv x86_fp80 %23, %25
  %27 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 2
  %28 = load x86_fp80, x86_fp80* %27, align 16
  %29 = fdiv x86_fp80 %26, %28
  br label %39

30:                                               ; preds = %17
  %31 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 2
  %32 = load x86_fp80, x86_fp80* %31, align 16
  %33 = fdiv x86_fp80 %23, %32
  br label %39

34:                                               ; preds = %13
  %35 = getelementptr inbounds %38, %38* %5, i64 0, i32 0
  %36 = load x86_fp80, x86_fp80* %35, align 16
  %37 = uitofp i64 %7 to x86_fp80
  %38 = fdiv x86_fp80 %36, %37
  br label %39

39:                                               ; preds = %34, %30, %24, %9
  %40 = phi x86_fp80* [ %35, %34 ], [ %22, %30 ], [ %22, %24 ], [ %12, %9 ]
  %41 = phi x86_fp80 [ %38, %34 ], [ %33, %30 ], [ %29, %24 ], [ 0xK00000000000000000000, %9 ]
