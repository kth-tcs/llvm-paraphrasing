; ModuleID = 'domlocator-strip-O2-renamed.bc'
...
@php_dom_domlocator_class_functions = hidden local_unnamed_addr constant [1 x %0] zeroinitializer, align 16

; Function Attrs: nounwind uwtable
define hidden i32 @dom_domlocator_line_number_read(%2* nocapture readnone %0, %10* nocapture %1) local_unnamed_addr #0 {
...
; Function Attrs: nounwind uwtable
define hidden i32 @dom_domlocator_column_number_read(%2* nocapture readnone %0, %10* nocapture %1) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @_emalloc(i64 32) #2
  %4 = bitcast i8* %3 to i32*
  store i32 1, i32* %4, align 8
  %5 = getelementptr inbounds i8, i8* %3, i64 4
...
; Function Attrs: nounwind uwtable
define hidden i32 @dom_domlocator_offset_read(%2* nocapture readnone %0, %10* nocapture %1) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @_emalloc(i64 32) #2
  %4 = bitcast i8* %3 to i32*
  store i32 1, i32* %4, align 8
  %5 = getelementptr inbounds i8, i8* %3, i64 4
...
; Function Attrs: nounwind uwtable
define hidden i32 @dom_domlocator_related_node_read(%2* nocapture readnone %0, %10* nocapture %1) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @_emalloc(i64 32) #2
  %4 = bitcast i8* %3 to i32*
  store i32 1, i32* %4, align 8
  %5 = getelementptr inbounds i8, i8* %3, i64 4
...
; Function Attrs: nounwind uwtable
define hidden i32 @dom_domlocator_uri_read(%2* nocapture readnone %0, %10* nocapture %1) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @_emalloc(i64 32) #2
  %4 = bitcast i8* %3 to i32*
  store i32 1, i32* %4, align 8
  %5 = getelementptr inbounds i8, i8* %3, i64 4
