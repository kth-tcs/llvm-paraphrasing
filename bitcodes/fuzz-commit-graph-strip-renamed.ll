; ModuleID = 'fuzz-commit-graph-strip-renamed.bc'
...
define dso_local i32 @LLVMFuzzerTestOneInput(i8* %0, i64 %1) #0 {
  ...
  %9 = call %9* @parse_commit_graph(i8* %7, i64 %8)
  store %9* %9, %9** %5, align 8
  %10 = load %0*, %0** @the_repository, align 8
  call void @repo_clear(%0* %10)
...
declare dso_local %9* @parse_commit_graph(i8*, i64) #2
