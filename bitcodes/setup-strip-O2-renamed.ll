; ModuleID = 'setup-strip-O2-renamed.bc'
...
4:                                                ; preds = %2
  %5 = tail call i64 @strlen(i8* nonnull %0) #12
  %6 = trunc i64 %5 to i32
  br label %7

7:                                                ; preds = %2, %4
  %8 = phi i32 [ %6, %4 ], [ 0, %2 ]
  %9 = tail call i8* @prefix_path_gently(i8* %0, i32 %8, i32* null, i8* %1)
...
51:                                               ; preds = %14, %19, %25, %43, %47, %36, %6
  %52 = tail call i32 @98(i8* %0, i8* %1, i8* %2)
  br label %53

53:                                               ; preds = %51, %34
  %54 = phi i32 [ %52, %51 ], [ -1, %34 ]
  ret i32 %54
}
