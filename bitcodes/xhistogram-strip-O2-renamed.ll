; ModuleID = 'xhistogram-strip-O2-renamed.bc'
...
598:                                              ; preds = %596
  %599 = bitcast %1* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %599) #5
  %600 = getelementptr inbounds %1, %1* %0, i64 0, i32 0
  %601 = load i64, i64* %600, align 8
  %602 = and i64 %601, -49153
  ...
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %599) #5
  br label %700
