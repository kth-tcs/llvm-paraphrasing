; ModuleID = 'attr-strip-O2-renamed.bc'
...
357:                                              ; preds = %428, %348
  %358 = phi %15* [ %309, %348 ], [ %431, %428 ]
  %359 = phi i32 [ %281, %348 ], [ %429, %428 ]
...
374:                                              ; preds = %421, %370
  %375 = phi i64 [ %373, %370 ], [ %427, %421 ]
  %376 = phi i32 [ %366, %370 ], [ %423, %421 ]
  %377 = phi i32 [ %359, %370 ], [ %422, %421 ]
...
384:                                              ; preds = %374
  ...
  br i1 %349, label %394, label %391

391:                                              ; preds = %384
  %392 = load i8, i8* %353, align 1
...
394:                                              ; preds = %391, %384
  ...
  %397 = getelementptr inbounds %11, %11* %380, i64 0, i32 0, i32 0, i32 3
...
405:                                              ; preds = %402
  %406 = sext i1 %395 to i32
  %407 = add i32 %356, %406
  %408 = getelementptr inbounds %11, %11* %380, i64 0, i32 0, i32 0, i32 1
  %409 = load i32, i32* %408, align 8
  %410 = call i32 @match_basename(i8* %355, i32 %407, i8* %388, i32 %390, i32 %409, i32 %398) #5
  br label %416

411:                                              ; preds = %402
  %412 = sub nsw i32 %23, %396
  %413 = getelementptr inbounds %11, %11* %380, i64 0, i32 0, i32 0, i32 1
  %414 = load i32, i32* %413, align 8
  %415 = call i32 @match_pathname(i8* %1, i32 %412, i8* %363, i32 %386, i8* %388, i32 %390, i32 %414, i32 %398) #5
  br label %416

416:                                              ; preds = %411, %405
  %417 = phi i32 [ %410, %405 ], [ %415, %411 ]
  %418 = icmp eq i32 %417, 0
  br i1 %418, label %421, label %419

419:                                              ; preds = %416
  %420 = call fastcc i32 @51(%10* %284, %11* nonnull %380, i32 %377) #5
  br label %421

421:                                              ; preds = %419, %416, %394, %374
  %422 = phi i32 [ %377, %374 ], [ %420, %419 ], [ %377, %416 ], [ %377, %394 ]
  %423 = add i32 %376, -1
  %424 = icmp sgt i32 %422, 0
  %425 = icmp sgt i32 %423, -1
  %426 = and i1 %425, %424
  %427 = add nsw i64 %375, -1
  br i1 %426, label %374, label %428

428:                                              ; preds = %421, %357
  %429 = phi i32 [ %359, %357 ], [ %422, %421 ]
  %430 = getelementptr inbounds %15, %15* %358, i64 0, i32 0
  %431 = load %15*, %15** %430, align 8
  %432 = icmp sgt i32 %429, 0
  %433 = icmp ne %15* %431, null
  %434 = and i1 %432, %433
  br i1 %434, label %357, label %435

435:                                              ; preds = %428, %308, %347
  ret void
}
...
6:                                                ; preds = %3
  %7 = tail call fastcc %15* @50(%22* %0, i8* %1, i32 %2)
  br label %23

8:                                                ; preds = %3
  %9 = tail call i32 @is_bare_repository() #5
  %10 = icmp eq i32 %9, 0
...
13:                                               ; preds = %11
  %14 = tail call fastcc %15* @50(%22* %0, i8* %1, i32 %2)
  %15 = icmp eq %15* %14, null
  br i1 %15, label %16, label %29

16:                                               ; preds = %13
  %17 = tail call fastcc %15* @47(i8* %1, i32 %2)
  br label %23

18:                                               ; preds = %11
  %19 = tail call fastcc %15* @47(i8* %1, i32 %2)
  %20 = icmp eq %15* %19, null
  br i1 %20, label %21, label %29

21:                                               ; preds = %18
  %22 = tail call fastcc %15* @50(%22* %0, i8* %1, i32 %2)
  br label %23

23:                                               ; preds = %21, %16, %6
  %24 = phi %15* [ %7, %6 ], [ %17, %16 ], [ %22, %21 ]
  %25 = icmp eq %15* %24, null
  br i1 %25, label %26, label %29

26:                                               ; preds = %11, %8, %23
  %27 = tail call i8* @xcalloc(i64 1, i64 40) #5
  %28 = bitcast i8* %27 to %15*
  br label %29

29:                                               ; preds = %18, %13, %23, %26
  %30 = phi %15* [ %24, %23 ], [ %28, %26 ], [ %19, %18 ], [ %14, %13 ]
  ret %15* %30
}
...
; Function Attrs: nounwind uwtable
define internal fastcc %15* @50(%22* %0, i8* %1, i32 %2) unnamed_addr #1 {
  %4 = icmp eq %22* %0, null
  br i1 %4, label %25, label %5

5:                                                ; preds = %3
  %6 = tail call i8* @read_blob_data_from_index(%22* nonnull %0, i8* %1, i64* null) #5
  %7 = icmp eq i8* %6, null
...
13:                                               ; preds = %8, %13
  ...
  %16 = tail call i8* @strchrnul(i8* %14, i32 10) #13
  %17 = load i8, i8* %16, align 1
  %18 = icmp eq i8 %17, 10
  store i8 0, i8* %16, align 1
  %19 = add nuw nsw i32 %15, 1
  tail call fastcc void @48(%15* %10, i8* %14, i8* %1, i32 %19, i32 %2)
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @51(%10* nocapture %0, %11* nocapture readonly %1, i32 %2) unnamed_addr #1 {
...
36:                                               ; preds = %24
  %37 = tail call fastcc i32 @51(%10* nonnull %0, %11* nonnull %31, i32 %29) #5
  br label %38
