; ModuleID = 'php_open_temporary_file-strip-O2-renamed.bc'
...
23:                                               ; preds = %20
  %24 = tail call i32 @php_check_open_basedir(i8* nonnull %15) #8
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %26, label %35

26:                                               ; preds = %23, %20
  %27 = tail call fastcc i32 @8(i8* nonnull %15, i8* %6, %11** %2)
  br label %35

28:                                               ; preds = %11
  %29 = tail call fastcc i32 @8(i8* nonnull %0, i8* %6, %11** %2)
  %30 = icmp eq i32 %29, -1
...
35:                                               ; preds = %28, %14, %17, %23, %26
  %36 = phi i32 [ %27, %26 ], [ -1, %23 ], [ -1, %17 ], [ -1, %14 ], [ %29, %28 ]
  ret i32 %36
}
