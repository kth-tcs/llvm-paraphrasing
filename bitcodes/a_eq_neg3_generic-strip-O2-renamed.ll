; ModuleID = 'a_eq_neg3_generic-strip-O2-renamed.bc'
...
54:                                               ; preds = %36, %50
  %55 = phi i64 [ %49, %36 ], [ %53, %50 ]
  %56 = phi i32 [ %34, %36 ], [ %51, %50 ]
  ...
  br i1 %39, label %50, label %57

57:                                               ; preds = %54, %89
  %58 = phi i64 [ %102, %89 ], [ 0, %54 ]
  %59 = phi [1 x %1]* [ %103, %89 ], [ %5, %54 ]
  %60 = icmp eq i64 %58, %21
  br i1 %60, label %61, label %75

61:                                               ; preds = %57
  br i1 %42, label %62, label %89

62:                                               ; preds = %61, %62
  %63 = phi i64 [ %74, %62 ], [ %47, %61 ]
  %64 = phi i32 [ %72, %62 ], [ %41, %61 ]
  %65 = phi i32 [ %71, %62 ], [ 0, %61 ]
  %66 = shl i32 %65, 1
  %67 = getelementptr inbounds [1 x %1], [1 x %1]* %59, i64 %63, i64 0
  %68 = call i32 @__gmpz_tstbit(%1* %67, i64 %55) #6
  %69 = icmp ne i32 %68, 0
  ...
  %74 = add nsw i64 %63, -1
  br i1 %73, label %62, label %89

75:                                               ; preds = %57
  br i1 %46, label %76, label %89

76:                                               ; preds = %75, %76
  %77 = phi i64 [ %88, %76 ], [ %48, %75 ]
  %78 = phi i32 [ %86, %76 ], [ %45, %75 ]
  %79 = phi i32 [ %85, %76 ], [ 0, %75 ]
  %80 = shl i32 %79, 1
  %81 = getelementptr inbounds [1 x %1], [1 x %1]* %59, i64 %77, i64 0
  %82 = call i32 @__gmpz_tstbit(%1* %81, i64 %55) #6
  %83 = icmp ne i32 %82, 0
  ...
  %88 = add nsw i64 %77, -1
  br i1 %87, label %76, label %89

89:                                               ; preds = %76, %62, %75, %61
  %90 = phi i32 [ 0, %61 ], [ 0, %75 ], [ %71, %62 ], [ %85, %76 ]
  %91 = load void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)*, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  %92 = getelementptr inbounds [1 x %1]*, [1 x %1]** %23, i64 %58
  %93 = load [1 x %1]*, [1 x %1]** %92, align 8
  %94 = sext i32 %90 to i64
  %95 = getelementptr inbounds [1 x %1], [1 x %1]* %93, i64 %94, i64 0
  %96 = getelementptr inbounds [1 x %1]*, [1 x %1]** %25, i64 %58
  %97 = load [1 x %1]*, [1 x %1]** %96, align 8
  %98 = getelementptr inbounds [1 x %1], [1 x %1]* %97, i64 %94, i64 0
  %99 = getelementptr inbounds [1 x %1]*, [1 x %1]** %27, i64 %58
  %100 = load [1 x %1]*, [1 x %1]** %99, align 8
  %101 = getelementptr inbounds [1 x %1], [1 x %1]* %100, i64 %94, i64 0
  call void %91(%2* nonnull %29, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32, %0* %3, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32, %1* %95, %1* %98, %1* %101) #5
  %102 = add nuw i64 %58, 1
  %103 = getelementptr inbounds [1 x %1], [1 x %1]* %59, i64 %20
  %104 = icmp eq i64 %102, %18
  br i1 %104, label %50, label %57
