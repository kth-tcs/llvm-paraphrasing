; ModuleID = 'internal_functions_cli-strip-renamed.bc'
...
define dso_local i32 @php_register_internal_extensions() #0 {
  %1 = call i32 @php_register_extensions(%0** getelementptr inbounds ([24 x %0*], [24 x %0*]* @0, i32 0, i32 0), i32 24)
  ret i32 %1
}

declare dso_local i32 @php_register_extensions(%0**, i32) #1
