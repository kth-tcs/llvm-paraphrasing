; ModuleID = 'sqlite_statement-strip-O3-renamed.bc'
...
%53 = type { i8, i8, i16 }
%54 = type { %4, %34 }
%55 = type { %56*, i8*, %60, %60, %65*, i8*, %34, i8, i8, [16 x i8], i32, %71*, %69*, i8*, %71*, i64, i8*, i64, i64, i64, i64, %55* }
...
%59 = type { i64, i64 }
%60 = type { %61*, %61*, %55* }
%61 = type { %62*, %34, %61*, %61*, i32, %60*, %63, %71* }
%62 = type { i32 (%55*, %61*, %63*, %63*, i64*, i32)*, void (%61*)*, i8* }
%63 = type { %64*, %64* }
%64 = type { %64*, %64*, %63*, i8*, i64, i8, i8, i32 }
%65 = type { %66*, i8*, i32 }
%66 = type { %55* (%65*, i8*, i8*, i32, %3**, %67*)*, i32 (%65*, %55*)*, i32 (%65*, %55*, %57*)*, i32 (%65*, i8*, i32, %57*, %67*)*, %55* (%65*, i8*, i8*, i32, %3**, %67*)*, i8*, i32 (%65*, i8*, i32, %67*)*, i32 (%65*, i8*, i8*, i32, %67*)*, i32 (%65*, i8*, i32, i32, %67*)*, i32 (%65*, i8*, i32, %67*)*, i32 (%65*, i8*, i32, i8*, %67*)* }
%67 = type { %68*, %34, %71* }
%68 = type { void (%67*, i32, i32, i8*, i32, i64, i64, i8*)*, void (%68*)*, %34, i32, i64, i64 }
%69 = type { i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, %70*, %69*, i32, i32, i64, i16, i8, [1 x i8], i8*, i64, i8*, i8*, i8*, i8*, i64, i32, [20 x i8] }
%70 = type { %70*, %69*, i32 }
%71 = type { %4, i32, i32, i8* }
...
24:                                               ; preds = %18
  ...
  %29 = getelementptr inbounds %0, %0* %0, i64 0, i32 4
...
39:                                               ; preds = %37, %68
  %40 = phi %2* [ %69, %68 ], [ %30, %37 ]
  %41 = phi i32 [ %70, %68 ], [ %35, %37 ]
  %42 = phi i64 [ %71, %68 ], [ 0, %37 ]
  %43 = getelementptr inbounds %2, %2* %40, i64 %42, i32 0
  %44 = load %3*, %3** %43, align 8
  %45 = icmp eq %3* %44, null
  br i1 %45, label %68, label %46

46:                                               ; preds = %39
  %47 = getelementptr inbounds %3, %3* %44, i64 0, i32 0, i32 1
  %48 = bitcast %5* %47 to %53*
  %49 = getelementptr inbounds %53, %53* %48, i64 0, i32 1
...
53:                                               ; preds = %46
  %54 = getelementptr inbounds %3, %3* %44, i64 0, i32 0, i32 0
...
63:                                               ; preds = %58
  tail call void @_efree(i8* %61) #6
  br label %64

64:                                               ; preds = %63, %62, %53, %46
  %65 = load %2*, %2** %29, align 8
  %66 = getelementptr inbounds %2, %2* %65, i64 %42, i32 0
  store %3* null, %3** %66, align 8
  %67 = load i32, i32* %32, align 4
  br label %68

68:                                               ; preds = %64, %39
  %69 = phi %2* [ %40, %39 ], [ %65, %64 ]
  %70 = phi i32 [ %41, %39 ], [ %67, %64 ]
...
74:                                               ; preds = %68, %37
  %75 = phi %2* [ %30, %37 ], [ %69, %68 ]
  %76 = bitcast %2* %75 to i8*
  tail call void @_efree(i8* %76) #6
  store %2* null, %2** %29, align 8
  store i32 %28, i32* %32, align 4
  br label %147

77:                                               ; preds = %18
  %78 = load %45*, %45** %21, align 8
  %79 = tail call i32 @sqlite3_column_count(%45* %78) #6
  %80 = getelementptr inbounds %0, %0* %0, i64 0, i32 4
  %81 = load %2*, %2** %80, align 8
  %82 = icmp eq %2* %81, null
  %83 = getelementptr inbounds %0, %0* %0, i64 0, i32 3
  br i1 %82, label %127, label %84
...
89:                                               ; preds = %87, %118
  %90 = phi %2* [ %119, %118 ], [ %81, %87 ]
  %91 = phi i32 [ %120, %118 ], [ %85, %87 ]
  %92 = phi i64 [ %121, %118 ], [ 0, %87 ]
  %93 = getelementptr inbounds %2, %2* %90, i64 %92, i32 0
  %94 = load %3*, %3** %93, align 8
  %95 = icmp eq %3* %94, null
  br i1 %95, label %118, label %96

96:                                               ; preds = %89
  %97 = getelementptr inbounds %3, %3* %94, i64 0, i32 0, i32 1
  %98 = bitcast %5* %97 to %53*
  %99 = getelementptr inbounds %53, %53* %98, i64 0, i32 1
...
103:                                              ; preds = %96
  %104 = getelementptr inbounds %3, %3* %94, i64 0, i32 0, i32 0
...
114:                                              ; preds = %113, %112, %103, %96
  %115 = load %2*, %2** %80, align 8
  %116 = getelementptr inbounds %2, %2* %115, i64 %92, i32 0
  store %3* null, %3** %116, align 8
  %117 = load i32, i32* %83, align 4
  br label %118

118:                                              ; preds = %114, %89
  %119 = phi %2* [ %90, %89 ], [ %115, %114 ]
  %120 = phi i32 [ %91, %89 ], [ %117, %114 ]
  %121 = add nuw nsw i64 %92, 1
  %122 = sext i32 %120 to i64
  %123 = icmp slt i64 %121, %122
  br i1 %123, label %89, label %124

124:                                              ; preds = %118, %87
  %125 = phi %2* [ %81, %87 ], [ %119, %118 ]
  %126 = bitcast %2* %125 to i8*
  tail call void @_efree(i8* %126) #6
  store %2* null, %2** %80, align 8
  br label %127
...
128:                                              ; preds = %127, %84
  %129 = getelementptr inbounds %46, %46* %4, i64 0, i32 0
  %130 = load %47*, %47** %129, align 8
  %131 = getelementptr inbounds %47, %47* %130, i64 0, i32 0
  %132 = load %48*, %48** %131, align 8
  %133 = tail call i32 @sqlite3_changes(%48* %132) #6
  %134 = sext i32 %133 to i64
  %135 = getelementptr inbounds %0, %0* %0, i64 0, i32 10
  store i64 %134, i64* %135, align 8
  %136 = load %45*, %45** %21, align 8
  %137 = tail call i32 @sqlite3_reset(%45* %136) #6
...
140:                                              ; preds = %18
  %141 = load %45*, %45** %21, align 8
  %142 = tail call i32 @sqlite3_reset(%45* %141) #6
  br label %143

143:                                              ; preds = %140, %18
  %144 = getelementptr inbounds %0, %0* %0, i64 0, i32 6
  %145 = load %6*, %6** %144, align 8
  %146 = tail call i32 @_pdo_sqlite_error(%6* %145, %0* nonnull %0, i8* getelementptr inbounds ([98 x i8], [98 x i8]* @0, i64 0, i64 0), i32 113) #6
  br label %147

147:                                              ; preds = %74, %34, %33, %143, %128
  %148 = phi i32 [ 0, %143 ], [ 1, %128 ], [ 1, %33 ], [ 1, %34 ], [ 1, %74 ]
  ret i32 %148
}
...
63:                                               ; preds = %57
  %64 = bitcast %44* %1 to %54**
  %65 = load %54*, %54** %64, align 8
  %66 = getelementptr inbounds %54, %54* %65, i64 0, i32 1
  br label %67
...
100:                                              ; preds = %94
  %101 = bitcast %44* %1 to %54**
  %102 = load %54*, %54** %101, align 8
  %103 = getelementptr inbounds %54, %54* %102, i64 0, i32 1
  br label %104
...
114:                                              ; preds = %109
  %115 = bitcast i8* %112 to %55*
  %116 = tail call %3* @_php_stream_copy_to_mem(%55* %115, i64 -1, i32 0) #6
  ...
  %122 = bitcast %5* %121 to %53*
  %123 = getelementptr inbounds %53, %53* %122, i64 0, i32 1
...
165:                                              ; preds = %159
  %166 = bitcast %44* %1 to %54**
  %167 = load %54*, %54** %166, align 8
  %168 = getelementptr inbounds %54, %54* %167, i64 0, i32 1
  br label %169
...
declare dso_local %3* @_php_stream_copy_to_mem(%55*, i64, i32) local_unnamed_addr #2
