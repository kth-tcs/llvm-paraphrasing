; ModuleID = 'libnetdata-strip-O2-renamed.bc'
...
6:                                                ; preds = %4
  %7 = and i32 %2, 1
  %8 = icmp eq i32 %7, 0
  %9 = load i32, i32* @enable_ksm, align 4
  %10 = icmp ne i32 %9, 0
  %11 = and i1 %8, %10
  %12 = icmp ne i32 %3, 0
  %13 = and i1 %12, %11
  %14 = tail call fastcc i32 @56(i8* nonnull %0, i64 %1) #9
  %15 = icmp eq i32 %14, -1
...
17:                                               ; preds = %16
  %18 = tail call i8* @mmap(i8* null, i64 %1, i32 3, i32 %2, i32 %14, i64 0) #9
  %19 = icmp eq i8* %18, inttoptr (i64 -1 to i8*)
  br i1 %19, label %30, label %20

20:                                               ; preds = %17
  %21 = or i32 %7, 10
  %22 = tail call i32 @madvise(i8* %18, i64 %1, i32 %21) #9
  %23 = icmp ne i32 %22, 0
  %24 = load i32, i32* @40, align 4
  %25 = icmp ne i32 %24, 0
  %26 = and i1 %23, %25
...
30:                                               ; preds = %17, %20, %27
  %31 = tail call i32 @close(i32 %14) #9
  br label %70

32:                                               ; preds = %6
  br i1 %15, label %75, label %33

33:                                               ; preds = %4, %32
  %34 = phi i32 [ %14, %32 ], [ -1, %4 ]
  %35 = or i32 %2, 32
  %36 = tail call i8* @mmap(i8* null, i64 %1, i32 3, i32 %35, i32 -1, i64 0) #9
...
40:                                               ; preds = %38
  %41 = tail call i64 @lseek(i32 %34, i64 0, i32 0) #9
  %42 = icmp eq i64 %41, 0
  br i1 %42, label %43, label %47

43:                                               ; preds = %40
  %44 = tail call i64 @read(i32 %34, i8* %36, i64 %1) #9
  %45 = icmp eq i64 %44, %1
...
48:                                               ; preds = %47, %46, %43, %38
  %49 = tail call i32 @madvise(i8* %36, i64 %1, i32 10) #9
  %50 = icmp ne i32 %49, 0
...
57:                                               ; preds = %54, %48
  %58 = tail call i32 @madvise(i8* %36, i64 %1, i32 12) #9
  %59 = icmp ne i32 %58, 0
...
68:                                               ; preds = %66
  %69 = tail call i32 @close(i32 %34) #9
  br label %70

70:                                               ; preds = %68, %66, %30
  %71 = phi i8* [ %18, %30 ], [ %36, %66 ], [ %36, %68 ]
  %72 = icmp eq i8* %71, inttoptr (i64 -1 to i8*)
  br i1 %72, label %75, label %73

73:                                               ; preds = %70
  %74 = tail call i32* @__errno_location() #12
  store i32 0, i32* %74, align 4
  br label %75

75:                                               ; preds = %32, %16, %70, %73
  %76 = phi i8* [ %71, %73 ], [ null, %70 ], [ null, %16 ], [ null, %32 ]
  ret i8* %76
}
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @56(i8* %0, i64 %1) unnamed_addr #0 {
