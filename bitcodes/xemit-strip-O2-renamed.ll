; ModuleID = 'xemit-strip-O2-renamed.bc'
...
11:                                               ; preds = %4
  ...
  %17 = getelementptr inbounds %2, %2* %0, i64 0, i32 0, i32 6
  %18 = getelementptr inbounds %1, %1* %3, i64 0, i32 3
  %19 = getelementptr inbounds %1, %1* %3, i64 0, i32 4
  %20 = getelementptr inbounds %2, %2* %0, i64 0, i32 1, i32 6
...
129:                                              ; preds = %122
  switch i8 %123, label %144 [
    i8 95, label %130
    i8 36, label %130
  ]

130:                                              ; preds = %129, %129, %122
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %15, i8* nonnull align 1 %115, i64 %137, i1 false) #5
  br label %141

138:                                              ; preds = %109
  %139 = load i8*, i8** %19, align 8
  %140 = call i64 %118(i8* %115, i64 %117, i8* nonnull %15, i64 1, i8* %139) #5
  br label %141

141:                                              ; preds = %138, %130
  %142 = phi i64 [ %140, %138 ], [ %137, %130 ]
  %143 = icmp slt i64 %142, 0
  br i1 %143, label %144, label %150

144:                                              ; preds = %141, %129, %120
...
302:                                              ; preds = %300
  ...
  %305 = getelementptr inbounds [256 x i8], [256 x i8]* @sane_ctype, i64 0, i64 %304
...
310:                                              ; preds = %309, %309, %302
  %311 = load i8, i8* %295, align 1
  %312 = zext i8 %311 to i64
  %313 = getelementptr inbounds [256 x i8], [256 x i8]* @sane_ctype, i64 0, i64 %312
  %314 = load i8, i8* %313, align 1
  %315 = and i8 %314, 1
  %316 = icmp eq i8 %315, 0
  %317 = select i1 %316, i64 1, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %15, i8* nonnull align 1 %295, i64 %317, i1 false) #5
  br label %321

318:                                              ; preds = %289
  %319 = load i8*, i8** %19, align 8
  %320 = call i64 %298(i8* %295, i64 %297, i8* nonnull %15, i64 1, i8* %319) #5
  br label %321

321:                                              ; preds = %318, %310
  %322 = phi i64 [ %320, %318 ], [ %317, %310 ]
  %323 = icmp slt i64 %322, 0
  br i1 %323, label %324, label %332

324:                                              ; preds = %321, %309, %300
...
412:                                              ; preds = %401
  %413 = icmp sgt i64 %409, 0
  br i1 %413, label %414, label %436

414:                                              ; preds = %412
  %415 = load i8, i8* %407, align 1
...
421:                                              ; preds = %414
  switch i8 %415, label %436 [
    i8 95, label %422
    i8 36, label %422
  ]

422:                                              ; preds = %421, %421, %414
  %423 = load i8, i8* %407, align 1
  %424 = zext i8 %423 to i64
  %425 = getelementptr inbounds [256 x i8], [256 x i8]* @sane_ctype, i64 0, i64 %424
  %426 = load i8, i8* %425, align 1
  %427 = and i8 %426, 1
  %428 = icmp eq i8 %427, 0
  %429 = select i1 %428, i64 1, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %15, i8* nonnull align 1 %407, i64 %429, i1 false) #5
  br label %433

430:                                              ; preds = %401
  %431 = load i8*, i8** %19, align 8
  %432 = call i64 %410(i8* %407, i64 %409, i8* nonnull %15, i64 1, i8* %431) #5
  br label %433

433:                                              ; preds = %430, %422
  %434 = phi i64 [ %432, %430 ], [ %429, %422 ]
  %435 = icmp slt i64 %434, 0
  br i1 %435, label %436, label %445

436:                                              ; preds = %433, %421, %412
