; ModuleID = 'zend_strtod-strip-O2-renamed.bc'
...
820:                                              ; preds = %810, %808
  ...
  %827 = tail call noalias i8* @malloc(i64 %826) #8
  %828 = icmp eq i8* %827, null
  br i1 %828, label %829, label %830

829:                                              ; preds = %820
  tail call void (i32, i8*, ...) @zend_error_noreturn(i32 1, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @5, i64 0, i64 0)) #9
  unreachable
...
888:                                              ; preds = %879, %874
  ...
  %894 = tail call noalias i8* @malloc(i64 %893) #8
...
903:                                              ; preds = %897, %884
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %907, i8* nonnull align 8 %909, i64 %913, i1 false) #8
...
993:                                              ; preds = %984, %979
  ...
  %999 = tail call noalias i8* @malloc(i64 %998) #8
...
1008:                                             ; preds = %1002, %989
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1012, i8* nonnull align 8 %1014, i64 %1018, i1 false) #8
...
1074:                                             ; preds = %1065, %1062
  ...
  %1080 = tail call noalias i8* @malloc(i64 %1079) #8
...
1104:                                             ; preds = %1089
  %1105 = tail call noalias i8* @malloc(i64 36) #8
...
1278:                                             ; preds = %1269, %1266
  ...
  %1284 = tail call noalias i8* @malloc(i64 %1283) #8
...
1397:                                             ; preds = %1394
  tail call void @free(i8* nonnull %1254) #8
...
1960:                                             ; preds = %1959
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1961) #8
  %1962 = bitcast i32* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1962) #8
...
1974:                                             ; preds = %1967
  %1975 = tail call noalias i8* @malloc(i64 36) #8
...
1990:                                             ; preds = %1960
  %1991 = call fastcc %0* @10(%1* nonnull %9, i32* nonnull %4, i32* nonnull %3) #8
  ...
  %2000 = tail call fastcc %0* @13(%0* %1991, i32 %1999) #8
...
2019:                                             ; preds = %2005
  %2020 = tail call noalias i8* @malloc(i64 36) #8
...
2035:                                             ; preds = %2029
  %2036 = tail call fastcc %0* @11(%0* %2030, i32 %1964) #8
...
2040:                                             ; preds = %2038
  %2041 = tail call fastcc %0* @11(%0* %2010, i32 %2012) #8
  br label %2042
...
2090:                                             ; preds = %2081
  %2091 = tail call fastcc %0* @13(%0* %2045, i32 %2088) #8
  br label %2092
...
2096:                                             ; preds = %2092
  %2097 = tail call fastcc %0* @13(%0* %2044, i32 %2094) #8
  br label %2098

2098:                                             ; preds = %2096, %2092
  %2099 = phi %0* [ %2097, %2096 ], [ %2044, %2092 ]
  %2100 = tail call fastcc i32 @15(%0* %2093, %0* %2099) #8
...
2139:                                             ; preds = %2130, %2125
  ...
  %2145 = tail call noalias i8* @malloc(i64 %2144) #8
...
2154:                                             ; preds = %2148, %2135
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %2158, i8* nonnull align 8 %2160, i64 %2164, i1 false) #8
...
2182:                                             ; preds = %2175, %2119
  ...
  %2184 = tail call fastcc i32 @15(%0* %2183, %0* %2099) #8
  br label %2185
...
2301:                                             ; preds = %2292, %2287
  ...
  %2307 = tail call noalias i8* @malloc(i64 %2306) #8
...
2316:                                             ; preds = %2310, %2297
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %2320, i8* nonnull align 8 %2322, i64 %2326, i1 false) #8
...
2344:                                             ; preds = %2337, %2280
  ...
  %2346 = tail call fastcc i32 @15(%0* %2345, %0* %2099) #8
...
2468:                                             ; preds = %2459, %2454
  ...
  %2474 = tail call noalias i8* @malloc(i64 %2473) #8
...
2483:                                             ; preds = %2477, %2464
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %2487, i8* nonnull align 8 %2489, i64 %2493, i1 false) #8
...
2511:                                             ; preds = %2504, %2447
  ...
  %2513 = tail call fastcc i32 @15(%0* %2512, %0* %2099) #8
...
2649:                                             ; preds = %2563, %2565, %2568, %2591, %2597, %2620, %2633, %2638, %2643
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1962) #8
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1961) #8
...
12:                                               ; preds = %3, %1
  ...
  %18 = tail call noalias i8* @malloc(i64 %17) #8
...
9:                                                ; preds = %3
  %10 = tail call noalias i8* @malloc(i64 36) #8
...
47:                                               ; preds = %38, %33
  ...
  %53 = tail call noalias i8* @malloc(i64 %52) #8
...
62:                                               ; preds = %43, %56
  ...
  %71 = shl nsw i64 %70, 2
  %72 = add nsw i64 %71, 8
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %66, i8* nonnull align 8 %68, i64 %72, i1 false) #8
...
103:                                              ; preds = %97
  %104 = tail call noalias i8* @malloc(i64 36) #8
...
27:                                               ; preds = %25
  %28 = load %0*, %0** getelementptr inbounds ([8 x %0*], [8 x %0*]* @4, i64 0, i64 0), align 16
  %29 = icmp eq %0* %28, null
  br i1 %29, label %33, label %30

30:                                               ; preds = %27
  %31 = bitcast %0* %28 to i64*
  %32 = load i64, i64* %31, align 8
  store i64 %32, i64* bitcast ([8 x %0*]* @4 to i64*), align 16
  br label %43

33:                                               ; preds = %27
  %34 = tail call noalias i8* @malloc(i64 32) #8
...
43:                                               ; preds = %30, %37
  %44 = phi %0* [ %28, %30 ], [ %38, %37 ]
  %45 = getelementptr inbounds %0, %0* %44, i64 0, i32 4
  %46 = getelementptr inbounds %0, %0* %44, i64 0, i32 3
  store i32 0, i32* %46, align 8
  store i32 1, i32* %45, align 4
  %47 = getelementptr inbounds %0, %0* %44, i64 0, i32 5, i64 0
  store i32 0, i32* %47, align 8
  br label %270

48:                                               ; preds = %22, %2
  %49 = phi i32 [ %7, %2 ], [ %24, %22 ]
  %50 = icmp slt i32 %49, 0
  %51 = lshr i32 %49, 31
  %52 = select i1 %50, %0* %0, %0* %1
  %53 = ptrtoint %0* %52 to i64
  %54 = bitcast %0* %52 to i8*
  %55 = select i1 %50, %0* %1, %0* %0
  %56 = bitcast %0* %55 to i8*
  %57 = getelementptr inbounds %0, %0* %55, i64 0, i32 1
...
60:                                               ; preds = %48
  ...
  %62 = getelementptr inbounds [8 x %0*], [8 x %0*]* @4, i64 0, i64 %61
...
69:                                               ; preds = %60, %48
  ...
  %75 = tail call noalias i8* @malloc(i64 %74) #8
...
78:                                               ; preds = %69
  %79 = bitcast i8* %75 to %0*
  %80 = getelementptr inbounds i8, i8* %75, i64 8
  %81 = bitcast i8* %80 to i32*
  store i32 %58, i32* %81, align 8
  %82 = getelementptr inbounds i8, i8* %75, i64 12
  %83 = bitcast i8* %82 to i32*
  store i32 %70, i32* %83, align 4
  br label %84

84:                                               ; preds = %65, %78
  %85 = phi %0* [ %63, %65 ], [ %79, %78 ]
  %86 = bitcast %0* %85 to i8*
  %87 = getelementptr inbounds %0, %0* %85, i64 0, i32 4
  store i32 0, i32* %87, align 4
  %88 = getelementptr inbounds %0, %0* %85, i64 0, i32 3
  store i32 %51, i32* %88, align 8
  %89 = getelementptr inbounds %0, %0* %55, i64 0, i32 4
  %90 = load i32, i32* %89, align 4
  %91 = getelementptr inbounds %0, %0* %55, i64 0, i32 5, i64 0
  %92 = sext i32 %90 to i64
  %93 = getelementptr inbounds %0, %0* %52, i64 0, i32 4
  %94 = load i32, i32* %93, align 4
  %95 = getelementptr inbounds %0, %0* %52, i64 0, i32 5, i64 0
  %96 = sext i32 %94 to i64
  %97 = getelementptr inbounds %0, %0* %85, i64 0, i32 5, i64 0
  %98 = shl nsw i64 %96, 2
  %99 = add nsw i64 %98, 24
  %100 = getelementptr i8, i8* %54, i64 %99
  %101 = ptrtoint i8* %100 to i64
  %102 = getelementptr %0, %0* %52, i64 0, i32 5, i64 1
  ...
  %113 = getelementptr i8, i8* %86, i64 %111
  %114 = getelementptr i8, i8* %54, i64 %99
  %115 = ptrtoint i8* %114 to i64
  %116 = getelementptr %0, %0* %52, i64 0, i32 5, i64 1
...
130:                                              ; preds = %130, %128
  %131 = phi i32* [ %91, %128 ], [ %148, %130 ]
  %132 = phi i32* [ %95, %128 ], [ %151, %130 ]
  %133 = phi i32* [ %97, %128 ], [ %159, %130 ]
  %134 = phi i64 [ 0, %128 ], [ %157, %130 ]
  %135 = phi i64 [ %129, %128 ], [ %160, %130 ]
  ...
  %147 = getelementptr inbounds i32, i32* %133, i64 1
  store i32 %146, i32* %133, align 4
  %148 = getelementptr inbounds i32, i32* %131, i64 2
  %149 = load i32, i32* %136, align 4
  %150 = zext i32 %149 to i64
  %151 = getelementptr inbounds i32, i32* %132, i64 2
  ...
  %159 = getelementptr inbounds i32, i32* %133, i64 2
...
162:                                              ; preds = %130, %84
  %163 = phi i64 [ undef, %84 ], [ %157, %130 ]
  %164 = phi i32* [ %91, %84 ], [ %148, %130 ]
  %165 = phi i32* [ %95, %84 ], [ %151, %130 ]
  %166 = phi i32* [ %97, %84 ], [ %159, %130 ]
  %167 = phi i64 [ 0, %84 ], [ %157, %130 ]
...
179:                                              ; preds = %162, %169
  %180 = phi i64 [ %163, %162 ], [ %178, %169 ]
  %181 = getelementptr inbounds %0, %0* %55, i64 0, i32 5, i64 %92
  %182 = bitcast i8* %112 to i32*
  %183 = bitcast i8* %113 to i32*
  %184 = icmp ugt i32* %181, %182
  br i1 %184, label %187, label %185

185:                                              ; preds = %223, %179
  %186 = phi i32* [ %183, %179 ], [ %224, %223 ]
  br label %262

187:                                              ; preds = %179
  %188 = ptrtoint i8* %112 to i64
  %189 = shl nsw i64 %92, 2
  %190 = add nsw i64 %189, 23
  %191 = sub i64 %190, %188
  %192 = getelementptr i8, i8* %56, i64 %191
  %193 = ptrtoint i8* %192 to i64
  %194 = lshr i64 %193, 2
  %195 = add nuw nsw i64 %194, 1
  %196 = shl nsw i64 %92, 2
  %197 = add nsw i64 %196, 23
  %198 = sub i64 %197, %111
  %199 = lshr i64 %198, 2
...
203:                                              ; preds = %187, %203
  %204 = phi i64 [ %213, %203 ], [ %180, %187 ]
  %205 = phi i32* [ %215, %203 ], [ %183, %187 ]
  %206 = phi i32* [ %208, %203 ], [ %182, %187 ]
  %207 = phi i64 [ %216, %203 ], [ %201, %187 ]
  %208 = getelementptr inbounds i32, i32* %206, i64 1
  %209 = load i32, i32* %206, align 4
  %210 = zext i32 %209 to i64
  %211 = sub nsw i64 %210, %204
  %212 = lshr i64 %211, 32
  %213 = and i64 %212, 1
...
218:                                              ; preds = %203, %187
  %219 = phi i64 [ %180, %187 ], [ %213, %203 ]
  %220 = phi i32* [ %183, %187 ], [ %215, %203 ]
  %221 = phi i32* [ %182, %187 ], [ %208, %203 ]
  %222 = icmp ult i64 %198, 12
  br i1 %222, label %223, label %225

223:                                              ; preds = %225, %218
  %224 = getelementptr i32, i32* %183, i64 %195
  br label %185

225:                                              ; preds = %218, %225
  %226 = phi i64 [ %258, %225 ], [ %219, %218 ]
  %227 = phi i32* [ %260, %225 ], [ %220, %218 ]
  %228 = phi i32* [ %253, %225 ], [ %221, %218 ]
  ...
  %236 = getelementptr inbounds i32, i32* %227, i64 1
  store i32 %235, i32* %227, align 4
  %237 = getelementptr inbounds i32, i32* %228, i64 2
  %238 = load i32, i32* %229, align 4
  ...
  %245 = getelementptr inbounds i32, i32* %228, i64 3
  ...
  %252 = getelementptr inbounds i32, i32* %227, i64 3
  store i32 %251, i32* %244, align 4
  %253 = getelementptr inbounds i32, i32* %228, i64 4
  %254 = load i32, i32* %245, align 4
  %255 = zext i32 %254 to i64
  %256 = sub nsw i64 %255, %250
  %257 = lshr i64 %256, 32
  %258 = and i64 %257, 1
  %259 = trunc i64 %256 to i32
  %260 = getelementptr inbounds i32, i32* %227, i64 4
  store i32 %259, i32* %252, align 4
  %261 = icmp ult i32* %253, %181
  br i1 %261, label %225, label %223

262:                                              ; preds = %185, %262
  %263 = phi i32 [ %268, %262 ], [ %90, %185 ]
  %264 = phi i32* [ %265, %262 ], [ %186, %185 ]
  %265 = getelementptr inbounds i32, i32* %264, i64 -1
  %266 = load i32, i32* %265, align 4
  %267 = icmp eq i32 %266, 0
  %268 = add nsw i32 %263, -1
  br i1 %267, label %262, label %269

269:                                              ; preds = %262
  store i32 %263, i32* %87, align 4
  br label %270

270:                                              ; preds = %269, %43
  %271 = phi %0* [ %85, %269 ], [ %44, %43 ]
  ret %0* %271
}
...
63:                                               ; preds = %59
  %64 = tail call noalias i8* @malloc(i64 32) #8
...
98:                                               ; preds = %94
  %99 = tail call noalias i8* @malloc(i64 32) #8
...
131:                                              ; preds = %125
  %132 = tail call noalias i8* @malloc(i64 32) #8
...
286:                                              ; preds = %272, %270
  ...
  %297 = tail call noalias i8* @malloc(i64 %296) #8
...
630:                                              ; preds = %617
  %631 = tail call noalias i8* @malloc(i64 36) #8
...
690:                                              ; preds = %682
  %691 = tail call noalias i8* @malloc(i64 36) #8
...
847:                                              ; preds = %838, %833
  ...
  %853 = tail call noalias i8* @malloc(i64 %852) #8
...
862:                                              ; preds = %843, %856
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %866, i8* nonnull align 8 %868, i64 %872, i1 false) #8
...
929:                                              ; preds = %920, %915
  ...
  %935 = tail call noalias i8* @malloc(i64 %934) #8
...
944:                                              ; preds = %925, %938
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %948, i8* nonnull align 8 %950, i64 %954, i1 false) #8
...
1020:                                             ; preds = %1011, %1006
  ...
  %1026 = tail call noalias i8* @malloc(i64 %1025) #8
...
1035:                                             ; preds = %1016, %1029
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1039, i8* nonnull align 8 %1041, i64 %1045, i1 false) #8
...
1122:                                             ; preds = %1113, %1109
  ...
  %1128 = tail call noalias i8* @malloc(i64 %1127) #8
...
1175:                                             ; preds = %1166, %1163
  ...
  %1181 = tail call noalias i8* @malloc(i64 %1180) #8
...
1296:                                             ; preds = %1293
  tail call void @free(i8* nonnull %1140) #8
  br label %1303
...
1307:                                             ; preds = %1945, %1303
  ...
  %1313 = tail call fastcc i32 @15(%0* %1309, %0* %781)
...
1450:                                             ; preds = %1441, %1438
  ...
  %1456 = tail call noalias i8* @malloc(i64 %1455) #8
...
1570:                                             ; preds = %1567
  tail call void @free(i8* nonnull %1412) #8
...
1664:                                             ; preds = %1655, %1650
  ...
  %1670 = tail call noalias i8* @malloc(i64 %1669) #8
...
1679:                                             ; preds = %1660, %1673
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1683, i8* nonnull align 8 %1685, i64 %1689, i1 false) #8
...
1745:                                             ; preds = %1736, %1731
  ...
  %1751 = tail call noalias i8* @malloc(i64 %1750) #8
...
1760:                                             ; preds = %1741, %1754
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1764, i8* nonnull align 8 %1766, i64 %1770, i1 false) #8
...
1821:                                             ; preds = %1812, %1807
  ...
  %1827 = tail call noalias i8* @malloc(i64 %1826) #8
...
1836:                                             ; preds = %1817, %1830
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1840, i8* nonnull align 8 %1842, i64 %1846, i1 false) #8
...
1902:                                             ; preds = %1893, %1888
  ...
  %1908 = tail call noalias i8* @malloc(i64 %1907) #8
...
1917:                                             ; preds = %1898, %1911
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1921, i8* nonnull align 8 %1923, i64 %1927, i1 false) #8
...
1949:                                             ; preds = %1101, %2098
  ...
  %1953 = tail call fastcc i32 @15(%0* %1951, %0* %781)
...
2055:                                             ; preds = %2046, %2041
  ...
  %2061 = tail call noalias i8* @malloc(i64 %2060) #8
...
2070:                                             ; preds = %2051, %2064
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %2074, i8* nonnull align 8 %2076, i64 %2080, i1 false) #8
...
2134:                                             ; preds = %2125, %2122
  ...
  %2140 = tail call noalias i8* @malloc(i64 %2139) #8
...
2255:                                             ; preds = %2252
  tail call void @free(i8* nonnull %2109) #8
...
define internal fastcc i32 @15(%0* %0, %0* readonly %1) unnamed_addr #4 {
...
; Function Attrs: norecurse nounwind uwtable
define dso_local double @zend_hex_strtod(i8* %0, i8** %1) local_unnamed_addr #4 {
...
; Function Attrs: norecurse nounwind uwtable
define dso_local double @zend_oct_strtod(i8* %0, i8** %1) local_unnamed_addr #4 {
  %3 = load i8, i8* %0, align 1
  %4 = icmp eq i8 %3, 0
...
; Function Attrs: norecurse nounwind uwtable
define dso_local double @zend_bin_strtod(i8* %0, i8** %1) local_unnamed_addr #4 {
  %3 = load i8, i8* %0, align 1
  %4 = icmp eq i8 %3, 48
  br i1 %4, label %5, label %11
...
declare dso_local void @zend_error_noreturn(i32, i8*, ...) local_unnamed_addr #6
