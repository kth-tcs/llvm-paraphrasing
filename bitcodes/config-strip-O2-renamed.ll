; ModuleID = 'config-strip-O2-renamed.bc'
...
424:                                              ; preds = %414
  ...
  store <2 x i32 (i8*, i8*, i8*)*> <i32 (i8*, i8*, i8*)* @174, i32 (i8*, i8*, i8*)* null>, <2 x i32 (i8*, i8*, i8*)*>* %433, align 8
...
478:                                              ; preds = %475, %465
  ...
  %480 = call fastcc i32 @173(%10* nonnull %6, i8* %471, i8* %479) #12
...
587:                                              ; preds = %576
  ...
  %592 = tail call i32 @config_with_options(i32 (i8*, i8*, i8*)* nonnull @175, i8* null, %1* nonnull @1, %4* nonnull @18) #12
...
622:                                              ; preds = %618, %616
  ...
  %625 = tail call i32 @config_with_options(i32 (i8*, i8*, i8*)* nonnull @176, i8* null, %1* nonnull @1, %4* nonnull @18) #12
...
12:                                               ; preds = %9
  ...
  %13 = load i32, i32* @29, align 4
  br label %14

14:                                               ; preds = %9, %12
  %15 = phi i32 [ %5, %9 ], [ %13, %12 ]
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %18, label %17

17:                                               ; preds = %14
  call fastcc void @171(%10* nonnull %4)
  br label %18

18:                                               ; preds = %14, %17
  %19 = getelementptr inbounds %10, %10* %4, i64 0, i32 2
  %20 = load i8*, i8** %19, align 8
  %21 = getelementptr inbounds %10, %10* %4, i64 0, i32 1
  %22 = load i64, i64* %21, align 8
  %23 = load %5*, %5** @stdout, align 8
  %24 = call i64 @fwrite(i8* %20, i64 1, i64 %22, %5* %23)
  call void @strbuf_release(%10* nonnull %4) #12
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %10) #12
  br label %25

25:                                               ; preds = %3, %18
  %26 = load i32, i32* @27, align 4
  %27 = icmp eq i32 %26, 0
...
30:                                               ; preds = %25
  %31 = load i1, i1* @21, align 1
  %32 = select i1 %31, i32 10, i32 61
  %33 = load i1, i1* @20, align 1
  %34 = select i1 %33, i32 0, i32 10
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @124, i64 0, i64 0), i8* %0, i32 %32, i8* nonnull %1, i32 %34)
  br label %40

36:                                               ; preds = %25
  %37 = load i1, i1* @20, align 1
  %38 = select i1 %37, i32 0, i32 10
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @125, i64 0, i64 0), i8* %0, i32 %38)
  br label %40
...
83:                                               ; preds = %68, %61
  %84 = call i32 @config_with_options(i32 (i8*, i8*, i8*)* nonnull @172, i8* nonnull %4, %1* nonnull @1, %4* nonnull @18) #12
...
114:                                              ; preds = %95, %108
  ...
  %121 = call fastcc i32 @173(%10* %119, i8* %0, i8* %120)
...
define internal fastcc void @170(%10* %0) unnamed_addr #0 {
  ...
  %3 = icmp eq i32 %2, 0
  %4 = tail call i32 @current_config_scope() #12
  %5 = tail call i8* @config_scope_name(i32 %4) #12
  %6 = tail call i64 @strlen(i8* %5) #15
  tail call void @strbuf_add(%10* %0, i8* %5, i64 %6) #12
  %7 = select i1 %3, i8 9, i8 0
  %8 = getelementptr inbounds %10, %10* %0, i64 0, i32 0
  %9 = load i64, i64* %8, align 8
  %10 = icmp eq i64 %9, 0
  %11 = getelementptr inbounds %10, %10* %0, i64 0, i32 1
...
19:                                               ; preds = %12, %16
  ...
  %22 = getelementptr inbounds %10, %10* %0, i64 0, i32 2
...
; Function Attrs: nounwind uwtable
define internal fastcc void @171(%10* %0) unnamed_addr #0 {
  %2 = load i32, i32* @19, align 4
  %3 = icmp eq i32 %2, 0
...
; Function Attrs: nounwind uwtable
define internal i32 @172(i8* %0, i8* %1, i8* nocapture %2) #0 {
...
52:                                               ; preds = %31, %45
  ...
  %63 = tail call fastcc i32 @173(%10* %62, i8* %0, i8* %1)
  br label %64
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @173(%10* %0, i8* %1, i8* %2) unnamed_addr #0 {
...
14:                                               ; preds = %11
  tail call fastcc void @171(%10* %0)
  br label %15

15:                                               ; preds = %11, %14
  %16 = load i1, i1* @41, align 4
  br i1 %16, label %17, label %19

17:                                               ; preds = %15
  %18 = tail call i64 @strlen(i8* %1) #15
  tail call void @strbuf_add(%10* %0, i8* %1, i64 %18) #12
  br label %19

19:                                               ; preds = %17, %15
  %20 = load i32, i32* @27, align 4
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %119

22:                                               ; preds = %19
  %23 = load i1, i1* @41, align 4
  br i1 %23, label %24, label %47

24:                                               ; preds = %22
  %25 = load i1, i1* @22, align 1
  %26 = getelementptr inbounds %10, %10* %0, i64 0, i32 0
  %27 = load i64, i64* %26, align 8
  %28 = icmp eq i64 %27, 0
  %29 = getelementptr inbounds %10, %10* %0, i64 0, i32 1
...
37:                                               ; preds = %30, %34
  ...
  %40 = select i1 %25, i8 10, i8 32
  %41 = getelementptr inbounds %10, %10* %0, i64 0, i32 2
...
49:                                               ; preds = %47
  ...
  %51 = select i1 %50, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @90, i64 0, i64 0), i8* %2
  %52 = tail call i64 @git_config_int64(i8* %1, i8* %51) #12
  tail call void (%10*, i8*, ...) @strbuf_addf(%10* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @129, i64 0, i64 0), i64 %52) #12
  br label %119

53:                                               ; preds = %47
  %54 = tail call i32 @git_config_bool(i8* %1, i8* %2) #12
  %55 = icmp eq i32 %54, 0
  %56 = select i1 %55, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @131, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @130, i64 0, i64 0)
  %57 = select i1 %55, i64 5, i64 4
  tail call void @strbuf_add(%10* %0, i8* %56, i64 %57) #12
  br label %119

58:                                               ; preds = %47
  %59 = bitcast i32* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %59) #12
  %60 = call i32 @git_config_bool_or_int(i8* %1, i8* %2, i32* nonnull %4) #12
...
63:                                               ; preds = %58
  %64 = icmp eq i32 %60, 0
  %65 = select i1 %64, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @131, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @130, i64 0, i64 0)
  %66 = select i1 %64, i64 5, i64 4
  call void @strbuf_add(%10* %0, i8* %65, i64 %66) #12
  br label %68

67:                                               ; preds = %58
  call void (%10*, i8*, ...) @strbuf_addf(%10* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @132, i64 0, i64 0), i32 %60) #12
  br label %68
...
69:                                               ; preds = %47
  ...
  %71 = call i32 @git_config_pathname(i8** nonnull %5, i8* %1, i8* %2) #12
  %72 = icmp slt i32 %71, 0
  br i1 %72, label %77, label %73

73:                                               ; preds = %69
  %74 = load i8*, i8** %5, align 8
  %75 = call i64 @strlen(i8* %74) #15
  call void @strbuf_add(%10* %0, i8* %74, i64 %75) #12
...
78:                                               ; preds = %47
  ...
  %80 = call i32 @git_config_expiry_date(i64* nonnull %6, i8* %1, i8* %2) #12
  %81 = icmp slt i32 %80, 0
  br i1 %81, label %84, label %82

82:                                               ; preds = %78
  %83 = load i64, i64* %6, align 8
  call void (%10*, i8*, ...) @strbuf_addf(%10* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @144, i64 0, i64 0), i64 %83) #12
...
85:                                               ; preds = %47
  %86 = getelementptr inbounds [75 x i8], [75 x i8]* %7, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 75, i8* nonnull %86) #12
  %87 = call i32 @git_config_color(i8* nonnull %86, i8* %1, i8* %2) #12
  %88 = icmp slt i32 %87, 0
  br i1 %88, label %91, label %89

89:                                               ; preds = %85
  %90 = call i64 @strlen(i8* nonnull %86) #15
  call void @strbuf_add(%10* %0, i8* nonnull %86, i64 %90) #12
  call void @llvm.lifetime.end.p0i8(i64 75, i8* nonnull %86) #12
  br label %119
...
94:                                               ; preds = %92
  %95 = tail call i64 @strlen(i8* nonnull %2) #15
  tail call void @strbuf_add(%10* %0, i8* nonnull %2, i64 %95) #12
  br label %119

96:                                               ; preds = %92
  %97 = load i1, i1* @41, align 4
  br i1 %97, label %98, label %119

98:                                               ; preds = %96
  %99 = getelementptr inbounds %10, %10* %0, i64 0, i32 1
  %100 = load i64, i64* %99, align 8
  %101 = add i64 %100, -1
  %102 = getelementptr inbounds %10, %10* %0, i64 0, i32 0
...
109:                                              ; preds = %98
  ...
  %110 = getelementptr inbounds %10, %10* %0, i64 0, i32 2
...
119:                                              ; preds = %115, %113, %89, %82, %73, %19, %49, %68, %94, %96, %53
  %120 = load i1, i1* @20, align 1
  %121 = getelementptr inbounds %10, %10* %0, i64 0, i32 0
  %122 = load i64, i64* %121, align 8
  %123 = icmp eq i64 %122, 0
  %124 = getelementptr inbounds %10, %10* %0, i64 0, i32 1
...
132:                                              ; preds = %125, %129
  %133 = phi i64 [ %127, %125 ], [ %131, %129 ]
  %134 = phi i64 [ %126, %125 ], [ %130, %129 ]
  %135 = select i1 %120, i8 0, i8 10
...
142:                                              ; preds = %91, %84, %77, %132
  %143 = phi i32 [ 0, %132 ], [ -1, %77 ], [ -1, %84 ], [ -1, %91 ]
  ret i32 %143
}
...
; Function Attrs: nounwind uwtable
define internal i32 @176(i8* %0, i8* %1, i8* nocapture readnone %2) #0 {
