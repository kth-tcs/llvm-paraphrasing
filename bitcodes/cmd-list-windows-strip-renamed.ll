; ModuleID = 'cmd-list-windows-strip-renamed.bc'
...
; Function Attrs: nounwind uwtable
define internal void @10(%3* %0, %4* %1) #0 {
  %3 = alloca %3*, align 8
  %4 = alloca %4*, align 8
  %5 = alloca %6*, align 8
  store %3* %0, %3** %3, align 8
...
11:                                               ; preds = %8
  ...
  call void @11(%3* %12, %6* %13, %4* %14, i32 1)
  br label %15
...
; Function Attrs: nounwind uwtable
define internal void @11(%3* %0, %6* %1, %4* %2, i32 %3) #0 {
  %5 = alloca %3*, align 8
  %6 = alloca %6*, align 8
  %7 = alloca %4*, align 8
  ...
  %30 = call i8* @args_get(%38* %29, i8 zeroext 70)
...
35:                                               ; preds = %33
  store i8* getelementptr inbounds ([173 x i8], [173 x i8]* @4, i32 0, i32 0), i8** %13, align 8
  br label %37

36:                                               ; preds = %33
  store i8* getelementptr inbounds ([123 x i8], [123 x i8]* @5, i32 0, i32 0), i8** %13, align 8
  br label %37
...
38:                                               ; preds = %37, %4
  ...
  %40 = call i8* @args_get(%38* %39, i8 zeroext 102)
  store i8* %40, i8** %14, align 8
  store i32 0, i32* %11, align 4
  %41 = load %6*, %6** %6, align 8
  %42 = getelementptr inbounds %6, %6* %41, i32 0, i32 10
  %43 = call %18* @winlinks_RB_MINMAX(%90* %42, i32 -1)
  store %18* %43, %18** %10, align 8
  br label %44

44:                                               ; preds = %81, %38
  %45 = load %18*, %18** %10, align 8
  %46 = icmp ne %18* %45, null
  br i1 %46, label %47, label %84

47:                                               ; preds = %44
  %48 = load %4*, %4** %7, align 8
  %49 = call %41* @cmdq_get_client(%4* %48)
  %50 = load %4*, %4** %7, align 8
  %51 = call %74* @format_create(%41* %49, %4* %50, i32 0, i32 0)
  store %74* %51, %74** %12, align 8
  %52 = load %74*, %74** %12, align 8
  %53 = load i32, i32* %11, align 4
  call void (%74*, i8*, i8*, ...) @format_add(%74* %52, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @7, i32 0, i32 0), i32 %53)
  %54 = load %74*, %74** %12, align 8
  %55 = load %6*, %6** %6, align 8
  %56 = load %18*, %18** %10, align 8
  call void @format_defaults(%74* %54, %41* null, %6* %55, %18* %56, %20* null)
  %57 = load i8*, i8** %14, align 8
  %58 = icmp ne i8* %57, null
  br i1 %58, label %59, label %66

59:                                               ; preds = %47
  %60 = load %74*, %74** %12, align 8
  %61 = load i8*, i8** %14, align 8
  %62 = call i8* @format_expand(%74* %60, i8* %61)
  store i8* %62, i8** %16, align 8
  %63 = load i8*, i8** %16, align 8
  %64 = call i32 @format_true(i8* %63)
...
70:                                               ; preds = %67
  %71 = load %74*, %74** %12, align 8
  %72 = load i8*, i8** %13, align 8
  %73 = call i8* @format_expand(%74* %71, i8* %72)
  store i8* %73, i8** %15, align 8
  %74 = load %4*, %4** %7, align 8
  %75 = load i8*, i8** %15, align 8
  call void (%4*, i8*, ...) @cmdq_print(%4* %74, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @8, i32 0, i32 0), i8* %75)
  %76 = load i8*, i8** %15, align 8
  call void @free(i8* %76) #5
  br label %77

77:                                               ; preds = %70, %67
  %78 = load %74*, %74** %12, align 8
  call void @format_free(%74* %78)
...
81:                                               ; preds = %77
  %82 = load %18*, %18** %10, align 8
  %83 = call %18* @winlinks_RB_NEXT(%18* %82)
  store %18* %83, %18** %10, align 8
  br label %44
