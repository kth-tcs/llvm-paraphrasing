; ModuleID = 'string-list-strip-O2-renamed.bc'
...
14:                                               ; preds = %6, %47
  %15 = phi i64 [ 1, %6 ], [ %49, %47 ]
  %16 = phi i32 [ 1, %6 ], [ %48, %47 ]
...
30:                                               ; preds = %26
  ...
  %32 = getelementptr inbounds %1, %1* %31, i64 %15, i32 0
...
35:                                               ; preds = %34
  ...
  %37 = getelementptr inbounds %1, %1* %36, i64 %15, i32 1
...
39:                                               ; preds = %14
  ...
  %44 = getelementptr inbounds %1, %1* %40, i64 %15
  %45 = bitcast %1* %43 to i8*
  %46 = bitcast %1* %44 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %45, i8* nonnull align 8 %46, i64 16, i1 false)
  br label %47

47:                                               ; preds = %34, %39, %35
  %48 = phi i32 [ %41, %39 ], [ %16, %35 ], [ %16, %34 ]
...
35:                                               ; preds = %27, %31
  br i1 %11, label %40, label %36

36:                                               ; preds = %35
  %37 = load %1*, %1** %9, align 8
  %38 = getelementptr inbounds %1, %1* %37, i64 %13, i32 1
  %39 = load i8*, i8** %38, align 8
  tail call void @free(i8* %39) #7
  br label %40

40:                                               ; preds = %35, %19, %36
  %41 = phi i32 [ %21, %19 ], [ %14, %36 ], [ %14, %35 ]
...
10:                                               ; preds = %35, %6
  %11 = phi i64 [ 0, %6 ], [ %37, %35 ]
  %12 = phi i32 [ 0, %6 ], [ %36, %35 ]
...
31:                                               ; preds = %30
  ...
  %33 = getelementptr inbounds %1, %1* %32, i64 %11, i32 1
  %34 = load i8*, i8** %33, align 8
  tail call void @free(i8* %34) #7
  br label %35

35:                                               ; preds = %31, %30, %19
  %36 = phi i32 [ %20, %19 ], [ %12, %31 ], [ %12, %30 ]
