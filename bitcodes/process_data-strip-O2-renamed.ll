; ModuleID = 'process_data-strip-O2-renamed.bc'
...
5:                                                ; preds = %1, %29
  %6 = phi %0* [ %32, %29 ], [ %3, %1 ]
  %7 = getelementptr inbounds %0, %0* %6, i64 0, i32 54
  %8 = tail call i32 @__netdata_rwlock_rdlock(%30* nonnull %7) #6
  tail call void @start_host_formatting(%36* %0, %0* nonnull %6)
  %9 = getelementptr inbounds %0, %0* %6, i64 0, i32 53
  %10 = load %15*, %15** %9, align 8
  %11 = icmp eq %15* %10, null
  br i1 %11, label %29, label %12

12:                                               ; preds = %5, %24
  %13 = phi %15* [ %27, %24 ], [ %10, %5 ]
  %14 = getelementptr inbounds %15, %15* %13, i64 0, i32 22
  %15 = tail call i32 @__netdata_rwlock_rdlock(%30* nonnull %14) #6
  tail call void @start_chart_formatting(%36* %0, %15* nonnull %13)
  %16 = getelementptr inbounds %15, %15* %13, i64 0, i32 49
  %17 = load %19*, %19** %16, align 8
  %18 = icmp eq %19* %17, null
  br i1 %18, label %24, label %19

19:                                               ; preds = %12, %19
  %20 = phi %19* [ %22, %19 ], [ %17, %12 ]
  tail call void @metric_formatting(%36* %0, %19* nonnull %20)
  %21 = getelementptr inbounds %19, %19* %20, i64 0, i32 24
  %22 = load %19*, %19** %21, align 8
  %23 = icmp eq %19* %22, null
  br i1 %23, label %24, label %19

24:                                               ; preds = %19, %12
  tail call void @end_chart_formatting(%36* %0, %15* nonnull %13)
  %25 = tail call i32 @__netdata_rwlock_unlock(%30* nonnull %14) #6
  %26 = getelementptr inbounds %15, %15* %13, i64 0, i32 40
  %27 = load %15*, %15** %26, align 8
  %28 = icmp eq %15* %27, null
  br i1 %28, label %29, label %12

29:                                               ; preds = %24, %5
  tail call void @end_host_formatting(%36* %0, %0* nonnull %6)
  %30 = tail call i32 @__netdata_rwlock_unlock(%30* nonnull %7) #6
  %31 = getelementptr inbounds %0, %0* %6, i64 0, i32 64
  %32 = load %0*, %0** %31, align 8
  %33 = icmp eq %0* %32, null
  br i1 %33, label %34, label %5

34:                                               ; preds = %29, %1
  %35 = tail call i32 @__netdata_rwlock_unlock(%30* nonnull @rrd_rwlock) #6
