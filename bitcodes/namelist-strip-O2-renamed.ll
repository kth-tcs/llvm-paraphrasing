; ModuleID = 'namelist-strip-O2-renamed.bc'
source_filename = "/home/travis/build/orestisfl/compilation-database/build/php-src/ext/dom/namelist.c"
...
@0 = private unnamed_addr constant [8 x i8] c"getName\00", align 1
@1 = internal constant [2 x %0] [%0 { i8* inttoptr (i64 1 to i8*), i64 0, i8 0, i8 0 }, %0 { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @5, i32 0, i32 0), i64 0, i8 0, i8 0 }], align 16
@2 = private unnamed_addr constant [16 x i8] c"getNamespaceURI\00", align 1
@3 = internal constant [2 x %0] [%0 { i8* inttoptr (i64 1 to i8*), i64 0, i8 0, i8 0 }, %0 { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @5, i32 0, i32 0), i64 0, i8 0, i8 0 }], align 16
@php_dom_namelist_class_functions = hidden local_unnamed_addr constant [3 x { i8*, void (%1*, %29*)*, %0*, i32, i32 }] [{ i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @0, i32 0, i32 0), void (%1*, %29*)* @zif_dom_namelist_get_name, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @1, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([16 x i8], [16 x i8]* @2, i32 0, i32 0), void (%1*, %29*)* @zif_dom_namelist_get_namespace_uri, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @3, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } zeroinitializer], align 16
@4 = private unnamed_addr constant [20 x i8] c"Not yet implemented\00", align 1
@5 = private unnamed_addr constant [6 x i8] c"index\00", align 1

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_namelist_get_name(%1* nocapture readnone %0, %29* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @4, i64 0, i64 0)) #3
  ret void
}

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_namelist_get_namespace_uri(%1* nocapture readnone %0, %29* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @4, i64 0, i64 0)) #3
  ret void
}

; Function Attrs: nounwind uwtable
define hidden i32 @dom_namelist_length_read(%33* nocapture readnone %0, %29* nocapture %1) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @_emalloc(i64 32) #4
