; ModuleID = 'phpdbg_io-strip-O2-renamed.bc'
...
8:                                                ; preds = %4
  %9 = getelementptr inbounds %85, %85* %5, i64 0, i32 0
  store i32 %0, i32* %9, align 4
  %10 = getelementptr inbounds %85, %85* %5, i64 0, i32 1
  store i16 1, i16* %10, align 4
  %11 = call i32 @poll(%85* nonnull %5, i64 1, i32 %3) #8
  %12 = icmp eq i32 %11, 0
...
14:                                               ; preds = %13, %45
  %15 = phi i8* [ %50, %45 ], [ %1, %13 ]
  %16 = phi i32 [ %47, %45 ], [ %2, %13 ]
...
21:                                               ; preds = %20
  %22 = call i64 @recv(i32 %0, i8* %15, i64 %18, i32 2) #8
...
31:                                               ; preds = %25, %20, %29
  %32 = phi i32 [ %30, %29 ], [ %16, %20 ], [ -1, %25 ]
  %33 = sext i32 %32 to i64
  br label %34

34:                                               ; preds = %38, %31
  %35 = call i64 @recv(i32 %0, i8* %15, i64 %33, i32 0) #8
...
42:                                               ; preds = %38
  %43 = load i32, i32* getelementptr inbounds (%0, %0* @phpdbg_globals, i64 0, i32 38, i64 2, i32 1), align 8
  %44 = call i64 @write(i32 %43, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @1, i64 0, i64 0), i64 26) #8
  br label %56
