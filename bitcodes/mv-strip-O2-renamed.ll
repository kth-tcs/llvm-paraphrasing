; ModuleID = 'mv-strip-O2-renamed.bc'
...
45:                                               ; preds = %40, %36
  ...
  %48 = tail call i8* @xmemdupz(i8* %32, i64 %47) #10
  br i1 %27, label %53, label %49

49:                                               ; preds = %45
  %50 = tail call i8* @__xpg_basename(i8* %48) #10
  %51 = tail call i8* @xstrdup(i8* %50) #10
  %52 = getelementptr inbounds i8*, i8** %18, i64 %30
  store i8* %51, i8** %52, align 8
  tail call void @free(i8* %48) #10
  br label %55

53:                                               ; preds = %45
  %54 = getelementptr inbounds i8*, i8** %18, i64 %30
...
63:                                               ; preds = %63, %61
  ...
  %67 = tail call i8* @prefix_path(i8* %0, i32 %10, i8* %66) #10
