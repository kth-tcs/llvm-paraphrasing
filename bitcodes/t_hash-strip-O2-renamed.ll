; ModuleID = 't_hash-strip-O2-renamed.bc'
...
35:                                               ; preds = %25, %27
  %36 = tail call %28* @dictCreate(%29* nonnull @hashDictType, i8* null) #6
...
43:                                               ; preds = %67, %35
  %44 = call i32 @hashTypeNext(%35* %17)
  %45 = icmp eq i32 %44, -1
...
46:                                               ; preds = %43
  ...
  call void @hashTypeCurrentObject(%35* %17, i32 1, i8** nonnull %6, i32* nonnull %7, i64* nonnull %8) #6
...
49:                                               ; preds = %46
  ...
  %52 = call i8* @sdsnewlen(i8* nonnull %47, i64 %51) #6
  br label %56

53:                                               ; preds = %46
  %54 = load i64, i64* %8, align 8
  %55 = call i8* @sdsfromlonglong(i64 %54) #6
  br label %56
...
56:                                               ; preds = %49, %53
  ...
  call void @hashTypeCurrentObject(%35* %17, i32 2, i8** nonnull %3, i32* nonnull %4, i64* nonnull %5) #6
...
60:                                               ; preds = %56
  ...
  %63 = call i8* @sdsnewlen(i8* nonnull %58, i64 %62) #6
  br label %67

64:                                               ; preds = %56
  %65 = load i64, i64* %5, align 8
  %66 = call i8* @sdsfromlonglong(i64 %65) #6
  br label %67
...
67:                                               ; preds = %60, %64
  ...
  %69 = call i32 @dictAdd(%28* %36, i8* %57, i8* %68) #6
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %43, label %71

71:                                               ; preds = %67
  %72 = getelementptr inbounds %9, %9* %0, i64 0, i32 2
  %73 = load i8*, i8** %72, align 8
  %74 = call i64 @ziplistBlobLen(i8* %73) #6
  call void @serverLogHexDump(i32 3, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @9, i64 0, i64 0), i8* %73, i64 %74) #6
...
78:                                               ; preds = %75
  %79 = getelementptr inbounds i8, i8* %16, i64 32
  %80 = bitcast i8* %79 to %36**
  %81 = load %36*, %36** %80, align 8
  call void @dictReleaseIterator(%36* %81) #6
  br label %82

82:                                               ; preds = %75, %78
  call void @zfree(i8* nonnull %16) #6
  %83 = getelementptr inbounds %9, %9* %0, i64 0, i32 2
  %84 = load i8*, i8** %83, align 8
  call void @zfree(i8* %84) #6
  %85 = load i32, i32* %9, align 8
  %86 = and i32 %85, -241
  %87 = or i32 %86, 32
  store i32 %87, i32* %9, align 8
  %88 = bitcast i8** %83 to %28**
  store %28* %36, %28** %88, align 8
  br label %90
...
51:                                               ; preds = %50, %49
  %52 = tail call i8* @zmalloc(i64 48) #6
  %53 = bitcast i8* %52 to %35*
  %54 = bitcast i8* %52 to %9**
  store %9* %12, %9** %54, align 8
...
61:                                               ; preds = %51
  ...
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %62, i8 0, i64 16, i1 false) #6
  br label %71

63:                                               ; preds = %51
  %64 = getelementptr inbounds %9, %9* %12, i64 0, i32 2
  %65 = bitcast i8** %64 to %28**
  %66 = load %28*, %28** %65, align 8
  %67 = tail call %36* @dictGetIterator(%28* %66) #6
  %68 = getelementptr inbounds i8, i8* %52, i64 32
  %69 = bitcast i8* %68 to %36**
  store %36* %67, %36** %69, align 8
  br label %71
...
71:                                               ; preds = %61, %63
  %72 = tail call i32 @hashTypeNext(%35* nonnull %53)
  %73 = icmp eq i32 %72, -1
  br i1 %73, label %86, label %74

74:                                               ; preds = %71, %82
  %75 = phi i32 [ %83, %82 ], [ 0, %71 ]
  br i1 %42, label %76, label %78

76:                                               ; preds = %74
  tail call fastcc void @25(%23* %0, %35* %53, i32 1)
  %77 = add nsw i32 %75, 1
  br label %78
...
80:                                               ; preds = %78
  tail call fastcc void @25(%23* %0, %35* %53, i32 2)
  %81 = add nsw i32 %79, 1
  br label %82

82:                                               ; preds = %78, %80
  %83 = phi i32 [ %81, %80 ], [ %79, %78 ]
  %84 = tail call i32 @hashTypeNext(%35* %53)
  %85 = icmp eq i32 %84, -1
  br i1 %85, label %86, label %74

86:                                               ; preds = %82, %71
  %87 = phi i32 [ 0, %71 ], [ %83, %82 ]
  %88 = load i32, i32* %59, align 8
  %89 = icmp eq i32 %88, 2
  br i1 %89, label %90, label %94

90:                                               ; preds = %86
  %91 = getelementptr inbounds i8, i8* %52, i64 32
  %92 = bitcast i8* %91 to %36**
  %93 = load %36*, %36** %92, align 8
  tail call void @dictReleaseIterator(%36* %93) #6
  br label %94

94:                                               ; preds = %86, %90
  tail call void @zfree(i8* nonnull %52) #6
  %95 = sdiv i32 %87, 2
  %96 = select i1 %46, i32 %87, i32 %95
