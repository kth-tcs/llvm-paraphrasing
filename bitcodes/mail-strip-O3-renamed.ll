; ModuleID = 'mail-strip-O3-renamed.bc'
...
132:                                              ; preds = %3
  %133 = bitcast %7* %2 to %2**
  %134 = load %2*, %2** %133, align 8
  %135 = getelementptr inbounds %2, %2* %134, i64 0, i32 3
  %136 = load %6*, %6** %135, align 8
  %137 = getelementptr inbounds %2, %2* %134, i64 0, i32 4
  %138 = load i32, i32* %137, align 8
  %139 = zext i32 %138 to i64
  %140 = getelementptr inbounds %6, %6* %136, i64 %139
  %141 = icmp eq i32 %138, 0
  br i1 %141, label %166, label %142

142:                                              ; preds = %132
  %143 = getelementptr inbounds %11, %11* %1, i64 0, i32 3, i64 0
  br label %144

144:                                              ; preds = %142, %161
  %145 = phi %6* [ %136, %142 ], [ %162, %161 ]
  %146 = getelementptr inbounds %6, %6* %145, i64 0, i32 0
  %147 = getelementptr inbounds %6, %6* %145, i64 0, i32 0, i32 1
...
151:                                              ; preds = %144
  %152 = getelementptr inbounds %6, %6* %145, i64 0, i32 2
  %153 = load %11*, %11** %152, align 8
  %154 = icmp eq %11* %153, null
  br i1 %154, label %157, label %155

155:                                              ; preds = %151
  %156 = getelementptr inbounds %11, %11* %153, i64 0, i32 3, i64 0
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @44, i64 0, i64 0), i8* nonnull %156) #9
  br label %161

157:                                              ; preds = %151
  %158 = icmp eq i8 %149, 6
  br i1 %158, label %160, label %159

159:                                              ; preds = %157
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @45, i64 0, i64 0), i8* nonnull %143) #9
  br label %161

160:                                              ; preds = %157
  tail call fastcc void @46(%36* %0, %11* %1, %7* nonnull %146) #9
  br label %161

161:                                              ; preds = %160, %159, %155, %144
  %162 = getelementptr inbounds %6, %6* %145, i64 1
  %163 = icmp eq %6* %162, %140
  br i1 %163, label %166, label %144

164:                                              ; preds = %3
  %165 = getelementptr inbounds %11, %11* %1, i64 0, i32 3, i64 0
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @43, i64 0, i64 0), i8* nonnull %165) #9
  br label %166

166:                                              ; preds = %161, %132, %20, %46, %164, %124
  ret void
}
