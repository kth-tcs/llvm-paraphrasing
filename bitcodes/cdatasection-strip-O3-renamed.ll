; ModuleID = 'cdatasection-strip-O3-renamed.bc'
...
12:                                               ; preds = %2
  ...
  %16 = call %33* @xmlNewCDataBlock(%34* null, i8* %13, i32 %15) #3
...
20:                                               ; preds = %12
  %21 = bitcast %29* %5 to %15**
  %22 = load %15*, %15** %21, align 8
  %23 = getelementptr inbounds %15, %15* %22, i64 -1, i32 4
  %24 = bitcast %7** %23 to %39*
  %25 = call %33* @dom_object_get_node(%39* nonnull %24) #3
  %26 = icmp eq %33* %25, null
  br i1 %26, label %28, label %27

27:                                               ; preds = %20
  call void @php_libxml_node_free_resource(%33* nonnull %25) #3
  br label %28

28:                                               ; preds = %20, %27
  %29 = bitcast %7** %23 to %42*
  %30 = bitcast %7** %23 to i8*
  %31 = call i32 @php_libxml_increment_node_ptr(%42* nonnull %29, %33* nonnull %16, i8* nonnull %30) #3
  br label %32
...
declare dso_local %33* @xmlNewCDataBlock(%34*, i8*, i32) local_unnamed_addr #2
