; ModuleID = 't_list-strip-O2-renamed.bc'
...
define dso_local void @rpoplpushCommand(%23* %0) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds %34, %34* @shared, i64 0, i32 10, i64 %10
  %12 = load %9*, %9** %11, align 8
  %13 = tail call %9* @lookupKeyWriteOrReply(%23* %0, %9* %7, %9* %12) #5
  %14 = icmp eq %9* %13, null
...
24:                                               ; preds = %18
  %25 = getelementptr inbounds %9, %9* %13, i64 0, i32 2
  %26 = bitcast i8** %25 to %35**
  %27 = load %35*, %35** %26, align 8
  %28 = tail call i64 @quicklistCount(%35* %27) #5
  %29 = icmp eq i64 %28, 0
...
45:                                               ; preds = %42, %31
  ...
  %47 = bitcast %9** %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %47) #5
  store %9* null, %9** %3, align 8
  %48 = load i32, i32* %19, align 8
  %49 = and i32 %48, 240
  %50 = icmp eq i32 %49, 144
  br i1 %50, label %51, label %62

51:                                               ; preds = %45
  %52 = load %35*, %35** %26, align 8
  %53 = bitcast %9** %3 to i8**
  %54 = call i32 @quicklistPopCustom(%35* %52, i32 -1, i8** nonnull %53, i32* null, i64* nonnull %2, i8* (i8*, i32)* nonnull @listPopSaver) #5
  %55 = icmp eq i32 %54, 0
...
59:                                               ; preds = %51
  ...
  %61 = call %9* @createStringObjectFromLongLong(i64 %60) #5
...
63:                                               ; preds = %51, %59
  %64 = phi %9* [ %56, %51 ], [ %61, %59 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %47) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %46) #5
  call void @incrRefCount(%9* %40) #5
  %65 = load %9**, %9*** %4, align 8
  %66 = getelementptr inbounds %9*, %9** %65, i64 2
  %67 = load %9*, %9** %66, align 8
  call void @rpoplpushHandlePush(%23* nonnull %0, %9* %67, %9* %37, %9* %64)
  call void @decrRefCount(%9* %64) #5
  %68 = load %1*, %1** %32, align 8
  %69 = getelementptr inbounds %1, %1* %68, i64 0, i32 5
  %70 = load i32, i32* %69, align 8
  call void @notifyKeyspaceEvent(i32 16, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i64 0, i64 0), %9* %40, i32 %70) #5
...
75:                                               ; preds = %63
  %76 = load %35*, %35** %26, align 8
  %77 = call i64 @quicklistCount(%35* %76) #5
  %78 = icmp eq i64 %77, 0
  br i1 %78, label %79, label %85

79:                                               ; preds = %75
  %80 = load %1*, %1** %32, align 8
  %81 = call i32 @dbDelete(%1* %80, %9* %40) #5
  %82 = load %1*, %1** %32, align 8
  %83 = getelementptr inbounds %1, %1* %82, i64 0, i32 5
  %84 = load i32, i32* %83, align 8
  call void @notifyKeyspaceEvent(i32 4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @15, i64 0, i64 0), %9* %40, i32 %84) #5
  br label %85

85:                                               ; preds = %79, %75
  %86 = load %1*, %1** %32, align 8
  call void @signalModifiedKey(%23* nonnull %0, %1* %86, %9* %40) #5
  call void @decrRefCount(%9* %40) #5
  %87 = load i64, i64* getelementptr inbounds (%0, %0* @server, i64 0, i32 171), align 8
  %88 = add nsw i64 %87, 1
  store i64 %88, i64* getelementptr inbounds (%0, %0* @server, i64 0, i32 171), align 8
  %89 = getelementptr inbounds %23, %23* %0, i64 0, i32 11
  %90 = load %8*, %8** %89, align 8
  %91 = getelementptr inbounds %8, %8* %90, i64 0, i32 1
  %92 = load void (%23*)*, void (%23*)** %91, align 8
  %93 = icmp eq void (%23*)* %92, @brpoplpushCommand
  br i1 %93, label %94, label %101

94:                                               ; preds = %85
  %95 = load %9*, %9** getelementptr inbounds (%34, %34* @shared, i64 0, i32 43), align 8
  %96 = load %9**, %9*** %4, align 8
  %97 = getelementptr inbounds %9*, %9** %96, i64 1
  %98 = load %9*, %9** %97, align 8
  %99 = getelementptr inbounds %9*, %9** %96, i64 2
  %100 = load %9*, %9** %99, align 8
  call void (%23*, i32, ...) @rewriteClientCommandVector(%23* nonnull %0, i32 3, %9* %95, %9* %98, %9* %100) #5
  br label %101

101:                                              ; preds = %42, %30, %85, %94, %1, %15
  ret void
}
...
32:                                               ; preds = %27
  %33 = tail call i32 @checkType(%23* nonnull %0, %9* nonnull %30, i32 1) #5
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %35, label %47

35:                                               ; preds = %32, %27
  tail call void @rpoplpushHandlePush(%23* nonnull %0, %9* nonnull %2, %9* %30, %9* %4)
  %36 = load i64, i64* bitcast (%9** getelementptr inbounds (%34, %34* @shared, i64 0, i32 43) to i64*), align 8
  %37 = bitcast [3 x %9*]* %7 to i64*
  store i64 %36, i64* %37, align 16
  %38 = getelementptr inbounds [3 x %9*], [3 x %9*]* %7, i64 0, i64 1
  store %9* %1, %9** %38, align 8
  %39 = getelementptr inbounds [3 x %9*], [3 x %9*]* %7, i64 0, i64 2
  store %9* %2, %9** %39, align 16
  %40 = load %8*, %8** getelementptr inbounds (%0, %0* @server, i64 0, i32 79), align 8
  %41 = getelementptr inbounds %1, %1* %3, i64 0, i32 5
  %42 = load i32, i32* %41, align 8
  %43 = getelementptr inbounds [3 x %9*], [3 x %9*]* %7, i64 0, i64 0
  call void @propagate(%8* %40, i32 %42, %9** nonnull %43, i32 3, i32 3) #5
  %44 = load %1*, %1** %28, align 8
  %45 = getelementptr inbounds %1, %1* %44, i64 0, i32 5
  %46 = load i32, i32* %45, align 8
  call void @notifyKeyspaceEvent(i32 16, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i64 0, i64 0), %9* %1, i32 %46) #5
  br label %47

47:                                               ; preds = %10, %35, %32
  %48 = phi i32 [ -1, %32 ], [ 0, %35 ], [ 0, %10 ]
