; ModuleID = 'generic-strip-O2-renamed.bc'
...
55:                                               ; preds = %36, %51
  %56 = phi i64 [ %50, %36 ], [ %54, %51 ]
  %57 = phi i32 [ %34, %36 ], [ %52, %51 ]
  %58 = load void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)*, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %39, align 8
  call void %58(%2* nonnull %29, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32, %0* %3, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32) #5
  br i1 %40, label %51, label %59

59:                                               ; preds = %55, %91
  %60 = phi i64 [ %104, %91 ], [ 0, %55 ]
  %61 = phi [1 x %1]* [ %105, %91 ], [ %5, %55 ]
...
64:                                               ; preds = %63, %64
  %65 = phi i64 [ %76, %64 ], [ %48, %63 ]
  %66 = phi i32 [ %74, %64 ], [ %42, %63 ]
  %67 = phi i32 [ %73, %64 ], [ 0, %63 ]
  %68 = shl i32 %67, 1
  %69 = getelementptr inbounds [1 x %1], [1 x %1]* %61, i64 %65, i64 0
  %70 = call i32 @__gmpz_tstbit(%1* %69, i64 %56) #6
  %71 = icmp ne i32 %70, 0
  ...
  %76 = add nsw i64 %65, -1
  br i1 %75, label %64, label %91

77:                                               ; preds = %59
  br i1 %47, label %78, label %91

78:                                               ; preds = %77, %78
  %79 = phi i64 [ %90, %78 ], [ %49, %77 ]
  %80 = phi i32 [ %88, %78 ], [ %46, %77 ]
  %81 = phi i32 [ %87, %78 ], [ 0, %77 ]
  %82 = shl i32 %81, 1
  %83 = getelementptr inbounds [1 x %1], [1 x %1]* %61, i64 %79, i64 0
  %84 = call i32 @__gmpz_tstbit(%1* %83, i64 %56) #6
  %85 = icmp ne i32 %84, 0
...
91:                                               ; preds = %78, %64, %77, %63
  %92 = phi i32 [ 0, %63 ], [ 0, %77 ], [ %73, %64 ], [ %87, %78 ]
  %93 = load void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)*, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %44, align 8
  %94 = getelementptr inbounds [1 x %1]*, [1 x %1]** %23, i64 %60
  %95 = load [1 x %1]*, [1 x %1]** %94, align 8
  %96 = sext i32 %92 to i64
  %97 = getelementptr inbounds [1 x %1], [1 x %1]* %95, i64 %96, i64 0
  %98 = getelementptr inbounds [1 x %1]*, [1 x %1]** %25, i64 %60
  %99 = load [1 x %1]*, [1 x %1]** %98, align 8
  %100 = getelementptr inbounds [1 x %1], [1 x %1]* %99, i64 %96, i64 0
  %101 = getelementptr inbounds [1 x %1]*, [1 x %1]** %27, i64 %60
  %102 = load [1 x %1]*, [1 x %1]** %101, align 8
  %103 = getelementptr inbounds [1 x %1], [1 x %1]* %102, i64 %96, i64 0
  call void %93(%2* nonnull %29, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32, %0* %3, %1* nonnull %30, %1* nonnull %31, %1* nonnull %32, %1* %97, %1* %100, %1* %103) #5
  %104 = add nuw i64 %60, 1
  %105 = getelementptr inbounds [1 x %1], [1 x %1]* %61, i64 %20
  %106 = icmp eq i64 %104, %18
  br i1 %106, label %51, label %59
