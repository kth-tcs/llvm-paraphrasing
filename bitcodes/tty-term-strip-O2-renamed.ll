; ModuleID = 'tty-term-strip-O2-renamed.bc'
...
32:                                               ; preds = %29, %114
  %33 = phi i8 [ %31, %29 ], [ %116, %114 ]
  %34 = phi i64 [ %27, %29 ], [ 0, %114 ]
  %35 = phi i64 [ %26, %29 ], [ %38, %114 ]
  br label %13
...
61:                                               ; preds = %58, %59, %45, %50
  ...
  %63 = phi i32 [ 0, %50 ], [ 0, %45 ], [ 1, %58 ], [ 0, %59 ]
...
72:                                               ; preds = %61, %66, %71, %70
  %73 = icmp eq i32 %63, 0
  br label %74

74:                                               ; preds = %110, %72
  %75 = phi i64 [ 0, %72 ], [ %111, %110 ]
...
83:                                               ; preds = %80
  %84 = getelementptr inbounds %88, %88* %82, i64 0, i32 0
  store i32 0, i32* %84, align 8
  br label %110

85:                                               ; preds = %80
  %86 = getelementptr inbounds [221 x %91], [221 x %91]* @4, i64 0, i64 %75, i32 0
...
88:                                               ; preds = %85
  %89 = getelementptr inbounds %88, %88* %82, i64 0, i32 0
  %90 = load i32, i32* %89, align 8
  %91 = icmp eq i32 %90, 1
  %92 = getelementptr inbounds %88, %88* %81, i64 %75, i32 1, i32 0
...
95:                                               ; preds = %88, %93
  %96 = call i8* @xstrdup(i8* %62) #10
  store i8* %96, i8** %92, align 8
  store i32 1, i32* %89, align 8
  br label %110

97:                                               ; preds = %85
  %98 = call i64 @strtonum(i8* %62, i64 0, i64 2147483647, i8** nonnull %4) #10
...
101:                                              ; preds = %97
  ...
  %103 = getelementptr inbounds %88, %88* %81, i64 %75, i32 1
  %104 = bitcast %89* %103 to i32*
  store i32 %102, i32* %104, align 8
  %105 = getelementptr inbounds %88, %88* %82, i64 0, i32 0
  store i32 2, i32* %105, align 8
  br label %110

106:                                              ; preds = %85
  %107 = getelementptr inbounds %88, %88* %81, i64 %75, i32 1
  %108 = bitcast %89* %107 to i32*
  store i32 1, i32* %108, align 8
  %109 = getelementptr inbounds %88, %88* %82, i64 0, i32 0
  store i32 3, i32* %109, align 8
  br label %110

110:                                              ; preds = %97, %74, %95, %101, %106, %85, %83
  %111 = add nuw nsw i64 %75, 1
  %112 = icmp eq i64 %111, 221
...
114:                                              ; preds = %113, %36
  %115 = getelementptr inbounds i8, i8* %1, i64 %38
...
253:                                              ; preds = %252, %253
  ...
  br i1 %257, label %259, label %253

258:                                              ; preds = %32, %34, %36, %38, %162, %156
  call void @tty_term_free(%1* nonnull %9)
  br label %259

259:                                              ; preds = %253, %258
  %260 = phi %1* [ null, %258 ], [ %9, %253 ]
