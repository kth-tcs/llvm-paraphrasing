; ModuleID = 'argv-array-strip-O2-renamed.bc'
...
23:                                               ; preds = %18
  %24 = call i8* @argv_array_push(%1* %0, i8* nonnull %21)
  br label %7
...
5:                                                ; preds = %2, %5
  %6 = phi i8* [ %10, %5 ], [ %3, %2 ]
  %7 = phi i8** [ %9, %5 ], [ %1, %2 ]
  %8 = tail call i8* @argv_array_push(%1* %0, i8* nonnull %6)
