; ModuleID = 'cat-file-strip-O2-renamed.bc'
...
53:                                               ; preds = %46, %50
  ...
  %63 = getelementptr inbounds %56, %56* %2, i64 0, i32 3
...
172:                                              ; preds = %167
  %173 = getelementptr inbounds %51, %51* %3, i64 0, i32 2
  %174 = load i64, i64* %173, align 8
  %175 = icmp eq i64 %171, %174
  br i1 %175, label %178, label %176

176:                                              ; preds = %172
  %177 = call i8* @oid_to_hex(%6* nonnull %79) #9
  call void (i8*, ...) @die(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @64, i64 0, i64 0), i8* %177) #10
  unreachable
...
183:                                              ; preds = %178
  ...
  %185 = call i64 @fwrite(i8* nonnull %157, i64 1, i64 %182, %0* %184) #9
...
188:                                              ; preds = %178
  call void @write_or_die(i32 1, i8* nonnull %157, i64 %182) #9
  br label %189
...
190:                                              ; preds = %146, %148, %189
  %191 = load i32, i32* %63, align 4
  %192 = icmp eq i32 %191, 0
  br i1 %192, label %198, label %193

193:                                              ; preds = %190
  %194 = load %0*, %0** @stdout, align 8
  %195 = call i64 @fwrite(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @52, i64 0, i64 0), i64 1, i64 1, %0* %194) #9
