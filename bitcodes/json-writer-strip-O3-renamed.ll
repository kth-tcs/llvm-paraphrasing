; ModuleID = 'json-writer-strip-O3-renamed.bc'
...
define dso_local void @jw_object_inline_begin_object(%1* %0, i8* %1) local_unnamed_addr #0 {
  ...
  %3 = getelementptr inbounds %1, %1* %0, i64 0, i32 2
  %4 = getelementptr inbounds %1, %1* %0, i64 0, i32 0
  %5 = getelementptr inbounds %1, %1* %0, i64 0, i32 0, i32 0
  %6 = load i64, i64* %5, align 8
  %7 = icmp eq i64 %6, 0
  %8 = getelementptr inbounds %1, %1* %0, i64 0, i32 0, i32 1
...
13:                                               ; preds = %9, %2
  tail call void @strbuf_grow(%0* nonnull %4, i64 1) #6
...
16:                                               ; preds = %13, %9
  ...
  %19 = getelementptr inbounds %1, %1* %0, i64 0, i32 0, i32 2
  ...
  %28 = icmp eq i64 %27, 0
  %29 = getelementptr inbounds %1, %1* %0, i64 0, i32 1, i32 1
...
34:                                               ; preds = %30, %16
  tail call void @strbuf_grow(%0* nonnull %25, i64 1) #6
...
37:                                               ; preds = %30, %34
  ...
  %40 = getelementptr inbounds %1, %1* %0, i64 0, i32 1, i32 2
  %41 = load i8*, i8** %40, align 8
  store i64 %38, i64* %29, align 8
  %42 = getelementptr inbounds i8, i8* %41, i64 %39
  store i8 123, i8* %42, align 1
...
define dso_local void @jw_array_inline_begin_object(%1* %0) local_unnamed_addr #0 {
  ...
  %5 = load i64, i64* %4, align 8
  %6 = icmp eq i64 %5, 0
  %7 = getelementptr inbounds %1, %1* %0, i64 0, i32 0, i32 1
...
12:                                               ; preds = %8, %1
  tail call void @strbuf_grow(%0* nonnull %3, i64 1) #6
  %13 = load i64, i64* %7, align 8
  %14 = add i64 %13, 1
  br label %15

15:                                               ; preds = %12, %8
  %16 = phi i64 [ %10, %8 ], [ %14, %12 ]
  %17 = phi i64 [ %9, %8 ], [ %13, %12 ]
  %18 = getelementptr inbounds %1, %1* %0, i64 0, i32 0, i32 2
  ...
  %27 = icmp eq i64 %26, 0
  %28 = getelementptr inbounds %1, %1* %0, i64 0, i32 1, i32 1
...
33:                                               ; preds = %29, %15
  tail call void @strbuf_grow(%0* nonnull %24, i64 1) #6
...
36:                                               ; preds = %29, %33
  ...
  %39 = getelementptr inbounds %1, %1* %0, i64 0, i32 1, i32 2
  %40 = load i8*, i8** %39, align 8
  store i64 %37, i64* %28, align 8
  %41 = getelementptr inbounds i8, i8* %40, i64 %38
  store i8 123, i8* %41, align 1
