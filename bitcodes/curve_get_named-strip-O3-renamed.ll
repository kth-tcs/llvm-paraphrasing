; ModuleID = 'curve_get_named-strip-O3-renamed.bc'
...
define dso_local %0* @vec_curve_get_named_len(i8* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #2 {
  ...
  %5 = sext i32 %1 to i64
  %6 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 0, i32 0), align 16
  %7 = tail call i32 @strncmp(i8* %0, i8* %6, i64 %5) #8
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %13, label %9

9:                                                ; preds = %3
  %10 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 1, i32 0), align 16
  %11 = tail call i32 @strncmp(i8* %0, i8* %10, i64 %5) #8
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %13, label %75

13:                                               ; preds = %167, %163, %159, %155, %151, %147, %143, %139, %135, %131, %127, %123, %119, %115, %111, %107, %103, %99, %95, %91, %87, %83, %79, %75, %9, %3
  %14 = phi i64 [ 0, %3 ], [ 1, %9 ], [ 2, %75 ], [ 3, %79 ], [ 4, %83 ], [ 5, %87 ], [ 6, %91 ], [ 7, %95 ], [ 8, %99 ], [ 9, %103 ], [ 10, %107 ], [ 11, %111 ], [ 12, %115 ], [ 13, %119 ], [ 14, %123 ], [ 15, %127 ], [ 16, %131 ], [ 17, %135 ], [ 18, %139 ], [ 19, %143 ], [ 20, %147 ], [ 21, %151 ], [ 22, %155 ], [ 23, %159 ], [ 24, %163 ], [ 25, %167 ]
  %15 = phi i8* [ %6, %3 ], [ %10, %9 ], [ %76, %75 ], [ %80, %79 ], [ %84, %83 ], [ %88, %87 ], [ %92, %91 ], [ %96, %95 ], [ %100, %99 ], [ %104, %103 ], [ %108, %107 ], [ %112, %111 ], [ %116, %115 ], [ %120, %119 ], [ %124, %123 ], [ %128, %127 ], [ %132, %131 ], [ %136, %135 ], [ %140, %139 ], [ %144, %143 ], [ %148, %147 ], [ %152, %151 ], [ %156, %155 ], [ %160, %159 ], [ %164, %163 ], [ %168, %167 ]
  %16 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 1
  %17 = load i8*, i8** %16, align 8
  %18 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 2
  %19 = load i8*, i8** %18, align 16
  %20 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 3
  %21 = load i8*, i8** %20, align 8
  %22 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 4
  %23 = load i8*, i8** %22, align 16
  %24 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 5
  %25 = load i8*, i8** %24, align 8
  %26 = getelementptr inbounds [26 x [26 x i8*]], [26 x [26 x i8*]]* bitcast ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves to [26 x [26 x i8*]]*), i64 0, i64 %14, i64 6
  %27 = load i8*, i8** %26, align 16
  %28 = tail call %0* (...) @vec_curve_alloc() #7
  %29 = getelementptr inbounds %0, %0* %28, i64 0, i32 0
  store i8* %15, i8** %29, align 8
  %30 = getelementptr inbounds %0, %0* %28, i64 0, i32 1, i64 0
  %31 = tail call i32 @__gmpz_set_str(%1* nonnull %30, i8* %17, i32 16) #7
  %32 = getelementptr inbounds %0, %0* %28, i64 0, i32 2, i64 0
  %33 = tail call i32 @__gmpz_set_str(%1* nonnull %32, i8* %19, i32 16) #7
  %34 = getelementptr inbounds %0, %0* %28, i64 0, i32 3, i64 0
  %35 = tail call i32 @__gmpz_set_str(%1* nonnull %34, i8* %21, i32 16) #7
  %36 = getelementptr inbounds %0, %0* %28, i64 0, i32 4, i64 0
  %37 = tail call i32 @__gmpz_set_str(%1* nonnull %36, i8* %23, i32 16) #7
  %38 = getelementptr inbounds %0, %0* %28, i64 0, i32 5, i64 0
  %39 = tail call i32 @__gmpz_set_str(%1* nonnull %38, i8* %25, i32 16) #7
  %40 = getelementptr inbounds %0, %0* %28, i64 0, i32 6, i64 0
  %41 = tail call i32 @__gmpz_set_str(%1* nonnull %40, i8* %27, i32 16) #7
  %42 = getelementptr inbounds %0, %0* %28, i64 0, i32 7
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)* @vec_jdbl_generic, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %42, align 8
  %43 = getelementptr inbounds %0, %0* %28, i64 0, i32 8
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)* @vec_jadd_generic, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  %44 = getelementptr inbounds %0, %0* %28, i64 0, i32 9
  store void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)* @vec_jmulsw_generic, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %44, align 8
  %45 = getelementptr inbounds %0, %0* %28, i64 0, i32 10
  store void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)* @vec_jsmul_generic, void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)** %45, align 8
  %46 = getelementptr inbounds %0, %0* %28, i64 0, i32 11
  store %3* (%0*, %1*, %1*, %1*, i64)* @vec_jfmul_precomp_generic, %3* (%0*, %1*, %1*, %1*, i64)** %46, align 8
  %47 = getelementptr inbounds %0, %0* %28, i64 0, i32 12
  store void (%1*, %1*, %1*, %0*, %3*, %1*)* @vec_jfmul_generic, void (%1*, %1*, %1*, %0*, %3*, %1*)** %47, align 8
  %48 = getelementptr inbounds %0, %0* %28, i64 0, i32 13
  store void (%3*)* @vec_jfmul_free_generic, void (%3*)** %48, align 8
  %49 = getelementptr inbounds %0, %0* %28, i64 0, i32 14
  %50 = bitcast i64 (i32, %1*, %1*)** %49 to i8*
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %50, i8 0, i64 16, i1 false) #7
  %51 = bitcast [1 x %1]* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %51) #7
  %52 = getelementptr inbounds [1 x %1], [1 x %1]* %4, i64 0, i64 0
  call void @__gmpz_init(%1* nonnull %52) #7
  call void @__gmpz_sub(%1* nonnull %52, %1* nonnull %32, %1* nonnull %30) #7
  %53 = call i32 @__gmpz_cmp_si(%1* nonnull %52, i64 -3) #8
  %54 = icmp eq i32 %53, 0
  call void @__gmpz_clear(%1* nonnull %52) #7
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %51) #7
  br i1 %54, label %55, label %56

55:                                               ; preds = %13
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)* @vec_jadd_a_eq_neg3_generic, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)* @vec_jdbl_a_eq_neg3_generic, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %42, align 8
  store void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)* @vec_jmulsw_a_eq_neg3_generic, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %44, align 8
  store void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)* @vec_jsmul_a_eq_neg3_generic, void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)** %45, align 8
  store %3* (%0*, %1*, %1*, %1*, i64)* @vec_jfmul_precomp_a_eq_neg3_generic, %3* (%0*, %1*, %1*, %1*, i64)** %46, align 8
  store void (%1*, %1*, %1*, %0*, %3*, %1*)* @vec_jfmul_a_eq_neg3_generic, void (%1*, %1*, %1*, %0*, %3*, %1*)** %47, align 8
  store void (%3*)* @vec_jfmul_free_a_eq_neg3_generic, void (%3*)** %48, align 8
  br label %56
...
58:                                               ; preds = %56
  %59 = call i32 @strncmp(i8* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @127, i64 0, i64 0), i64 %5) #8
  %60 = icmp eq i32 %59, 0
  br i1 %60, label %61, label %63

61:                                               ; preds = %58
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)* @vec_jdbl_nistp224, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %42, align 8
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)* @vec_jadd_nistp224, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  store void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)* @vec_jmulsw_nistp224, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %44, align 8
  store void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)* @vec_jsmul_nistp224, void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)** %45, align 8
  store %3* (%0*, %1*, %1*, %1*, i64)* @vec_jfmul_precomp_nistp224, %3* (%0*, %1*, %1*, %1*, i64)** %46, align 8
  store void (%1*, %1*, %1*, %0*, %3*, %1*)* @vec_jfmul_nistp224, void (%1*, %1*, %1*, %0*, %3*, %1*)** %47, align 8
  store void (%3*)* @vec_jfmul_free_nistp224, void (%3*)** %48, align 8
  %62 = bitcast i64 (i32, %1*, %1*)** %49 to <2 x i64 (i32, %1*, %1*)*>*
  store <2 x i64 (i32, %1*, %1*)*> <i64 (i32, %1*, %1*)* @time_jdbl_nistp224, i64 (i32, %1*, %1*)* @time_jadd_nistp224>, <2 x i64 (i32, %1*, %1*)*>* %62, align 8
  br label %63

63:                                               ; preds = %61, %58
  %64 = call i32 @strncmp(i8* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @126, i64 0, i64 0), i64 %5) #8
  %65 = icmp eq i32 %64, 0
  br i1 %65, label %66, label %68

66:                                               ; preds = %63
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)* @vec_jdbl_nistp256, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %42, align 8
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)* @vec_jadd_nistp256, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  store void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)* @vec_jmulsw_nistp256, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %44, align 8
  store void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)* @vec_jsmul_nistp256, void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)** %45, align 8
  store %3* (%0*, %1*, %1*, %1*, i64)* @vec_jfmul_precomp_nistp256, %3* (%0*, %1*, %1*, %1*, i64)** %46, align 8
  store void (%1*, %1*, %1*, %0*, %3*, %1*)* @vec_jfmul_nistp256, void (%1*, %1*, %1*, %0*, %3*, %1*)** %47, align 8
  store void (%3*)* @vec_jfmul_free_nistp256, void (%3*)** %48, align 8
  %67 = bitcast i64 (i32, %1*, %1*)** %49 to <2 x i64 (i32, %1*, %1*)*>*
  store <2 x i64 (i32, %1*, %1*)*> <i64 (i32, %1*, %1*)* @time_jdbl_nistp256, i64 (i32, %1*, %1*)* @time_jadd_nistp256>, <2 x i64 (i32, %1*, %1*)*>* %67, align 8
  br label %68

68:                                               ; preds = %66, %63
  %69 = call i32 @strncmp(i8* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @125, i64 0, i64 0), i64 %5) #8
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %71, label %73

71:                                               ; preds = %68
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)* @vec_jdbl_nistp521, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*)** %42, align 8
  store void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)* @vec_jadd_nistp521, void (%2*, %1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*, %1*, %1*)** %43, align 8
  store void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)* @vec_jmulsw_nistp521, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %44, align 8
  store void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)* @vec_jsmul_nistp521, void (%1*, %1*, %1*, %0*, [1 x %1]*, [1 x %1]*, [1 x %1]*, [1 x %1]*, i64)** %45, align 8
  store %3* (%0*, %1*, %1*, %1*, i64)* @vec_jfmul_precomp_nistp521, %3* (%0*, %1*, %1*, %1*, i64)** %46, align 8
  store void (%1*, %1*, %1*, %0*, %3*, %1*)* @vec_jfmul_nistp521, void (%1*, %1*, %1*, %0*, %3*, %1*)** %47, align 8
  store void (%3*)* @vec_jfmul_free_nistp521, void (%3*)** %48, align 8
  %72 = bitcast i64 (i32, %1*, %1*)** %49 to <2 x i64 (i32, %1*, %1*)*>*
  store <2 x i64 (i32, %1*, %1*)*> <i64 (i32, %1*, %1*)* @time_jdbl_nistp521, i64 (i32, %1*, %1*)* @time_jadd_nistp521>, <2 x i64 (i32, %1*, %1*)*>* %72, align 8
  br label %73

73:                                               ; preds = %167, %56, %71, %68
  %74 = phi %0* [ %28, %68 ], [ %28, %71 ], [ %28, %56 ], [ null, %167 ]
  ret %0* %74

75:                                               ; preds = %9
  %76 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 2, i32 0), align 16
  %77 = tail call i32 @strncmp(i8* %0, i8* %76, i64 %5) #8
  %78 = icmp eq i32 %77, 0
  br i1 %78, label %13, label %79

79:                                               ; preds = %75
  %80 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 3, i32 0), align 16
  %81 = tail call i32 @strncmp(i8* %0, i8* %80, i64 %5) #8
  %82 = icmp eq i32 %81, 0
  br i1 %82, label %13, label %83

83:                                               ; preds = %79
  %84 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 4, i32 0), align 16
  %85 = tail call i32 @strncmp(i8* %0, i8* %84, i64 %5) #8
  %86 = icmp eq i32 %85, 0
  br i1 %86, label %13, label %87

87:                                               ; preds = %83
  %88 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 5, i32 0), align 16
  %89 = tail call i32 @strncmp(i8* %0, i8* %88, i64 %5) #8
  %90 = icmp eq i32 %89, 0
  br i1 %90, label %13, label %91

91:                                               ; preds = %87
  %92 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 6, i32 0), align 16
  %93 = tail call i32 @strncmp(i8* %0, i8* %92, i64 %5) #8
  %94 = icmp eq i32 %93, 0
  br i1 %94, label %13, label %95

95:                                               ; preds = %91
  %96 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 7, i32 0), align 16
  %97 = tail call i32 @strncmp(i8* %0, i8* %96, i64 %5) #8
  %98 = icmp eq i32 %97, 0
  br i1 %98, label %13, label %99

99:                                               ; preds = %95
  %100 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 8, i32 0), align 16
  %101 = tail call i32 @strncmp(i8* %0, i8* %100, i64 %5) #8
  %102 = icmp eq i32 %101, 0
  br i1 %102, label %13, label %103

103:                                              ; preds = %99
  %104 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 9, i32 0), align 16
  %105 = tail call i32 @strncmp(i8* %0, i8* %104, i64 %5) #8
  %106 = icmp eq i32 %105, 0
  br i1 %106, label %13, label %107

107:                                              ; preds = %103
  %108 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 10, i32 0), align 16
  %109 = tail call i32 @strncmp(i8* %0, i8* %108, i64 %5) #8
  %110 = icmp eq i32 %109, 0
  br i1 %110, label %13, label %111

111:                                              ; preds = %107
  %112 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 11, i32 0), align 16
  %113 = tail call i32 @strncmp(i8* %0, i8* %112, i64 %5) #8
  %114 = icmp eq i32 %113, 0
  br i1 %114, label %13, label %115

115:                                              ; preds = %111
  %116 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 12, i32 0), align 16
  %117 = tail call i32 @strncmp(i8* %0, i8* %116, i64 %5) #8
  %118 = icmp eq i32 %117, 0
  br i1 %118, label %13, label %119

119:                                              ; preds = %115
  %120 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 13, i32 0), align 16
  %121 = tail call i32 @strncmp(i8* %0, i8* %120, i64 %5) #8
  %122 = icmp eq i32 %121, 0
  br i1 %122, label %13, label %123

123:                                              ; preds = %119
  %124 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 14, i32 0), align 16
  %125 = tail call i32 @strncmp(i8* %0, i8* %124, i64 %5) #8
  %126 = icmp eq i32 %125, 0
  br i1 %126, label %13, label %127

127:                                              ; preds = %123
  %128 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 15, i32 0), align 16
  %129 = tail call i32 @strncmp(i8* %0, i8* %128, i64 %5) #8
  %130 = icmp eq i32 %129, 0
  br i1 %130, label %13, label %131

131:                                              ; preds = %127
  %132 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 16, i32 0), align 16
  %133 = tail call i32 @strncmp(i8* %0, i8* %132, i64 %5) #8
  %134 = icmp eq i32 %133, 0
  br i1 %134, label %13, label %135

135:                                              ; preds = %131
  %136 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 17, i32 0), align 16
  %137 = tail call i32 @strncmp(i8* %0, i8* %136, i64 %5) #8
  %138 = icmp eq i32 %137, 0
  br i1 %138, label %13, label %139

139:                                              ; preds = %135
  %140 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 18, i32 0), align 16
  %141 = tail call i32 @strncmp(i8* %0, i8* %140, i64 %5) #8
  %142 = icmp eq i32 %141, 0
  br i1 %142, label %13, label %143

143:                                              ; preds = %139
  %144 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 19, i32 0), align 16
  %145 = tail call i32 @strncmp(i8* %0, i8* %144, i64 %5) #8
  %146 = icmp eq i32 %145, 0
  br i1 %146, label %13, label %147

147:                                              ; preds = %143
  %148 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 20, i32 0), align 16
  %149 = tail call i32 @strncmp(i8* %0, i8* %148, i64 %5) #8
  %150 = icmp eq i32 %149, 0
  br i1 %150, label %13, label %151

151:                                              ; preds = %147
  %152 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 21, i32 0), align 16
  %153 = tail call i32 @strncmp(i8* %0, i8* %152, i64 %5) #8
  %154 = icmp eq i32 %153, 0
  br i1 %154, label %13, label %155

155:                                              ; preds = %151
  %156 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 22, i32 0), align 16
  %157 = tail call i32 @strncmp(i8* %0, i8* %156, i64 %5) #8
  %158 = icmp eq i32 %157, 0
  br i1 %158, label %13, label %159

159:                                              ; preds = %155
  %160 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 23, i32 0), align 16
  %161 = tail call i32 @strncmp(i8* %0, i8* %160, i64 %5) #8
  %162 = icmp eq i32 %161, 0
  br i1 %162, label %13, label %163

163:                                              ; preds = %159
  %164 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 24, i32 0), align 16
  %165 = tail call i32 @strncmp(i8* %0, i8* %164, i64 %5) #8
  %166 = icmp eq i32 %165, 0
  br i1 %166, label %13, label %167

167:                                              ; preds = %163
  %168 = load i8*, i8** getelementptr inbounds ([26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>], [26 x <{ i8*, i8*, i8*, i8*, i8*, i8*, i8*, [19 x i8*] }>]* @named_curves, i64 0, i64 25, i32 0), align 16
  %169 = tail call i32 @strncmp(i8* %0, i8* %168, i64 %5) #8
  %170 = icmp eq i32 %169, 0
  br i1 %170, label %13, label %73
}
