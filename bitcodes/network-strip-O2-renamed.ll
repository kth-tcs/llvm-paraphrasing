; ModuleID = 'network-strip-O2-renamed.bc'
...
32:                                               ; preds = %18, %73
  %33 = phi %31* [ %16, %18 ], [ %76, %73 ]
  %34 = phi i32 [ 0, %18 ], [ %74, %73 ]
  %35 = phi %31** [ %15, %18 ], [ %75, %73 ]
...
53:                                               ; preds = %47
  ...
  %54 = call i32 @setsockopt(i32 %39, i32 41, i32 26, i8* nonnull %24, i32 4) #10
...
56:                                               ; preds = %55
  %57 = call i32 @setsockopt(i32 %39, i32 1, i32 15, i8* nonnull %11, i32 4) #10
  br label %58
...
59:                                               ; preds = %58
  %60 = call i32 @setsockopt(i32 %39, i32 1, i32 6, i8* nonnull %11, i32 4) #10
  br label %61
...
62:                                               ; preds = %61
  %63 = call i32 @setsockopt(i32 %39, i32 6, i32 1, i8* nonnull %11, i32 4) #10
  br label %64

64:                                               ; preds = %61, %62
  %65 = call i32 @bind(i32 %39, %31* nonnull %33, i32 %49) #10
  %66 = icmp eq i32 %65, -1
  br i1 %66, label %67, label %101

67:                                               ; preds = %64
  %68 = tail call i32* @__errno_location() #11
  %69 = load i32, i32* %68, align 4
  br label %70

70:                                               ; preds = %41, %67
  %71 = phi i32 [ %69, %67 ], [ %34, %41 ]
  %72 = call i32 @close(i32 %39) #10
  br label %73

73:                                               ; preds = %32, %70
  %74 = phi i32 [ %34, %32 ], [ %71, %70 ]
  %75 = getelementptr inbounds %31*, %31** %35, i64 1
  %76 = load %31*, %31** %75, align 8
  %77 = icmp eq %31* %76, null
  br i1 %77, label %78, label %32

78:                                               ; preds = %73, %14
  %79 = phi i32 [ 0, %14 ], [ %74, %73 ]
  %80 = icmp eq i32* %5, null
...
82:                                               ; preds = %78, %81
  %83 = icmp eq %15** %4, null
  br i1 %83, label %101, label %84

84:                                               ; preds = %82
  %85 = call i8* @strerror(i32 %79) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %98, i8* align 1 %85, i64 %86, i1 false) #10
  %99 = getelementptr inbounds %15, %15* %90, i64 0, i32 3, i64 %86
  store i8 0, i8* %99, align 1
  %100 = bitcast %15** %4 to i8**
  store i8* %89, i8** %100, align 8
  br label %101

101:                                              ; preds = %64, %82, %84
  %102 = phi i32 [ -1, %84 ], [ -1, %82 ], [ %39, %64 ]
  %103 = icmp eq %31** %15, null
  br i1 %103, label %116, label %104

104:                                              ; preds = %101
  %105 = load %31*, %31** %15, align 8
  %106 = icmp eq %31* %105, null
  br i1 %106, label %114, label %107

107:                                              ; preds = %104, %107
  %108 = phi %31* [ %112, %107 ], [ %105, %104 ]
  %109 = phi %31** [ %111, %107 ], [ %15, %104 ]
  %110 = bitcast %31* %108 to i8*
  call void @_efree(i8* %110) #10
  %111 = getelementptr inbounds %31*, %31** %109, i64 1
  %112 = load %31*, %31** %111, align 8
  %113 = icmp eq %31* %112, null
  br i1 %113, label %114, label %107

114:                                              ; preds = %107, %104
  %115 = bitcast %31** %15 to i8*
  call void @_efree(i8* %115) #10
  br label %116

116:                                              ; preds = %114, %101, %6
  %117 = phi i32 [ -1, %6 ], [ %102, %101 ], [ %102, %114 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #10
