; ModuleID = 'cmd-list-windows-strip-O2-renamed.bc'
...
26:                                               ; preds = %21
  %27 = tail call i8* @format_expand(%74* %25, i8* nonnull %15) #3
  %28 = tail call i32 @format_true(i8* %27) #3
  tail call void @free(i8* %27) #3
  %29 = icmp eq i32 %28, 0
  br i1 %29, label %32, label %30

30:                                               ; preds = %21, %26
  %31 = tail call i8* @format_expand(%74* %25, i8* %14) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @8, i64 0, i64 0), i8* %31) #3
...
32:                                               ; preds = %26, %30
  ...
  %33 = add i32 %23, 1
  %34 = tail call %18* @winlinks_RB_NEXT(%18* nonnull %22) #3
