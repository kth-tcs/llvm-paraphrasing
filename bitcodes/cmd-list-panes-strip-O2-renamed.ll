; ModuleID = 'cmd-list-panes-strip-O2-renamed.bc'
...
30:                                               ; preds = %25
  %31 = tail call i8* @format_expand(%74* %29, i8* nonnull %17) #3
  %32 = tail call i32 @format_true(i8* %31) #3
  tail call void @free(i8* %31) #3
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %36, label %34

34:                                               ; preds = %25, %30
  %35 = tail call i8* @format_expand(%74* %29, i8* %16) #3
  tail call void (%4*, i8*, ...) @cmdq_print(%4* %3, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @9, i64 0, i64 0), i8* %35) #3
...
36:                                               ; preds = %30, %34
  ...
  %37 = add i32 %27, 1
  %38 = getelementptr inbounds %20, %20* %26, i64 0, i32 43, i32 0
