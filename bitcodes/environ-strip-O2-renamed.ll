; ModuleID = 'environ-strip-O2-renamed.bc'
...
12:                                               ; preds = %10, %40
  ...
  %17 = getelementptr inbounds %1, %1* %13, i64 0, i32 0
  %18 = load i8*, i8** %17, align 8
  br i1 %16, label %19, label %20

19:                                               ; preds = %12
  tail call void @environ_clear(%0* %1, i8* %18)
  br label %23

20:                                               ; preds = %12
  %21 = getelementptr inbounds %1, %1* %13, i64 0, i32 2
  %22 = load i32, i32* %21, align 8
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %1, i8* %18, i32 %22, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* nonnull %15)
  br label %23

23:                                               ; preds = %19, %20
  %24 = getelementptr inbounds %1, %1* %13, i64 0, i32 3, i32 1
  %25 = load %1*, %1** %24, align 8
  %26 = icmp eq %1* %25, null
  br i1 %26, label %32, label %27

27:                                               ; preds = %23, %27
  %28 = phi %1* [ %30, %27 ], [ %25, %23 ]
  %29 = getelementptr inbounds %1, %1* %28, i64 0, i32 3, i32 0
  %30 = load %1*, %1** %29, align 8
  %31 = icmp eq %1* %30, null
  br i1 %31, label %40, label %27

32:                                               ; preds = %23
  %33 = getelementptr inbounds %1, %1* %13, i64 0, i32 3, i32 2
  %34 = load %1*, %1** %33, align 8
  %35 = icmp eq %1* %34, null
  br i1 %35, label %52, label %36

36:                                               ; preds = %32
  %37 = getelementptr inbounds %1, %1* %34, i64 0, i32 3, i32 0
  %38 = load %1*, %1** %37, align 8
  %39 = icmp eq %1* %38, %13
  br i1 %39, label %40, label %42

40:                                               ; preds = %27, %42, %36
  %41 = phi %1* [ %34, %36 ], [ %44, %42 ], [ %28, %27 ]
  br label %12

42:                                               ; preds = %36, %48
  %43 = phi %1* [ %44, %48 ], [ %13, %36 ]
  %44 = phi %1* [ %50, %48 ], [ %34, %36 ]
  %45 = getelementptr inbounds %1, %1* %44, i64 0, i32 3, i32 1
  %46 = load %1*, %1** %45, align 8
  %47 = icmp eq %1* %43, %46
  br i1 %47, label %48, label %40

48:                                               ; preds = %42
  %49 = getelementptr inbounds %1, %1* %44, i64 0, i32 3, i32 2
  %50 = load %1*, %1** %49, align 8
  %51 = icmp eq %1* %50, null
...
22:                                               ; preds = %14
  %23 = getelementptr inbounds %1, %1* %7, i64 0, i32 0
...
11:                                               ; preds = %9, %38
  %12 = phi %6* [ %7, %9 ], [ %39, %38 ]
  %13 = tail call %7* @options_array_item_value(%6* nonnull %12) #6
...
18:                                               ; preds = %11, %30
  %19 = phi %1* [ %32, %30 ], [ %16, %11 ]
  %20 = getelementptr inbounds %1, %1* %19, i64 0, i32 0
  %21 = load i8*, i8** %20, align 8
  %22 = tail call i32 @strcmp(i8* %15, i8* %21) #9
  %23 = icmp slt i32 %22, 0
  br i1 %23, label %24, label %26

24:                                               ; preds = %18
  %25 = getelementptr inbounds %1, %1* %19, i64 0, i32 3, i32 0
  br label %30
...
28:                                               ; preds = %26
  %29 = getelementptr inbounds %1, %1* %19, i64 0, i32 3, i32 1
  br label %30

30:                                               ; preds = %28, %24
  %31 = phi %1** [ %25, %24 ], [ %29, %28 ]
  %32 = load %1*, %1** %31, align 8
  %33 = icmp eq %1* %32, null
  br i1 %33, label %34, label %18

34:                                               ; preds = %30, %11
  tail call void @environ_clear(%0* %2, i8* %15)
  br label %38

35:                                               ; preds = %26
  %36 = getelementptr inbounds %1, %1* %19, i64 0, i32 1
  %37 = load i8*, i8** %36, align 8
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %2, i8* %21, i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* %37)
  br label %38

38:                                               ; preds = %35, %34
  %39 = tail call %6* @options_array_next(%6* nonnull %12) #6
  %40 = icmp eq %6* %39, null
...
define dso_local %0* @environ_for_session(%8* readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %5 = load %0*, %0** @global_environ, align 8
...
7:                                                ; preds = %7, %2
  %8 = phi %1** [ %6, %2 ], [ %12, %7 ]
  %9 = phi %1* [ null, %2 ], [ %10, %7 ]
  %10 = load %1*, %1** %8, align 8
  %11 = icmp eq %1* %10, null
  %12 = getelementptr inbounds %1, %1* %10, i64 0, i32 3, i32 0
  br i1 %11, label %13, label %7

13:                                               ; preds = %7
  %14 = bitcast i8* %3 to %0*
  %15 = icmp eq %1* %9, null
...
23:                                               ; preds = %16
  tail call void @environ_clear(%0* %14, i8* %22) #6
  br label %27

24:                                               ; preds = %16
  %25 = getelementptr inbounds %1, %1* %17, i64 0, i32 2
  %26 = load i32, i32* %25, align 8
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* %22, i32 %26, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* nonnull %19) #6
  br label %27

27:                                               ; preds = %24, %23
  %28 = getelementptr inbounds %1, %1* %17, i64 0, i32 3, i32 1
  %29 = load %1*, %1** %28, align 8
  %30 = icmp eq %1* %29, null
  br i1 %30, label %36, label %31

31:                                               ; preds = %27, %31
  %32 = phi %1* [ %34, %31 ], [ %29, %27 ]
  %33 = getelementptr inbounds %1, %1* %32, i64 0, i32 3, i32 0
  %34 = load %1*, %1** %33, align 8
  %35 = icmp eq %1* %34, null
  br i1 %35, label %44, label %31

36:                                               ; preds = %27
  %37 = getelementptr inbounds %1, %1* %17, i64 0, i32 3, i32 2
  %38 = load %1*, %1** %37, align 8
  %39 = icmp eq %1* %38, null
  br i1 %39, label %56, label %40

40:                                               ; preds = %36
  %41 = getelementptr inbounds %1, %1* %38, i64 0, i32 3, i32 0
  %42 = load %1*, %1** %41, align 8
  %43 = icmp eq %1* %42, %17
  br i1 %43, label %44, label %46

44:                                               ; preds = %31, %46, %40
  %45 = phi %1* [ %38, %40 ], [ %48, %46 ], [ %32, %31 ]
  br label %16

46:                                               ; preds = %40, %52
  %47 = phi %1* [ %48, %52 ], [ %17, %40 ]
  %48 = phi %1* [ %54, %52 ], [ %38, %40 ]
  %49 = getelementptr inbounds %1, %1* %48, i64 0, i32 3, i32 1
  %50 = load %1*, %1** %49, align 8
  %51 = icmp eq %1* %47, %50
  br i1 %51, label %52, label %44

52:                                               ; preds = %46
  %53 = getelementptr inbounds %1, %1* %48, i64 0, i32 3, i32 2
  %54 = load %1*, %1** %53, align 8
  %55 = icmp eq %1* %54, null
...
58:                                               ; preds = %56
  %59 = getelementptr inbounds %8, %8* %0, i64 0, i32 17
  %60 = load %0*, %0** %59, align 8
  %61 = getelementptr inbounds %0, %0* %60, i64 0, i32 0
  br label %62

62:                                               ; preds = %62, %58
  %63 = phi %1** [ %61, %58 ], [ %67, %62 ]
  %64 = phi %1* [ null, %58 ], [ %65, %62 ]
  %65 = load %1*, %1** %63, align 8
  %66 = icmp eq %1* %65, null
  %67 = getelementptr inbounds %1, %1* %65, i64 0, i32 3, i32 0
  br i1 %66, label %68, label %62

68:                                               ; preds = %62
  %69 = icmp eq %1* %64, null
  br i1 %69, label %110, label %70

70:                                               ; preds = %68, %98
  %71 = phi %1* [ %99, %98 ], [ %64, %68 ]
  %72 = getelementptr inbounds %1, %1* %71, i64 0, i32 1
  %73 = load i8*, i8** %72, align 8
  %74 = icmp eq i8* %73, null
  %75 = getelementptr inbounds %1, %1* %71, i64 0, i32 0
  %76 = load i8*, i8** %75, align 8
  br i1 %74, label %77, label %78

77:                                               ; preds = %70
  tail call void @environ_clear(%0* %14, i8* %76) #6
  br label %81

78:                                               ; preds = %70
  %79 = getelementptr inbounds %1, %1* %71, i64 0, i32 2
  %80 = load i32, i32* %79, align 8
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* %76, i32 %80, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* nonnull %73) #6
  br label %81

81:                                               ; preds = %78, %77
  %82 = getelementptr inbounds %1, %1* %71, i64 0, i32 3, i32 1
  %83 = load %1*, %1** %82, align 8
  %84 = icmp eq %1* %83, null
  br i1 %84, label %90, label %85

85:                                               ; preds = %81, %85
  %86 = phi %1* [ %88, %85 ], [ %83, %81 ]
...
90:                                               ; preds = %81
  %91 = getelementptr inbounds %1, %1* %71, i64 0, i32 3, i32 2
...
98:                                               ; preds = %85, %100, %94
  %99 = phi %1* [ %92, %94 ], [ %102, %100 ], [ %86, %85 ]
  br label %70

100:                                              ; preds = %94, %106
  %101 = phi %1* [ %102, %106 ], [ %71, %94 ]
...
110:                                              ; preds = %90, %106, %68, %56
  %111 = icmp eq i32 %1, 0
  br i1 %111, label %112, label %116

112:                                              ; preds = %110
  %113 = load %3*, %3** @global_options, align 8
  %114 = tail call i8* @options_get_string(%3* %113, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @4, i64 0, i64 0)) #6
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @5, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* %114)
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @6, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @7, i64 0, i64 0))
  %115 = tail call i8* @getversion() #6
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @8, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0), i8* %115)
  br label %116

116:                                              ; preds = %110, %112
  br i1 %57, label %117, label %120

117:                                              ; preds = %116
  %118 = getelementptr inbounds %8, %8* %0, i64 0, i32 0
  %119 = load i32, i32* %118, align 8
  br label %120

120:                                              ; preds = %116, %117
  %121 = phi i32 [ %119, %117 ], [ -1, %116 ]
  %122 = load i8*, i8** @socket_path, align 8
  %123 = tail call i32 @getpid() #6
  %124 = sext i32 %123 to i64
  tail call void (%0*, i8*, i32, i8*, ...) @environ_set(%0* %14, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @9, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @10, i64 0, i64 0), i8* %122, i64 %124, i32 %121)
  ret %0* %14
}
