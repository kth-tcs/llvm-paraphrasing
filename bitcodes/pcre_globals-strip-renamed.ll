; ModuleID = 'pcre_globals-strip-renamed.bc'
...
@php_pcre_malloc = dso_local global i8* (i64)* @malloc, align 8
@php_pcre_free = dso_local global void (i8*)* @free, align 8
@php_pcre_stack_malloc = dso_local global i8* (i64)* @malloc, align 8
@php_pcre_stack_free = dso_local global void (i8*)* @free, align 8
@php_pcre_callout = dso_local global i32 (%0*)* null, align 8
@php_pcre_stack_guard = dso_local global i32 ()* null, align 8

; Function Attrs: nounwind
declare dso_local noalias i8* @malloc(i64) #0

; Function Attrs: nounwind
declare dso_local void @free(i8*) #0
