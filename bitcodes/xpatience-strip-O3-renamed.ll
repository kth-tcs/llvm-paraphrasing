; ModuleID = 'xpatience-strip-O3-renamed.bc'
...
97:                                               ; preds = %90
  ...
  %98 = getelementptr %2, %2* %3, i64 0, i32 0, i32 6
  %99 = getelementptr inbounds %1, %1* %2, i64 0, i32 2
  %100 = getelementptr %1, %1* %2, i64 0, i32 0
...
209:                                              ; preds = %204
  %210 = getelementptr %2, %2* %3, i64 0, i32 1, i32 6
...
462:                                              ; preds = %456
  ...
  %466 = load %6**, %6*** %210, align 8
  %467 = load i64, i64* %100, align 8
  %468 = add nsw i64 %458, -2
  %469 = getelementptr inbounds %6*, %6** %465, i64 %468
  %470 = load %6*, %6** %469, align 8
  %471 = add nsw i64 %457, -2
  %472 = getelementptr inbounds %6*, %6** %466, i64 %471
  %473 = load %6*, %6** %472, align 8
  %474 = getelementptr inbounds %6, %6* %470, i64 0, i32 1
  %475 = load i8*, i8** %474, align 8
  %476 = getelementptr inbounds %6, %6* %470, i64 0, i32 2
  %477 = load i64, i64* %476, align 8
  %478 = getelementptr inbounds %6, %6* %473, i64 0, i32 1
  %479 = load i8*, i8** %478, align 8
  %480 = getelementptr inbounds %6, %6* %473, i64 0, i32 2
  %481 = load i64, i64* %480, align 8
  %482 = tail call i32 @xdl_recmatch(i8* %475, i64 %477, i8* %479, i64 %481, i64 %467) #7
...
498:                                              ; preds = %493, %522
  ...
  %504 = load %6**, %6*** %210, align 8
  %505 = load i64, i64* %100, align 8
  %506 = add nsw i64 %500, -1
  %507 = getelementptr inbounds %6*, %6** %503, i64 %506
  %508 = load %6*, %6** %507, align 8
  %509 = add nsw i64 %499, -1
  %510 = getelementptr inbounds %6*, %6** %504, i64 %509
  %511 = load %6*, %6** %510, align 8
  %512 = getelementptr inbounds %6, %6* %508, i64 0, i32 1
  %513 = load i8*, i8** %512, align 8
  %514 = getelementptr inbounds %6, %6* %508, i64 0, i32 2
  %515 = load i64, i64* %514, align 8
  %516 = getelementptr inbounds %6, %6* %511, i64 0, i32 1
  %517 = load i8*, i8** %516, align 8
  %518 = getelementptr inbounds %6, %6* %511, i64 0, i32 2
  %519 = load i64, i64* %518, align 8
  %520 = tail call i32 @xdl_recmatch(i8* %513, i64 %515, i8* %517, i64 %519, i64 %505) #7
...
580:                                              ; preds = %416, %434
  %581 = load i64, i64* %100, align 8
  %582 = bitcast %1* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %582) #7
  %583 = and i64 %581, -49153
  ...
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %582) #7
  br label %588
