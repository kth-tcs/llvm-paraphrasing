; ModuleID = 'health-strip-O3-renamed.bc'
...
41:                                               ; preds = %37
  %42 = getelementptr inbounds %40, %40* %13, i64 0, i32 7
  %43 = load i8*, i8** %42, align 8
  %44 = icmp eq i8* %43, null
  br i1 %44, label %51, label %45

45:                                               ; preds = %41
  %46 = load i8*, i8** %11, align 16
  %47 = icmp eq i8* %46, null
  br i1 %47, label %65, label %48

48:                                               ; preds = %45
  %49 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %43, i8* nonnull %46, i8* null, i64 0) #8
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %65, label %51

51:                                               ; preds = %48, %41
  %52 = getelementptr inbounds %40, %40* %13, i64 0, i32 9
  %53 = load i8*, i8** %52, align 8
  %54 = icmp eq i8* %53, null
  br i1 %54, label %125, label %55

55:                                               ; preds = %51
  %56 = load %22*, %22** %9, align 16
  %57 = icmp eq %22* %56, null
  br i1 %57, label %65, label %58

58:                                               ; preds = %55
  %59 = getelementptr inbounds %22, %22* %56, i64 0, i32 6
  %60 = load i8*, i8** %59, align 8
  %61 = icmp eq i8* %60, null
  br i1 %61, label %65, label %62

62:                                               ; preds = %58
  %63 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %53, i8* nonnull %60, i8* null, i64 0) #8
  %64 = icmp eq i32 %63, 0
  br i1 %64, label %65, label %125

65:                                               ; preds = %37, %62, %58, %55, %48, %45, %34, %30, %27, %20, %17
  %66 = getelementptr inbounds %40, %40* %13, i64 0, i32 10
  %67 = load %40*, %40** %66, align 8
  %68 = icmp eq %40* %67, null
  br i1 %68, label %132, label %12

69:                                               ; preds = %7, %128
  %70 = phi %40* [ %130, %128 ], [ %5, %7 ]
  %71 = getelementptr inbounds %40, %40* %70, i64 0, i32 1
  %72 = load i8*, i8** %71, align 8
  %73 = icmp eq i8* %72, null
  br i1 %73, label %80, label %74

74:                                               ; preds = %69
  %75 = load i8*, i8** %8, align 16
  %76 = icmp eq i8* %75, null
  br i1 %76, label %128, label %77

77:                                               ; preds = %74
  %78 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %72, i8* nonnull %75, i8* null, i64 0) #8
  %79 = icmp eq i32 %78, 0
  br i1 %79, label %128, label %80

80:                                               ; preds = %77, %69
  %81 = getelementptr inbounds %40, %40* %70, i64 0, i32 5
  %82 = load i8*, i8** %81, align 8
  %83 = icmp eq i8* %82, null
  br i1 %83, label %94, label %84

84:                                               ; preds = %80
  %85 = load %22*, %22** %9, align 16
  %86 = icmp eq %22* %85, null
  br i1 %86, label %128, label %87

87:                                               ; preds = %84
  %88 = getelementptr inbounds %22, %22* %85, i64 0, i32 9
  %89 = load i8*, i8** %88, align 16
  %90 = icmp eq i8* %89, null
  br i1 %90, label %128, label %91

91:                                               ; preds = %87
  %92 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %82, i8* nonnull %89, i8* null, i64 0) #8
  %93 = icmp eq i32 %92, 0
  br i1 %93, label %128, label %94

94:                                               ; preds = %91, %80
  %95 = getelementptr inbounds %40, %40* %70, i64 0, i32 3
  %96 = load i8*, i8** %95, align 8
  %97 = icmp eq i8* %96, null
  br i1 %97, label %101, label %98

98:                                               ; preds = %94
  %99 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %96, i8* nonnull %1, i8* null, i64 0) #8
  %100 = icmp eq i32 %99, 0
  br i1 %100, label %128, label %101

101:                                              ; preds = %98, %94
  %102 = getelementptr inbounds %40, %40* %70, i64 0, i32 7
...
108:                                              ; preds = %105
  %109 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %103, i8* nonnull %106, i8* null, i64 0) #8
  %110 = icmp eq i32 %109, 0
  br i1 %110, label %128, label %111

111:                                              ; preds = %108, %101
  %112 = getelementptr inbounds %40, %40* %70, i64 0, i32 9
  %113 = load i8*, i8** %112, align 8
  %114 = icmp eq i8* %113, null
  br i1 %114, label %125, label %115

115:                                              ; preds = %111
  %116 = load %22*, %22** %9, align 16
  %117 = icmp eq %22* %116, null
  br i1 %117, label %128, label %118

118:                                              ; preds = %115
  %119 = getelementptr inbounds %22, %22* %116, i64 0, i32 6
  %120 = load i8*, i8** %119, align 8
  %121 = icmp eq i8* %120, null
  br i1 %121, label %128, label %122

122:                                              ; preds = %118
  %123 = tail call i32 @simple_pattern_matches_extract(i8* nonnull %113, i8* nonnull %120, i8* null, i64 0) #8
  %124 = icmp eq i32 %123, 0
  br i1 %124, label %128, label %125

125:                                              ; preds = %122, %111, %51, %62
  %126 = getelementptr inbounds %39, %39* %2, i64 0, i32 1
  %127 = load i32, i32* %126, align 4
  br label %132

128:                                              ; preds = %77, %74, %91, %87, %84, %98, %108, %105, %122, %118, %115
  %129 = getelementptr inbounds %40, %40* %70, i64 0, i32 10
  %130 = load %40*, %40** %129, align 8
  %131 = icmp eq %40* %130, null
  br i1 %131, label %132, label %69

132:                                              ; preds = %128, %65, %3, %125
  %133 = phi i32 [ %127, %125 ], [ 0, %3 ], [ 0, %65 ], [ 0, %128 ]
  ret i32 %133
}
