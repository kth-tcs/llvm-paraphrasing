; ModuleID = 'locks-strip-O3-renamed.bc'
...
define dso_local i32 @netdata_mutex_trylock_debug(i8* nocapture readnone %0, i8* nocapture readnone %1, i64 %2, %0* %3) local_unnamed_addr #3 {
  ...
  %6 = load i64, i64* @debug_flags, align 8
  %7 = and i64 %6, 67108864
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %11, label %9

9:                                                ; preds = %4
  %10 = tail call i64 @now_boottime_usec() #5
  br label %11

11:                                               ; preds = %4, %9
  %12 = bitcast i32* %5 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #5
  %13 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %5) #5
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %17, label %15

15:                                               ; preds = %11
  %16 = call i8* @netdata_thread_tag() #5
  call void (i8*, i8*, i8*, i64, i8*, ...) @error_int(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @1, i64 0, i64 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @2, i64 0, i64 0), i64 15, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @3, i64 0, i64 0), i8* %16, i32 %13) #5
  br label %24
...
24:                                               ; preds = %22, %15
  ...
  %25 = call i32 @pthread_mutex_trylock(%0* %3) #5
  %26 = icmp eq i32 %25, 0
  br i1 %26, label %28, label %27

27:                                               ; preds = %24
  call void @netdata_thread_enable_cancelability() #5
  br label %28
...
24:                                               ; preds = %22, %15
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5
  %25 = call i32 @pthread_rwlock_tryrdlock(%4* %3) #5
  %26 = icmp eq i32 %25, 0
  br i1 %26, label %28, label %27
...
24:                                               ; preds = %22, %15
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5
  %25 = call i32 @pthread_rwlock_trywrlock(%4* %3) #5
  %26 = icmp eq i32 %25, 0
  br i1 %26, label %28, label %27
