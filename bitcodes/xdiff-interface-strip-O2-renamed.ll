; ModuleID = 'xdiff-interface-strip-O2-renamed.bc'
...
define dso_local i32 @xdi_diff_outf(%42* nocapture readonly %0, %42* nocapture readonly %1, void (i8*, i64, i64, i64, i64, i8*, i64)* %2, void (i8*, i8*, i64)* %3, i8* %4, %43* %5, %44* %6) local_unnamed_addr #0 {
  ...
  %12 = getelementptr inbounds %47, %47* %8, i64 0, i32 3
  %13 = bitcast %48* %12 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %13, i8 0, i64 24, i1 false)
  %14 = getelementptr inbounds %47, %47* %8, i64 0, i32 0
  store void (i8*, i64, i64, i64, i64, i8*, i64)* %2, void (i8*, i64, i64, i64, i64, i8*, i64)** %14, align 8
  %15 = getelementptr inbounds %47, %47* %8, i64 0, i32 1
  store void (i8*, i8*, i64)* %3, void (i8*, i8*, i64)** %15, align 8
  %16 = getelementptr inbounds %47, %47* %8, i64 0, i32 2
  store i8* %4, i8** %16, align 8
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %11, i8 0, i64 24, i1 false)
  %17 = icmp eq void (i8*, i64, i64, i64, i64, i8*, i64)* %2, null
  br i1 %17, label %20, label %18

18:                                               ; preds = %7
  %19 = getelementptr inbounds %45, %45* %9, i64 0, i32 1
  store i32 (i8*, i64, i64, i64, i64, i8*, i64)* @20, i32 (i8*, i64, i64, i64, i64, i8*, i64)** %19, align 8
  br label %20

20:                                               ; preds = %7, %18
  %21 = getelementptr inbounds %45, %45* %9, i64 0, i32 2
  store i32 (i8*, %46*, i32)* @21, i32 (i8*, %46*, i32)** %21, align 8
  %22 = bitcast %45* %9 to %47**
  store %47* %8, %47** %22, align 8
  %23 = getelementptr inbounds %47, %47* %8, i64 0, i32 3
  call void @strbuf_init(%48* nonnull %23, i64 0) #10
  %24 = call i32 @xdi_diff(%42* %0, %42* %1, %43* %5, %44* %6, %45* nonnull %9)
  call void @strbuf_release(%48* nonnull %23) #10
