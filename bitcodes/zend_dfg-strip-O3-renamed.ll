; ModuleID = 'zend_dfg-strip-O3-renamed.bc'
...
315:                                              ; preds = %313
  ...
  %333 = icmp ult i32 %10, 4
  %334 = and i64 %316, 3
  %335 = icmp eq i64 %334, 0
  %336 = and i64 %316, 4294967292
  %337 = and i64 %329, 1
  %338 = icmp eq i64 %327, 0
  %339 = sub nsw i64 %329, %337
  %340 = icmp eq i64 %337, 0
  %341 = icmp eq i64 %336, %316
...
446:                                              ; preds = %436
  ...
  br i1 %318, label %667, label %448

448:                                              ; preds = %446
  %449 = sext i32 %444 to i64
  %450 = getelementptr i64, i64* %324, i64 %433
  br label %451

451:                                              ; preds = %448, %568
  %452 = phi i64 [ 1, %448 ], [ %569, %568 ]
  %453 = getelementptr inbounds i32, i32* %447, i64 %452
  %454 = load i32, i32* %453, align 4
  %455 = mul nsw i32 %454, %10
  %456 = sext i32 %455 to i64
  %457 = getelementptr inbounds i64, i64* %19, i64 %456
  br i1 %333, label %523, label %458

458:                                              ; preds = %451
  %459 = getelementptr i64, i64* %325, i64 %456
...
463:                                              ; preds = %458
  br i1 %338, label %503, label %464

464:                                              ; preds = %463, %464
  %465 = phi i64 [ %500, %464 ], [ 0, %463 ]
  %466 = phi i64 [ %501, %464 ], [ %339, %463 ]
  %467 = getelementptr inbounds i64, i64* %457, i64 %465
  ...
  %483 = or i64 %465, 4
  %484 = getelementptr inbounds i64, i64* %457, i64 %483
...
503:                                              ; preds = %464, %463
  ...
  br i1 %340, label %522, label %505

505:                                              ; preds = %503
  %506 = getelementptr inbounds i64, i64* %457, i64 %504
...
522:                                              ; preds = %503, %505
  br i1 %341, label %568, label %523

523:                                              ; preds = %522, %458, %451
  %524 = phi i64 [ 0, %458 ], [ 0, %451 ], [ %336, %522 ]
  %525 = xor i64 %524, -1
  %526 = add nsw i64 %525, %316
  br i1 %335, label %538, label %527

527:                                              ; preds = %523, %527
  %528 = phi i64 [ %535, %527 ], [ %524, %523 ]
  %529 = phi i64 [ %536, %527 ], [ %334, %523 ]
  %530 = getelementptr inbounds i64, i64* %457, i64 %528
...
541:                                              ; preds = %538, %541
  ...
  %543 = getelementptr inbounds i64, i64* %457, i64 %542
  ...
  %549 = getelementptr inbounds i64, i64* %457, i64 %548
  ...
  %555 = getelementptr inbounds i64, i64* %457, i64 %554
  ...
  %561 = getelementptr inbounds i64, i64* %457, i64 %560
...
568:                                              ; preds = %538, %541, %522
  %569 = add nuw nsw i64 %452, 1
  %570 = icmp slt i64 %569, %449
  br i1 %570, label %451, label %572
