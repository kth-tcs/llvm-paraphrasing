; ModuleID = 'nistp256-strip-O3-renamed.bc'
...
define dso_local void @vec_jmul_nistp256_inner(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, %0* nocapture readnone %3, i64* nocapture readonly %4, i64* nocapture readonly %5, i64* nocapture readonly %6, %1* %7) local_unnamed_addr #0 {
...
; Function Attrs: nounwind sspstrong uwtable
define internal fastcc void @0(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, i128* nocapture readonly %3, i128* nocapture readonly %4, i128* nocapture readonly %5) unnamed_addr #0 {
...
; Function Attrs: nounwind sspstrong uwtable
define internal fastcc void @1(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, i128* nocapture readonly %3, i128* nocapture readonly %4, i128* nocapture readonly %5, i64* nocapture readonly %6, i64* nocapture readonly %7, i64* nocapture readonly %8) unnamed_addr #0 {
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @vec_jmulsw_nistp256_inner(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, %0* nocapture readnone %3, i64* nocapture readonly %4, i64* nocapture readonly %5, i64* nocapture readonly %6, %1* %7) local_unnamed_addr #0 {
...
524:                                              ; preds = %317, %35
  ...
  tail call void @llvm.memset.p0i8.i64(i8* align 16 %525, i8 0, i64 64, i1 false)
  %526 = bitcast i128* %1 to i8*
  tail call void @llvm.memset.p0i8.i64(i8* align 16 %526, i8 0, i64 64, i1 false)
  %527 = bitcast i128* %2 to i8*
  tail call void @llvm.memset.p0i8.i64(i8* align 16 %527, i8 0, i64 64, i1 false)
...
532:                                              ; preds = %529, %536
  ...
  %534 = tail call i32 @__gmpz_tstbit(%1* %7, i64 %533) #6
...
550:                                              ; preds = %546, %555
  ...
  %553 = tail call i32 @__gmpz_tstbit(%1* %7, i64 %551) #6
...
571:                                              ; preds = %564, %571
  ...
  %574 = shl i32 %573, 1
  %575 = tail call i32 @__gmpz_tstbit(%1* %7, i64 %572) #6
  %576 = or i32 %575, %574
...
583:                                              ; preds = %579, %568
  ...
  tail call fastcc void @1(i128* %0, i128* %1, i128* %2, i128* %0, i128* %1, i128* %2, i64* %586, i64* %587, i64* %588)
...
59:                                               ; preds = %55, %59
  ...
  %65 = tail call i32 @__gmpz_tstbit(%1* %64, i64 %52) #6
  %66 = icmp ne i32 %65, 0
...
73:                                               ; preds = %72, %73
  ...
  %79 = tail call i32 @__gmpz_tstbit(%1* %78, i64 %52) #6
  %80 = icmp ne i32 %79, 0
...
86:                                               ; preds = %59, %73, %72
  ...
  call fastcc void @1(i128* nonnull %27, i128* nonnull %28, i128* nonnull %29, i128* nonnull %27, i128* nonnull %28, i128* nonnull %29, i64* %91, i64* %94, i64* %97)
  %98 = add nuw i64 %56, 1
...
106:                                              ; preds = %101, %106
  ...
  %112 = tail call i32 @__gmpz_tstbit(%1* %111, i64 %52) #6
...
119:                                              ; preds = %106, %101
  ...
  call fastcc void @1(i128* nonnull %27, i128* nonnull %28, i128* nonnull %29, i128* nonnull %27, i128* nonnull %28, i128* nonnull %29, i64* %124, i64* %127, i64* %130)
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @vec_jsmul_block_batch_nistp256_inner(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, %0* nocapture readnone %3, [4 x i64]* nocapture readonly %4, [4 x i64]* nocapture readonly %5, [4 x i64]* nocapture readonly %6, [1 x %1]* readonly %7, i64 %8, i64 %9, i64 %10, i64 %11) local_unnamed_addr #0 {
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @vec_jsmul_nistp256_inner(i128* nocapture %0, i128* nocapture %1, i128* nocapture %2, %0* nocapture readnone %3, [4 x i64]* nocapture readonly %4, [4 x i64]* nocapture readonly %5, [4 x i64]* nocapture readonly %6, [1 x %1]* %7, i64 %8) local_unnamed_addr #0 {
  %10 = icmp eq i64 %8, 0
...
342:                                              ; preds = %330, %5
  tail call void @vec_jsmul_precomp_nistp256_inner(%4* %12, %0* undef, [4 x i64]* %17, [4 x i64]* %19, [4 x i64]* %21)
