; ModuleID = 'imsg-buffer-strip-O3-renamed.bc'
...
44:                                               ; preds = %41
  %45 = getelementptr inbounds %2, %2* %0, i64 0, i32 0, i32 1
  %46 = bitcast %0*** %45 to i64*
  %47 = getelementptr inbounds %2, %2* %0, i64 0, i32 1
  br label %48

48:                                               ; preds = %82, %44
  %49 = phi i64 [ %34, %44 ], [ %60, %82 ]
  %50 = phi %0* [ %42, %44 ], [ %52, %82 ]
  %51 = getelementptr inbounds %0, %0* %50, i64 0, i32 0, i32 0
  %52 = load %0*, %0** %51, align 8
  %53 = getelementptr inbounds %0, %0* %50, i64 0, i32 5
  %54 = load i64, i64* %53, align 8
  %55 = add i64 %54, %49
  %56 = getelementptr inbounds %0, %0* %50, i64 0, i32 4
...
59:                                               ; preds = %48
  %60 = sub i64 %55, %57
  %61 = icmp eq %0* %52, null
  %62 = getelementptr inbounds %0, %0* %50, i64 0, i32 0, i32 1
  %63 = bitcast %0*** %62 to i64*
  %64 = load i64, i64* %63, align 8
  %65 = ptrtoint %0* %52 to i64
  br i1 %61, label %71, label %66

66:                                               ; preds = %59
  %67 = getelementptr inbounds %0, %0* %52, i64 0, i32 0, i32 1
  %68 = bitcast %0*** %67 to i64*
  store i64 %64, i64* %68, align 8
  %69 = bitcast %0*** %62 to i64**
...
73:                                               ; preds = %71, %66
  ...
  %75 = getelementptr inbounds %0, %0* %50, i64 0, i32 6
  %76 = load i32, i32* %75, align 8
  %77 = icmp eq i32 %76, -1
  br i1 %77, label %82, label %78

78:                                               ; preds = %73
  %79 = call i32 @close(i32 %76) #8
  br label %82

80:                                               ; preds = %48
  %81 = getelementptr inbounds %0, %0* %50, i64 0, i32 5
...
82:                                               ; preds = %78, %73
  ...
  %84 = add i32 %83, -1
  store i32 %84, i32* %47, align 8
  %85 = getelementptr inbounds %0, %0* %50, i64 0, i32 1
  %86 = load i8*, i8** %85, align 8
  %87 = getelementptr inbounds %0, %0* %50, i64 0, i32 2
  %88 = load i64, i64* %87, align 8
  call void @freezero(i8* %86, i64 %88) #8
  %89 = bitcast %0* %50 to i8*
  call void @free(i8* %89) #8
  %90 = icmp ne %0* %52, null
  %91 = icmp ne i64 %60, 0
  %92 = and i1 %90, %91
  br i1 %92, label %48, label %93

93:                                               ; preds = %35, %82, %41, %80, %38, %39
  %94 = phi i32 [ 0, %39 ], [ -1, %38 ], [ 1, %41 ], [ 1, %80 ], [ 1, %82 ], [ -1, %35 ]
...
81:                                               ; preds = %78
  %82 = getelementptr inbounds %2, %2* %0, i64 0, i32 0, i32 1
  %83 = bitcast %0*** %82 to i64*
  %84 = getelementptr inbounds %2, %2* %0, i64 0, i32 1
  br label %85

85:                                               ; preds = %119, %81
  %86 = phi i64 [ %64, %81 ], [ %97, %119 ]
  %87 = phi %0* [ %79, %81 ], [ %89, %119 ]
  %88 = getelementptr inbounds %0, %0* %87, i64 0, i32 0, i32 0
  %89 = load %0*, %0** %88, align 8
  %90 = getelementptr inbounds %0, %0* %87, i64 0, i32 5
  %91 = load i64, i64* %90, align 8
  %92 = add i64 %91, %86
  %93 = getelementptr inbounds %0, %0* %87, i64 0, i32 4
...
96:                                               ; preds = %85
  %97 = sub i64 %92, %94
  %98 = icmp eq %0* %89, null
  %99 = getelementptr inbounds %0, %0* %87, i64 0, i32 0, i32 1
  %100 = bitcast %0*** %99 to i64*
  %101 = load i64, i64* %100, align 8
  %102 = ptrtoint %0* %89 to i64
  br i1 %98, label %108, label %103

103:                                              ; preds = %96
  %104 = getelementptr inbounds %0, %0* %89, i64 0, i32 0, i32 1
  %105 = bitcast %0*** %104 to i64*
  store i64 %101, i64* %105, align 8
  %106 = bitcast %0*** %99 to i64**
...
110:                                              ; preds = %108, %103
  %111 = phi i64* [ %109, %108 ], [ %107, %103 ]
  store i64 %102, i64* %111, align 8
  %112 = getelementptr inbounds %0, %0* %87, i64 0, i32 6
  %113 = load i32, i32* %112, align 8
  %114 = icmp eq i32 %113, -1
  br i1 %114, label %119, label %115

115:                                              ; preds = %110
  %116 = call i32 @close(i32 %113) #8
  br label %119

117:                                              ; preds = %85
  %118 = getelementptr inbounds %0, %0* %87, i64 0, i32 5
...
119:                                              ; preds = %115, %110
  ...
  %121 = add i32 %120, -1
  store i32 %121, i32* %84, align 8
  %122 = getelementptr inbounds %0, %0* %87, i64 0, i32 1
  %123 = load i8*, i8** %122, align 8
  %124 = getelementptr inbounds %0, %0* %87, i64 0, i32 2
  %125 = load i64, i64* %124, align 8
  call void @freezero(i8* %123, i64 %125) #8
  %126 = bitcast %0* %87 to i8*
  call void @free(i8* %126) #8
  %127 = icmp ne %0* %89, null
  %128 = icmp ne i64 %97, 0
  %129 = and i1 %127, %128
  br i1 %129, label %85, label %130

130:                                              ; preds = %65, %119, %78, %117, %68, %69
  %131 = phi i32 [ 0, %69 ], [ -1, %68 ], [ 1, %78 ], [ 1, %117 ], [ 1, %119 ], [ -1, %65 ]
