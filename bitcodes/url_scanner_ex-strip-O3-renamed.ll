; ModuleID = 'url_scanner_ex-strip-O3-renamed.bc'
...
define internal fastcc void @24(%49* nocapture readonly %0, %49* %1, %49* nocapture readonly %2, i8* nocapture readonly %3) unnamed_addr #5 {
  ...
  %6 = getelementptr %49, %49* %0, i64 0, i32 0
...
246:                                              ; preds = %238, %243
  ...
  %253 = getelementptr %49, %49* %2, i64 0, i32 0
...
621:                                              ; preds = %611, %616
  ...
  %628 = getelementptr %49, %49* %2, i64 0, i32 0
...
655:                                              ; preds = %579
  %656 = getelementptr %49, %49* %2, i64 0, i32 0
...
286:                                              ; preds = %651, %284, %281, %33
  ...
  %292 = getelementptr %48, %48* %8, i64 0, i32 5, i32 0
  %293 = getelementptr inbounds %48, %48* %8, i64 0, i32 0, i32 0
  %294 = getelementptr %48, %48* %8, i64 0, i32 10
  %295 = getelementptr %48, %48* %8, i64 0, i32 11, i32 0
...
414:                                              ; preds = %410
  ...
  %416 = load %11*, %11** %295, align 8
  %417 = icmp eq i32 %415, 0
  %418 = select i1 %417, %2* getelementptr inbounds (%16, %16* @basic_globals, i64 0, i32 37), %2* getelementptr inbounds (%16, %16* @basic_globals, i64 0, i32 35)
  %419 = icmp eq %11* %416, null
  br i1 %419, label %515, label %420

420:                                              ; preds = %414
  %421 = getelementptr inbounds %11, %11* %416, i64 0, i32 2
  %422 = load i64, i64* %421, align 8
  %423 = icmp eq i64 %422, 0
  br i1 %423, label %515, label %424

424:                                              ; preds = %420
  %425 = getelementptr inbounds %11, %11* %416, i64 0, i32 3, i64 0
...
444:                                              ; preds = %439
  %445 = getelementptr inbounds %2, %2* %418, i64 0, i32 5
...
510:                                              ; preds = %508, %461, %456, %451, %448, %444
  ...
  %513 = tail call %7* @zend_hash_str_find(%2* nonnull %418, i8* %511, i64 %512) #11
...
818:                                              ; preds = %814, %806
  ...
  %822 = getelementptr %49, %49* %821, i64 0, i32 0
...
124:                                              ; preds = %120
  %125 = getelementptr %48, %48* %0, i64 0, i32 2, i32 0
  %126 = load %11*, %11** %125, align 8
  %127 = icmp eq %11* %126, null
