; ModuleID = 'lauxlib-strip-O2-renamed.bc'
...
9:                                                ; preds = %6
  %10 = tail call i8* @luaL_checklstring(%2* %0, i32 %1, i64* null) #4
  br label %13

11:                                               ; preds = %4
  %12 = tail call i8* @luaL_checklstring(%2* %0, i32 %1, i64* null)
  br label %13
...
17:                                               ; preds = %13, %22
  ...
  %20 = tail call i32 @strcmp(i8* nonnull %19, i8* %14) #9
  %21 = icmp eq i32 %20, 0
...
27:                                               ; preds = %22, %13
  %28 = tail call i8* (%2*, i8*, ...) @lua_pushfstring(%2* %0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @10, i64 0, i64 0), i8* %14) #4
  %29 = tail call i32 @luaL_argerror(%2* %0, i32 %1, i8* %28)
  br label %32
...
15:                                               ; preds = %4
  %16 = tail call i8* @luaL_checklstring(%2* %0, i32 %1, i64* %3)
  br label %17
...
52:                                               ; preds = %44, %31
  %53 = xor i32 %3, -1
  tail call void @lua_settop(%2* %0, i32 %53) #4
  ret void
}
