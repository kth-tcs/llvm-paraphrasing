; ModuleID = 'reset-strip-O2-renamed.bc'
...
36:                                               ; preds = %33
  ...
  %39 = tail call i32 @remove_file_from_index(%23* nonnull @the_index, i8* %38) #10
  br label %58

40:                                               ; preds = %33
  %41 = zext i16 %20 to i32
  %42 = getelementptr inbounds %51, %51* %18, i64 0, i32 0
  %43 = getelementptr inbounds %51, %51* %18, i64 0, i32 1
  %44 = load i8*, i8** %43, align 8
  %45 = tail call %24* @make_cache_entry(%23* nonnull @the_index, i32 %41, %4* %42, i8* %44, i32 0, i32 0) #10
  %46 = icmp eq %24* %45, null
  br i1 %46, label %47, label %51

47:                                               ; preds = %40
  %48 = getelementptr inbounds %51, %51* %18, i64 0, i32 1
  %49 = tail call fastcc i8* @75(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @57, i64 0, i64 0))
  %50 = load i8*, i8** %48, align 8
  tail call void (i8*, ...) @die(i8* %49, i8* %50) #12
  unreachable
...
52:                                               ; preds = %51
  %53 = getelementptr inbounds %24, %24* %45, i64 0, i32 3
  %54 = load i32, i32* %53, align 8
  %55 = or i32 %54, 536870912
  store i32 %55, i32* %53, align 8
  tail call void @set_object_name_for_intent_to_add_entry(%24* nonnull %45) #10
  br label %56

56:                                               ; preds = %51, %52
  %57 = tail call i32 @add_index_entry(%23* nonnull @the_index, %24* nonnull %45, i32 3) #10
  br label %58
