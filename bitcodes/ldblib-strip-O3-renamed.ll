; ModuleID = 'ldblib-strip-O3-renamed.bc'
...
define internal i32 @63(%1* %0) #0 {
  %2 = tail call i64 @luaL_checkinteger(%1* %0, i32 2) #6
  tail call void @luaL_checktype(%1* %0, i32 1, i32 6) #6
  %3 = tail call i32 @lua_iscfunction(%1* %0, i32 1) #6
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %10

5:                                                ; preds = %1
  %6 = trunc i64 %2 to i32
  %7 = tail call i8* @lua_getupvalue(%1* %0, i32 1, i32 %6) #6
  %8 = icmp eq i8* %7, null
  br i1 %8, label %10, label %9

9:                                                ; preds = %5
  tail call void @lua_pushstring(%1* %0, i8* nonnull %7) #6
...
5:                                                ; preds = %1
  %6 = trunc i64 %2 to i32
  %7 = tail call i8* @lua_setupvalue(%1* %0, i32 1, i32 %6) #6
  %8 = icmp eq i8* %7, null
  br i1 %8, label %10, label %9

9:                                                ; preds = %5
  tail call void @lua_pushstring(%1* %0, i8* nonnull %7) #6
  tail call void @lua_insert(%1* %0, i32 -1) #6
  br label %10
...
40:                                               ; preds = %33, %94
  %41 = phi i32 [ %21, %33 ], [ %95, %94 ]
  %42 = phi i1 [ true, %33 ], [ false, %94 ]
  %43 = add nsw i32 %41, 1
  br i1 %42, label %44, label %77

44:                                               ; preds = %40, %71
  %45 = phi i32 [ %74, %71 ], [ %43, %40 ]
  %46 = phi i32 [ %45, %71 ], [ %41, %40 ]
  %47 = icmp sgt i32 %46, 11
  br i1 %47, label %83, label %48

48:                                               ; preds = %44
  call void @lua_pushlstring(%1* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @48, i64 0, i64 0), i64 2) #6
  %49 = call i32 @lua_getinfo(%1* %9, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @49, i64 0, i64 0), %4* nonnull %2) #6
  %50 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @50, i64 0, i64 0), i8* nonnull %34) #6
  %51 = load i32, i32* %35, align 8
  %52 = icmp sgt i32 %51, 0
  br i1 %52, label %53, label %55

53:                                               ; preds = %48
  %54 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @51, i64 0, i64 0), i32 %51) #6
  br label %55
...
59:                                               ; preds = %55
  ...
  %61 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @52, i64 0, i64 0), i8* %60) #6
  br label %71
...
66:                                               ; preds = %62
  %67 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @53, i64 0, i64 0)) #6
  br label %71

68:                                               ; preds = %62
  %69 = load i32, i32* %39, align 8
  %70 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @55, i64 0, i64 0), i8* nonnull %34, i32 %69) #6
  br label %71

71:                                               ; preds = %68, %66, %65, %59
  %72 = call i32 @lua_gettop(%1* %0) #6
  %73 = sub nsw i32 %72, %8
  call void @lua_concat(%1* %0, i32 %73) #6
  %74 = add nsw i32 %45, 1
  %75 = call i32 @lua_getstack(%1* %9, i32 %45, %4* nonnull %2) #6
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %122, label %44

77:                                               ; preds = %40, %116
  %78 = phi i32 [ %119, %116 ], [ %43, %40 ]
  call void @lua_pushlstring(%1* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @48, i64 0, i64 0), i64 2) #6
  %79 = call i32 @lua_getinfo(%1* %9, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @49, i64 0, i64 0), %4* nonnull %2) #6
  %80 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @50, i64 0, i64 0), i8* nonnull %34) #6
  %81 = load i32, i32* %35, align 8
  %82 = icmp sgt i32 %81, 0
  br i1 %82, label %98, label %100

83:                                               ; preds = %44
  %84 = add nsw i32 %46, 11
  %85 = call i32 @lua_getstack(%1* %9, i32 %84, %4* nonnull %2) #6
  %86 = icmp eq i32 %85, 0
...
88:                                               ; preds = %88, %87
  %89 = phi i32 [ %45, %87 ], [ %93, %88 ]
  %90 = add nsw i32 %89, 10
  %91 = call i32 @lua_getstack(%1* %9, i32 %90, %4* nonnull %2) #6
  %92 = icmp eq i32 %91, 0
  %93 = add nsw i32 %89, 1
  br i1 %92, label %94, label %88

94:                                               ; preds = %88, %83
  %95 = phi i32 [ %46, %83 ], [ %89, %88 ]
  %96 = call i32 @lua_getstack(%1* %9, i32 %95, %4* nonnull %2) #6
  %97 = icmp eq i32 %96, 0
  br i1 %97, label %122, label %40

98:                                               ; preds = %77
  %99 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @51, i64 0, i64 0), i32 %81) #6
  br label %100
...
104:                                              ; preds = %100
  ...
  %106 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @52, i64 0, i64 0), i8* %105) #6
  br label %116
...
110:                                              ; preds = %107
  %111 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @53, i64 0, i64 0)) #6
  br label %116
...
113:                                              ; preds = %107
  ...
  %115 = call i8* (%1*, i8*, ...) @lua_pushfstring(%1* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @55, i64 0, i64 0), i8* nonnull %34, i32 %114) #6
  br label %116

116:                                              ; preds = %110, %113, %112, %104
  %117 = call i32 @lua_gettop(%1* %0) #6
  %118 = sub nsw i32 %117, %8
  call void @lua_concat(%1* %0, i32 %118) #6
  %119 = add nsw i32 %78, 1
  %120 = call i32 @lua_getstack(%1* %9, i32 %78, %4* nonnull %2) #6
  %121 = icmp eq i32 %120, 0
  br i1 %121, label %122, label %77

122:                                              ; preds = %94, %71, %116, %30
  %123 = call i32 @lua_gettop(%1* %0) #6
  %124 = sub nsw i32 %123, %8
  call void @lua_concat(%1* %0, i32 %124) #6
  br label %125
