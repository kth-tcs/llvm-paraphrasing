; ModuleID = 'ziplist-strip-O2-renamed.bc'
...
14:                                               ; preds = %13, %11
  ...
  %15 = getelementptr inbounds %2, %2* %5, i64 0, i32 5
...
19:                                               ; preds = %18
  %20 = getelementptr inbounds %2, %2* %5, i64 0, i32 3
  %21 = load i32, i32* %20, align 4
  store i32 %21, i32* %2, align 4
  %22 = getelementptr inbounds %2, %2* %5, i64 0, i32 4
...
28:                                               ; preds = %26
  %29 = getelementptr inbounds %2, %2* %5, i64 0, i32 4
...
44:                                               ; preds = %28
  %45 = bitcast i8* %32 to i24*
  %46 = load i24, i24* %45, align 1
  %47 = sext i24 %46 to i64
  br label %59

48:                                               ; preds = %28
  %49 = bitcast i8* %32 to i64*
...
59:                                               ; preds = %33, %36, %40, %44, %48, %54
  %60 = phi i64 [ %35, %33 ], [ %39, %36 ], [ %43, %40 ], [ %47, %44 ], [ %50, %48 ], [ %57, %54 ]
  store i64 %60, i64* %3, align 8
  br label %61

61:                                               ; preds = %19, %18, %59, %26, %4, %8
  %62 = phi i32 [ 0, %8 ], [ 0, %4 ], [ 1, %26 ], [ 1, %59 ], [ 1, %18 ], [ 1, %19 ]
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %6) #8
  ret i32 %62
}
