; ModuleID = 'window-client-strip-O3-renamed.bc'
...
78:                                               ; preds = %72, %78
  ...
  %86 = tail call i8* @format_single(%98* null, i8* %85, %57* %84, %18* null, %17* null, %11* null) #6
  %87 = load %92*, %92** %77, align 8
  %88 = bitcast %93* %82 to i8*
  %89 = ptrtoint %57* %84 to i64
  %90 = getelementptr inbounds %57, %57* %84, i64 0, i32 0
  %91 = load i8*, i8** %90, align 8
  %92 = tail call %99* @mode_tree_add(%92* %87, %99* null, i8* %88, i64 %89, i8* %91, i8* %86, i32 -1) #6
  tail call void @free(i8* %86) #6
  %93 = add nuw nsw i64 %79, 1
  %94 = load i32, i32* %6, align 8
  %95 = zext i32 %94 to i64
  %96 = icmp ult i64 %93, %95
  br i1 %96, label %78, label %121

97:                                               ; preds = %72, %116
  %98 = phi i64 [ %117, %116 ], [ 0, %72 ]
  %99 = load %93**, %93*** %10, align 8
  %100 = getelementptr inbounds %93*, %93** %99, i64 %98
  %101 = load %93*, %93** %100, align 8
  %102 = getelementptr inbounds %93, %93* %101, i64 0, i32 0
  %103 = load %57*, %57** %102, align 8
  %104 = tail call i8* @format_single(%98* null, i8* nonnull %3, %57* %103, %18* null, %17* null, %11* null) #6
  %105 = tail call i32 @format_true(i8* %104) #6
  %106 = icmp eq i32 %105, 0
  tail call void @free(i8* %104) #6
  br i1 %106, label %116, label %107

107:                                              ; preds = %97
  %108 = load i8*, i8** %75, align 8
  %109 = tail call i8* @format_single(%98* null, i8* %108, %57* %103, %18* null, %17* null, %11* null) #6
  %110 = load %92*, %92** %77, align 8
  %111 = bitcast %93* %101 to i8*
  %112 = ptrtoint %57* %103 to i64
  %113 = getelementptr inbounds %57, %57* %103, i64 0, i32 0
  %114 = load i8*, i8** %113, align 8
  %115 = tail call %99* @mode_tree_add(%92* %110, %99* null, i8* %111, i64 %112, i8* %114, i8* %109, i32 -1) #6
