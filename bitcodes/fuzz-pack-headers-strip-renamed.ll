; ModuleID = 'fuzz-pack-headers-strip-renamed.bc'
...
define dso_local i32 @LLVMFuzzerTestOneInput(i8* %0, i64 %1) #0 {
  ...
  %11 = call i64 @unpack_object_header_buffer(i8* %9, i64 %10, i32* %5, i64* %6)
...
declare dso_local i64 @unpack_object_header_buffer(i8*, i64, i32*, i64*) #2
