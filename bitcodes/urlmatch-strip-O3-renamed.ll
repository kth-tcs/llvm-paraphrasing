; ModuleID = 'urlmatch-strip-O3-renamed.bc'
...
87:                                               ; preds = %82, %66
  %88 = phi i8 [ 0, %66 ], [ 1, %82 ]
  %89 = getelementptr i8, i8* %2, i64 104
  %90 = bitcast i8* %89 to i64*
  %91 = load i64, i64* %90, align 8
  %92 = getelementptr inbounds %1, %1* %6, i64 0, i32 9
...
99:                                               ; preds = %87
  ...
  %102 = getelementptr i8, i8* %2, i64 96
  %103 = bitcast i8* %102 to i64*
  %104 = load i64, i64* %103, align 8
  %105 = getelementptr inbounds i8, i8* %54, i64 %101
  %106 = getelementptr inbounds i8, i8* %50, i64 %104
  br label %107

107:                                              ; preds = %141, %99
  %108 = phi i32 [ %157, %141 ], [ %95, %99 ]
  %109 = phi i32 [ %150, %141 ], [ %94, %99 ]
  %110 = phi i8* [ %153, %141 ], [ %105, %99 ]
