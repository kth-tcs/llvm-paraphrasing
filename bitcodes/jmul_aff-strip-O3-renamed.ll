; ModuleID = 'jmul_aff-strip-O3-renamed.bc'
...
define dso_local void @vec_jmul_aff(%1* %0, %1* %1, %0* %2, %1* %3, %1* %4, %1* %5) local_unnamed_addr #0 {
  ...
  call void @__gmpz_set(%1* nonnull %16, %1* %3) #3
  call void @__gmpz_set(%1* nonnull %17, %1* %4) #3
  call void @vec_affj(%1* nonnull %16, %1* nonnull %17, %1* nonnull %18) #3
  %19 = getelementptr inbounds %0, %0* %2, i64 0, i32 9
  %20 = load void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)*, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %19, align 8
  call void %20(%1* %0, %1* %1, %1* nonnull %15, %0* %2, %1* nonnull %16, %1* nonnull %17, %1* nonnull %18, %1* %5) #3
  call void @vec_jaff(%1* %0, %1* %1, %1* nonnull %15, %0* %2) #3
