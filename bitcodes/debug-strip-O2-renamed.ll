; ModuleID = 'debug-strip-O2-renamed.bc'
...
20:                                               ; preds = %17, %3
  ...
  %22 = select i1 %10, i8* %9, i8* null
  br label %23

23:                                               ; preds = %20, %30
  %24 = phi i64 [ 8, %20 ], [ %32, %30 ]
  %25 = load %9*, %9** %1, align 8
  %26 = getelementptr inbounds %9, %9* %25, i64 0, i32 2
  %27 = load i8*, i8** %26, align 8
  %28 = select i1 %10, i64 %24, i64 0
  %29 = call i32 @je_mallctl(i8* %27, i8* nonnull %8, i64* nonnull %7, i8* %22, i64 %28) #8
...
30:                                               ; preds = %23
  ...
  %33 = icmp eq i64 %32, 0
  br i1 %33, label %38, label %23

34:                                               ; preds = %23
  %35 = call i8* @strerror(i32 %29) #8
  call void (%23*, i8*, ...) @addReplyErrorFormat(%23* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @9, i64 0, i64 0), i8* %35) #8
  br label %40

36:                                               ; preds = %23
  %37 = load i64, i64* %4, align 8
  call void @addReplyLongLong(%23* %0, i64 %37) #8
  br label %40

38:                                               ; preds = %30
  %39 = call i8* @strerror(i32 22) #8
  call void (%23*, i8*, ...) @addReplyErrorFormat(%23* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @9, i64 0, i64 0), i8* %39) #8
  br label %40
...
18:                                               ; preds = %10
  ...
  %20 = call i64 @write(i32 %11, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @162, i64 0, i64 0), i64 5) #8
  %21 = load i64, i64* %14, align 8
  %22 = bitcast [101 x i8*]* %2 to i64*
  store i64 %21, i64* %22, align 16
  call void @backtrace_symbols_fd(i8** nonnull %19, i32 1, i32 %11) #8
  %23 = call i64 @write(i32 %11, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @163, i64 0, i64 0), i64 12) #8
  br label %24

24:                                               ; preds = %10, %18
  call void @backtrace_symbols_fd(i8** nonnull %12, i32 %13, i32 %11) #8
  %25 = load i8*, i8** getelementptr inbounds (%0, %0* @server, i64 0, i32 200), align 8
  %26 = load i8, i8* %25, align 1
  %27 = icmp eq i8 %26, 0
  br i1 %27, label %30, label %28

28:                                               ; preds = %24
  %29 = call i32 @close(i32 %11) #8
  br label %30
