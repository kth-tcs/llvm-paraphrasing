; ModuleID = 'symlinks-strip-O2-renamed.bc'
...
140:                                              ; preds = %136
  ...
  %146 = icmp slt i32 %141, %5
  %147 = load i8*, i8** %113, align 8
  br i1 %146, label %148, label %150

148:                                              ; preds = %140
  %149 = call i32 @__xstat64(i32 1, i8* nonnull %147, %4* nonnull %116) #6
  br label %152

150:                                              ; preds = %140
  %151 = call i32 @__lxstat64(i32 1, i8* nonnull %147, %4* nonnull %116) #6
  br label %152
...
155:                                              ; preds = %152
  %156 = trunc i64 %130 to i32
  store i32 8, i32* %3, align 4
  %157 = tail call i32* @__errno_location() #8
  %158 = load i32, i32* %157, align 4
  %159 = icmp eq i32 %158, 2
  %160 = select i1 %159, i32 10, i32 8
  store i32 %160, i32* %3, align 4
  br label %174

161:                                              ; preds = %152
  %162 = load i32, i32* %117, align 8
...
165:                                              ; preds = %161
  %166 = trunc i64 %130 to i32
  store i32 4, i32* %3, align 4
  br label %174

167:                                              ; preds = %161
  %168 = trunc i64 %130 to i32
...
171:                                              ; preds = %118, %169
  %172 = phi i32 [ %170, %169 ], [ %119, %118 ]
  %173 = load i32, i32* %3, align 4
  br label %174

174:                                              ; preds = %171, %155, %165, %167
  %175 = phi i32 [ 4, %165 ], [ 16, %167 ], [ %160, %155 ], [ %173, %171 ]
  %176 = phi i32 [ %166, %165 ], [ %168, %167 ], [ %156, %155 ], [ %172, %171 ]
  %177 = phi i32 [ %166, %165 ], [ %168, %167 ], [ %156, %155 ], [ %119, %171 ]
  %178 = and i32 %4, 6
  %179 = and i32 %178, %175
...
183:                                              ; preds = %174
  ...
  store i64 %185, i64* %104, align 8
  %187 = getelementptr inbounds %0, %0* %0, i64 0, i32 1
...
188:                                              ; preds = %174
  ...
  %191 = icmp sgt i32 %119, 0
  %192 = and i1 %190, %191
  br i1 %192, label %193, label %198

193:                                              ; preds = %188
  %194 = load i8*, i8** %113, align 8
  %195 = sext i32 %119 to i64
  %196 = getelementptr inbounds i8, i8* %194, i64 %195
  store i8 0, i8* %196, align 1
  store i64 %195, i64* %104, align 8
...
202:                                              ; preds = %198
  %203 = load i8, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @strbuf_slopbuf, i64 0, i64 0), align 1
...
206:                                              ; preds = %201, %202
  %207 = getelementptr inbounds %0, %0* %0, i64 0, i32 1
  store i32 0, i32* %207, align 8
  br label %208

208:                                              ; preds = %82, %183, %206, %193, %98
  %209 = phi i32 [ %2, %98 ], [ %176, %193 ], [ %176, %206 ], [ %176, %183 ], [ %93, %82 ]
