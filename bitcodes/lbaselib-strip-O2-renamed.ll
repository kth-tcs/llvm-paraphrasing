; ModuleID = 'lbaselib-strip-O2-renamed.bc'
...
4:                                                ; preds = %1
  %5 = tail call i32 @luaL_argerror(%1* %0, i32 1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @74, i64 0, i64 0)) #5
  br label %6

6:                                                ; preds = %1, %4
  %7 = tail call i32 @lua_gettop(%1* %0) #5
  %8 = add nsw i32 %7, -1
  %9 = tail call fastcc i32 @118(%1* %0, %1* %2, i32 %8)
  %10 = icmp slt i32 %9, 0
...
12:                                               ; preds = %6
  ...
  %13 = add nsw i32 %9, 1
  %14 = xor i32 %9, -1
  tail call void @lua_insert(%1* %0, i32 %14) #5
  br label %15
...
define internal i32 @115(%1* %0) #0 {
  %2 = alloca %4, align 8
  %3 = tail call %1* @lua_tothread(%1* %0, i32 1) #5
  %4 = icmp eq %1* %3, null
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call i32 @luaL_argerror(%1* %0, i32 1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @74, i64 0, i64 0)) #5
  br label %7
...
9:                                                ; preds = %7
  %10 = tail call i32 @lua_status(%1* %3) #5
...
11:                                               ; preds = %9
  %12 = bitcast %4* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 120, i8* nonnull %12) #5
  %13 = call i32 @lua_getstack(%1* %3, i32 0, %4* nonnull %2) #5
  %14 = icmp sgt i32 %13, 0
  br i1 %14, label %19, label %15

15:                                               ; preds = %11
  %16 = call i32 @lua_gettop(%1* %3) #5
  %17 = icmp eq i32 %16, 0
  %18 = select i1 %17, i64 3, i64 1
  br label %19

19:                                               ; preds = %15, %11
  %20 = phi i64 [ 2, %11 ], [ %18, %15 ]
...
22:                                               ; preds = %7, %9, %19, %21
  %23 = phi i64 [ 3, %21 ], [ %20, %19 ], [ 0, %7 ], [ 1, %9 ]
  %24 = getelementptr inbounds [4 x i8*], [4 x i8*]* @77, i64 0, i64 %23
  %25 = load i8*, i8** %24, align 8
  call void @lua_pushstring(%1* %0, i8* %25) #5
  ret i32 1
}

; Function Attrs: nounwind uwtable
define internal i32 @116(%1* %0) #0 {
  %2 = tail call i32 @112(%1* %0)
