; ModuleID = 'window-strip-O3-renamed.bc'
...
13:                                               ; preds = %6, %13
  %14 = phi %13* [ %16, %13 ], [ %4, %6 ]
  %15 = getelementptr inbounds %13, %13* %14, i64 0, i32 25, i32 1
  %16 = load %13*, %13** %15, align 8
  %17 = icmp eq %13* %16, null
  br i1 %17, label %18, label %13

18:                                               ; preds = %13, %8, %2
  %19 = phi %13* [ null, %2 ], [ %9, %8 ], [ %14, %13 ]
  ret %13* %19
}
...
13:                                               ; preds = %6, %13
  %14 = phi %12* [ %16, %13 ], [ %4, %6 ]
  %15 = getelementptr inbounds %12, %12* %14, i64 0, i32 44, i32 1
  %16 = load %12*, %12** %15, align 8
  %17 = icmp eq %12* %16, null
  br i1 %17, label %18, label %13

18:                                               ; preds = %13, %8, %2
  %19 = phi %12* [ null, %2 ], [ %9, %8 ], [ %14, %13 ]
  ret %12* %19
}
...
23:                                               ; preds = %14, %19, %2
  %24 = tail call %18* @winlinks_RB_REMOVE(%21* %0, %18* nonnull %1)
  %25 = bitcast %18* %1 to i8*
...
45:                                               ; preds = %30, %36, %41, %44
  %46 = getelementptr inbounds %12, %12* %1, i64 0, i32 43, i32 0
  %47 = load %12*, %12** %46, align 8
  %48 = icmp eq %12* %47, null
  %49 = getelementptr inbounds %12, %12* %1, i64 0, i32 43, i32 1
  %50 = bitcast %12*** %49 to i64*
  %51 = load i64, i64* %50, align 8
  %52 = ptrtoint %12* %47 to i64
  br i1 %48, label %58, label %53

53:                                               ; preds = %45
  %54 = getelementptr inbounds %12, %12* %47, i64 0, i32 43, i32 1
  %55 = bitcast %12*** %54 to i64*
  store i64 %51, i64* %55, align 8
  %56 = bitcast %12*** %49 to i64**
  %57 = load i64*, i64** %56, align 8
  br label %62

58:                                               ; preds = %45
  %59 = inttoptr i64 %51 to i64*
  %60 = getelementptr inbounds %13, %13* %0, i64 0, i32 10, i32 1
  %61 = bitcast %12*** %60 to i64*
  store i64 %51, i64* %61, align 8
  br label %62

62:                                               ; preds = %58, %53
  %63 = phi i64* [ %59, %58 ], [ %57, %53 ]
...
27:                                               ; preds = %26, %51
  %28 = phi %3* [ %53, %51 ], [ %22, %26 ]
  %29 = phi i32 [ %52, %51 ], [ 0, %26 ]
  %30 = getelementptr inbounds %3, %3* %28, i64 0, i32 1
  %31 = load i32, i32* %30, align 4
  %32 = call i8* @grid_view_string_cells(%3* %28, i32 0, i32 %29, i32 %31) #13
  %33 = call i64 @strlen(i8* %32) #14
  %34 = icmp eq i64 %33, 0
  br i1 %34, label %48, label %57

35:                                               ; preds = %57, %46
  %36 = phi i64 [ %33, %57 ], [ %38, %46 ]
  %37 = load i16*, i16** %58, align 8
  %38 = add i64 %36, -1
...
48:                                               ; preds = %46, %35, %27
  call void (i8*, ...) @log_debug(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @45, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @46, i64 0, i64 0), i8* %32) #13
  %49 = call i32 @regexec(%93* nonnull %5, i8* %32, i64 0, %94* null, i32 0) #13
  %50 = icmp eq i32 %49, 0
...
51:                                               ; preds = %48
  %52 = add nuw i32 %29, 1
  %53 = load %3*, %3** %21, align 8
  %54 = getelementptr inbounds %3, %3* %53, i64 0, i32 2
  %55 = load i32, i32* %54, align 8
  %56 = icmp ult i32 %52, %55
  br i1 %56, label %27, label %92

57:                                               ; preds = %27
  %58 = tail call i16** @__ctype_b_loc() #15
  br label %35

59:                                               ; preds = %26, %86
  %60 = phi %3* [ %88, %86 ], [ %22, %26 ]
  %61 = phi i32 [ %87, %86 ], [ 0, %26 ]
  %62 = getelementptr inbounds %3, %3* %60, i64 0, i32 1
  %63 = load i32, i32* %62, align 4
  %64 = call i8* @grid_view_string_cells(%3* %60, i32 0, i32 %61, i32 %63) #13
  %65 = call i64 @strlen(i8* %64) #14
  %66 = icmp eq i64 %65, 0
  br i1 %66, label %82, label %67

67:                                               ; preds = %59
  %68 = tail call i16** @__ctype_b_loc() #15
  br label %69

69:                                               ; preds = %67, %80
  %70 = phi i64 [ %65, %67 ], [ %72, %80 ]
  %71 = load i16*, i16** %68, align 8
  %72 = add i64 %70, -1
...
82:                                               ; preds = %80, %69, %59
  call void (i8*, ...) @log_debug(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @45, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @46, i64 0, i64 0), i8* %64) #13
  %83 = load i8*, i8** %6, align 8
  %84 = call i32 @fnmatch(i8* %83, i8* %64, i32 %20) #13
  %85 = icmp eq i32 %84, 0
...
86:                                               ; preds = %82
  %87 = add nuw i32 %61, 1
  %88 = load %3*, %3** %21, align 8
  %89 = getelementptr inbounds %3, %3* %88, i64 0, i32 2
  %90 = load i32, i32* %89, align 8
  %91 = icmp ult i32 %87, %90
  br i1 %91, label %59, label %92

92:                                               ; preds = %86, %82, %51, %48, %19
  %93 = phi i32 [ 0, %19 ], [ %29, %48 ], [ %52, %51 ], [ %61, %82 ], [ %87, %86 ]
  br i1 %9, label %96, label %94
...
97:                                               ; preds = %96, %94
  %98 = load %3*, %3** %21, align 8
  %99 = getelementptr inbounds %3, %3* %98, i64 0, i32 2
