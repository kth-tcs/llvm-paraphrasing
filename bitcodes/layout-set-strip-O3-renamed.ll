; ModuleID = 'layout-set-strip-O3-renamed.bc'
...
53:                                               ; preds = %48, %53
  %54 = phi i32 [ %65, %53 ], [ 0, %48 ]
  %55 = phi %13* [ %64, %53 ], [ %44, %48 ]
  ...
  %63 = getelementptr inbounds %13, %13* %55, i64 0, i32 43, i32 0
  %64 = load %13*, %13** %63, align 8
  %65 = add nuw i32 %54, 1
  %66 = icmp uge i32 %65, %9
  %67 = icmp eq %13* %64, null
  %68 = or i1 %67, %66
  br i1 %68, label %129, label %53

69:                                               ; preds = %48, %123
  %70 = phi i32 [ %125, %123 ], [ 0, %48 ]
  %71 = phi %13* [ %124, %123 ], [ %44, %48 ]
  %72 = tail call %83* @layout_create_cell(%83* %30) #8
  %73 = load i32, i32* %17, align 8
  tail call void @layout_set_size(%83* %72, i32 %73, i32 %29, i32 0, i32 0) #8
  %74 = getelementptr inbounds %83, %83* %72, i64 0, i32 8, i32 0
  store %83* null, %83** %74, align 8
  %75 = load i64, i64* %50, align 8
  %76 = getelementptr inbounds %83, %83* %72, i64 0, i32 8, i32 1
  %77 = bitcast %83*** %76 to i64*
  store i64 %75, i64* %77, align 8
  %78 = inttoptr i64 %75 to %83**
  store %83* %72, %83** %78, align 8
  store %83** %74, %83*** %49, align 8
  %79 = mul i32 %70, %13
  %80 = sub i32 %4, %79
  %81 = icmp eq i32 %80, 1
...
82:                                               ; preds = %69
  tail call void @layout_make_leaf(%83* %72, %13* nonnull %71) #8
  %83 = getelementptr inbounds %13, %13* %71, i64 0, i32 43, i32 0
  %84 = load %13*, %13** %83, align 8
  br label %123

85:                                               ; preds = %69
  tail call void @layout_make_node(%83* %72, i32 0) #8
  br i1 %52, label %104, label %86

86:                                               ; preds = %85
  %87 = getelementptr inbounds %83, %83* %72, i64 0, i32 7, i32 1
  %88 = bitcast %83*** %87 to i64*
  br label %89

89:                                               ; preds = %86, %101
  %90 = phi i32 [ 0, %86 ], [ %102, %101 ]
  %91 = phi %13* [ %71, %86 ], [ %99, %101 ]
  %92 = tail call %83* @layout_create_cell(%83* %72) #8
  tail call void @layout_set_size(%83* %92, i32 %23, i32 %29, i32 0, i32 0) #8
  tail call void @layout_make_leaf(%83* %92, %13* nonnull %91) #8
  %93 = getelementptr inbounds %83, %83* %92, i64 0, i32 8, i32 0
  store %83* null, %83** %93, align 8
  %94 = load i64, i64* %88, align 8
  %95 = getelementptr inbounds %83, %83* %92, i64 0, i32 8, i32 1
  %96 = bitcast %83*** %95 to i64*
  store i64 %94, i64* %96, align 8
  %97 = inttoptr i64 %94 to %83**
  store %83* %92, %83** %97, align 8
  store %83** %93, %83*** %87, align 8
  %98 = getelementptr inbounds %13, %13* %91, i64 0, i32 43, i32 0
...
104:                                              ; preds = %101, %89, %85
  %105 = phi i32 [ 0, %85 ], [ %90, %89 ], [ %102, %101 ]
  %106 = phi %13* [ %71, %85 ], [ null, %89 ], [ %99, %101 ]
  %107 = icmp eq i32 %105, %13
...
115:                                              ; preds = %104
  %116 = getelementptr inbounds %83, %83* %72, i64 0, i32 7, i32 1
  %117 = bitcast %83*** %116 to %84**
  %118 = load %84*, %84** %117, align 8
  %119 = getelementptr inbounds %84, %84* %118, i64 0, i32 1
  %120 = load %83**, %83*** %119, align 8
  %121 = load %83*, %83** %120, align 8
  %122 = sub i32 %113, %112
  tail call void @layout_resize_adjust(%1* nonnull %0, %83* %121, i32 0, i32 %122) #8
  br label %123

123:                                              ; preds = %104, %115, %82
  %124 = phi %13* [ %84, %82 ], [ %106, %104 ], [ %106, %115 ]
  %125 = add nuw i32 %70, 1
  %126 = icmp uge i32 %125, %9
  %127 = icmp eq %13* %124, null
  %128 = or i1 %127, %126
...
134:                                              ; preds = %129
  %135 = getelementptr inbounds %83, %83* %30, i64 0, i32 7, i32 1
  %136 = bitcast %83*** %135 to %84**
  %137 = load %84*, %84** %136, align 8
  %138 = getelementptr inbounds %84, %84* %137, i64 0, i32 1
  %139 = load %83**, %83*** %138, align 8
  %140 = load %83*, %83** %139, align 8
  %141 = sub i32 %132, %131
  tail call void @layout_resize_adjust(%1* nonnull %0, %83* %140, i32 1, i32 %141) #8
  br label %142

142:                                              ; preds = %134, %129
  tail call void @layout_fix_offsets(%1* nonnull %0) #8
  tail call void @layout_fix_panes(%1* nonnull %0) #8
  %143 = load %83*, %83** %2, align 8
  tail call void @layout_print_cell(%83* %143, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @14, i64 0, i64 0), i32 1) #8
  %144 = getelementptr inbounds %83, %83* %30, i64 0, i32 2
  %145 = load i32, i32* %144, align 8
  %146 = getelementptr inbounds %83, %83* %30, i64 0, i32 3
  %147 = load i32, i32* %146, align 4
  tail call void @window_resize(%1* nonnull %0, i32 %145, i32 %147, i32 -1, i32 -1) #8
