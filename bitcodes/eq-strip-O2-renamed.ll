; ModuleID = 'eq-strip-O2-renamed.bc'
...
define dso_local i32 @vec_eq(%0* readonly %0, %0* readonly %1, %0* readonly %2, %0* readonly %3) local_unnamed_addr #0 {
  %5 = tail call i32 @__gmpz_cmp(%0* %0, %0* %2) #2
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %7, label %11

7:                                                ; preds = %4
  %8 = tail call i32 @__gmpz_cmp(%0* %1, %0* %3) #2
  %9 = icmp eq i32 %8, 0
  %10 = zext i1 %9 to i32
  br label %11
...
declare dso_local i32 @__gmpz_cmp(%0*, %0*) local_unnamed_addr #1
