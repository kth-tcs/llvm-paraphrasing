; ModuleID = 'test-lazy-init-name-hash-strip-O3-renamed.bc'
...
6:                                                ; preds = %4, %28
  ...
  %23 = load i32, i32* getelementptr inbounds (%10, %10* @the_index, i64 0, i32 2), align 4
  br i1 %17, label %24, label %26

24:                                               ; preds = %6
  %25 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @41, i64 0, i64 0), double %20, double %22, i32 %23)
  br label %28

26:                                               ; preds = %6
  %27 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @40, i64 0, i64 0), double %20, double %22, i32 %23, i32 %13)
  br label %28

28:                                               ; preds = %26, %24
  %29 = load %29*, %29** @stdout, align 8
  %30 = tail call i32 @fflush(%29* %29)
  %31 = tail call i32 @discard_index(%10* nonnull @the_index) #6
  %32 = add nuw nsw i32 %7, 1
  %33 = load i32, i32* @12, align 4
  %34 = icmp slt i32 %32, %33
  br i1 %34, label %6, label %62

35:                                               ; preds = %4, %48
  %36 = phi i32 [ %59, %48 ], [ 0, %4 ]
  %37 = phi i64 [ %45, %48 ], [ 0, %4 ]
  %38 = tail call i64 @getnanotime() #6
  %39 = load %2*, %2** @the_repository, align 8
  %40 = tail call i32 @repo_read_index(%2* %39) #6
  %41 = tail call i64 @getnanotime() #6
  %42 = tail call i32 @test_lazy_init_name_hash(%10* nonnull @the_index, i32 %0) #6
  %43 = tail call i64 @getnanotime() #6
  %44 = sub i64 %43, %41
  %45 = add i64 %44, %37
  %46 = icmp eq i32 %42, 0
...
48:                                               ; preds = %35
  ...
  %52 = uitofp i64 %44 to double
  %53 = fdiv double %52, 1.000000e+09
  %54 = load i32, i32* getelementptr inbounds (%10, %10* @the_index, i64 0, i32 2), align 4
  %55 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @40, i64 0, i64 0), double %51, double %53, i32 %54, i32 %42)
  %56 = load %29*, %29** @stdout, align 8
  %57 = tail call i32 @fflush(%29* %56)
  %58 = tail call i32 @discard_index(%10* nonnull @the_index) #6
...
62:                                               ; preds = %48, %28
  %63 = phi i64 [ %16, %28 ], [ %45, %48 ]
  %64 = phi i32 [ %33, %28 ], [ %60, %48 ]
...
68:                                               ; preds = %62
  ...
  %71 = icmp eq i32 %0, 0
  %72 = select i1 %71, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @8, i64 0, i64 0)
  %73 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @42, i64 0, i64 0), double %70, i8* %72)
  br label %74

74:                                               ; preds = %1, %68, %62
  %75 = phi i64 [ %66, %68 ], [ %66, %62 ], [ 0, %1 ]
  ret i64 %75
}
