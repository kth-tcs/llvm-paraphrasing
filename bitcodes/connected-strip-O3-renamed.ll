; ModuleID = 'connected-strip-O3-renamed.bc'
...
168:                                              ; preds = %161, %173
  %169 = call i8* @oid_to_hex(%4* nonnull %7) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %13, i8* align 1 %169, i64 %163, i1 false)
  %170 = load i32, i32* %135, align 8
  %171 = call i64 @write_in_full(i32 %170, i8* nonnull %13, i64 %167) #8
  %172 = icmp slt i64 %171, 0
  br i1 %172, label %184, label %173

173:                                              ; preds = %168
  %174 = call i32 %0(i8* %1, %4* nonnull %7) #8
  %175 = icmp eq i32 %174, 0
  br i1 %175, label %168, label %198

176:                                              ; preds = %161, %195
  %177 = call i64 @find_pack_entry_one(i8* nonnull %14, %11* nonnull %63) #8
  %178 = icmp eq i64 %177, 0
  br i1 %178, label %179, label %195

179:                                              ; preds = %176
  %180 = call i8* @oid_to_hex(%4* nonnull %7) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %13, i8* align 1 %180, i64 %163, i1 false)
  %181 = load i32, i32* %135, align 8
  %182 = call i64 @write_in_full(i32 %181, i8* nonnull %13, i64 %167) #8
  %183 = icmp slt i64 %182, 0
  br i1 %183, label %184, label %195

184:                                              ; preds = %179, %168
  %185 = tail call i32* @__errno_location() #10
...
187:                                              ; preds = %184
  %188 = call i32 @use_gettext_poison() #8
  %189 = icmp eq i32 %188, 0
  br i1 %189, label %190, label %192

190:                                              ; preds = %187
  %191 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([25 x i8], [25 x i8]* @15, i64 0, i64 0), i32 5) #8
  br label %192

192:                                              ; preds = %187, %190
  %193 = phi i8* [ %191, %190 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @17, i64 0, i64 0), %187 ]
  %194 = call i32 (i8*, ...) @error_errno(i8* %193) #8
  br label %198

195:                                              ; preds = %176, %179
  %196 = call i32 %0(i8* %1, %4* nonnull %7) #8
  %197 = icmp eq i32 %196, 0
  br i1 %197, label %176, label %198

198:                                              ; preds = %195, %173, %192, %184, %184
  %199 = phi i32 [ -1, %184 ], [ -1, %184 ], [ -1, %192 ], [ 0, %173 ], [ 0, %195 ]
  %200 = load i32, i32* %135, align 8
  %201 = call i32 @close(i32 %200) #8
  %202 = icmp eq i32 %201, 0
  br i1 %202, label %211, label %203

203:                                              ; preds = %198
  %204 = call i32 @use_gettext_poison() #8
  %205 = icmp eq i32 %204, 0
  br i1 %205, label %206, label %208

206:                                              ; preds = %203
  %207 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([33 x i8], [33 x i8]* @16, i64 0, i64 0), i32 5) #8
  br label %208

208:                                              ; preds = %203, %206
  %209 = phi i8* [ %207, %206 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @17, i64 0, i64 0), %203 ]
  %210 = call i32 (i8*, ...) @error_errno(i8* %209) #8
  br label %211

211:                                              ; preds = %198, %208
  %212 = phi i32 [ -1, %208 ], [ %199, %198 ]
  %213 = call i32 @sigchain_pop(i32 13) #8
  %214 = call i32 @finish_command(%51* nonnull %4) #8
  %215 = or i32 %214, %212
  %216 = icmp ne i32 %215, 0
  %217 = zext i1 %216 to i32
  br label %218

218:                                              ; preds = %85, %30, %26, %211, %158
  %219 = phi i32 [ -1, %158 ], [ %217, %211 ], [ 0, %26 ], [ 0, %30 ], [ 0, %85 ]
