; ModuleID = 'namelist-strip-renamed.bc'
...
@3 = internal constant [2 x %0] [%0 { i8* inttoptr (i64 1 to i8*), i64 0, i8 0, i8 0 }, %0 { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @6, i32 0, i32 0), i64 0, i8 0, i8 0 }], align 16
@php_dom_namelist_class_functions = hidden constant [3 x { i8*, void (%1*, %29*)*, %0*, i32, i32 }] [{ i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @0, i32 0, i32 0), void (%1*, %29*)* @zif_dom_namelist_get_name, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @1, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([16 x i8], [16 x i8]* @2, i32 0, i32 0), void (%1*, %29*)* @zif_dom_namelist_get_namespace_uri, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @3, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } zeroinitializer], align 16
@4 = private unnamed_addr constant [5 x i8] c"TEST\00", align 1
@5 = private unnamed_addr constant [20 x i8] c"Not yet implemented\00", align 1
@6 = private unnamed_addr constant [6 x i8] c"index\00", align 1

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_namelist_get_name(%1* %0, %29* %1) #0 {
  %3 = alloca %1*, align 8
  %4 = alloca %29*, align 8
  store %1* %0, %1** %3, align 8
  store %29* %1, %29** %4, align 8
  call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @5, i32 0, i32 0))
  ret void
}

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_namelist_get_namespace_uri(%1* %0, %29* %1) #0 {
  %3 = alloca %1*, align 8
  %4 = alloca %29*, align 8
  store %1* %0, %1** %3, align 8
  store %29* %1, %29** %4, align 8
...
; Function Attrs: nounwind uwtable
define hidden i32 @dom_namelist_length_read(%33* %0, %29* %1) #0 {
  %3 = alloca %33*, align 8
  %4 = alloca %29*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %29*, align 8
...
8:                                                ; preds = %2
  ...
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @4, i32 0, i32 0), i8** %5, align 8
  br label %10
...
11:                                               ; preds = %10
  ...
  %18 = call %28* @7(i8* %15, i64 %17, i32 0)
...
; Function Attrs: alwaysinline nounwind uwtable
define internal %28* @8(i64 %0, i32 %1) #2 {
