; ModuleID = 'spl_exceptions-strip-renamed.bc'
...
define hidden i32 @zm_startup_spl_exceptions(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  store i32 %1, i32* %4, align 4
  %5 = load %0*, %0** @zend_ce_exception, align 8
  call void @spl_register_sub_class(%0** @spl_ce_LogicException, %0* %5, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @0, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %6 = load %0*, %0** @spl_ce_LogicException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_BadFunctionCallException, %0* %6, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @1, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %7 = load %0*, %0** @spl_ce_BadFunctionCallException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_BadMethodCallException, %0* %7, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @2, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %8 = load %0*, %0** @spl_ce_LogicException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_DomainException, %0* %8, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @3, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %9 = load %0*, %0** @spl_ce_LogicException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_InvalidArgumentException, %0* %9, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @4, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %10 = load %0*, %0** @spl_ce_LogicException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_LengthException, %0* %10, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @5, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %11 = load %0*, %0** @spl_ce_LogicException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_OutOfRangeException, %0* %11, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @6, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %12 = load %0*, %0** @zend_ce_exception, align 8
  call void @spl_register_sub_class(%0** @spl_ce_RuntimeException, %0* %12, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @7, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %13 = load %0*, %0** @spl_ce_RuntimeException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_OutOfBoundsException, %0* %13, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @8, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %14 = load %0*, %0** @spl_ce_RuntimeException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_OverflowException, %0* %14, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @9, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %15 = load %0*, %0** @spl_ce_RuntimeException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_RangeException, %0* %15, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @10, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %16 = load %0*, %0** @spl_ce_RuntimeException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_UnderflowException, %0* %16, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @11, i32 0, i32 0), %21* (%0*)* null, %32* null)
  %17 = load %0*, %0** @spl_ce_RuntimeException, align 8
  call void @spl_register_sub_class(%0** @spl_ce_UnexpectedValueException, %0* %17, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @12, i32 0, i32 0), %21* (%0*)* null, %32* null)
  ret i32 0
}

declare dso_local void @spl_register_sub_class(%0**, %0*, i8*, %21* (%0*)*, %32*) #1
