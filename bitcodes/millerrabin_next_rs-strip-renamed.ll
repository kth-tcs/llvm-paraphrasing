; ModuleID = 'millerrabin_next_rs-strip-renamed.bc'
...
define dso_local void @gmpmee_millerrabin_next_rs(%1* %0, %0* %1, %1* %2, i32 %3) #0 {
  %5 = alloca %1*, align 8
  %6 = alloca %0*, align 8
  %7 = alloca %1*, align 8
  ...
  call void @llvm.lifetime.start.p0i8(i64 72, i8* %10) #5
  %11 = load %1*, %1** %7, align 8
  %12 = call i32 @__gmpz_cmp_ui(%1* %11, i64 2) #6
  %13 = icmp slt i32 %12, 0
  br i1 %13, label %14, label %16

14:                                               ; preds = %4
  %15 = load %1*, %1** %5, align 8
  call void @__gmpz_set_ui(%1* %15, i64 2)
  br label %40

16:                                               ; preds = %4
  %17 = load %1*, %1** %7, align 8
  %18 = call i32 @__gmpz_cmp_ui(%1* %17, i64 3) #6
  %19 = icmp slt i32 %18, 0
  br i1 %19, label %20, label %22

20:                                               ; preds = %16
  %21 = load %1*, %1** %5, align 8
  call void @__gmpz_set_ui(%1* %21, i64 3)
  br label %39

22:                                               ; preds = %16
  %23 = getelementptr inbounds [1 x %3], [1 x %3]* %9, i32 0, i32 0
  %24 = load %1*, %1** %7, align 8
  call void @gmpmee_millerrabin_init(%3* %23, %1* %24)
  br label %25

25:                                               ; preds = %27, %22
  %26 = getelementptr inbounds [1 x %3], [1 x %3]* %9, i32 0, i32 0
  call void @gmpmee_millerrabin_next_cand(%3* %26)
  br label %27
...
27:                                               ; preds = %25
  ...
  %31 = call i32 @gmpmee_millerrabin_reps_rs(%0* %28, %3* %29, i32 %30)
  %32 = icmp eq i32 %31, 0
...
33:                                               ; preds = %27
  ...
  call void @__gmpz_set(%1* %34, %1* %37)
  %38 = getelementptr inbounds [1 x %3], [1 x %3]* %9, i32 0, i32 0
  call void @gmpmee_millerrabin_clear(%3* %38)
  br label %39
...
40:                                               ; preds = %39, %14
  ...
  call void @llvm.lifetime.end.p0i8(i64 72, i8* %41) #5
  ret void
}
...
declare dso_local void @gmpmee_millerrabin_next_cand(%3*) #4
