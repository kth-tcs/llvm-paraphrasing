; ModuleID = 'lua_cjson-strip-O3-renamed.bc'
...
8:                                                ; preds = %4
  ...
  %10 = icmp eq i32 %9, 0
  %11 = getelementptr %2, %2* %3, i64 0, i32 1
  %12 = load i32, i32* %11, align 8
  %13 = getelementptr %2, %2* %3, i64 0, i32 2
...
101:                                              ; preds = %97
  %102 = getelementptr %3, %3* %1, i64 0, i32 9
...
112:                                              ; preds = %110
  %113 = getelementptr %2, %2* %3, i64 0, i32 1
  %114 = load i32, i32* %113, align 8
  %115 = getelementptr %2, %2* %3, i64 0, i32 2
...
168:                                              ; preds = %106, %97, %83, %110
  %169 = getelementptr %2, %2* %3, i64 0, i32 1
  %170 = load i32, i32* %169, align 8
  %171 = getelementptr %2, %2* %3, i64 0, i32 2
...
188:                                              ; preds = %179
  %189 = getelementptr %3, %3* %1, i64 0, i32 9
  br label %190
...
283:                                              ; preds = %4
  %284 = getelementptr %2, %2* %3, i64 0, i32 1
  %285 = load i32, i32* %284, align 8
  %286 = getelementptr %2, %2* %3, i64 0, i32 2
...
306:                                              ; preds = %303
  %307 = getelementptr %2, %2* %3, i64 0, i32 1
  %308 = load i32, i32* %307, align 8
  %309 = getelementptr %2, %2* %3, i64 0, i32 2
...
326:                                              ; preds = %303, %4
  %327 = getelementptr %3, %3* %1, i64 0, i32 9
...
define internal fastcc void @118(%1* %0, %2* %1, i32 %2) unnamed_addr #0 {
  ...
  %9 = mul i32 %8, 6
  %10 = add i32 %9, 2
  %11 = getelementptr %2, %2* %1, i64 0, i32 1
  %12 = load i32, i32* %11, align 8
  %13 = getelementptr %2, %2* %1, i64 0, i32 2
  %14 = load i32, i32* %13, align 4
  %15 = xor i32 %14, -1
  %16 = add i32 %12, %15
...
14:                                               ; preds = %11, %8
  %15 = getelementptr %3, %3* %1, i64 0, i32 9
...
26:                                               ; preds = %23
  %27 = getelementptr %2, %2* %2, i64 0, i32 1
  %28 = load i32, i32* %27, align 8
  %29 = getelementptr %2, %2* %2, i64 0, i32 2
...
49:                                               ; preds = %46, %43
  %50 = getelementptr %2, %2* %2, i64 0, i32 1
  %51 = load i32, i32* %50, align 8
  %52 = getelementptr %2, %2* %2, i64 0, i32 2
...
67:                                               ; preds = %11, %23, %46, %19
  %68 = getelementptr %2, %2* %2, i64 0, i32 1
  %69 = load i32, i32* %68, align 8
  %70 = getelementptr %2, %2* %2, i64 0, i32 2
...
78:                                               ; preds = %67, %75
  ...
  %80 = getelementptr %2, %2* %2, i64 0, i32 0
...
define internal fastcc void @120(%4* %0, %5* %1) unnamed_addr #0 {
  ...
  %8 = getelementptr %4, %4* %0, i64 0, i32 1
...
296:                                              ; preds = %54
  ...
  %299 = getelementptr %2, %2* %298, i64 0, i32 0
  %300 = load i8*, i8** %299, align 8
  %301 = getelementptr %2, %2* %298, i64 0, i32 2
...
50:                                               ; preds = %46
  ...
  %53 = getelementptr %4, %4* %1, i64 0, i32 2
...
132:                                              ; preds = %128
  %133 = getelementptr %4, %4* %1, i64 0, i32 2
...
156:                                              ; preds = %3
  %157 = getelementptr %4, %4* %1, i64 0, i32 2
