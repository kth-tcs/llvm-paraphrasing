; ModuleID = 'server-fn-strip-O2-renamed.bc'
...
27:                                               ; preds = %24, %42
  %28 = phi %70* [ %22, %24 ], [ %44, %42 ]
  br i1 %26, label %42, label %29

29:                                               ; preds = %27, %38
  %30 = phi %1* [ %40, %38 ], [ %25, %27 ]
  %31 = getelementptr inbounds %1, %1* %30, i64 0, i32 43
  %32 = load %70*, %70** %31, align 8
  %33 = icmp eq %70* %32, %28
  br i1 %33, label %34, label %38

34:                                               ; preds = %29
  %35 = getelementptr inbounds %1, %1* %30, i64 0, i32 27
  %36 = load i64, i64* %35, align 8
  %37 = or i64 %36, 587203608
  store i64 %37, i64* %35, align 8
  br label %38

38:                                               ; preds = %34, %29
  %39 = getelementptr inbounds %1, %1* %30, i64 0, i32 57, i32 0
  %40 = load %1*, %1** %39, align 8
  %41 = icmp eq %1* %40, null
  br i1 %41, label %42, label %29

42:                                               ; preds = %38, %27
  %43 = getelementptr inbounds %70, %70* %28, i64 0, i32 19, i32 0
...
79:                                               ; preds = %94, %76
  %80 = phi %70* [ %74, %76 ], [ %96, %94 ]
  br i1 %78, label %94, label %81

81:                                               ; preds = %79, %90
  %82 = phi %1* [ %92, %90 ], [ %77, %79 ]
  %83 = getelementptr inbounds %1, %1* %82, i64 0, i32 43
  %84 = load %70*, %70** %83, align 8
  %85 = icmp eq %70* %84, %80
  br i1 %85, label %86, label %90

86:                                               ; preds = %81
  %87 = getelementptr inbounds %1, %1* %82, i64 0, i32 27
  %88 = load i64, i64* %87, align 8
  %89 = or i64 %88, 587203608
  store i64 %89, i64* %87, align 8
  br label %90

90:                                               ; preds = %86, %81
  %91 = getelementptr inbounds %1, %1* %82, i64 0, i32 57, i32 0
  %92 = load %1*, %1** %91, align 8
  %93 = icmp eq %1* %92, null
  br i1 %93, label %94, label %81

94:                                               ; preds = %90, %79
  %95 = getelementptr inbounds %70, %70* %80, i64 0, i32 19, i32 0
  %96 = load %70*, %70** %95, align 8
  %97 = icmp eq %70* %96, null
  br i1 %97, label %98, label %79

98:                                               ; preds = %94, %68, %56, %72
  %99 = tail call %11* @winlink_find_by_window(%72* nonnull %35, %7* %0) #6
  %100 = icmp eq %11* %99, null
  br i1 %100, label %101, label %38

101:                                              ; preds = %98, %50, %34, %46, %45
  %102 = getelementptr inbounds %70, %70* %5, i64 0, i32 13
  %103 = load %16*, %16** %102, align 8
  %104 = tail call i64 @options_get_number(%16* %103, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i64 0, i64 0)) #6
  %105 = icmp eq i64 %104, 0
  br i1 %105, label %119, label %106

106:                                              ; preds = %101
  %107 = tail call %91* @session_group_contains(%70* nonnull %5) #6
  %108 = icmp eq %91* %107, null
  br i1 %108, label %118, label %109

109:                                              ; preds = %106
  %110 = getelementptr inbounds %91, %91* %107, i64 0, i32 1, i32 0
  %111 = load %70*, %70** %110, align 8
  %112 = icmp eq %70* %111, null
  br i1 %112, label %119, label %113

113:                                              ; preds = %109, %113
  %114 = phi %70* [ %116, %113 ], [ %111, %109 ]
  tail call void @session_renumber_windows(%70* nonnull %114) #6
  %115 = getelementptr inbounds %70, %70* %114, i64 0, i32 19, i32 0
...
119:                                              ; preds = %113, %118, %101, %109, %4
  %120 = icmp eq %70* %6, null
  br i1 %120, label %121, label %4
...
89:                                               ; preds = %104, %86
  %90 = phi %70* [ %84, %86 ], [ %106, %104 ]
  br i1 %88, label %104, label %91

91:                                               ; preds = %89, %100
  %92 = phi %1* [ %102, %100 ], [ %87, %89 ]
  %93 = getelementptr inbounds %1, %1* %92, i64 0, i32 43
  %94 = load %70*, %70** %93, align 8
  %95 = icmp eq %70* %94, %90
  br i1 %95, label %96, label %100

96:                                               ; preds = %91
  %97 = getelementptr inbounds %1, %1* %92, i64 0, i32 27
  %98 = load i64, i64* %97, align 8
  %99 = or i64 %98, 587203608
  store i64 %99, i64* %97, align 8
  br label %100

100:                                              ; preds = %96, %91
  %101 = getelementptr inbounds %1, %1* %92, i64 0, i32 57, i32 0
  %102 = load %1*, %1** %101, align 8
  %103 = icmp eq %1* %102, null
  br i1 %103, label %104, label %91

104:                                              ; preds = %100, %89
  %105 = getelementptr inbounds %70, %70* %90, i64 0, i32 19, i32 0
  %106 = load %70*, %70** %105, align 8
  %107 = icmp eq %70* %106, null
  br i1 %107, label %108, label %89

108:                                              ; preds = %104, %78, %82, %66, %50, %31, %17
  %109 = phi i32 [ -1, %17 ], [ -1, %31 ], [ -1, %50 ], [ 0, %66 ], [ 0, %82 ], [ 0, %78 ], [ 0, %104 ]
  ret i32 %109
}
...
42:                                               ; preds = %57, %39
  %43 = phi %70* [ %37, %39 ], [ %59, %57 ]
  br i1 %41, label %57, label %44

44:                                               ; preds = %42, %53
  %45 = phi %1* [ %55, %53 ], [ %40, %42 ]
  %46 = getelementptr inbounds %1, %1* %45, i64 0, i32 43
  %47 = load %70*, %70** %46, align 8
  %48 = icmp eq %70* %47, %43
  br i1 %48, label %49, label %53

49:                                               ; preds = %44
  %50 = getelementptr inbounds %1, %1* %45, i64 0, i32 27
  %51 = load i64, i64* %50, align 8
  %52 = or i64 %51, 587203608
  store i64 %52, i64* %50, align 8
  br label %53

53:                                               ; preds = %49, %44
  %54 = getelementptr inbounds %1, %1* %45, i64 0, i32 57, i32 0
  %55 = load %1*, %1** %54, align 8
  %56 = icmp eq %1* %55, null
  br i1 %56, label %57, label %44

57:                                               ; preds = %53, %42
  %58 = getelementptr inbounds %70, %70* %43, i64 0, i32 19, i32 0
  %59 = load %70*, %70** %58, align 8
  %60 = icmp eq %70* %59, null
  br i1 %60, label %61, label %42

61:                                               ; preds = %13, %57, %31, %35, %19, %9, %8
  ret void
}
...
47:                                               ; preds = %46
  ...
  %48 = getelementptr inbounds %1, %1* %42, i64 0, i32 27
...
51:                                               ; preds = %46
  %52 = getelementptr inbounds %1, %1* %42, i64 0, i32 44
  store %70* null, %70** %52, align 8
  store %70* %35, %70** %43, align 8
  tail call void @server_client_set_key_table(%1* nonnull %42, i8* null) #6
  tail call void @tty_update_client_offset(%1* nonnull %42) #6
  tail call void @status_timer_start(%1* nonnull %42) #6
  tail call void @notify_client(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @12, i64 0, i64 0), %1* nonnull %42) #6
  tail call void @session_update_activity(%70* nonnull %35, %48* null) #6
  %53 = tail call i32 @gettimeofday(%48* nonnull %40, %97* null) #6
  %54 = getelementptr inbounds %1, %1* %42, i64 0, i32 27
  %55 = load i64, i64* %54, align 8
  %56 = or i64 %55, 587203608
  store i64 %56, i64* %54, align 8
  tail call void @alerts_check_session(%70* nonnull %35) #6
  br label %57

57:                                               ; preds = %41, %47, %51
  %58 = getelementptr inbounds %1, %1* %42, i64 0, i32 57, i32 0
