; ModuleID = 'url-strip-O2-renamed.bc'
...
87:                                               ; preds = %70, %74, %80, %84, %60
  %88 = phi i64 [ %61, %60 ], [ %72, %70 ], [ %76, %74 ], [ %82, %80 ], [ %86, %84 ]
  %89 = phi i64 [ %62, %60 ], [ %71, %70 ], [ %75, %74 ], [ %81, %80 ], [ %85, %84 ]
  %90 = phi i8 [ %63, %60 ], [ 32, %70 ], [ 32, %74 ], [ %17, %80 ], [ %17, %84 ]
  %91 = phi i64 [ 3, %60 ], [ 1, %70 ], [ 1, %74 ], [ 1, %80 ], [ 1, %84 ]
  %92 = phi i32 [ -3, %60 ], [ -1, %70 ], [ -1, %74 ], [ -1, %80 ], [ -1, %84 ]
  ...
  %98 = getelementptr inbounds i8, i8* %15, i64 %91
  %99 = add nsw i32 %16, %92
  %100 = icmp eq i32 %99, 0
  br i1 %100, label %101, label %14

101:                                              ; preds = %87, %14, %24, %5
  %102 = phi i8* [ %6, %5 ], [ %25, %24 ], [ %15, %14 ], [ %98, %87 ]
  store i8* %102, i8** %0, align 8
  %103 = tail call i8* @strbuf_detach(%0* %3, i64* null) #9
  ret i8* %103
}
