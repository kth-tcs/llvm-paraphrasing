; ModuleID = 'remote-strip-O2-renamed.bc'
...
1153:                                             ; preds = %1148, %1145
  ...
  %1155 = getelementptr inbounds %52, %52* %1140, i64 0, i32 1
  %1156 = load i8*, i8** %1155, align 8
  %1157 = getelementptr inbounds %52, %52* %1140, i64 0, i32 15
...
1694:                                             ; preds = %1405
  ...
  br i1 %1696, label %1697, label %1861
...
1727:                                             ; preds = %1854, %1715
  %1728 = phi i32 [ 0, %1715 ], [ %1856, %1854 ]
  %1729 = phi i8** [ %1, %1715 ], [ %1858, %1854 ]
  %1730 = phi i32 [ %1713, %1715 ], [ %1857, %1854 ]
...
1796:                                             ; preds = %1794, %1793
  ...
  %1800 = load i32, i32* %1718, align 8
  %1801 = icmp eq i32 %1800, 0
  %1802 = or i1 %1799, %1801
  br i1 %1802, label %1852, label %1803

1803:                                             ; preds = %1796, %1845
  %1804 = phi %1* [ %1846, %1845 ], [ %1798, %1796 ]
  %1805 = getelementptr inbounds %1, %1* %1804, i64 0, i32 1
  %1806 = load i8*, i8** %1805, align 8
  %1807 = call i32 @use_gettext_poison() #11
  %1808 = icmp eq i32 %1807, 0
  br i1 %1733, label %1809, label %1827

1809:                                             ; preds = %1803
  br i1 %1808, label %1810, label %1812

1810:                                             ; preds = %1809
  %1811 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([20 x i8], [20 x i8]* @210, i64 0, i64 0), i32 5) #11
  br label %1812

1812:                                             ; preds = %1810, %1809
  %1813 = phi i8* [ %1811, %1810 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @119, i64 0, i64 0), %1809 ]
  br label %1814

1814:                                             ; preds = %1819, %1812
  %1815 = phi i8* [ %1806, %1812 ], [ %1820, %1819 ]
  %1816 = phi i8* [ getelementptr inbounds ([14 x i8], [14 x i8]* @118, i64 0, i64 0), %1812 ], [ %1822, %1819 ]
  %1817 = load i8, i8* %1816, align 1
  %1818 = icmp eq i8 %1817, 0
  br i1 %1818, label %1824, label %1819

1819:                                             ; preds = %1814
  %1820 = getelementptr inbounds i8, i8* %1815, i64 1
  %1821 = load i8, i8* %1815, align 1
  %1822 = getelementptr inbounds i8, i8* %1816, i64 1
  %1823 = icmp eq i8 %1821, %1817
  br i1 %1823, label %1814, label %1824

1824:                                             ; preds = %1819, %1814
  %1825 = phi i8* [ %1806, %1819 ], [ %1815, %1814 ]
  %1826 = call i32 (i8*, ...) @printf_ln(i8* %1813, i8* %1825) #11
  br label %1845

1827:                                             ; preds = %1803
  br i1 %1808, label %1828, label %1830

1828:                                             ; preds = %1827
  %1829 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([15 x i8], [15 x i8]* @211, i64 0, i64 0), i32 5) #11
  br label %1830

1830:                                             ; preds = %1828, %1827
  %1831 = phi i8* [ %1829, %1828 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @119, i64 0, i64 0), %1827 ]
  br label %1832

1832:                                             ; preds = %1837, %1830
  %1833 = phi i8* [ %1806, %1830 ], [ %1838, %1837 ]
  %1834 = phi i8* [ getelementptr inbounds ([14 x i8], [14 x i8]* @118, i64 0, i64 0), %1830 ], [ %1840, %1837 ]
  %1835 = load i8, i8* %1834, align 1
  %1836 = icmp eq i8 %1835, 0
  br i1 %1836, label %1842, label %1837

1837:                                             ; preds = %1832
  %1838 = getelementptr inbounds i8, i8* %1833, i64 1
  %1839 = load i8, i8* %1833, align 1
  %1840 = getelementptr inbounds i8, i8* %1834, i64 1
  %1841 = icmp eq i8 %1839, %1835
  br i1 %1841, label %1832, label %1842

1842:                                             ; preds = %1837, %1832
  %1843 = phi i8* [ %1806, %1837 ], [ %1833, %1832 ]
  %1844 = call i32 (i8*, ...) @printf_ln(i8* %1831, i8* %1843) #11
  br label %1845

1845:                                             ; preds = %1842, %1824
  %1846 = getelementptr inbounds %1, %1* %1804, i64 1
  %1847 = load %1*, %1** %1725, align 8
  %1848 = load i32, i32* %1718, align 8
  %1849 = zext i32 %1848 to i64
  %1850 = getelementptr inbounds %1, %1* %1847, i64 %1849
  %1851 = icmp ult %1* %1846, %1850
  br i1 %1851, label %1803, label %1852

1852:                                             ; preds = %1845, %1796
  %1853 = load %2*, %2** @stdout, align 8
  call void @warn_dangling_symrefs(%2* %1853, i8* %1743, %0* nonnull %8) #11
...
1854:                                             ; preds = %1852, %1746
  %1855 = phi i32 [ %1797, %1852 ], [ 0, %1746 ]
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %1717) #11
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %1716) #11
  %1856 = or i32 %1855, %1728
  %1857 = add nsw i32 %1730, -1
  %1858 = getelementptr inbounds i8*, i8** %1729, i64 1
  %1859 = icmp eq i32 %1857, 0
  br i1 %1859, label %1860, label %1727
...
1861:                                             ; preds = %1694
  %1862 = call i32 @strcmp(i8* %70, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @14, i64 0, i64 0)) #12
  %1863 = icmp eq i32 %1862, 0
  br i1 %1863, label %1864, label %1928

1864:                                             ; preds = %1861
  %1865 = bitcast i32* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1865) #11
  store i32 -1, i32* %4, align 4
  %1866 = bitcast [2 x %57]* %25 to i8*
  call void @llvm.lifetime.start.p0i8(i64 160, i8* nonnull %1866) #11
  %1867 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 0
  store i32 9, i32* %1867, align 16
  %1868 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 1
  store i32 112, i32* %1868, align 4
  %1869 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 2
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @13, i64 0, i64 0), i8** %1869, align 8
  %1870 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 3
  %1871 = bitcast i8** %1870 to i32**
  store i32* %4, i32** %1871, align 16
  %1872 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 4
  %1873 = bitcast i8** %1872 to <2 x i8*>*
  store <2 x i8*> <i8* null, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @212, i64 0, i64 0)>, <2 x i8*>* %1873, align 8
  %1874 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 6
  store i32 2, i32* %1874, align 8
  %1875 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 7
  store i32 (%57*, i8*, i32)* null, i32 (%57*, i8*, i32)** %1875, align 16
  %1876 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 8
  store i64 1, i64* %1876, align 8
  %1877 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0, i32 9
  %1878 = bitcast %50* %5 to i8*
  %1879 = bitcast i32 (%58*, %57*, i8*, i32)** %1877 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %1879, i8 0, i64 96, i1 false) #11
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %1878) #11
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %1878, i8* align 8 bitcast (%50* @213 to i8*), i64 16, i1 false) #11
  %1880 = bitcast i32* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1880) #11
  store i32 0, i32* %6, align 4
  %1881 = getelementptr inbounds [2 x %57], [2 x %57]* %25, i64 0, i64 0
  %1882 = call i32 @parse_options(i32 %65, i8** nonnull %1, i8* null, %57* nonnull %1881, i8** getelementptr inbounds ([2 x i8*], [2 x i8*]* @214, i64 0, i64 0), i32 4) #11
  %1883 = call i8* @argv_array_push(%50* nonnull %5, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @33, i64 0, i64 0)) #11
...
1886:                                             ; preds = %1864
  ...
  %1888 = select i1 %1887, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @216, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @215, i64 0, i64 0)
  %1889 = call i8* @argv_array_push(%50* nonnull %5, i8* %1888) #11
  br label %1890

1890:                                             ; preds = %1886, %1864
  %1891 = load i32, i32* @1, align 4
  %1892 = icmp eq i32 %1891, 0
  br i1 %1892, label %1895, label %1893

1893:                                             ; preds = %1890
  %1894 = call i8* @argv_array_push(%50* nonnull %5, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @75, i64 0, i64 0)) #11
  br label %1895

1895:                                             ; preds = %1893, %1890
  %1896 = call i8* @argv_array_push(%50* nonnull %5, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @217, i64 0, i64 0)) #11
  %1897 = icmp slt i32 %1882, 2
  br i1 %1897, label %1898, label %1900

1898:                                             ; preds = %1895
  %1899 = call i8* @argv_array_push(%50* nonnull %5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @218, i64 0, i64 0)) #11
  br label %1909

1900:                                             ; preds = %1895
  %1901 = zext i32 %1882 to i64
  br label %1902

1902:                                             ; preds = %1902, %1900
  %1903 = phi i64 [ 1, %1900 ], [ %1907, %1902 ]
  %1904 = getelementptr inbounds i8*, i8** %1, i64 %1903
  %1905 = load i8*, i8** %1904, align 8
  %1906 = call i8* @argv_array_push(%50* nonnull %5, i8* %1905) #11
  %1907 = add nuw nsw i64 %1903, 1
  %1908 = icmp eq i64 %1907, %1901
  br i1 %1908, label %1909, label %1902

1909:                                             ; preds = %1902, %1898
  %1910 = getelementptr inbounds %50, %50* %5, i64 0, i32 0
  %1911 = load i8**, i8*** %1910, align 8
  %1912 = getelementptr inbounds %50, %50* %5, i64 0, i32 1
  %1913 = load i32, i32* %1912, align 8
  %1914 = add nsw i32 %1913, -1
  %1915 = sext i32 %1914 to i64
  %1916 = getelementptr inbounds i8*, i8** %1911, i64 %1915
  %1917 = load i8*, i8** %1916, align 8
  %1918 = call i32 @strcmp(i8* %1917, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @218, i64 0, i64 0)) #12
  %1919 = icmp eq i32 %1918, 0
  br i1 %1919, label %1920, label %1925

1920:                                             ; preds = %1909
  call void @git_config(i32 (i8*, i8*, i8*)* nonnull @243, i8* nonnull %1880) #11
...
1923:                                             ; preds = %1920
  ...
  %1924 = call i8* @argv_array_push(%50* nonnull %5, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @219, i64 0, i64 0)) #11
  br label %1925

1925:                                             ; preds = %1909, %1920, %1923
  %1926 = load i8**, i8*** %1910, align 8
  %1927 = call i32 @run_command_v_opt(i8** %1926, i32 2) #11
  call void @argv_array_clear(%50* nonnull %5) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1880) #11
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %1878) #11
  call void @llvm.lifetime.end.p0i8(i64 160, i8* nonnull %1866) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1865) #11
  br label %1932

1928:                                             ; preds = %1861
  %1929 = call fastcc i8* @223(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @15, i64 0, i64 0))
  %1930 = load i8*, i8** %1, align 8
  %1931 = call i32 (i8*, ...) @error(i8* %1929, i8* %1930) #11
  call void @usage_with_options(i8** getelementptr inbounds ([14 x i8*], [14 x i8*]* @3, i64 0, i64 0), %57* nonnull %58) #13
  unreachable

1932:                                             ; preds = %324, %937, %1169, %1404, %1860, %1925, %1692, %1248, %1107, %767, %67
  %1933 = phi i32 [ %68, %67 ], [ %1927, %1925 ], [ %1856, %1860 ], [ %1693, %1692 ], [ 0, %1404 ], [ 0, %1248 ], [ %1170, %1169 ], [ %1108, %1107 ], [ %938, %937 ], [ %768, %767 ], [ %325, %324 ]
