; ModuleID = 'crypt-strip-O2-renamed.bc'
...
148:                                              ; preds = %145
  %149 = getelementptr inbounds i8, i8* %2, i64 1
  %150 = load i8, i8* %149, align 1
  %151 = icmp eq i8 %150, 48
  br i1 %151, label %167, label %152

152:                                              ; preds = %148, %145
  %153 = call i64 @strlen(i8* nonnull %143) #8
  %154 = add i64 %153, 32
  %155 = and i64 %154, -8
  %156 = call noalias i8* @_emalloc(i64 %155) #9
  %157 = bitcast i8* %156 to %0*
  ...
  %163 = getelementptr inbounds i8, i8* %156, i64 16
  %164 = bitcast i8* %163 to i64*
  store i64 %153, i64* %164, align 8
  %165 = getelementptr inbounds i8, i8* %156, i64 24
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %165, i8* nonnull align 1 %143, i64 %153, i1 false) #7
  %166 = getelementptr inbounds %0, %0* %157, i64 0, i32 3, i64 %153
  store i8 0, i8* %166, align 1
  br label %167

167:                                              ; preds = %113, %148, %142, %71, %72, %47, %48, %152, %111, %37
  %168 = phi %0* [ %38, %37 ], [ %112, %111 ], [ %157, %152 ], [ %53, %48 ], [ null, %47 ], [ %77, %72 ], [ null, %71 ], [ null, %113 ], [ null, %142 ], [ null, %148 ]
