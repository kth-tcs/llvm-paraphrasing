; ModuleID = 'credential-store-strip-O3-renamed.bc'
...
22:                                               ; preds = %21, %37
  %23 = phi i32 [ %38, %37 ], [ 0, %21 ]
  %24 = load i8*, i8** %16, align 8
  %25 = call i32 @credential_from_url_gently(%8* nonnull %6, i8* %24, i32 1) #8
  %26 = icmp ne i32 %25, 0
...
33:                                               ; preds = %22
  %34 = call i32 @credential_match(%8* %1, %8* nonnull %6) #8
  %35 = icmp eq i32 %34, 0
...
37:                                               ; preds = %33, %36
  %38 = phi i32 [ %23, %36 ], [ 1, %33 ]
  %39 = call i32 @strbuf_getline_lf(%7* nonnull %5, %2* nonnull %10) #8
  %40 = icmp eq i32 %39, -1
  br i1 %40, label %98, label %22

41:                                               ; preds = %21, %56
  %42 = phi i32 [ %57, %56 ], [ 0, %21 ]
  %43 = load i8*, i8** %16, align 8
  %44 = call i32 @credential_from_url_gently(%8* nonnull %6, i8* %43, i32 1) #8
  %45 = icmp ne i32 %44, 0
...
52:                                               ; preds = %41
  %53 = call i32 @credential_match(%8* %1, %8* nonnull %6) #8
  %54 = icmp eq i32 %53, 0
...
56:                                               ; preds = %52, %55
  %57 = phi i32 [ %42, %55 ], [ 1, %52 ]
  %58 = call i32 @strbuf_getline_lf(%7* nonnull %5, %2* nonnull %10) #8
  %59 = icmp eq i32 %58, -1
  br i1 %59, label %98, label %41

60:                                               ; preds = %15
  br i1 %18, label %61, label %81

61:                                               ; preds = %60, %74
  %62 = load i8*, i8** %16, align 8
  %63 = call i32 @credential_from_url_gently(%8* nonnull %6, i8* %62, i32 1) #8
  %64 = icmp ne i32 %63, 0
...
71:                                               ; preds = %61
  %72 = call i32 @credential_match(%8* %1, %8* nonnull %6) #8
  %73 = icmp eq i32 %72, 0
  br i1 %73, label %74, label %94

74:                                               ; preds = %71, %61
  %75 = call i32 @strbuf_getline_lf(%7* nonnull %5, %2* nonnull %10) #8
  %76 = icmp eq i32 %75, -1
  br i1 %76, label %98, label %61
...
81:                                               ; preds = %60, %95
  ...
  %83 = call i32 @credential_from_url_gently(%8* nonnull %6, i8* %82, i32 1) #8
  %84 = icmp ne i32 %83, 0
...
91:                                               ; preds = %81
  %92 = call i32 @credential_match(%8* %1, %8* nonnull %6) #8
  %93 = icmp eq i32 %92, 0
...
95:                                               ; preds = %91, %81
  call void %3(%7* nonnull %5) #8
  %96 = call i32 @strbuf_getline_lf(%7* nonnull %5, %2* nonnull %10) #8
  %97 = icmp eq i32 %96, -1
  br i1 %97, label %98, label %81

98:                                               ; preds = %95, %74, %56, %37, %12, %94
  %99 = phi i32 [ 1, %94 ], [ 0, %12 ], [ %38, %37 ], [ %57, %56 ], [ 0, %74 ], [ 0, %95 ]
  call void @credential_clear(%8* nonnull %6) #8
  call void @strbuf_release(%7* nonnull %5) #8
  %100 = call i32 @fclose(%2* nonnull %10)
  br label %101

101:                                              ; preds = %77, %77, %98
  %102 = phi i32 [ %99, %98 ], [ 0, %77 ], [ 0, %77 ]
