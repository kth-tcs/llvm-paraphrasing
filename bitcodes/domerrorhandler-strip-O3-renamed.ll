; ModuleID = 'domerrorhandler-strip-O3-renamed.bc'
source_filename = "/home/travis/build/orestisfl/compilation-database/build/php-src/ext/dom/domerrorhandler.c"
...
@0 = private unnamed_addr constant [12 x i8] c"handleError\00", align 1
@1 = internal constant [2 x %0] [%0 { i8* inttoptr (i64 1 to i8*), i64 0, i8 0, i8 0 }, %0 { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @3, i32 0, i32 0), i64 ptrtoint ([12 x i8]* @4 to i64), i8 0, i8 0 }], align 16
@php_dom_domerrorhandler_class_functions = hidden local_unnamed_addr constant [2 x { i8*, void (%1*, %29*)*, %0*, i32, i32 }] [{ i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @0, i32 0, i32 0), void (%1*, %29*)* @zif_dom_domerrorhandler_handle_error, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @1, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } zeroinitializer], align 16
@2 = private unnamed_addr constant [20 x i8] c"Not yet implemented\00", align 1
@3 = private unnamed_addr constant [6 x i8] c"error\00", align 1
@4 = private unnamed_addr constant [12 x i8] c"DOMDomError\00", align 1

; Function Attrs: nounwind uwtable
define hidden void @zif_dom_domerrorhandler_handle_error(%1* nocapture readnone %0, %29* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0)) #2
  ret void
}
