; ModuleID = 'zend_vm_opcodes-strip-O2-renamed.bc'
...
define dso_local i8* @zend_get_opcode_name(i8 zeroext %0) local_unnamed_addr #0 {
  %2 = zext i8 %0 to i64
  %3 = getelementptr inbounds [198 x i8*], [198 x i8*]* @0, i64 0, i64 %2
  %4 = load i8*, i8** %3, align 8
  ret i8* %4
}

; Function Attrs: norecurse nounwind readnone uwtable
define dso_local i32 @zend_get_opcode_flags(i8 zeroext %0) local_unnamed_addr #0 {
  %2 = zext i8 %0 to i64
  %3 = getelementptr inbounds [198 x i32], [198 x i32]* @1, i64 0, i64 %2
