; ModuleID = 'cmd-display-panes-strip-O3-renamed.bc'
...
144:                                              ; preds = %222, %136
  %145 = phi i8 [ %134, %136 ], [ %225, %222 ]
  %146 = phi i8* [ %23, %136 ], [ %224, %222 ]
  %147 = phi i32 [ %138, %136 ], [ %223, %222 ]
  %148 = add i8 %145, -48
...
154:                                              ; preds = %150
  ...
  %164 = add i32 %158, 3
  %165 = add i32 %158, 4
  br i1 %160, label %172, label %166

166:                                              ; preds = %154
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %140) #5
  %167 = load i32, i32* %4, align 4
  %168 = zext i32 %167 to i64
  %169 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %168, i64 0, i64 0
  %170 = load i8, i8* %169, align 1
  %171 = icmp eq i8 %170, 0
  br i1 %171, label %214, label %213

172:                                              ; preds = %154, %210
  %173 = phi i64 [ %211, %210 ], [ 0, %154 ]
  %174 = trunc i64 %173 to i32
  %175 = add i32 %140, %174
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %175) #5
  %176 = load i32, i32* %4, align 4
  %177 = zext i32 %176 to i64
  %178 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %177, i64 %173, i64 0
...
182:                                              ; preds = %172, %181
  call void @tty_cursor(%55* nonnull %38, i32 %162, i32 %175) #5
  %183 = load i32, i32* %4, align 4
  %184 = zext i32 %183 to i64
  %185 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %184, i64 %173, i64 1
...
189:                                              ; preds = %188, %182
  call void @tty_cursor(%55* nonnull %38, i32 %163, i32 %175) #5
  %190 = load i32, i32* %4, align 4
  %191 = zext i32 %190 to i64
  %192 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %191, i64 %173, i64 2
...
196:                                              ; preds = %195, %189
  call void @tty_cursor(%55* nonnull %38, i32 %164, i32 %175) #5
  %197 = load i32, i32* %4, align 4
  %198 = zext i32 %197 to i64
  %199 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %198, i64 %173, i64 3
...
203:                                              ; preds = %202, %196
  call void @tty_cursor(%55* nonnull %38, i32 %165, i32 %175) #5
  %204 = load i32, i32* %4, align 4
  %205 = zext i32 %204 to i64
  %206 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %205, i64 %173, i64 4
...
210:                                              ; preds = %209, %203
  %211 = add nuw nsw i64 %173, 1
  %212 = icmp eq i64 %211, 5
  br i1 %212, label %220, label %172
...
214:                                              ; preds = %166, %213
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %141) #5
  %215 = load i32, i32* %4, align 4
  %216 = zext i32 %215 to i64
  %217 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %216, i64 1, i64 0
  %218 = load i8, i8* %217, align 1
  %219 = icmp eq i8 %218, 0
  br i1 %219, label %250, label %249

220:                                              ; preds = %210, %264, %270, %150
  %221 = add i32 %147, 6
  br label %222

222:                                              ; preds = %220, %144
  %223 = phi i32 [ %147, %144 ], [ %221, %220 ]
  %224 = getelementptr inbounds i8, i8* %146, i64 1
  %225 = load i8, i8* %224, align 1
  %226 = icmp eq i8 %225, 0
  br i1 %226, label %227, label %144

227:                                              ; preds = %222, %129
  %228 = load i32, i32* %47, align 8
  %229 = load i32, i32* %59, align 4
  %230 = call i32 (i8*, i64, i8*, ...) @xsnprintf(i8* nonnull %23, i64 16, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @13, i64 0, i64 0), i32 %228, i32 %229) #5
  %231 = sext i32 %230 to i64
  %232 = icmp ult i64 %112, %231
  %233 = icmp ult i32 %95, 6
  %234 = or i1 %233, %232
...
235:                                              ; preds = %227
  %236 = add i32 %83, %82
  %237 = sub i32 %236, %230
  call void @tty_cursor(%55* nonnull %38, i32 %237, i32 %102) #5
  br label %238

238:                                              ; preds = %235, %123
  %239 = phi %15** [ %130, %235 ], [ %128, %123 ]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %21, i8* align 1 getelementptr inbounds (%5, %5* @grid_default_cell, i64 0, i32 0, i32 0, i64 0), i64 36, i1 false) #5
  %240 = load %15*, %15** %239, align 8
  %241 = icmp eq %15* %240, %33
  %242 = select i1 %241, i32 %118, i32 %116
  store i32 %242, i32* %30, align 1
  call void @tty_attributes(%55* nonnull %38, %5* nonnull %3, %5* nonnull @grid_default_cell, i32* null) #5
  call void @tty_puts(%55* nonnull %38, i8* nonnull %23) #5
  call void @tty_cursor(%55* nonnull %38, i32 0, i32 0) #5
  br label %243

243:                                              ; preds = %36, %52, %56, %64, %108, %227, %238
...
244:                                              ; preds = %32, %243
  %245 = getelementptr inbounds %15, %15* %33, i64 0, i32 43, i32 0
...
250:                                              ; preds = %249, %214
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %139) #5
  %251 = load i32, i32* %4, align 4
  %252 = zext i32 %251 to i64
  %253 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %252, i64 2, i64 0
...
257:                                              ; preds = %256, %250
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %142) #5
  %258 = load i32, i32* %4, align 4
  %259 = zext i32 %258 to i64
  %260 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %259, i64 3, i64 0
...
264:                                              ; preds = %263, %257
  call void @tty_cursor(%55* nonnull %38, i32 %158, i32 %143) #5
  %265 = load i32, i32* %4, align 4
  %266 = zext i32 %265 to i64
  %267 = getelementptr inbounds [14 x [5 x [5 x i8]]], [14 x [5 x [5 x i8]]]* @window_clock_table, i64 0, i64 %266, i64 4, i64 0
  %268 = load i8, i8* %267, align 1
  %269 = icmp eq i8 %268, 0
  br i1 %269, label %220, label %270
