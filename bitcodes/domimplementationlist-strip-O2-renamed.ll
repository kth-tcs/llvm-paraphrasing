; ModuleID = 'domimplementationlist-strip-O2-renamed.bc'
source_filename = "/home/travis/build/orestisfl/compilation-database/build/php-src/ext/dom/domimplementationlist.c"
...
@php_dom_domimplementationlist_class_functions = hidden local_unnamed_addr constant [2 x { i8*, void (%1*, %29*)*, %0*, i32, i32 }] [{ i8*, void (%1*, %29*)*, %0*, i32, i32 } { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0), void (%1*, %29*)* @zif_dom_domimplementationlist_item, %0* getelementptr inbounds ([2 x %0], [2 x %0]* @1, i32 0, i32 0), i32 1, i32 0 }, { i8*, void (%1*, %29*)*, %0*, i32, i32 } zeroinitializer], align 16
...
define hidden void @zif_dom_domimplementationlist_item(%1* nocapture readnone %0, %29* nocapture readnone %1) #0 {
  tail call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @2, i64 0, i64 0)) #3
  ret void
}

; Function Attrs: nounwind uwtable
define hidden i32 @dom_domimplementationlist_length_read(%33* nocapture readnone %0, %29* nocapture %1) local_unnamed_addr #0 {
