; ModuleID = 'sub-process-strip-O2-renamed.bc'
...
149:                                              ; preds = %139
  %150 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @11, i64 0, i64 0)) #11
  br label %191

151:                                              ; preds = %164, %147
  %152 = phi i8* [ %145, %147 ], [ %165, %164 ]
  %153 = phi i8* [ getelementptr inbounds ([12 x i8], [12 x i8]* @21, i64 0, i64 0), %147 ], [ %166, %164 ]
  %154 = load i8, i8* %153, align 1
  %155 = icmp eq i8 %154, 0
  br i1 %155, label %156, label %159

156:                                              ; preds = %151
  %157 = load i8*, i8** %121, align 8
  %158 = icmp eq i8* %157, null
  br i1 %158, label %183, label %171

159:                                              ; preds = %151
  %160 = getelementptr inbounds i8, i8* %152, i64 1
  %161 = load i8, i8* %152, align 1
  %162 = getelementptr inbounds i8, i8* %153, i64 1
  %163 = icmp eq i8 %161, %154
  br i1 %163, label %164, label %187

164:                                              ; preds = %159, %187
  %165 = phi i8* [ %160, %159 ], [ %189, %187 ]
  %166 = phi i8* [ %162, %159 ], [ getelementptr inbounds ([12 x i8], [12 x i8]* @21, i64 0, i64 0), %187 ]
  br label %151

167:                                              ; preds = %171
  %168 = getelementptr inbounds %6, %6* %4, i64 %176, i32 0
  %169 = load i8*, i8** %168, align 8
  %170 = icmp eq i8* %169, null
  br i1 %170, label %183, label %171

171:                                              ; preds = %156, %167
  %172 = phi i64 [ %176, %167 ], [ 0, %156 ]
  %173 = phi i8* [ %169, %167 ], [ %157, %156 ]
  %174 = tail call i32 @strcmp(i8* %152, i8* nonnull %173) #10
  %175 = icmp eq i32 %174, 0
  %176 = add nuw i64 %172, 1
  br i1 %175, label %177, label %167

177:                                              ; preds = %171
  br i1 %148, label %187, label %178

178:                                              ; preds = %177
  %179 = getelementptr inbounds %6, %6* %4, i64 %172, i32 1
...
183:                                              ; preds = %156, %167
  %184 = getelementptr inbounds %1, %1* %0, i64 0, i32 2, i32 0
  %185 = load i8**, i8*** %184, align 8
  %186 = load i8*, i8** %185, align 8
  tail call void (i8*, ...) @die(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @22, i64 0, i64 0), i8* %186, i8* %152) #12
  unreachable

187:                                              ; preds = %159, %178, %177
  %188 = load i32, i32* %44, align 4
  %189 = tail call i8* @packet_read_line(i32 %188, i32* null) #11
  %190 = icmp eq i8* %189, null
  br i1 %190, label %191, label %164

191:                                              ; preds = %187, %149, %143, %137, %119
  %192 = phi i32 [ 1, %119 ], [ 1, %137 ], [ 1, %149 ], [ 0, %143 ], [ 0, %187 ]
  %193 = tail call i32 @sigchain_pop(i32 13) #11
  ret i32 %192
}
