; ModuleID = 'entry-strip-O2-renamed.bc'
...
150:                                              ; preds = %176, %148
  %151 = phi i64 [ 0, %148 ], [ %177, %176 ]
  %152 = phi %33* [ %144, %148 ], [ %178, %176 ]
  %153 = getelementptr inbounds %33, %33* %152, i64 0, i32 0
  %154 = load %34**, %34*** %153, align 8
  %155 = getelementptr inbounds %34*, %34** %154, i64 %151
...
163:                                              ; preds = %158
  br i1 %149, label %168, label %164

164:                                              ; preds = %163
  %165 = getelementptr inbounds %34, %34* %156, i64 0, i32 1
  %166 = call i32 @match_stat_data(%25* nonnull %165, %53* nonnull %5) #10
  %167 = icmp eq i32 %166, 0
  br i1 %167, label %172, label %176

168:                                              ; preds = %163
  %169 = getelementptr inbounds %34, %34* %156, i64 0, i32 8, i64 0
  %170 = call i32 @fspathcmp(i8* nonnull %51, i8* nonnull %169) #10
  %171 = icmp eq i32 %170, 0
  br i1 %171, label %172, label %176

172:                                              ; preds = %168, %164
  %173 = getelementptr inbounds %34, %34* %156, i64 0, i32 3
  %174 = load i32, i32* %173, align 8
  %175 = or i32 %174, 67108864
  store i32 %175, i32* %173, align 8
  br label %183

176:                                              ; preds = %168, %164, %158
  %177 = add nuw nsw i64 %151, 1
  %178 = load %33*, %33** %85, align 8
...
183:                                              ; preds = %176, %150, %172, %140, %137
  %184 = getelementptr inbounds %53, %53* %5, i64 0, i32 3
...
188:                                              ; preds = %183
  %189 = getelementptr inbounds %34, %34* %0, i64 0, i32 2
...
197:                                              ; preds = %193
  ...
  %199 = call i32 (i8*, ...) @error(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @10, i64 0, i64 0), i8* %198) #10
  br label %275
...
201:                                              ; preds = %183
  %202 = load i8*, i8** getelementptr inbounds (%0, %0* @4, i64 0, i32 2), align 8
  %203 = call i32 @unlink(i8* %202) #10
  %204 = icmp eq i32 %203, 0
  br i1 %204, label %213, label %205

205:                                              ; preds = %201
  %206 = load i8*, i8** getelementptr inbounds (%0, %0* @4, i64 0, i32 2), align 8
  %207 = call i32 (i8*, ...) @error_errno(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @11, i64 0, i64 0), i8* %206) #10
  br label %275

208:                                              ; preds = %78, %80
  %209 = getelementptr inbounds %50, %50* %1, i64 0, i32 5
  %210 = load i8, i8* %209, align 8
  %211 = and i8 %210, 4
  %212 = icmp eq i8 %211, 0
  br i1 %212, label %213, label %275

213:                                              ; preds = %201, %200, %208
  %214 = load i8*, i8** getelementptr inbounds (%0, %0* @4, i64 0, i32 2), align 8
  %215 = load i64, i64* getelementptr inbounds (%0, %0* @4, i64 0, i32 1), align 8
  %216 = trunc i64 %215 to i32
  %217 = shl i64 %215, 32
  %218 = ashr exact i64 %217, 32
  %219 = call i8* @xmallocz(i64 %218) #10
  %220 = icmp sgt i32 %216, 0
  br i1 %220, label %221, label %267

221:                                              ; preds = %213
  %222 = getelementptr inbounds %50, %50* %1, i64 0, i32 5
  br label %223

223:                                              ; preds = %247, %221
  %224 = phi i64 [ 0, %221 ], [ %233, %247 ]
  %225 = shl i64 %224, 32
  %226 = ashr exact i64 %225, 32
  %227 = getelementptr inbounds i8, i8* %214, i64 %226
  %228 = load i8, i8* %227, align 1
  br label %229

229:                                              ; preds = %235, %223
  %230 = phi i8 [ %228, %223 ], [ %237, %235 ]
  %231 = phi i64 [ %226, %223 ], [ %233, %235 ]
  %232 = getelementptr inbounds i8, i8* %219, i64 %231
...
235:                                              ; preds = %229
  %236 = getelementptr inbounds i8, i8* %214, i64 %233
...
239:                                              ; preds = %235
  ...
  %243 = getelementptr inbounds i8, i8* %219, i64 %242
  store i8 0, i8* %243, align 1
  %244 = load i32, i32* %48, align 8
  %245 = call i32 @has_dirs_only_path(i8* nonnull %219, i32 %240, i32 %244) #10
  %246 = icmp eq i32 %245, 0
  br i1 %246, label %249, label %247

247:                                              ; preds = %263, %249, %239
  %248 = icmp slt i32 %240, %216
  br i1 %248, label %223, label %267

249:                                              ; preds = %239
  %250 = call i32 @mkdir(i8* nonnull %219, i32 511) #10
  %251 = icmp eq i32 %250, 0
  br i1 %251, label %247, label %252

252:                                              ; preds = %249
  %253 = tail call i32* @__errno_location() #13
  %254 = load i32, i32* %253, align 4
  %255 = icmp eq i32 %254, 17
  br i1 %255, label %256, label %266

256:                                              ; preds = %252
  %257 = load i8, i8* %222, align 8
  %258 = and i8 %257, 1
  %259 = icmp eq i8 %258, 0
  br i1 %259, label %266, label %260

260:                                              ; preds = %256
  %261 = call i32 @unlink_or_warn(i8* nonnull %219) #10
  %262 = icmp eq i32 %261, 0
  br i1 %262, label %263, label %266

263:                                              ; preds = %260
  %264 = call i32 @mkdir(i8* nonnull %219, i32 511) #10
  %265 = icmp eq i32 %264, 0
  br i1 %265, label %247, label %266

266:                                              ; preds = %263, %260, %256, %252
  call void (i8*, ...) @die_errno(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @37, i64 0, i64 0), i8* nonnull %219) #12
  unreachable

267:                                              ; preds = %247, %229, %213
  call void @free(i8* %219) #10
  %268 = icmp eq i32* %3, null
...
272:                                              ; preds = %267, %269
  ...
  %274 = call fastcc i32 @40(%34* %0, i8* %273, %50* %1, i32 0)
  br label %275

275:                                              ; preds = %188, %133, %130, %123, %205, %197, %121, %32, %27, %22, %208, %272, %35
  %276 = phi i32 [ %36, %35 ], [ %274, %272 ], [ 0, %208 ], [ 0, %22 ], [ 0, %27 ], [ 0, %32 ], [ 0, %188 ], [ -1, %133 ], [ -1, %130 ], [ 0, %123 ], [ -1, %205 ], [ -1, %197 ], [ %122, %121 ]
...
define internal fastcc i32 @40(%34* %0, i8* %1, %50* %2, i32 %3) unnamed_addr #0 {
  ...
  %12 = getelementptr inbounds %34, %34* %0, i64 0, i32 2
