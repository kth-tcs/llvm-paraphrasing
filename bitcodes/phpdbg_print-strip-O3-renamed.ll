; ModuleID = 'phpdbg_print-strip-O3-renamed.bc'
...
47:                                               ; preds = %43
  ...
  %49 = getelementptr inbounds %10, %10* %48, i64 0, i32 0
...
52:                                               ; preds = %47
  ...
  %54 = getelementptr inbounds %10, %10* %48, i64 0, i32 1
  %55 = load %29*, %29** %54, align 8
  %56 = getelementptr inbounds %29, %29* %55, i64 0, i32 3, i64 0
  %57 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %53, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @76, i64 0, i64 0), i8* nonnull %56, i8* %1) #9
  br label %74

58:                                               ; preds = %47
  %59 = getelementptr inbounds %10, %10* %48, i64 0, i32 10
  %60 = call i64 @strlen(i8* %1) #10
  %61 = call %49* @zend_hash_str_find(%57* nonnull %59, i8* %1, i64 %60) #9
  %62 = icmp eq %49* %61, null
  br i1 %62, label %74, label %63

63:                                               ; preds = %58
  %64 = bitcast %49* %61 to i8**
  %65 = load i8*, i8** %64, align 8
  %66 = icmp eq i8* %65, null
  br i1 %66, label %74, label %67

67:                                               ; preds = %63
  %68 = bitcast i8* %65 to %8*
  %69 = load i32, i32* getelementptr inbounds (%4, %4* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %70 = getelementptr inbounds %10, %10* %48, i64 0, i32 1
  %71 = load %29*, %29** %70, align 8
  %72 = getelementptr inbounds %29, %29* %71, i64 0, i32 3, i64 0
  %73 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %69, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @77, i64 0, i64 0), i8* nonnull %72, i8* %1) #9
  call fastcc void @88(%8* %68) #9
  br label %74

74:                                               ; preds = %67, %63, %58, %52, %24, %32, %36, %43, %18
  %75 = getelementptr inbounds %59, %59* %19, i64 1
  %76 = icmp eq %59* %75, %16
  br i1 %76, label %104, label %18

77:                                               ; preds = %2
  %78 = load %10*, %10** %3, align 8
  %79 = getelementptr inbounds %10, %10* %78, i64 0, i32 0
...
82:                                               ; preds = %77
  ...
  %84 = getelementptr inbounds %10, %10* %78, i64 0, i32 1
  %85 = load %29*, %29** %84, align 8
  %86 = getelementptr inbounds %29, %29* %85, i64 0, i32 3, i64 0
  %87 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %83, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @76, i64 0, i64 0), i8* nonnull %86, i8* %1) #9
  br label %104

88:                                               ; preds = %77
  %89 = getelementptr inbounds %10, %10* %78, i64 0, i32 10
  %90 = call i64 @strlen(i8* %1) #10
  %91 = call %49* @zend_hash_str_find(%57* nonnull %89, i8* %1, i64 %90) #9
  %92 = icmp eq %49* %91, null
  br i1 %92, label %104, label %93

93:                                               ; preds = %88
  %94 = bitcast %49* %91 to i8**
  %95 = load i8*, i8** %94, align 8
  %96 = icmp eq i8* %95, null
  br i1 %96, label %104, label %97

97:                                               ; preds = %93
  %98 = bitcast i8* %95 to %8*
  %99 = load i32, i32* getelementptr inbounds (%4, %4* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %100 = getelementptr inbounds %10, %10* %78, i64 0, i32 1
  %101 = load %29*, %29** %100, align 8
  %102 = getelementptr inbounds %29, %29* %101, i64 0, i32 3, i64 0
  %103 = call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %99, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @77, i64 0, i64 0), i8* nonnull %102, i8* %1) #9
  call fastcc void @88(%8* %98) #9
  br label %104

104:                                              ; preds = %74, %9, %97, %93, %88, %82
...
; Function Attrs: nounwind uwtable
define internal fastcc void @89(%10* nocapture readonly %0) unnamed_addr #0 {
...
69:                                               ; preds = %63
  ...
  tail call fastcc void @89(%10* %65)
  br label %72
