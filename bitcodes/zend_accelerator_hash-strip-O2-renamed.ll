; ModuleID = 'zend_accelerator_hash-strip-O2-renamed.bc'
...
12:                                               ; preds = %2, %10
  ...
  %14 = load i64, i64* getelementptr inbounds (%0, %0* @accel_globals, i64 0, i32 22), align 8
  %15 = xor i64 %14, %13
  ...
  %22 = getelementptr inbounds %38*, %38** %21, i64 %19
