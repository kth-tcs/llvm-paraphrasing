; ModuleID = 'plugins_d-strip-O3-renamed.bc'
...
157:                                              ; preds = %153, %11
  ...
  call void @__pthread_unregister_cancel(%41* nonnull %2) #12
  %158 = getelementptr inbounds i8, i8* %0, i64 24
  %159 = bitcast i8* %158 to i32*
  store volatile i32 2, i32* %159, align 8
  call void (i8*, i8*, i64, i8*, ...) @info_int(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @6, i64 0, i64 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @95, i64 0, i64 0), i64 810, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @96, i64 0, i64 0)) #12
  %160 = load %0*, %0** @pluginsd_root, align 8
  %161 = icmp eq %0* %160, null
  br i1 %161, label %180, label %162

162:                                              ; preds = %157, %176
  %163 = phi %0* [ %178, %176 ], [ %160, %157 ]
  %164 = getelementptr inbounds %0, %0* %163, i64 0, i32 10
  %165 = load volatile i32, i32* %164, align 8
...
171:                                              ; preds = %167
  %172 = getelementptr inbounds %0, %0* %163, i64 0, i32 0, i64 0
  call void (i8*, i8*, i64, i8*, ...) @info_int(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @6, i64 0, i64 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @95, i64 0, i64 0), i64 815, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @97, i64 0, i64 0), i8* nonnull %172) #12
  %173 = getelementptr inbounds %0, %0* %163, i64 0, i32 5
  %174 = load i64, i64* %173, align 8
  %175 = call i32 @netdata_thread_cancel(i64 %174) #12
  br label %176

176:                                              ; preds = %171, %167, %162
  %177 = getelementptr inbounds %0, %0* %163, i64 0, i32 12
  %178 = load %0*, %0** %177, align 8
  %179 = icmp eq %0* %178, null
  br i1 %179, label %180, label %162

180:                                              ; preds = %176, %157
  call void (i8*, i8*, i64, i8*, ...) @info_int(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @6, i64 0, i64 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @95, i64 0, i64 0), i64 820, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @98, i64 0, i64 0)) #12
  store volatile i32 0, i32* %159, align 8
