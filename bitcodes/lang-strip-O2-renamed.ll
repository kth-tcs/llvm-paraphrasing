; ModuleID = 'lang-strip-O2-renamed.bc'
...
define dso_local i64 @get_lang_count() local_unnamed_addr #0 {
  ret i64 134
}

; Function Attrs: nounwind uwtable
define dso_local i8* @make_lang_regex(i8* nocapture readonly %0, i64 %1) local_unnamed_addr #1 {
  %3 = tail call i8* @ag_malloc(i64 100) #6
  %4 = bitcast i8* %3 to i32*
  store i32 2633308, i32* %4, align 1
  %5 = icmp eq i64 %1, 0
  br i1 %5, label %44, label %6

6:                                                ; preds = %2, %35
  %7 = phi i32 [ %29, %35 ], [ 100, %2 ]
  %8 = phi i64 [ %42, %35 ], [ 0, %2 ]
  %9 = phi i8* [ %28, %35 ], [ %3, %2 ]
  %10 = phi i32 [ %37, %35 ], [ 0, %2 ]
  %11 = phi i32 [ %41, %35 ], [ 3, %2 ]
  %12 = mul i64 %8, 20
  %13 = getelementptr inbounds i8, i8* %0, i64 %12
  %14 = tail call i64 @strlen(i8* %13) #7
...
20:                                               ; preds = %6, %20
  %21 = phi i32 [ %23, %20 ], [ %7, %6 ]
  %22 = phi i8* [ %25, %20 ], [ %9, %6 ]
  %23 = shl nsw i32 %21, 1
  %24 = sext i32 %23 to i64
  %25 = tail call i8* @ag_realloc(i8* %22, i64 %24) #6
  %26 = icmp sgt i32 %18, %23
  br i1 %26, label %20, label %27

27:                                               ; preds = %20, %6
  %28 = phi i8* [ %9, %6 ], [ %25, %20 ]
  %29 = phi i32 [ %7, %6 ], [ %23, %20 ]
  %30 = icmp eq i32 %10, 0
...
35:                                               ; preds = %27, %31
  %36 = phi i32 [ %32, %31 ], [ %11, %27 ]
  %37 = phi i32 [ %10, %31 ], [ 1, %27 ]
  %38 = sext i32 %36 to i64
  %39 = getelementptr inbounds i8, i8* %28, i64 %38
  %40 = tail call i8* @strcpy(i8* %39, i8* %13) #6
...
declare dso_local i8* @ag_realloc(i8*, i64) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local i64 @combine_file_extensions(i64* nocapture readonly %0, i64 %1, i8** nocapture %2) local_unnamed_addr #1 {
  %4 = tail call i8* @ag_malloc(i64 2000) #6
  store i8* %4, i8** %2, align 8
  tail call void @llvm.memset.p0i8.i64(i8* align 1 %4, i8 0, i64 2000, i1 false)
  %5 = icmp eq i64 %1, 0
...
6:                                                ; preds = %3, %30
  ...
  %11 = getelementptr inbounds [134 x %0], [134 x %0]* bitcast (<{ { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> } }>* @langs to [134 x %0]*), i64 0, i64 %10, i32 1, i64 0
  %12 = load i8*, i8** %11, align 8
  br label %13

13:                                               ; preds = %18, %6
  %14 = phi i64 [ 0, %6 ], [ %26, %18 ]
  %15 = phi i8* [ %12, %6 ], [ %28, %18 ]
  %16 = phi i64 [ %7, %6 ], [ %24, %18 ]
...
18:                                               ; preds = %13
  ...
  %22 = tail call i64 @strlen(i8* %15) #7
  %23 = tail call i8* @strncpy(i8* %21, i8* %15, i64 %22) #6
  %24 = add i64 %16, 1
  %25 = load i64, i64* %9, align 8
  %26 = add i64 %14, 1
  %27 = getelementptr inbounds [134 x %0], [134 x %0]* bitcast (<{ { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, %0, { i8*, <{ i8*, i8*, i8*, [9 x i8*] }> }, { i8*, <{ i8*, i8*, i8*, i8*, [8 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, i8*, [10 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, { i8*, <{ i8*, [11 x i8*] }> }, %0, { i8*, <{ i8*, i8*, [10 x i8*] }> } }>* @langs to [134 x %0]*), i64 0, i64 %25, i32 1, i64 %26
  %28 = load i8*, i8** %27, align 8
  %29 = icmp eq i8* %28, null
  br i1 %29, label %30, label %13

30:                                               ; preds = %18, %13
  %31 = phi i64 [ 100, %13 ], [ %24, %18 ]
  %32 = add nuw i64 %8, 1
  %33 = icmp eq i64 %32, %1
  br i1 %33, label %34, label %6

34:                                               ; preds = %30, %3
  %35 = phi i64 [ 0, %3 ], [ %31, %30 ]
  ret i64 %35
}
