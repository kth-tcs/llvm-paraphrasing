; ModuleID = 'sha1-name-strip-O2-renamed.bc'
...
17:                                               ; preds = %15, %56
  %18 = phi %18* [ %3, %15 ], [ %57, %56 ]
  %19 = getelementptr inbounds %18, %18* %18, i64 0, i32 0
...
23:                                               ; preds = %17
  %24 = getelementptr inbounds %18, %18* %18, i64 0, i32 2
  %25 = tail call %18* @parse_object(%1* %0, %19* nonnull %24) #7
  %26 = icmp eq %18* %25, null
  %27 = or i1 %26, %16
  br i1 %27, label %59, label %28

28:                                               ; preds = %23
  %29 = load i8, i8* %19, align 4
  br label %31
...
37:                                               ; preds = %31
  %38 = trunc i8 %33 to i3
  switch i3 %38, label %47 [
    i3 -4, label %39
    i3 1, label %43
  ]

39:                                               ; preds = %37
  %40 = getelementptr inbounds %18, %18* %18, i64 1
  %41 = bitcast %18* %40 to %18**
  %42 = load %18*, %18** %41, align 8
  br label %56

43:                                               ; preds = %37
  %44 = bitcast %18* %18 to %56*
  %45 = tail call %58* @repo_get_commit_tree(%1* %0, %56* %44) #7
  %46 = getelementptr inbounds %58, %58* %45, i64 0, i32 0
  br label %56

47:                                               ; preds = %37
  br i1 %6, label %61, label %48

48:                                               ; preds = %47
  %49 = tail call i8* @type_name(i32 %4) #7
  %50 = load i8, i8* %19, align 4
  %51 = lshr i8 %50, 1
  %52 = and i8 %51, 7
  %53 = zext i8 %52 to i32
  %54 = tail call i8* @type_name(i32 %53) #7
  %55 = tail call i32 (i8*, ...) @error(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @11, i64 0, i64 0), i32 %13, i8* nonnull %1, i8* %49, i8* %54) #7
  br label %61

56:                                               ; preds = %43, %39
  %57 = phi %18* [ %42, %39 ], [ %46, %43 ]
  %58 = icmp eq %18* %57, null
  br i1 %58, label %61, label %17

59:                                               ; preds = %23
  %60 = select i1 %26, %18* null, %18* %18
  br label %61

61:                                               ; preds = %30, %31, %56, %59, %12, %48, %47
  %62 = phi %18* [ null, %47 ], [ null, %48 ], [ null, %12 ], [ %60, %59 ], [ %18, %30 ], [ %18, %31 ], [ null, %56 ]
  ret %18* %62
}
...
18:                                               ; preds = %12
  %19 = tail call fastcc i32 @74(%1* %0, i8* %1, i32 %13, %42* %3)
  %20 = icmp eq i32 %19, 0
...
25:                                               ; preds = %23
  %26 = tail call fastcc i32 @75(%1* %0, i8* %1, i32 %13, i32 %19, %42* %3, i32 %4)
  br label %189
...
27:                                               ; preds = %12, %21
  ...
  %30 = add i64 %28, %29
  %31 = call i8* @memchr(i8* %1, i32 64, i64 %28) #14
...
33:                                               ; preds = %27
  ...
  %35 = icmp eq i32 %34, 0
  %36 = and i1 %14, %35
  %37 = bitcast %42* %6 to i8*
  %38 = bitcast %42* %7 to i8*
  %39 = getelementptr inbounds i8, i8* %1, i64 1
  %40 = add i32 %13, -1
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds i8, i8* %1, i64 %28
  %43 = icmp eq i32 %4, 0
  %44 = getelementptr inbounds %42, %42* %3, i64 0, i32 1
  %45 = getelementptr inbounds %42, %42* %3, i64 0, i32 2
  %46 = and i32 %4, 2
  %47 = icmp eq i32 %46, 0
  %48 = xor i1 %36, true
  br label %49
...
59:                                               ; preds = %56
  %60 = call i8* @memchr(i8* nonnull %39, i32 64, i64 %41) #14
...
62:                                               ; preds = %59
  ...
  %64 = load i8, i8* %63, align 1
  %65 = icmp eq i8 %64, 123
  br i1 %65, label %66, label %79

66:                                               ; preds = %59, %62
  %67 = phi i8* [ %60, %62 ], [ %42, %59 ]
  %68 = icmp eq i8* %67, %39
...
77:                                               ; preds = %73, %72
  ...
  %78 = call fastcc i32 @75(%1* %0, i8* nonnull %1, i32 %13, i32 1, %42* nonnull %3, i32 %4)
  br label %189

79:                                               ; preds = %49, %66, %62, %56
  %80 = phi i32 [ 0, %66 ], [ 0, %62 ], [ 0, %56 ], [ %53, %49 ]
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %37) #7
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %37, i8* align 8 bitcast (%42* @54 to i8*), i64 24, i1 false) #7
  %81 = shl i64 %52, 32
  %82 = ashr exact i64 %81, 32
  %83 = getelementptr inbounds i8, i8* %1, i64 %82
  %84 = sub nsw i32 %13, %80
  %85 = icmp slt i32 %84, 11
  br i1 %85, label %89, label %86

86:                                               ; preds = %79
  %87 = call i32 @strncasecmp(i8* %83, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @27, i64 0, i64 0), i64 11) #14
  %88 = icmp eq i32 %87, 0
  br i1 %88, label %94, label %91

89:                                               ; preds = %79
  %90 = icmp slt i32 %84, 4
  br i1 %90, label %131, label %91

91:                                               ; preds = %89, %86
  %92 = call i32 @strncasecmp(i8* %83, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @28, i64 0, i64 0), i64 4) #14
  %93 = icmp eq i32 %92, 0
  br i1 %93, label %94, label %131

94:                                               ; preds = %91, %86
  %95 = phi i32 [ 11, %86 ], [ 4, %91 ]
  %96 = call i8* @memchr(i8* %1, i32 58, i64 %82) #14
...
100:                                              ; preds = %98
  %101 = call i8* @xmemdupz(i8* %1, i64 %82) #7
  %102 = call %60* @branch_get(i8* %101) #7
  call void @free(i8* %101) #7
  br label %105

103:                                              ; preds = %98
  %104 = call %60* @branch_get(i8* null) #7
  br label %105

105:                                              ; preds = %103, %100
  %106 = phi %60* [ %102, %100 ], [ %104, %103 ]
  %107 = call i8* @branch_get_upstream(%60* %106, %42* nonnull %6) #7
  %108 = icmp eq i8* %107, null
  br i1 %108, label %109, label %112

109:                                              ; preds = %105
  %110 = getelementptr inbounds %42, %42* %6, i64 0, i32 2
  %111 = load i8*, i8** %110, align 8
  call void (i8*, ...) @die(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @25, i64 0, i64 0), i8* %111) #15
  unreachable

112:                                              ; preds = %105
  br i1 %43, label %121, label %113

113:                                              ; preds = %112
  br i1 %16, label %117, label %114

114:                                              ; preds = %113
  %115 = call i32 @starts_with(i8* nonnull %107, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @14, i64 0, i64 0)) #7
...
118:                                              ; preds = %117
  %119 = call i32 @starts_with(i8* nonnull %107, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @26, i64 0, i64 0)) #7
  %120 = icmp eq i32 %119, 0
  br i1 %120, label %131, label %121

121:                                              ; preds = %118, %114, %112
  %122 = call %26* @get_main_ref_store(%1* %0) #7
  %123 = call i8* @refs_shorten_unambiguous_ref(%26* %122, i8* nonnull %107, i32 0) #7
  store i64 0, i64* %44, align 8
...
131:                                              ; preds = %94, %117, %118, %89, %91
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %37) #7
  br label %136

132:                                              ; preds = %126, %127
  %133 = call i64 @strlen(i8* %123) #14
  call void @strbuf_add(%42* nonnull %3, i8* %123, i64 %133) #7
  call void @free(i8* %123) #7
  %134 = add nsw i32 %95, %80
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %37) #7
...
136:                                              ; preds = %131, %132
  ...
  %137 = icmp slt i32 %84, 7
  br i1 %137, label %177, label %138

138:                                              ; preds = %136
  %139 = call i32 @strncasecmp(i8* %83, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @29, i64 0, i64 0), i64 7) #14
  %140 = icmp eq i32 %139, 0
  br i1 %140, label %141, label %177

141:                                              ; preds = %138
  %142 = call i8* @memchr(i8* %1, i32 58, i64 %82) #14
...
146:                                              ; preds = %144
  %147 = call i8* @xmemdupz(i8* %1, i64 %82) #7
  %148 = call %60* @branch_get(i8* %147) #7
  call void @free(i8* %147) #7
  br label %151

149:                                              ; preds = %144
  %150 = call %60* @branch_get(i8* null) #7
  br label %151

151:                                              ; preds = %149, %146
  %152 = phi %60* [ %148, %146 ], [ %150, %149 ]
  %153 = call i8* @branch_get_push(%60* %152, %42* nonnull %7) #7
  %154 = icmp eq i8* %153, null
  br i1 %154, label %155, label %158

155:                                              ; preds = %151
  %156 = getelementptr inbounds %42, %42* %7, i64 0, i32 2
  %157 = load i8*, i8** %156, align 8
  call void (i8*, ...) @die(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @25, i64 0, i64 0), i8* %157) #15
  unreachable

158:                                              ; preds = %151
  br i1 %43, label %167, label %159

159:                                              ; preds = %158
  br i1 %16, label %163, label %160

160:                                              ; preds = %159
  %161 = call i32 @starts_with(i8* nonnull %153, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @14, i64 0, i64 0)) #7
  %162 = icmp eq i32 %161, 0
  br i1 %162, label %163, label %167

163:                                              ; preds = %160, %159
  br i1 %47, label %177, label %164

164:                                              ; preds = %163
  %165 = call i32 @starts_with(i8* nonnull %153, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @26, i64 0, i64 0)) #7
  %166 = icmp eq i32 %165, 0
  br i1 %166, label %177, label %167

167:                                              ; preds = %164, %160, %158
  %168 = call %26* @get_main_ref_store(%1* %0) #7
  %169 = call i8* @refs_shorten_unambiguous_ref(%26* %168, i8* nonnull %153, i32 0) #7
  store i64 0, i64* %44, align 8
  %170 = load i8*, i8** %45, align 8
...
177:                                              ; preds = %141, %163, %164, %138, %136
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %38) #7
  br label %181

178:                                              ; preds = %172, %173
  %179 = call i64 @strlen(i8* %169) #14
  call void @strbuf_add(%42* nonnull %3, i8* %169, i64 %179) #7
  call void @free(i8* %169) #7
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %38) #7
  %180 = icmp sgt i32 %80, -7
  br i1 %180, label %187, label %181

181:                                              ; preds = %177, %178
  %182 = getelementptr inbounds i8, i8* %50, i64 1
  %183 = ptrtoint i8* %182 to i64
  %184 = sub i64 %30, %183
  %185 = call i8* @memchr(i8* nonnull %182, i32 64, i64 %184) #14
  %186 = icmp eq i8* %185, null
  br i1 %186, label %189, label %49

187:                                              ; preds = %178
  %188 = add nsw i32 %80, 7
  br label %189

189:                                              ; preds = %132, %181, %27, %187, %23, %18, %77, %25
  %190 = phi i32 [ %26, %25 ], [ %78, %77 ], [ 0, %18 ], [ %13, %23 ], [ %188, %187 ], [ -1, %27 ], [ %134, %132 ], [ -1, %181 ]
  ret i32 %190
}
