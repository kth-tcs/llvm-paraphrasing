; ModuleID = 'http-push-strip-O2-renamed.bc'
...
632:                                              ; preds = %628
  ...
  call fastcc void @156(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @80, i64 0, i64 0), i32 5, void (%105*)* nonnull @166, i8* nonnull %633) #9
...
define internal fastcc void @149() unnamed_addr #0 {
  ...
  %6 = tail call i64 @time(i64* null) #9
  %7 = icmp eq %6* %5, null
  br i1 %7, label %87, label %8

8:                                                ; preds = %0
  %9 = bitcast %55* %2 to i8*
  %10 = bitcast %53* %1 to i8*
  %11 = getelementptr inbounds %53, %53* %1, i64 0, i32 2
  %12 = getelementptr inbounds %53, %53* %1, i64 0, i32 1
  %13 = getelementptr inbounds %55, %55* %2, i64 0, i32 0
  br label %14

14:                                               ; preds = %8, %83
  %15 = phi %6* [ %5, %8 ], [ %85, %83 ]
  %16 = getelementptr inbounds %6, %6* %15, i64 0, i32 4
  %17 = load i64, i64* %16, align 8
  %18 = getelementptr inbounds %6, %6* %15, i64 0, i32 5
  %19 = load i64, i64* %18, align 8
  %20 = sub i64 %17, %6
  %21 = add i64 %20, %19
  %22 = trunc i64 %21 to i32
  %23 = getelementptr inbounds %6, %6* %15, i64 0, i32 6
  %24 = load i32, i32* %23, align 8
  %25 = icmp eq i32 %24, 0
  %26 = icmp slt i32 %22, 30
  %27 = and i1 %25, %26
...
28:                                               ; preds = %14
  ...
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %10) #9
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %10, i8* align 8 bitcast (%53* @130 to i8*), i64 24, i1 false) #9
  %29 = call %51* @http_copy_default_headers() #9
  %30 = getelementptr inbounds %6, %6* %15, i64 0, i32 2
  %31 = load i8*, i8** %30, align 8
  call void (%53*, i8*, ...) @strbuf_addf(%53* nonnull %1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @131, i64 0, i64 0), i8* %31) #9
  %32 = load i8*, i8** %11, align 8
  %33 = call %51* @curl_slist_append(%51* %29, i8* %32) #9
...
41:                                               ; preds = %37, %36
  ...
  call void (%53*, i8*, ...) @strbuf_addf(%53* nonnull %1, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @72, i64 0, i64 0), i64 %42) #9
  %43 = load i8*, i8** %11, align 8
  %44 = call %51* @curl_slist_append(%51* %33, i8* %43) #9
  store i64 0, i64* %12, align 8
...
52:                                               ; preds = %48, %47
  call void @strbuf_release(%53* nonnull %1) #9
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %10) #9
  %53 = call %54* @get_active_slot() #9
  %54 = getelementptr inbounds %54, %54* %53, i64 0, i32 5
  store %55* %2, %55** %54, align 8
  %55 = getelementptr inbounds %54, %54* %53, i64 0, i32 0
  %56 = load i8*, i8** %55, align 8
  %57 = getelementptr inbounds %6, %6* %15, i64 0, i32 0
  %58 = load i8*, i8** %57, align 8
  %59 = call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %56, i32 80, i32 1) #9
  %60 = call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %56, i32 10002, i8* %58) #9
  %61 = call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %56, i32 10036, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @73, i64 0, i64 0)) #9
  %62 = call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %56, i32 20011, i64 (i8*, i64, i64, i8*)* nonnull @fwrite_null) #9
  %63 = load i8*, i8** %55, align 8
  %64 = call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %63, i32 10023, %51* %44) #9
  %65 = call i32 @start_active_slot(%54* %53) #9
  %66 = icmp eq i32 %65, 0
  br i1 %66, label %77, label %67

67:                                               ; preds = %52
  call void @run_active_slot(%54* %53) #9
  %68 = load i32, i32* %13, align 8
  %69 = icmp eq i32 %68, 0
  br i1 %69, label %75, label %70

70:                                               ; preds = %67
  %71 = load %7*, %7** @stderr, align 8
  %72 = getelementptr inbounds %55, %55* %2, i64 0, i32 1
  %73 = load i64, i64* %72, align 8
  %74 = call i32 (%7*, i8*, ...) @fprintf(%7* %71, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @140, i64 0, i64 0), i64 %73) #12
  store i32 0, i32* %23, align 8
  call void @curl_slist_free_all(%51* %44) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %9) #9
  br label %78

75:                                               ; preds = %67
  %76 = call i64 @time(i64* null) #9
...
78:                                               ; preds = %77, %70
  %79 = getelementptr inbounds %6, %6* %15, i64 0, i32 0
  %80 = load %7*, %7** @stderr, align 8
  %81 = load i8*, i8** %79, align 8
  %82 = call i32 (%7*, i8*, ...) @fprintf(%7* %80, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @139, i64 0, i64 0), i8* %81) #13
  store i1 true, i1* @45, align 4
  br label %87

83:                                               ; preds = %75, %14
  %84 = getelementptr inbounds %6, %6* %15, i64 0, i32 7
...
16:                                               ; preds = %11
  %17 = getelementptr inbounds %50, %50* %12, i64 0, i32 6
  %18 = load %0*, %0** @0, align 8
  %19 = getelementptr inbounds %0, %0* %18, i64 0, i32 0
  %20 = load i8*, i8** %19, align 8
  %21 = getelementptr inbounds %50, %50* %12, i64 0, i32 0
  %22 = load %24*, %24** %21, align 8
  %23 = getelementptr inbounds %24, %24* %22, i64 0, i32 2
  %24 = tail call %106* @new_http_object_request(i8* %20, %10* nonnull %23) #9
  %25 = icmp eq %106* %24, null
...
27:                                               ; preds = %16
  %28 = getelementptr inbounds %106, %106* %24, i64 0, i32 12
  %29 = load %54*, %54** %28, align 8
  %30 = getelementptr inbounds %54, %54* %29, i64 0, i32 7
  store void (i8*)* @162, void (i8*)** %30, align 8
  %31 = getelementptr inbounds %54, %54* %29, i64 0, i32 6
  %32 = bitcast i8** %31 to %50**
  store %50* %12, %50** %32, align 8
  %33 = getelementptr inbounds %50, %50* %12, i64 0, i32 11
  store %54* %29, %54** %33, align 8
  %34 = getelementptr inbounds %50, %50* %12, i64 0, i32 10
  %35 = bitcast i8** %34 to %106**
  store %106* %24, %106** %35, align 8
  store i32 1, i32* %17, align 8
  %36 = tail call i32 @start_active_slot(%54* %29) #9
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %112

38:                                               ; preds = %27
  %39 = load %7*, %7** @stderr, align 8
  %40 = tail call i64 @fwrite(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @95, i64 0, i64 0), i64 28, i64 1, %7* %39) #12
  %41 = load %0*, %0** @0, align 8
  %42 = getelementptr inbounds %0, %0* %41, i64 0, i32 4
  store i32 0, i32* %42, align 8
  tail call void @release_http_object_request(%106* nonnull %24) #9
  %43 = load %50*, %50** @52, align 8
  %44 = icmp eq %50* %43, %12
  br i1 %44, label %45, label %49

45:                                               ; preds = %38
  %46 = getelementptr inbounds %50, %50* %12, i64 0, i32 12
  %47 = bitcast %50** %46 to i64*
  %48 = load i64, i64* %47, align 8
  store i64 %48, i64* bitcast (%50** @52 to i64*), align 8
  br label %62

49:                                               ; preds = %38, %52
  %50 = phi %50* [ %54, %52 ], [ %43, %38 ]
  %51 = icmp eq %50* %50, null
  br i1 %51, label %62, label %52

52:                                               ; preds = %49
  %53 = getelementptr inbounds %50, %50* %50, i64 0, i32 12
  %54 = load %50*, %50** %53, align 8
  %55 = icmp eq %50* %54, %12
  br i1 %55, label %56, label %49

56:                                               ; preds = %52
  %57 = getelementptr inbounds %50, %50* %50, i64 0, i32 12
  %58 = getelementptr inbounds %50, %50* %12, i64 0, i32 12
  %59 = bitcast %50** %58 to i64*
  %60 = load i64, i64* %59, align 8
  %61 = bitcast %50** %57 to i64*
  store i64 %60, i64* %61, align 8
  br label %62

62:                                               ; preds = %49, %56, %45
  %63 = getelementptr inbounds %50, %50* %12, i64 0, i32 1
  %64 = load i8*, i8** %63, align 8
  tail call void @free(i8* %64) #9
  %65 = bitcast %50* %12 to i8*
...
69:                                               ; preds = %66
  %70 = getelementptr inbounds %50, %50* %12, i64 0, i32 6
  %71 = getelementptr inbounds %50, %50* %12, i64 0, i32 0
  %72 = load %24*, %24** %71, align 8
  %73 = getelementptr inbounds %24, %24* %72, i64 0, i32 2, i32 0, i64 0
  %74 = load i8, i8* %73, align 4
  %75 = zext i8 %74 to i64
  %76 = getelementptr inbounds [256 x i8], [256 x i8]* @17, i64 0, i64 %75
...
80:                                               ; preds = %69
  %81 = getelementptr inbounds %24, %24* %72, i64 0, i32 2
  %82 = tail call i8* @oid_to_hex(%10* nonnull %81) #9
  %83 = load %0*, %0** @0, align 8
  %84 = getelementptr inbounds %0, %0* %83, i64 0, i32 0
  %85 = load i8*, i8** %84, align 8
  %86 = tail call i8* @get_remote_object_url(i8* %85, i8* %82, i32 1) #9
  %87 = getelementptr inbounds %50, %50* %12, i64 0, i32 1
  store i8* %86, i8** %87, align 8
  %88 = tail call %54* @get_active_slot() #9
  %89 = getelementptr inbounds %54, %54* %88, i64 0, i32 7
  store void (i8*)* @162, void (i8*)** %89, align 8
  %90 = getelementptr inbounds %54, %54* %88, i64 0, i32 6
  %91 = bitcast i8** %90 to %50**
  store %50* %12, %50** %91, align 8
  %92 = getelementptr inbounds %54, %54* %88, i64 0, i32 0
  %93 = load i8*, i8** %92, align 8
  %94 = load i8*, i8** %87, align 8
  %95 = tail call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %93, i32 80, i32 1) #9
  %96 = tail call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %93, i32 10002, i8* %94) #9
  %97 = tail call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %93, i32 10036, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @68, i64 0, i64 0)) #9
  %98 = tail call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %93, i32 20011, i64 (i8*, i64, i64, i8*)* nonnull @fwrite_null) #9
  %99 = load i8*, i8** %92, align 8
  %100 = getelementptr inbounds %50, %50* %12, i64 0, i32 8, i64 0
  %101 = tail call i32 (i8*, i32, ...) @curl_easy_setopt(i8* %99, i32 10010, i8* nonnull %100) #9
  %102 = tail call i32 @start_active_slot(%54* %88) #9
  %103 = icmp eq i32 %102, 0
  br i1 %103, label %106, label %104

104:                                              ; preds = %80
  %105 = getelementptr inbounds %50, %50* %12, i64 0, i32 11
  store %54* %88, %54** %105, align 8
  store i32 4, i32* %70, align 8
  br label %112

106:                                              ; preds = %80
  store i32 7, i32* %70, align 8
  %107 = load i8*, i8** %87, align 8
  tail call void @free(i8* %107) #9
  store i8* null, i8** %87, align 8
  br label %112

108:                                              ; preds = %66
  %109 = getelementptr inbounds %50, %50* %12, i64 0, i32 12
  %110 = load %50*, %50** %109, align 8
  %111 = icmp eq %50* %110, null
  br i1 %111, label %112, label %11

112:                                              ; preds = %108, %6, %106, %104, %62, %27, %26, %79, %1
  %113 = phi i32 [ 0, %1 ], [ 1, %79 ], [ 1, %26 ], [ 1, %27 ], [ 1, %62 ], [ 1, %104 ], [ 1, %106 ], [ 0, %6 ], [ 0, %108 ]
  ret i32 %113
}
...
; Function Attrs: nounwind uwtable
define internal void @166(%105* nocapture readonly %0) #0 {
