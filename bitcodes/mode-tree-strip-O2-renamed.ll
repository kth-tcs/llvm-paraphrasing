; ModuleID = 'mode-tree-strip-O2-renamed.bc'
...
8:                                                ; preds = %5, %24
  %9 = phi %88* [ %3, %5 ], [ %11, %24 ]
  %10 = getelementptr inbounds %88, %88* %9, i64 0, i32 10, i32 0
  %11 = load %88*, %88** %10, align 8
  %12 = icmp eq %88* %11, null
  %13 = getelementptr inbounds %88, %88* %9, i64 0, i32 10, i32 1
  %14 = bitcast %88*** %13 to i64*
  %15 = load i64, i64* %14, align 8
  %16 = ptrtoint %88* %11 to i64
  br i1 %12, label %22, label %17

17:                                               ; preds = %8
  %18 = getelementptr inbounds %88, %88* %11, i64 0, i32 10, i32 1
  %19 = bitcast %88*** %18 to i64*
  store i64 %15, i64* %19, align 8
  %20 = bitcast %88*** %13 to i64**
...
24:                                               ; preds = %22, %17
  ...
  %26 = getelementptr inbounds %88, %88* %9, i64 0, i32 9
  tail call fastcc void @32(%87* nonnull %26) #10
  %27 = getelementptr inbounds %88, %88* %9, i64 0, i32 4
  %28 = load i8*, i8** %27, align 8
  tail call void @free(i8* %28) #10
  %29 = getelementptr inbounds %88, %88* %9, i64 0, i32 5
  %30 = load i8*, i8** %29, align 8
  tail call void @free(i8* %30) #10
  %31 = bitcast %88* %9 to i8*
  tail call void @free(i8* %31) #10
  br i1 %12, label %32, label %8
...
18:                                               ; preds = %15
  ...
  %21 = icmp eq i32 %20, 0
  %22 = getelementptr inbounds %3, %3* %0, i64 0, i32 16
...
28:                                               ; preds = %8, %59
  %29 = phi %88* [ %6, %8 ], [ %61, %59 ]
  %30 = phi i32 [ 1, %8 ], [ %54, %59 ]
  %31 = load i8*, i8** %10, align 8
  %32 = load i32, i32* %11, align 8
  %33 = add i32 %32, 1
  %34 = zext i32 %33 to i64
  %35 = tail call i8* @xreallocarray(i8* %31, i64 %34, i64 24) #10
  %36 = bitcast i8* %35 to %90*
  store i8* %35, i8** %10, align 8
  %37 = load i32, i32* %11, align 8
  %38 = add i32 %37, 1
  store i32 %38, i32* %11, align 8
  %39 = zext i32 %37 to i64
  %40 = getelementptr inbounds %90, %90* %36, i64 %39, i32 0
  store %88* %29, %88** %40, align 8
  %41 = getelementptr inbounds %90, %90* %36, i64 %39, i32 1
  store i32 %2, i32* %41, align 8
  %42 = load %87*, %87** %13, align 8
  %43 = getelementptr inbounds %87, %87* %42, i64 0, i32 1
  %44 = load %88**, %88*** %43, align 8
  %45 = load %88*, %88** %44, align 8
  %46 = icmp eq %88* %29, %45
  %47 = zext i1 %46 to i32
  %48 = getelementptr inbounds %90, %90* %36, i64 %39, i32 2
  store i32 %47, i32* %48, align 4
  %49 = getelementptr inbounds %88, %88* %29, i64 0, i32 2
  store i32 %37, i32* %49, align 8
  %50 = getelementptr inbounds %88, %88* %29, i64 0, i32 9
  %51 = getelementptr inbounds %87, %87* %50, i64 0, i32 0
  %52 = load %88*, %88** %51, align 8
  %53 = icmp eq %88* %52, null
  %54 = select i1 %53, i32 %30, i32 0
  %55 = getelementptr inbounds %88, %88* %29, i64 0, i32 6
  %56 = load i32, i32* %55, align 8
  %57 = icmp eq i32 %56, 0
  br i1 %57, label %59, label %58

58:                                               ; preds = %28
  tail call fastcc void @33(%3* nonnull %0, %87* nonnull %50, i32 %14)
  br label %59

59:                                               ; preds = %28, %58
  %60 = getelementptr inbounds %88, %88* %29, i64 0, i32 10, i32 0
  %61 = load %88*, %88** %60, align 8
  %62 = icmp eq %88* %61, null
  br i1 %62, label %15, label %28

63:                                               ; preds = %18, %88
  %64 = phi %88* [ %16, %18 ], [ %90, %88 ]
  br i1 %21, label %88, label %65

65:                                               ; preds = %63
  %66 = load %90*, %90** %22, align 8
  br i1 %25, label %80, label %67

67:                                               ; preds = %65, %95
  %68 = phi i64 [ %96, %95 ], [ 0, %65 ]
  %69 = phi i64 [ %97, %95 ], [ %26, %65 ]
  %70 = getelementptr inbounds %90, %90* %66, i64 %68, i32 0
  %71 = load %88*, %88** %70, align 8
  %72 = icmp eq %88* %71, %64
  br i1 %72, label %73, label %75

73:                                               ; preds = %67
  %74 = getelementptr inbounds %90, %90* %66, i64 %68, i32 3
  store i32 %54, i32* %74, align 8
  br label %75

75:                                               ; preds = %67, %73
  %76 = or i64 %68, 1
  %77 = getelementptr inbounds %90, %90* %66, i64 %76, i32 0
  %78 = load %88*, %88** %77, align 8
  %79 = icmp eq %88* %78, %64
  br i1 %79, label %93, label %95

80:                                               ; preds = %95, %65
  %81 = phi i64 [ 0, %65 ], [ %96, %95 ]
  br i1 %27, label %88, label %82

82:                                               ; preds = %80
  %83 = getelementptr inbounds %90, %90* %66, i64 %81, i32 0
  %84 = load %88*, %88** %83, align 8
  %85 = icmp eq %88* %84, %64
  br i1 %85, label %86, label %88

86:                                               ; preds = %82
  %87 = getelementptr inbounds %90, %90* %66, i64 %81, i32 3
  store i32 %54, i32* %87, align 8
  br label %88

88:                                               ; preds = %80, %82, %86, %63
  %89 = getelementptr inbounds %88, %88* %64, i64 0, i32 10, i32 0
...
93:                                               ; preds = %75
  %94 = getelementptr inbounds %90, %90* %66, i64 %76, i32 3
  store i32 %54, i32* %94, align 8
  br label %95
