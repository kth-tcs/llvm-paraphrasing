; ModuleID = 'test-write-cache-strip-renamed.bc'
...
14:                                               ; preds = %2
  ...
  %18 = call i64 @strtol(i8* %17, i8** null, i32 0) #6
  %19 = trunc i64 %18 to i32
  store i32 %19, i32* %7, align 4
  br label %20

20:                                               ; preds = %14, %2
  %21 = call i8* @setup_git_directory()
  %22 = load %0*, %0** @the_repository, align 8
  %23 = call i32 @repo_read_index(%0* %22)
...
28:                                               ; preds = %24
  ...
  %30 = call i32 @repo_hold_locked_index(%0* %29, %27* %5, i32 1)
  %31 = call i32 @write_locked_index(%8* @the_index, %27* %5, i32 1)
  %32 = icmp ne i32 %31, 0
  br i1 %32, label %33, label %34

33:                                               ; preds = %28
  call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @0, i32 0, i32 0)) #7
  unreachable
...
declare dso_local i32 @repo_hold_locked_index(%0*, %27*, i32) #4

declare dso_local i32 @write_locked_index(%8*, %27*, i32) #4
