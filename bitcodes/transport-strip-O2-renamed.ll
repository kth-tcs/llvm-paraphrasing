; ModuleID = 'transport-strip-O2-renamed.bc'
...
80:                                               ; preds = %78, %103
  %81 = phi %8* [ %1, %78 ], [ %105, %103 ]
  %82 = phi i32 [ %73, %78 ], [ %90, %103 ]
...
91:                                               ; preds = %88
  br i1 %79, label %96, label %92

92:                                               ; preds = %91
  %93 = getelementptr inbounds %8, %8* %81, i64 0, i32 11, i64 0
  %94 = call i32 @strcmp(i8* nonnull %45, i8* nonnull %93) #15
  %95 = icmp eq i32 %94, 0
...
99:                                               ; preds = %88, %92, %98, %97, %96
  %100 = phi i32 [ 2, %96 ], [ 8, %97 ], [ 16, %98 ], [ 1, %92 ], [ 4, %88 ]
...
103:                                              ; preds = %99, %88
  %104 = getelementptr inbounds %8, %8* %81, i64 0, i32 0
...
324:                                              ; preds = %321
  br i1 %283, label %325, label %331

325:                                              ; preds = %324
  %326 = getelementptr inbounds i8, i8* %318, i64 11
  %327 = load %4*, %4** %284, align 8
  %328 = getelementptr inbounds %4, %4* %327, i64 0, i32 1
  %329 = load i8*, i8** %328, align 8
  %330 = call i32 @install_branch_config(i32 1, i8* nonnull %326, i8* %329, i8* nonnull %306) #13
  br label %344

331:                                              ; preds = %324
  %332 = call i32 @use_gettext_poison() #13
  %333 = icmp eq i32 %332, 0
  br i1 %333, label %334, label %336

334:                                              ; preds = %331
  %335 = call i8* @dcgettext(i8* null, i8* nonnull getelementptr inbounds ([44 x i8], [44 x i8]* @119, i64 0, i64 0), i32 5) #13
  br label %336

336:                                              ; preds = %334, %331
  %337 = phi i8* [ %335, %334 ], [ getelementptr inbounds ([19 x i8], [19 x i8]* @44, i64 0, i64 0), %331 ]
  %338 = getelementptr inbounds i8, i8* %318, i64 11
  %339 = getelementptr inbounds %8, %8* %286, i64 0, i32 11, i64 11
  %340 = load %4*, %4** %284, align 8
  %341 = getelementptr inbounds %4, %4* %340, i64 0, i32 1
  %342 = load i8*, i8** %341, align 8
  %343 = call i32 (i8*, ...) @printf(i8* %337, i8* nonnull %338, i8* nonnull %339, i8* %342) #13
  br label %344

344:                                              ; preds = %336, %325, %321, %317, %293, %289, %285
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %282) #13
  %345 = getelementptr inbounds %8, %8* %286, i64 0, i32 0
  %346 = load %8*, %8** %345, align 8
  %347 = icmp eq %8* %346, null
  br i1 %347, label %348, label %285

348:                                              ; preds = %344, %278, %274
  %349 = and i32 %3, 32772
  %350 = icmp eq i32 %349, 0
  br i1 %350, label %351, label %362

351:                                              ; preds = %348
  %352 = load %8*, %8** %10, align 8
  %353 = icmp eq %8* %352, null
  br i1 %353, label %362, label %354

354:                                              ; preds = %351
  %355 = getelementptr inbounds %3, %3* %1, i64 0, i32 1
  br label %356

356:                                              ; preds = %354, %356
  %357 = phi %8* [ %352, %354 ], [ %360, %356 ]
  %358 = load %4*, %4** %355, align 8
  call void @transport_update_tracking_ref(%4* %358, %8* nonnull %357, i32 %30)
  %359 = getelementptr inbounds %8, %8* %357, i64 0, i32 0
  %360 = load %8*, %8** %359, align 8
  %361 = icmp eq %8* %360, null
  br i1 %361, label %362, label %356

362:                                              ; preds = %356, %351, %348
  %363 = icmp eq i32 %33, 0
  %364 = icmp ne i32 %254, 0
  %365 = or i1 %363, %364
  br i1 %365, label %368, label %366

366:                                              ; preds = %362
  %367 = call i32 @puts(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @32, i64 0, i64 0))
  br label %385

368:                                              ; preds = %362
  %369 = icmp ne i32 %275, 0
  %370 = or i1 %31, %369
  br i1 %370, label %385, label %371

371:                                              ; preds = %368
  %372 = load %8*, %8** %10, align 8
  %373 = icmp eq %8* %372, null
  br i1 %373, label %382, label %374

374:                                              ; preds = %371, %378
  %375 = phi %8* [ %380, %378 ], [ %372, %371 ]
  %376 = getelementptr inbounds %8, %8* %375, i64 0, i32 8
  %377 = load i32, i32* %376, align 4
  switch i32 %377, label %385 [
    i32 0, label %378
    i32 9, label %378
  ]

378:                                              ; preds = %374, %374
  %379 = getelementptr inbounds %8, %8* %375, i64 0, i32 0
  %380 = load %8*, %8** %379, align 8
  %381 = icmp eq %8* %380, null
  br i1 %381, label %382, label %374

382:                                              ; preds = %378, %371
  %383 = load %0*, %0** @stderr, align 8
  %384 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @33, i64 0, i64 0), i64 22, i64 1, %0* %383) #14
  br label %385

385:                                              ; preds = %374, %366, %382, %368, %162, %38, %23
  %386 = phi i32 [ -1, %23 ], [ -1, %38 ], [ -1, %162 ], [ %275, %368 ], [ 0, %382 ], [ %275, %366 ], [ 0, %374 ]
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %35) #13
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %24) #13
  br label %387

387:                                              ; preds = %17, %5, %385
  %388 = phi i32 [ %386, %385 ], [ -1, %5 ], [ 1, %17 ]
  ret i32 %388
}
...
define internal i32 @127(%3* %0, i32 %1, %8** %2) #1 {
  ...
  %105 = getelementptr inbounds %3, %3* %0, i64 0, i32 7
...
53:                                               ; preds = %40, %40
  %54 = getelementptr inbounds %3, %3* %0, i64 0, i32 7
