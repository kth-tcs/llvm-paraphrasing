; ModuleID = 'incremental_sum-strip-O3-renamed.bc'
...
define dso_local noalias nonnull i8* @grouping_create_incremental_sum(%0* nocapture readnone %0) local_unnamed_addr #0 {
  %2 = tail call noalias nonnull i8* @callocz(i64 1, i64 48) #4
  ret i8* %2
}
...
define dso_local void @grouping_reset_incremental_sum(%0* nocapture readonly %0) local_unnamed_addr #2 {
  ...
  %7 = getelementptr inbounds %38, %38* %4, i64 0, i32 2
  store i64 0, i64* %7, align 16
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @grouping_free_incremental_sum(%0* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 8
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_add_incremental_sum(%0* nocapture readonly %0, x86_fp80 %1) local_unnamed_addr #0 {
...
5:                                                ; preds = %2
  ...
  %9 = getelementptr inbounds %38, %38* %8, i64 0, i32 2
  %10 = load i64, i64* %9, align 16
  %11 = icmp eq i64 %10, 0
  %12 = getelementptr inbounds %38, %38* %8, i64 0, i32 1
  %13 = getelementptr inbounds %38, %38* %8, i64 0, i32 0
  %14 = select i1 %11, x86_fp80* %13, x86_fp80* %12
  store x86_fp80 %1, x86_fp80* %14, align 16
  %15 = add i64 %10, 1
  store i64 %15, i64* %9, align 16
  br label %16
...
; Function Attrs: norecurse nounwind uwtable
define dso_local x86_fp80 @grouping_flush_incremental_sum(%0* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #2 {
  %3 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 8
  %4 = bitcast i8** %3 to %38**
  %5 = load %38*, %38** %4, align 8
  %6 = getelementptr inbounds %38, %38* %5, i64 0, i32 2
...
11:                                               ; preds = %2
  %12 = getelementptr inbounds %38, %38* %5, i64 0, i32 1
  %13 = load x86_fp80, x86_fp80* %12, align 16
  %14 = getelementptr inbounds %38, %38* %5, i64 0, i32 0
  %15 = load x86_fp80, x86_fp80* %14, align 16
  %16 = fsub x86_fp80 %13, %15
  br label %17

17:                                               ; preds = %2, %11, %8
  %18 = phi x86_fp80 [ 0xK00000000000000000000, %8 ], [ %16, %11 ], [ 0xK00000000000000000000, %2 ]
  %19 = getelementptr inbounds %38, %38* %5, i64 0, i32 0
  store x86_fp80 0xK00000000000000000000, x86_fp80* %19, align 16
  %20 = getelementptr inbounds %38, %38* %5, i64 0, i32 1
