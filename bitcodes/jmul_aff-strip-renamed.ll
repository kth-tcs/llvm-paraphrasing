; ModuleID = 'jmul_aff-strip-renamed.bc'
source_filename = "jmul_aff.c"
...
define dso_local void @vec_jmul_aff(%1* %0, %1* %1, %0* %2, %1* %3, %1* %4, %1* %5) #0 {
  %7 = alloca %1*, align 8
  %8 = alloca %1*, align 8
  %9 = alloca %0*, align 8
  %10 = alloca %1*, align 8
  ...
  %25 = getelementptr inbounds [1 x %1], [1 x %1]* %14, i32 0, i32 0
  %26 = load %1*, %1** %10, align 8
  call void @__gmpz_set(%1* %25, %1* %26)
  %27 = getelementptr inbounds [1 x %1], [1 x %1]* %15, i32 0, i32 0
  %28 = load %1*, %1** %11, align 8
  call void @__gmpz_set(%1* %27, %1* %28)
  %29 = getelementptr inbounds [1 x %1], [1 x %1]* %14, i32 0, i32 0
  %30 = getelementptr inbounds [1 x %1], [1 x %1]* %15, i32 0, i32 0
  %31 = getelementptr inbounds [1 x %1], [1 x %1]* %16, i32 0, i32 0
  call void @vec_affj(%1* %29, %1* %30, %1* %31)
  %32 = load %0*, %0** %9, align 8
  %33 = getelementptr inbounds %0, %0* %32, i32 0, i32 9
  %34 = load void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)*, void (%1*, %1*, %1*, %0*, %1*, %1*, %1*, %1*)** %33, align 8
  %35 = load %1*, %1** %7, align 8
  %36 = load %1*, %1** %8, align 8
  %37 = getelementptr inbounds [1 x %1], [1 x %1]* %13, i32 0, i32 0
  %38 = load %0*, %0** %9, align 8
  %39 = getelementptr inbounds [1 x %1], [1 x %1]* %14, i32 0, i32 0
  %40 = getelementptr inbounds [1 x %1], [1 x %1]* %15, i32 0, i32 0
  %41 = getelementptr inbounds [1 x %1], [1 x %1]* %16, i32 0, i32 0
  %42 = load %1*, %1** %12, align 8
  call void %34(%1* %35, %1* %36, %1* %37, %0* %38, %1* %39, %1* %40, %1* %41, %1* %42)
  %43 = load %1*, %1** %7, align 8
  %44 = load %1*, %1** %8, align 8
  %45 = getelementptr inbounds [1 x %1], [1 x %1]* %13, i32 0, i32 0
  %46 = load %0*, %0** %9, align 8
  call void @vec_jaff(%1* %43, %1* %44, %1* %45, %0* %46)
