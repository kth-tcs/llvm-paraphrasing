; ModuleID = 'merge-tree-strip-O2-renamed.bc'
...
47:                                               ; preds = %42
  %48 = bitcast %44* %12 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %48) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %48, i8* align 8 bitcast (%44* @4 to i8*), i64 24, i1 false) #8
  %49 = getelementptr inbounds %54, %54* %3, i64 2, i32 1
  %50 = load i8*, i8** %49, align 8
  %51 = getelementptr inbounds %54, %54* %3, i64 2, i32 2
  %52 = load i32, i32* %51, align 8
  %53 = sext i32 %52 to i64
  call void @strbuf_make_traverse_path(%44* nonnull %12, %52* %4, i8* %50, i64 %53) #8
...
130:                                              ; preds = %100
  %131 = bitcast %44* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %131) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %131, i8* align 8 bitcast (%44* @4 to i8*), i64 24, i1 false) #8
  %132 = getelementptr inbounds %54, %54* %3, i64 %129, i32 1
  %133 = load i8*, i8** %132, align 8
  %134 = getelementptr inbounds %54, %54* %3, i64 %129, i32 2
  %135 = load i32, i32* %134, align 8
  %136 = sext i32 %135 to i64
  call void @strbuf_make_traverse_path(%44* nonnull %10, %52* %4, i8* %133, i64 %136) #8
...
170:                                              ; preds = %164
  %171 = bitcast %44* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %171) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %171, i8* align 8 bitcast (%44* @4 to i8*), i64 24, i1 false) #8
  %172 = getelementptr inbounds %54, %54* %3, i64 2, i32 1
  %173 = load i8*, i8** %172, align 8
  %174 = getelementptr inbounds %54, %54* %3, i64 2, i32 2
  %175 = load i32, i32* %174, align 8
  %176 = sext i32 %175 to i64
  call void @strbuf_make_traverse_path(%44* nonnull %8, %52* %4, i8* %173, i64 %176) #8
...
207:                                              ; preds = %202
  %208 = bitcast %44* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %208) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %208, i8* align 8 bitcast (%44* @4 to i8*), i64 24, i1 false) #8
  %209 = getelementptr inbounds %54, %54* %3, i64 1, i32 1
  %210 = load i8*, i8** %209, align 8
  %211 = getelementptr inbounds %54, %54* %3, i64 1, i32 2
  %212 = load i32, i32* %211, align 8
  %213 = sext i32 %212 to i64
  call void @strbuf_make_traverse_path(%44* nonnull %7, %52* %4, i8* %210, i64 %213) #8
  %214 = call i8* @strbuf_detach(%44* nonnull %7, i64* null) #8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %208) #8
...
248:                                              ; preds = %243
  %249 = bitcast %44* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %249) #8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %249, i8* align 8 bitcast (%44* @4 to i8*), i64 24, i1 false) #8
  %250 = getelementptr inbounds %54, %54* %3, i64 0, i32 1
  %251 = load i8*, i8** %250, align 8
  %252 = getelementptr inbounds %54, %54* %3, i64 0, i32 2
  %253 = load i32, i32* %252, align 8
  %254 = sext i32 %253 to i64
  call void @strbuf_make_traverse_path(%44* nonnull %6, %52* %4, i8* %251, i64 %254) #8
