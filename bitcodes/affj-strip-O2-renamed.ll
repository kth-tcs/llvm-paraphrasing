; ModuleID = 'affj-strip-O2-renamed.bc'
...
define dso_local void @vec_affj(%0* %0, %0* %1, %0* %2) local_unnamed_addr #0 {
  %4 = tail call i32 @__gmpz_cmp_si(%0* %0, i64 -1) #3
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %6, label %7

6:                                                ; preds = %3
  tail call void @__gmpz_set_si(%0* %0, i64 0) #4
  tail call void @__gmpz_set_si(%0* %1, i64 1) #4
  tail call void @__gmpz_set_si(%0* %2, i64 0) #4
  br label %8

7:                                                ; preds = %3
  tail call void @__gmpz_set_si(%0* %2, i64 1) #4
  br label %8
...
declare dso_local i32 @__gmpz_cmp_si(%0*, i64) local_unnamed_addr #1
