; ModuleID = 'clocks-strip-O3-renamed.bc'
...
define dso_local i64 @heartbeat_next(%6* nocapture %0, i64 %1) local_unnamed_addr #0 {
  ...
  %6 = bitcast <2 x i64>* %5 to %4*
  %7 = alloca <2 x i64>, align 16
  %8 = bitcast <2 x i64>* %7 to %4*
  %9 = alloca %4, align 8
  %10 = alloca %4, align 8
  %11 = load i1, i1* @1, align 4
  %12 = select i1 %11, i32 1, i32 6
  %13 = bitcast %4* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %13) #9
  %14 = call i32 @clock_gettime(i32 %12, %4* nonnull %10) #9
  %15 = icmp eq i32 %14, -1
  br i1 %15, label %16, label %17

16:                                               ; preds = %2
  call void (i8*, i8*, i8*, i64, i8*, ...) @error_int(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @16, i64 0, i64 0), i64 45, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @15, i64 0, i64 0), i32 %12) #9
  br label %26

17:                                               ; preds = %2
  %18 = getelementptr inbounds %4, %4* %10, i64 0, i32 0
  %19 = load i64, i64* %18, align 8
  %20 = mul i64 %19, 1000000
  %21 = getelementptr inbounds %4, %4* %10, i64 0, i32 1
...
26:                                               ; preds = %16, %17
  ...
  %29 = call i32 @clock_gettime(i32 0, %4* nonnull %9) #9
  %30 = icmp eq i32 %29, -1
...
32:                                               ; preds = %26
  %33 = getelementptr inbounds %4, %4* %9, i64 0, i32 0
  %34 = load i64, i64* %33, align 8
  %35 = mul i64 %34, 1000000
  %36 = getelementptr inbounds %4, %4* %9, i64 0, i32 1
...
47:                                               ; preds = %41
  ...
  %49 = bitcast <2 x i64>* %7 to i8*
  %50 = getelementptr inbounds <2 x i64>, <2 x i64>* %7, i64 0, i64 0
  %51 = getelementptr inbounds %4, %4* %8, i64 0, i32 1
  %52 = bitcast %4* %4 to i8*
  %53 = bitcast %4* %3 to i8*
  %54 = getelementptr inbounds %4, %4* %4, i64 0, i32 0
  %55 = getelementptr inbounds %4, %4* %4, i64 0, i32 1
  %56 = getelementptr inbounds %4, %4* %3, i64 0, i32 0
  %57 = getelementptr inbounds %4, %4* %3, i64 0, i32 1
  br label %58

58:                                               ; preds = %47, %101
  %59 = phi i64 [ %27, %47 ], [ %90, %101 ]
  %60 = sub i64 %45, %59
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %48) #9
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %49) #9
  %61 = udiv i64 %60, 1000000
  store i64 %61, i64* %50, align 16
  %62 = urem i64 %60, 1000000
  %63 = mul nuw nsw i64 %62, 1000
  store i64 %63, i64* %51, align 8
  %64 = call i32 @nanosleep(%4* nonnull %8, %4* nonnull %6) #9
  %65 = icmp eq i32 %64, -1
...
71:                                               ; preds = %68
  %72 = load <2 x i64>, <2 x i64>* %5, align 16
  store <2 x i64> %72, <2 x i64>* %7, align 16
  %73 = call i32 @nanosleep(%4* nonnull %8, %4* nonnull %6) #9
  %74 = icmp eq i32 %73, -1
  br i1 %74, label %68, label %76

75:                                               ; preds = %68
  call void (i8*, i8*, i8*, i64, i8*, ...) @error_int(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @6, i64 0, i64 0), i64 207, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @7, i64 0, i64 0), i64 %60) #9
  br label %76

76:                                               ; preds = %71, %58, %75
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %49) #9
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %48) #9
  %77 = load i1, i1* @1, align 4
  %78 = select i1 %77, i32 1, i32 6
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %52) #9
  %79 = call i32 @clock_gettime(i32 %78, %4* nonnull %4) #9
  %80 = icmp eq i32 %79, -1
  br i1 %80, label %81, label %82

81:                                               ; preds = %76
  call void (i8*, i8*, i8*, i64, i8*, ...) @error_int(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @16, i64 0, i64 0), i64 45, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @15, i64 0, i64 0), i32 %78) #9
  br label %89
...
101:                                              ; preds = %93, %94
  ...
  %103 = icmp ugt i64 %45, %90
  br i1 %103, label %58, label %104

104:                                              ; preds = %101, %41
  %105 = phi i64 [ %27, %41 ], [ %90, %101 ]
  %106 = phi i64 [ %42, %41 ], [ %102, %101 ]
  %107 = getelementptr inbounds %6, %6* %0, i64 0, i32 1
  %108 = load i64, i64* %107, align 8
  %109 = icmp eq i64 %108, 0
  %110 = getelementptr inbounds %6, %6* %0, i64 0, i32 0
...
118:                                              ; preds = %111
  %119 = tail call i32* @__errno_location() #10
  store i32 0, i32* %119, align 4
  %120 = sub i64 %113, %1
  call void (i8*, i8*, i8*, i64, i8*, ...) @error_int(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @4, i64 0, i64 0), i64 171, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @5, i64 0, i64 0), i64 %120) #9
  br label %122
...
122:                                              ; preds = %118, %111, %121
  %123 = phi i64 [ 0, %121 ], [ %114, %111 ], [ %114, %118 ]
  ret i64 %123
}
