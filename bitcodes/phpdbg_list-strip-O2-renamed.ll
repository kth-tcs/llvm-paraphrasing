; ModuleID = 'phpdbg_list-strip-O2-renamed.bc'
...
37:                                               ; preds = %29, %71
  %38 = phi i64 [ %34, %29 ], [ %39, %71 ]
  %39 = add nuw nsw i64 %38, 1
  %40 = getelementptr inbounds [1 x i32], [1 x i32]* %31, i64 0, i64 %38
  %41 = load i32, i32* %40, align 4
  %42 = getelementptr inbounds [1 x i32], [1 x i32]* %31, i64 0, i64 %39
...
48:                                               ; preds = %37
  ...
  %51 = tail call i32 (i32, i32, i8*, i8*, i8*, ...) @phpdbg_print(i32 4, i32 %49, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @30, i64 0, i64 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @31, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @32, i64 0, i64 0), i32 %50, i32 %44, i8* %47) #9
  br label %60

52:                                               ; preds = %37
  %53 = icmp eq i64 %39, %35
...
55:                                               ; preds = %52
  ...
  %57 = tail call i32 (i32, i32, i8*, i8*, i8*, ...) @phpdbg_print(i32 4, i32 %54, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @30, i64 0, i64 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @31, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @32, i64 0, i64 0), i32 %56, i32 %44, i8* %47) #9
  br label %60

58:                                               ; preds = %52
  %59 = tail call i32 (i32, i32, i8*, i8*, i8*, ...) @phpdbg_print(i32 4, i32 %54, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @30, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @33, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @34, i64 0, i64 0), i32 %3, i32 %44, i8* %47) #9
  br label %60
...
68:                                               ; preds = %60
  ...
  %70 = tail call i32 (i32, i8*, ...) @phpdbg_out_internal(i32 %69, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @35, i64 0, i64 0)) #9
  br label %71

71:                                               ; preds = %60, %68
  %72 = icmp ult i64 %39, %36
  br i1 %72, label %37, label %73

73:                                               ; preds = %71, %14
  %74 = load i32, i32* getelementptr inbounds (%4, %4* @phpdbg_globals, i64 0, i32 38, i64 1, i32 1), align 8
  %75 = tail call i32 (i32, i8*, ...) @phpdbg_xml_internal(i32 %74, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @36, i64 0, i64 0)) #9
  br label %76
