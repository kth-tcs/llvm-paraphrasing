; ModuleID = 'cmd-strip-O3-renamed.bc'
...
12:                                               ; preds = %6
  %13 = bitcast %15* %8 to i8*
  br label %87

14:                                               ; preds = %6, %83
  %15 = phi %3* [ %17, %83 ], [ %10, %6 ]
  %16 = getelementptr inbounds %3, %3* %15, i64 0, i32 8, i32 0
  %17 = load %3*, %3** %16, align 8
  %18 = icmp eq %3* %17, null
  %19 = getelementptr inbounds %3, %3* %15, i64 0, i32 8, i32 1
  %20 = bitcast %3*** %19 to i64*
  %21 = load i64, i64* %20, align 8
  %22 = ptrtoint %3* %17 to i64
  br i1 %18, label %53, label %23

23:                                               ; preds = %14
  %24 = getelementptr inbounds %3, %3* %17, i64 0, i32 8, i32 1
  %25 = bitcast %3*** %24 to i64*
  store i64 %21, i64* %25, align 8
  %26 = bitcast %3*** %19 to i64**
  %27 = load i64*, i64** %26, align 8
  store i64 %22, i64* %27, align 8
  %28 = getelementptr inbounds %3, %3* %15, i64 0, i32 5
  %29 = load i8*, i8** %28, align 8
  tail call void @free(i8* %29) #2
  %30 = getelementptr inbounds %3, %3* %15, i64 0, i32 6
  %31 = load i32, i32* %30, align 8
  %32 = getelementptr inbounds %3, %3* %15, i64 0, i32 7
...
45:                                               ; preds = %39, %35
  %46 = bitcast i8** %33 to i8*
  tail call void @free(i8* %46) #2
  br label %47

47:                                               ; preds = %23, %45
  %48 = getelementptr inbounds %3, %3* %15, i64 0, i32 3
  %49 = load i8*, i8** %48, align 8
  tail call void @free(i8* %49) #2
  %50 = getelementptr inbounds %3, %3* %15, i64 0, i32 1
  %51 = load %4*, %4** %50, align 8
  tail call void @args_free(%4* %51) #2
  %52 = bitcast %3* %15 to i8*
  tail call void @free(i8* %52) #2
  br label %83

53:                                               ; preds = %14
  %54 = inttoptr i64 %21 to i64*
  %55 = load %15*, %15** %7, align 8
  %56 = getelementptr inbounds %15, %15* %55, i64 0, i32 1
  %57 = bitcast %3*** %56 to i64*
  store i64 %21, i64* %57, align 8
  store i64 %22, i64* %54, align 8
  %58 = getelementptr inbounds %3, %3* %15, i64 0, i32 5
  %59 = load i8*, i8** %58, align 8
  tail call void @free(i8* %59) #2
  %60 = getelementptr inbounds %3, %3* %15, i64 0, i32 6
  %61 = load i32, i32* %60, align 8
  %62 = getelementptr inbounds %3, %3* %15, i64 0, i32 7
...
75:                                               ; preds = %69, %65
  %76 = bitcast i8** %63 to i8*
  tail call void @free(i8* %76) #2
  br label %77

77:                                               ; preds = %53, %75
  %78 = getelementptr inbounds %3, %3* %15, i64 0, i32 3
  %79 = load i8*, i8** %78, align 8
  tail call void @free(i8* %79) #2
  %80 = getelementptr inbounds %3, %3* %15, i64 0, i32 1
  %81 = load %4*, %4** %80, align 8
  tail call void @args_free(%4* %81) #2
  %82 = bitcast %3* %15 to i8*
  tail call void @free(i8* %82) #2
  br label %83

83:                                               ; preds = %77, %47
  br i1 %18, label %84, label %14

84:                                               ; preds = %83
  %85 = bitcast %15** %7 to i8**
  %86 = load i8*, i8** %85, align 8
  br label %87

87:                                               ; preds = %12, %84
  %88 = phi i8* [ %86, %84 ], [ %13, %12 ]
  tail call void @free(i8* %88) #2
  %89 = bitcast %14* %0 to i8*
  tail call void @free(i8* %89) #2
  br label %90
...
13:                                               ; preds = %10, %50
  %14 = phi %3* [ %51, %50 ], [ %8, %10 ]
  %15 = phi i64 [ %34, %50 ], [ 1, %10 ]
  %16 = phi i8* [ %35, %50 ], [ %4, %10 ]
...
46:                                               ; preds = %40
  %47 = call i64 @strlcat(i8* %35, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @13, i64 0, i64 0), i64 %34) #2
  br label %50

48:                                               ; preds = %40
  %49 = call i64 @strlcat(i8* %35, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @15, i64 0, i64 0), i64 %34) #2
  br label %50

50:                                               ; preds = %48, %46, %30
  call void @free(i8* %31) #2
  %51 = load %3*, %3** %37, align 8
  %52 = icmp eq %3* %51, null
  br i1 %52, label %93, label %13

53:                                               ; preds = %10, %90
  %54 = phi %3* [ %91, %90 ], [ %8, %10 ]
  %55 = phi i64 [ %74, %90 ], [ 1, %10 ]
  %56 = phi i8* [ %75, %90 ], [ %4, %10 ]
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %11) #2
  %57 = getelementptr inbounds %3, %3* %54, i64 0, i32 1
  %58 = load %4*, %4** %57, align 8
  %59 = call i8* @args_print(%4* %58) #2
  %60 = load i8, i8* %59, align 1
  %61 = icmp eq i8 %60, 0
  %62 = getelementptr inbounds %3, %3* %54, i64 0, i32 0
...
66:                                               ; preds = %53
  %67 = call i32 (i8**, i8*, ...) @xasprintf(i8** nonnull %3, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @11, i64 0, i64 0), i8* %65, i8* %59) #2
  br label %70

68:                                               ; preds = %53
  %69 = call i8* @xstrdup(i8* %65) #2
...
70:                                               ; preds = %66, %68
  ...
  %73 = add i64 %55, 6
  %74 = add i64 %73, %72
  %75 = call i8* @xrealloc(i8* %56, i64 %74) #2
  %76 = call i64 @strlcat(i8* %75, i8* %71, i64 %74) #2
  %77 = getelementptr inbounds %3, %3* %54, i64 0, i32 8, i32 0
  %78 = load %3*, %3** %77, align 8
  %79 = icmp eq %3* %78, null
  br i1 %79, label %90, label %80

80:                                               ; preds = %70
  %81 = getelementptr inbounds %3, %3* %54, i64 0, i32 2
  %82 = load i32, i32* %81, align 8
  %83 = getelementptr inbounds %3, %3* %78, i64 0, i32 2
  %84 = load i32, i32* %83, align 8
  %85 = icmp eq i32 %82, %84
  br i1 %85, label %88, label %86

86:                                               ; preds = %80
  %87 = call i64 @strlcat(i8* %75, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i64 0, i64 0), i64 %74) #2
  br label %90

88:                                               ; preds = %80
  %89 = call i64 @strlcat(i8* %75, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @16, i64 0, i64 0), i64 %74) #2
  br label %90

90:                                               ; preds = %70, %86, %88
  call void @free(i8* %71) #2
  %91 = load %3*, %3** %77, align 8
  %92 = icmp eq %3* %91, null
  br i1 %92, label %93, label %53

93:                                               ; preds = %50, %90, %2
  %94 = phi i8* [ %4, %2 ], [ %75, %90 ], [ %35, %50 ]
  ret i8* %94
}
...
14:                                               ; preds = %10, %107
  %15 = phi i8 [ %110, %107 ], [ %12, %10 ]
  %16 = phi i64 [ %108, %107 ], [ 0, %10 ]
  %17 = phi i32 [ %65, %107 ], [ 0, %10 ]
  %18 = phi i8* [ %70, %107 ], [ %0, %10 ]
  %19 = phi i8* [ %75, %107 ], [ %11, %10 ]
  %20 = icmp eq i32 %17, 0
  br i1 %20, label %44, label %21

21:                                               ; preds = %14, %36
  %22 = phi i8 [ %42, %36 ], [ %15, %14 ]
  %23 = phi i64 [ %39, %36 ], [ %16, %14 ]
  %24 = phi i8* [ %26, %36 ], [ %18, %14 ]
  %25 = phi i8* [ %38, %36 ], [ %19, %14 ]
...
36:                                               ; preds = %28, %21
  %37 = add i64 %23, 2
  %38 = call i8* @xrealloc(i8* %25, i64 %37) #2
  %39 = add i64 %23, 1
  %40 = getelementptr inbounds i8, i8* %38, i64 %23
  store i8 %22, i8* %40, align 1
  %41 = getelementptr inbounds i8, i8* %38, i64 %39
  store i8 0, i8* %41, align 1
  %42 = load i8, i8* %26, align 1
  %43 = icmp eq i8 %42, 0
  br i1 %43, label %120, label %21

44:                                               ; preds = %14, %112
  %45 = phi i8 [ %118, %112 ], [ %15, %14 ]
  %46 = phi i64 [ %115, %112 ], [ %16, %14 ]
  %47 = phi i8* [ %49, %112 ], [ %18, %14 ]
  %48 = phi i8* [ %114, %112 ], [ %19, %14 ]
...
61:                                               ; preds = %28, %59, %51
  %62 = phi i8* [ %48, %51 ], [ %48, %59 ], [ %25, %28 ]
  %63 = phi i8* [ %47, %51 ], [ %47, %59 ], [ %24, %28 ]
  %64 = phi i64 [ %46, %51 ], [ %46, %59 ], [ %23, %28 ]
  %65 = phi i32 [ 1, %59 ], [ 0, %51 ], [ %17, %28 ]
  %66 = getelementptr inbounds i8, i8* %63, i64 2
  %67 = load i8, i8* %66, align 1
  %68 = icmp eq i8 %67, 37
  %69 = getelementptr inbounds i8, i8* %63, i64 3
  %70 = select i1 %68, i8* %69, i8* %66
  %71 = call i64 @strlen(i8* %1) #9
  %72 = mul i64 %71, 3
  %73 = add i64 %64, 1
  %74 = add i64 %73, %72
  %75 = call i8* @xrealloc(i8* %62, i64 %74) #2
  %76 = load i8, i8* %1, align 1
  %77 = icmp eq i8 %76, 0
  br i1 %77, label %107, label %78

78:                                               ; preds = %61
  br i1 %68, label %79, label %98

79:                                               ; preds = %78, %90
  %80 = phi i8 [ %96, %90 ], [ %76, %78 ]
  %81 = phi i64 [ %93, %90 ], [ %64, %78 ]
  %82 = phi i8* [ %95, %90 ], [ %1, %78 ]
  %83 = sext i8 %80 to i32
  %84 = call i8* @strchr(i8* nonnull %5, i32 %83) #9
  %85 = icmp eq i8* %84, null
  br i1 %85, label %90, label %86

86:                                               ; preds = %79
  %87 = add i64 %81, 1
  %88 = getelementptr inbounds i8, i8* %75, i64 %81
  store i8 92, i8* %88, align 1
  %89 = load i8, i8* %82, align 1
  br label %90

90:                                               ; preds = %86, %79
  %91 = phi i8 [ %89, %86 ], [ %80, %79 ]
  %92 = phi i64 [ %87, %86 ], [ %81, %79 ]
  %93 = add i64 %92, 1
  %94 = getelementptr inbounds i8, i8* %75, i64 %92
  store i8 %91, i8* %94, align 1
  %95 = getelementptr inbounds i8, i8* %82, i64 1
  %96 = load i8, i8* %95, align 1
  %97 = icmp eq i8 %96, 0
  br i1 %97, label %107, label %79

98:                                               ; preds = %78, %98
  %99 = phi i8 [ %105, %98 ], [ %76, %78 ]
  %100 = phi i64 [ %102, %98 ], [ %64, %78 ]
  %101 = phi i8* [ %104, %98 ], [ %1, %78 ]
  %102 = add i64 %100, 1
  %103 = getelementptr inbounds i8, i8* %75, i64 %100
...
107:                                              ; preds = %98, %90, %61
  %108 = phi i64 [ %64, %61 ], [ %93, %90 ], [ %102, %98 ]
  %109 = getelementptr inbounds i8, i8* %75, i64 %108
  store i8 0, i8* %109, align 1
  %110 = load i8, i8* %70, align 1
  %111 = icmp eq i8 %110, 0
  br i1 %111, label %120, label %14

112:                                              ; preds = %59, %44
  %113 = add i64 %46, 2
  %114 = call i8* @xrealloc(i8* %48, i64 %113) #2
  %115 = add i64 %46, 1
  %116 = getelementptr inbounds i8, i8* %114, i64 %46
...
120:                                              ; preds = %107, %36, %112, %10, %8
  %121 = phi i8* [ %9, %8 ], [ %11, %10 ], [ %114, %112 ], [ %38, %36 ], [ %75, %107 ]
