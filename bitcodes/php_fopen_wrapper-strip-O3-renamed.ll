; ModuleID = 'php_fopen_wrapper-strip-O3-renamed.bc'
...
24:                                               ; preds = %19
  call void @_php_stream_filter_append(%2* nonnull %14, %3* nonnull %22) #11
  br label %26
...
26:                                               ; preds = %25, %24, %15
  %27 = call i8* @strtok_r(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @33, i64 0, i64 0), i8** nonnull %5) #11
  %28 = icmp eq i8* %27, null
  br i1 %28, label %50, label %15

29:                                               ; preds = %9, %47
  %30 = phi i8* [ %48, %47 ], [ %7, %9 ]
  %31 = call i64 @strlen(i8* nonnull %30) #12
  %32 = call i64 @php_url_decode(i8* nonnull %30, i64 %31) #11
  %33 = load i8, i8* %12, align 8
  %34 = and i8 %33, 1
  %35 = call %3* @php_stream_filter_create(i8* nonnull %30, %17* null, i8 zeroext %34) #11
  %36 = icmp eq %3* %35, null
  br i1 %36, label %38, label %37

37:                                               ; preds = %29
  call void @_php_stream_filter_append(%2* nonnull %13, %3* nonnull %35) #11
  br label %39

38:                                               ; preds = %29
  call void (i8*, i32, i8*, ...) @php_error_docref0(i8* null, i32 2, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @34, i64 0, i64 0), i8* nonnull %30) #11
  br label %39
...
40:                                               ; preds = %39
  ...
  %42 = and i8 %41, 1
  %43 = call %3* @php_stream_filter_create(i8* nonnull %30, %17* null, i8 zeroext %42) #11
  %44 = icmp eq %3* %43, null
  br i1 %44, label %46, label %45

45:                                               ; preds = %40
  call void @_php_stream_filter_append(%2* nonnull %14, %3* nonnull %43) #11
  br label %47
...
47:                                               ; preds = %39, %45, %46
  %48 = call i8* @strtok_r(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @33, i64 0, i64 0), i8** nonnull %5) #11
