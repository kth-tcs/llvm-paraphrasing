; ModuleID = 'menu-strip-O2-renamed.bc'
...
176:                                              ; preds = %174, %181
  %177 = phi i32 [ %172, %174 ], [ %182, %181 ]
  br i1 %175, label %181, label %178

178:                                              ; preds = %176
  %179 = load i8, i8* %99, align 1
...
185:                                              ; preds = %178, %184
  %186 = getelementptr inbounds %5, %5* %0, i64 0, i32 27
  %187 = load i64, i64* %186, align 8
  %188 = or i64 %187, 33554432
  store i64 %188, i64* %186, align 8
  br label %210

189:                                              ; preds = %98, %98
  %190 = add nsw i32 %10, -6
  %191 = icmp sgt i32 %12, %190
  %192 = add nsw i32 %12, 5
  %193 = add nsw i32 %10, -1
...
196:                                              ; preds = %189
  %197 = icmp eq i8* %99, null
  br label %198

198:                                              ; preds = %196, %203
  %199 = phi i32 [ %194, %196 ], [ %204, %203 ]
  br i1 %197, label %203, label %200

200:                                              ; preds = %198
  %201 = load i8, i8* %99, align 1
...
206:                                              ; preds = %200, %203, %189
  %207 = getelementptr inbounds %5, %5* %0, i64 0, i32 27
  %208 = load i64, i64* %207, align 8
  %209 = or i64 %208, 33554432
  store i64 %209, i64* %207, align 8
  br label %210

210:                                              ; preds = %132, %127, %98, %206, %185
  br label %255

211:                                              ; preds = %98, %69
  %212 = icmp eq i32 %12, -1
  br i1 %212, label %255, label %213

213:                                              ; preds = %211
  %214 = getelementptr inbounds %2, %2* %8, i64 0, i32 1
  %215 = load %3*, %3** %214, align 8
  br label %216

216:                                              ; preds = %213, %93
  %217 = phi %3* [ %23, %93 ], [ %215, %213 ]
  %218 = phi i32 [ %94, %93 ], [ %12, %213 ]
  %219 = sext i32 %218 to i64
  %220 = getelementptr inbounds %3, %3* %217, i64 %219, i32 0
...
223:                                              ; preds = %216
  ...
  %225 = icmp eq i8 %224, 45
  br i1 %225, label %255, label %226

226:                                              ; preds = %223
  %227 = getelementptr inbounds %92, %92* %6, i64 0, i32 8
  %228 = load void (%2*, i32, i64, i8*)*, void (%2*, i32, i64, i8*)** %227, align 8
  %229 = icmp eq void (%2*, i32, i64, i8*)* %228, null
  br i1 %229, label %235, label %230

230:                                              ; preds = %226
  %231 = getelementptr inbounds %3, %3* %217, i64 %219, i32 1
  %232 = load i64, i64* %231, align 8
  %233 = getelementptr inbounds %92, %92* %6, i64 0, i32 9
  %234 = load i8*, i8** %233, align 8
  tail call void %228(%2* %8, i32 %218, i64 %232, i8* %234) #6
  store void (%2*, i32, i64, i8*)* null, void (%2*, i32, i64, i8*)** %227, align 8
  br label %255

235:                                              ; preds = %226
  %236 = getelementptr inbounds %92, %92* %6, i64 0, i32 0
  %237 = load %4*, %4** %236, align 8
  %238 = icmp eq %4* %237, null
  br i1 %238, label %241, label %239

239:                                              ; preds = %235
  %240 = tail call %77* @cmdq_get_event(%4* nonnull %237) #6
  br label %241

241:                                              ; preds = %235, %239
  %242 = phi %77* [ %240, %239 ], [ null, %235 ]
  %243 = getelementptr inbounds %92, %92* %6, i64 0, i32 2
  %244 = tail call %96* @cmdq_new_state(%91* nonnull %243, %77* %242, i32 0) #6
  %245 = getelementptr inbounds %3, %3* %217, i64 %219, i32 2
  %246 = load i8*, i8** %245, align 8
  %247 = call i32 @cmd_parse_and_append(i8* %246, %97* null, %5* %0, %96* %244, i8** nonnull %3) #6
  %248 = icmp eq i32 %247, 1
  br i1 %248, label %249, label %254

249:                                              ; preds = %241
  %250 = load i8*, i8** %3, align 8
  %251 = call %4* @cmdq_get_error(i8* %250) #6
  %252 = call %4* @cmdq_append(%5* %0, %4* %251) #6
  %253 = load i8*, i8** %3, align 8
  call void @free(i8* %253) #6
  br label %254

254:                                              ; preds = %249, %241
  call void @cmdq_free_state(%96* %244) #6
  br label %255

255:                                              ; preds = %216, %223, %211, %98, %98, %98, %98, %137, %127, %77, %74, %65, %63, %58, %30, %254, %230, %210, %165, %123
  %256 = phi i32 [ 1, %230 ], [ 1, %254 ], [ 0, %210 ], [ 0, %165 ], [ 0, %123 ], [ %35, %30 ], [ 1, %58 ], [ 0, %63 ], [ 0, %65 ], [ 0, %74 ], [ 0, %77 ], [ 1, %127 ], [ 1, %137 ], [ 1, %98 ], [ 1, %98 ], [ 1, %98 ], [ 1, %98 ], [ 1, %211 ], [ 1, %223 ], [ 1, %216 ]
