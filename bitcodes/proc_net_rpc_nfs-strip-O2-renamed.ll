; ModuleID = 'proc_net_rpc_nfs-strip-O2-renamed.bc'
...
358:                                              ; preds = %355, %396
  %359 = phi i64 [ 2, %355 ], [ %403, %396 ]
  %360 = phi i32 [ 2, %355 ], [ %402, %396 ]
  %361 = phi i32 [ 0, %355 ], [ %401, %396 ]
  %362 = phi i64 [ 0, %355 ], [ %400, %396 ]
...
424:                                              ; preds = %421, %462
  %425 = phi i64 [ 2, %421 ], [ %469, %462 ]
  %426 = phi i32 [ 2, %421 ], [ %468, %462 ]
  %427 = phi i32 [ 0, %421 ], [ %467, %462 ]
  %428 = phi i64 [ 0, %421 ], [ %466, %462 ]
...
490:                                              ; preds = %487, %528
  %491 = phi i64 [ 2, %487 ], [ %535, %528 ]
  %492 = phi i32 [ 2, %487 ], [ %534, %528 ]
  %493 = phi i32 [ 0, %487 ], [ %533, %528 ]
  %494 = phi i64 [ 0, %487 ], [ %532, %528 ]
