; ModuleID = 'cmd-kill-pane-strip-O2-renamed.bc'
...
define internal i32 @4(%3* %0, %4* %1) #0 {
  ...
  %7 = getelementptr inbounds %8, %8* %4, i64 0, i32 5
  %8 = load %40*, %40** %7, align 8
  %9 = tail call i32 @args_has(%5* %3, i8 zeroext 97) #2
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %31, label %11

11:                                               ; preds = %2
  %12 = getelementptr inbounds %28, %28* %6, i64 0, i32 2
  %13 = load %32*, %32** %12, align 8
  tail call void @server_unzoom_window(%32* %13) #2
  %14 = load %32*, %32** %12, align 8
  %15 = getelementptr inbounds %32, %32* %14, i64 0, i32 10, i32 0
  %16 = load %40*, %40** %15, align 8
  %17 = icmp eq %40* %16, null
  br i1 %17, label %29, label %18

18:                                               ; preds = %11, %25
  %19 = phi %40* [ %21, %25 ], [ %16, %11 ]
  %20 = getelementptr inbounds %40, %40* %19, i64 0, i32 43, i32 0
  %21 = load %40*, %40** %20, align 8
  %22 = icmp eq %40* %19, %8
  br i1 %22, label %25, label %23

23:                                               ; preds = %18
  tail call void @server_client_remove_pane(%40* nonnull %19) #2
  tail call void @layout_close_pane(%40* nonnull %19) #2
  %24 = load %32*, %32** %12, align 8
  tail call void @window_remove_pane(%32* %24, %40* nonnull %19) #2
  br label %25

25:                                               ; preds = %18, %23
  %26 = icmp eq %40* %21, null
  br i1 %26, label %27, label %18

27:                                               ; preds = %25
  %28 = load %32*, %32** %12, align 8
  br label %29

29:                                               ; preds = %27, %11
  %30 = phi %32* [ %28, %27 ], [ %14, %11 ]
  tail call void @server_redraw_window(%32* %30) #2
  br label %32

31:                                               ; preds = %2
  tail call void @server_kill_pane(%40* %8) #2
  br label %32
...
declare dso_local void @layout_close_pane(%40*) local_unnamed_addr #1

declare dso_local void @window_remove_pane(%32*, %40*) local_unnamed_addr #1

declare dso_local void @server_redraw_window(%32*) local_unnamed_addr #1

declare dso_local void @server_kill_pane(%40*) local_unnamed_addr #1
