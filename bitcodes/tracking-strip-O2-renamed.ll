; ModuleID = 'tracking-strip-O2-renamed.bc'
...
45:                                               ; preds = %39, %29, %34, %44
  %46 = call i32 @raxNext(%34* nonnull %5) #6
  %47 = icmp eq i32 %46, 0
  br i1 %47, label %48, label %29

48:                                               ; preds = %45, %21
  call void @raxStop(%34* nonnull %5) #6
  %49 = call i64 @raxSize(%0* %18) #6
  %50 = load i64, i64* @TrackingTableTotalItems, align 8
  %51 = sub i64 %50, %49
  store i64 %51, i64* @TrackingTableTotalItems, align 8
  call void @raxFree(%0* %18) #6
  %52 = load %0*, %0** @TrackingTable, align 8
  %53 = call i32 @raxRemove(%0* %52, i8* %1, i64 %2, i8** null) #6
...
44:                                               ; preds = %53, %27
  %45 = phi i8* [ %63, %53 ], [ %37, %27 ]
  br label %46

46:                                               ; preds = %49, %44
  %47 = call i32 @raxNext(%34* nonnull %3) #6
  %48 = icmp eq i32 %47, 0
...
53:                                               ; preds = %49
  ...
  %55 = call i32 @ll2string(i8* nonnull %29, i64 32, i64 %54) #6
  %56 = sext i32 %55 to i64
  %57 = call i8* @sdscatlen(i8* %45, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @11, i64 0, i64 0), i64 1) #6
  %58 = call i8* @sdscatlen(i8* %57, i8* nonnull %29, i64 %56) #6
  %59 = call i8* @sdscatlen(i8* %58, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @10, i64 0, i64 0), i64 2) #6
  %60 = load i8*, i8** %42, align 8
  %61 = load i64, i64* %41, align 8
  %62 = call i8* @sdscatlen(i8* %59, i8* %60, i64 %61) #6
  %63 = call i8* @sdscatlen(i8* %62, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @10, i64 0, i64 0), i64 2) #6
  br label %44
...
65:                                               ; preds = %13, %25, %64
  %66 = phi i8* [ %45, %64 ], [ null, %25 ], [ null, %13 ]
  call void @llvm.lifetime.end.p0i8(i64 480, i8* nonnull %5) #6
  ret i8* %66
}
