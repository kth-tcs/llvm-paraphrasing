; ModuleID = 'min-strip-O3-renamed.bc'
source_filename = "web/api/queries/min/min.c"
...
define dso_local noalias nonnull i8* @grouping_create_min(%0* nocapture readnone %0) local_unnamed_addr #0 {
  %2 = tail call noalias nonnull i8* @callocz(i64 1, i64 32) #5
  ret i8* %2
}
...
define dso_local void @grouping_reset_min(%0* nocapture readonly %0) local_unnamed_addr #2 {
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_free_min(%0* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %0, %0* %0, i64 0, i32 16, i32 8
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_add_min(%0* nocapture readonly %0, x86_fp80 %1) local_unnamed_addr #0 {
  %3 = tail call i32 @__isnanl(x86_fp80 %1) #6
  %4 = icmp eq i32 %3, 0
...
14:                                               ; preds = %5
  %15 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %1)
  %16 = getelementptr inbounds %38, %38* %8, i64 0, i32 0
...
20:                                               ; preds = %12, %14
  %21 = phi x86_fp80* [ %13, %12 ], [ %16, %14 ]
  store x86_fp80 %1, x86_fp80* %21, align 16
  %22 = add i64 %10, 1
  store i64 %22, i64* %9, align 16
  br label %23
...
; Function Attrs: norecurse nounwind uwtable
define dso_local x86_fp80 @grouping_flush_min(%0* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #2 {
