; ModuleID = 'tr2_cmd_name-strip-renamed.bc'
...
define dso_local void @tr2_cmd_name_append_hierarchy(i8* %0) #0 {
  ...
  %5 = call i8* @getenv(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @0, i32 0, i32 0)) #8
  store i8* %5, i8** %3, align 8
  call void @6(%0* @1, i64 0)
...
13:                                               ; preds = %8
  ...
  call void @7(%0* @1, i8* %14)
  call void @8(%0* @1, i32 47)
  br label %15

15:                                               ; preds = %13, %8, %1
  %16 = load i8*, i8** %2, align 8
  call void @7(%0* @1, i8* %16)
  %17 = load i8*, i8** getelementptr inbounds (%0, %0* @1, i32 0, i32 2), align 8
  %18 = call i32 @setenv(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @0, i32 0, i32 0), i8* %17, i32 1) #8
...
define internal void @6(%0* %0, i64 %1) #3 {
  %3 = alloca %0*, align 8
...
19:                                               ; preds = %16
  call void (i8*, ...) @die(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @2, i32 0, i32 0)) #9
  unreachable
...
38:                                               ; preds = %34
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @4, i32 0, i32 0), i32 168, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @5, i32 0, i32 0)) #10
  unreachable
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @7(%0* %0, i8* %1) #3 {
  %3 = alloca %0*, align 8
  %4 = alloca i8*, align 8
  store %0* %0, %0** %3, align 8
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @8(%0* %0, i32 %1) #3 {
  %3 = alloca %0*, align 8
...
; Function Attrs: nounwind uwtable
define dso_local i8* @tr2_cmd_name_get_hierarchy() #0 {
  %1 = load i8*, i8** getelementptr inbounds (%0, %0* @1, i32 0, i32 2), align 8
  ret i8* %1
}
