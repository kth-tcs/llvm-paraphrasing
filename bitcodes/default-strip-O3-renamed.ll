; ModuleID = 'default-strip-O3-renamed.bc'
...
71:                                               ; preds = %68, %63, %58, %50
  %72 = getelementptr inbounds %34, %34* %51, i64 0, i32 1
  %73 = load %34*, %34** %72, align 8
  %74 = icmp eq %34* %73, null
  br i1 %74, label %9, label %50

75:                                               ; preds = %47, %96
  %76 = phi %34* [ %99, %96 ], [ %24, %47 ]
  %77 = getelementptr inbounds %34, %34* %76, i64 0, i32 0
  %78 = load %33*, %33** %77, align 8
  %79 = getelementptr inbounds %33, %33* %78, i64 0, i32 0, i32 1
...
83:                                               ; preds = %75
  ...
  %86 = tail call i32 @repo_parse_commit_gently(%0* %85, %33* nonnull %78, i32 0) #4
  %87 = icmp eq i32 %86, 0
  br i1 %87, label %88, label %96

88:                                               ; preds = %83
  %89 = getelementptr inbounds %33, %33* %78, i64 0, i32 0, i32 0
  tail call void @prio_queue_put(%37* %6, i8* %89) #4
...
96:                                               ; preds = %93, %88, %83, %75
  %97 = load %33*, %33** %77, align 8
  tail call fastcc void @7(%36* %5, %33* %97, i32 1, i32 0) #4
  %98 = getelementptr inbounds %34, %34* %76, i64 0, i32 1
  %99 = load %34*, %34** %98, align 8
  %100 = icmp eq %34* %99, null
  br i1 %100, label %9, label %75

101:                                              ; preds = %9
  %102 = getelementptr inbounds %33, %33* %44, i64 0, i32 0, i32 2
  br label %103

103:                                              ; preds = %11, %14, %101
  %104 = phi %4* [ %102, %101 ], [ null, %14 ], [ null, %11 ]
  ret %4* %104
}
