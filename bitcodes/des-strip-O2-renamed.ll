; ModuleID = 'des-strip-O2-renamed.bc'
...
define dso_local void @grouping_init_des() local_unnamed_addr #0 {
  %1 = load i64, i64* @2, align 8
  %2 = tail call i64 @appconfig_get_number(%0* nonnull @netdata_config, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @1, i64 0, i64 0), i64 %1) #5
  %3 = icmp slt i64 %2, 2
  br i1 %3, label %4, label %7

4:                                                ; preds = %0
  %5 = load i64, i64* @2, align 8
  %6 = tail call i64 @appconfig_set_number(%0* nonnull @netdata_config, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @1, i64 0, i64 0), i64 %5) #5
  br label %8
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @grouping_create_des(%11* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = tail call noalias i8* @malloc(i64 112) #5
...
22:                                               ; preds = %9
  %23 = getelementptr inbounds %11, %11* %0, i64 0, i32 16, i32 0
  %24 = load i64, i64* %23, align 16
  br label %25

25:                                               ; preds = %9, %22
  %26 = phi i64 [ %24, %22 ], [ %4, %9 ]
  %27 = sitofp i64 %26 to x86_fp80
  %28 = fcmp ogt x86_fp80 %27, %13
  %29 = select i1 %28, x86_fp80 %13, x86_fp80 %27
  %30 = fadd x86_fp80 %29, 0xK3FFF8000000000000000
  %31 = fdiv x86_fp80 0xK40008000000000000000, %30
  %32 = getelementptr inbounds i8, i8* %2, i64 32
  %33 = bitcast i8* %32 to x86_fp80*
  store x86_fp80 %31, x86_fp80* %33, align 16
  %34 = fsub x86_fp80 0xK3FFF8000000000000000, %31
  %35 = getelementptr inbounds i8, i8* %2, i64 48
  %36 = bitcast i8* %35 to x86_fp80*
  store x86_fp80 %34, x86_fp80* %36, align 16
  %37 = getelementptr inbounds i8, i8* %2, i64 64
  %38 = bitcast i8* %37 to x86_fp80*
  store x86_fp80 0xK00000000000000000000, x86_fp80* %38, align 16
  %39 = getelementptr inbounds i8, i8* %2, i64 80
  %40 = bitcast i8* %39 to x86_fp80*
  store x86_fp80 0xK00000000000000000000, x86_fp80* %40, align 16
  %41 = getelementptr inbounds i8, i8* %2, i64 96
...
define dso_local void @grouping_reset_des(%11* nocapture readonly %0) local_unnamed_addr #3 {
  %2 = getelementptr inbounds %11, %11* %0, i64 0, i32 16, i32 8
  %3 = bitcast i8** %2 to %41**
  %4 = load %41*, %41** %3, align 8
  %5 = getelementptr inbounds %41, %41* %4, i64 0, i32 4
  store x86_fp80 0xK00000000000000000000, x86_fp80* %5, align 16
  %6 = getelementptr inbounds %41, %41* %4, i64 0, i32 5
  store x86_fp80 0xK00000000000000000000, x86_fp80* %6, align 16
  %7 = getelementptr inbounds %41, %41* %4, i64 0, i32 6
  store i64 0, i64* %7, align 16
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @grouping_free_des(%11* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %11, %11* %0, i64 0, i32 16, i32 8
...
; Function Attrs: nounwind uwtable
define dso_local void @grouping_add_des(%11* nocapture readonly %0, x86_fp80 %1) local_unnamed_addr #0 {
...
9:                                                ; preds = %2
  %10 = getelementptr inbounds %41, %41* %5, i64 0, i32 6
...
12:                                               ; preds = %9
  %13 = getelementptr inbounds %41, %41* %5, i64 0, i32 4
  %14 = load x86_fp80, x86_fp80* %13, align 16
  %15 = getelementptr inbounds %41, %41* %5, i64 0, i32 5
  %16 = load x86_fp80, x86_fp80* %15, align 16
  br label %22

17:                                               ; preds = %9
  %18 = getelementptr inbounds %41, %41* %5, i64 0, i32 5
  %19 = load x86_fp80, x86_fp80* %18, align 16
  %20 = fsub x86_fp80 %1, %19
  store x86_fp80 %20, x86_fp80* %18, align 16
  %21 = getelementptr inbounds %41, %41* %5, i64 0, i32 4
  store x86_fp80 %1, x86_fp80* %21, align 16
  br label %22

22:                                               ; preds = %12, %17
  %23 = phi x86_fp80* [ %15, %12 ], [ %18, %17 ]
  %24 = phi x86_fp80* [ %13, %12 ], [ %21, %17 ]
  %25 = phi x86_fp80 [ %16, %12 ], [ %20, %17 ]
  %26 = phi x86_fp80 [ %14, %12 ], [ %1, %17 ]
  %27 = getelementptr inbounds %41, %41* %5, i64 0, i32 0
  %28 = load x86_fp80, x86_fp80* %27, align 16
  %29 = fmul x86_fp80 %28, %1
  %30 = getelementptr inbounds %41, %41* %5, i64 0, i32 1
  %31 = load x86_fp80, x86_fp80* %30, align 16
  %32 = fadd x86_fp80 %26, %25
  %33 = fmul x86_fp80 %31, %32
  %34 = fadd x86_fp80 %29, %33
  store x86_fp80 %34, x86_fp80* %24, align 16
  %35 = getelementptr inbounds %41, %41* %5, i64 0, i32 2
  %36 = load x86_fp80, x86_fp80* %35, align 16
  %37 = fsub x86_fp80 %34, %26
  %38 = fmul x86_fp80 %36, %37
  %39 = getelementptr inbounds %41, %41* %5, i64 0, i32 3
  %40 = load x86_fp80, x86_fp80* %39, align 16
  %41 = fmul x86_fp80 %25, %40
  %42 = fadd x86_fp80 %41, %38
  store x86_fp80 %42, x86_fp80* %23, align 16
  br label %46

43:                                               ; preds = %9
  %44 = getelementptr inbounds %41, %41* %5, i64 0, i32 5
  store x86_fp80 %1, x86_fp80* %44, align 16
  %45 = getelementptr inbounds %41, %41* %5, i64 0, i32 4
  store x86_fp80 %1, x86_fp80* %45, align 16
  br label %46

46:                                               ; preds = %43, %22
  %47 = add i64 %11, 1
  store i64 %47, i64* %10, align 16
  br label %48
...
declare dso_local i32 @__fpclassifyl(x86_fp80) local_unnamed_addr #4

; Function Attrs: nounwind uwtable
define dso_local x86_fp80 @grouping_flush_des(%11* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %11, %11* %0, i64 0, i32 16, i32 8
  %4 = bitcast i8** %3 to %41**
  %5 = load %41*, %41** %4, align 8
  %6 = getelementptr inbounds %41, %41* %5, i64 0, i32 6
...
9:                                                ; preds = %2
  ...
  %12 = tail call i32 @__fpclassifyl(x86_fp80 %11) #6
  %13 = and i32 %12, 1
  %14 = icmp eq i32 %13, 0
