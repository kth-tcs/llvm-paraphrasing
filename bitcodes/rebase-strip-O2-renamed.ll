; ModuleID = 'rebase-strip-O2-renamed.bc'
...
60:                                               ; preds = %50, %55
  ...
  call fastcc void @381(%48* nonnull sret %10, %1* nonnull %0) #11
...
220:                                              ; preds = %2, %217
  ...
  call fastcc void @381(%48* nonnull sret %14, %1* nonnull %0)
...
719:                                              ; preds = %717
  ...
  %724 = bitcast %7* %15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %724) #11
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %724, i8* align 8 bitcast (%7* @358 to i8*), i64 24, i1 false) #11
  %725 = load i32, i32* %331, align 8
  %726 = add i32 %725, -1
...
738:                                              ; preds = %719, %731, %734
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %724) #11
...
775:                                              ; preds = %717
  ...
  %778 = bitcast %7* %14 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %778) #11
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %778, i8* align 8 bitcast (%7* @358 to i8*), i64 24, i1 false) #11
  %779 = load i32, i32* %331, align 8
  %780 = add i32 %779, -1
...
806:                                              ; preds = %717
  ...
  %809 = bitcast %7* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %809) #11
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %809, i8* align 8 bitcast (%7* @358 to i8*), i64 24, i1 false) #11
  %810 = load i32, i32* %331, align 8
  %811 = add i32 %810, -1
...
823:                                              ; preds = %806, %816, %819
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %809) #11
...
; Function Attrs: nounwind uwtable
define internal fastcc void @381(%48* noalias sret %0, %1* nocapture readonly %1) unnamed_addr #0 {
...
62:                                               ; preds = %58
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 %63, i8* nonnull align 1 %64, i64 32, i1 false) #11
