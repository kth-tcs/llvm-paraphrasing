; ModuleID = 'geohash-strip-O2-renamed.bc'
...
define dso_local i32 @geohashEncodeWGS84(double %0, double %1, i8 zeroext %2, %1* %3) local_unnamed_addr #2 {
  ...
  %10 = bitcast %0* %8 to <2 x double>*
  store <2 x double> <double 0xC0554345B1A57F00, double 0x40554345B1A57F00>, <2 x double>* %10, align 16
  %11 = call i32 @geohashEncode(%0* nonnull %7, %0* nonnull %8, double %0, double %1, i8 zeroext %2, %1* %3) #4
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %6) #4
  ret i32 %11
}
...
define dso_local i32 @geohashDecodeWGS84(i64 %0, i8 %1, %2* %2) local_unnamed_addr #2 {
  %4 = tail call i32 @geohashDecode(double -1.800000e+02, double 1.800000e+02, double 0xC0554345B1A57F00, double 0x40554345B1A57F00, i64 %0, i8 %1, %2* %2) #4
  ret i32 %4
}
...
7:                                                ; preds = %3
  %8 = call i32 @geohashDecode(double -1.800000e+02, double 1.800000e+02, double 0xC0554345B1A57F00, double 0x40554345B1A57F00, i64 %0, i8 %1, %2* nonnull %4) #4
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %27, label %10

10:                                               ; preds = %7
  %11 = getelementptr inbounds %2, %2* %4, i64 0, i32 1, i32 0
  %12 = load double, double* %11, align 8
  %13 = getelementptr inbounds %2, %2* %4, i64 0, i32 1, i32 1
  %14 = bitcast double* %13 to <2 x double>*
  %15 = load <2 x double>, <2 x double>* %14, align 8
  %16 = getelementptr inbounds %2, %2* %4, i64 0, i32 2, i32 1
  ...
  %22 = fcmp ogt <2 x double> %21, <double 1.800000e+02, double 0x40554345B1A57F00>
  %23 = select <2 x i1> %22, <2 x double> <double 1.800000e+02, double 0x40554345B1A57F00>, <2 x double> %21
  %24 = fcmp olt <2 x double> %23, <double -1.800000e+02, double 0xC0554345B1A57F00>
  %25 = select <2 x i1> %24, <2 x double> <double -1.800000e+02, double 0xC0554345B1A57F00>, <2 x double> %23
  %26 = bitcast double* %2 to <2 x double>*
  store <2 x double> %25, <2 x double>* %26, align 8
  br label %27

27:                                               ; preds = %3, %7, %10
  %28 = phi i32 [ 1, %10 ], [ 0, %7 ], [ 0, %3 ]
...
define dso_local i32 @geohashDecodeToLongLatWGS84(i64 %0, i8 %1, double* %2) local_unnamed_addr #2 {
  ...
  %5 = bitcast %2* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 48, i8* nonnull %5) #4
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %5, i8 0, i64 48, i1 false) #4
  %6 = icmp eq double* %2, null
  br i1 %6, label %27, label %7
